...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        int getRccTransportControlFlagsFromActions(long j) {
            ...
            return (j & 256) != 0 ? rccTransportControlFlagsFromActions | Fields.RotationX : rccTransportControlFlagsFromActions;
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        int getRccTransportControlFlagsFromActions(long j) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j);
            return (j & 128) != 0 ? rccTransportControlFlagsFromActions | Fields.RotationY : rccTransportControlFlagsFromActions;
        }
