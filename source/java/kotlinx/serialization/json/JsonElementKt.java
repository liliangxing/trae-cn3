...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m2061JsonPrimitive7apg3OU(byte b) {
        return m2062JsonPrimitiveVKZWuLQ(ULong.m553constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m2064JsonPrimitivexj2QHRw(short s) {
        return m2062JsonPrimitiveVKZWuLQ(ULong.m553constructorimpl(s & 65535));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m2063JsonPrimitiveWZ4Q5Ns(int i) {
        return m2062JsonPrimitiveVKZWuLQ(ULong.m553constructorimpl(i & BodyPartID.bodyIdMax));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m2062JsonPrimitiveVKZWuLQ(long j) {
        String m28m;
        m28m = UByte$$ExternalSyntheticBackport0.m28m(j, 10);
        return JsonUnquotedLiteral(m28m);
    }
