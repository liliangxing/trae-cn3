...
public final class SerialDescriptorImpl implements SerialDescriptor, CachedNames {
    ...
    public SerialDescriptorImpl(String serialName, SerialKind kind, int i, List<? extends SerialDescriptor> typeParameters, ClassSerialDescriptorBuilder builder) {
        ...
        for (IndexedValue indexedValue : withIndex) {
            arrayList.add(TuplesKt.m12to(indexedValue.getValue(), Integer.valueOf(indexedValue.getIndex())));
        }
    ...
    public static final int _hashCode_delegate$lambda$1(SerialDescriptorImpl this$0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence toString$lambda$3(SerialDescriptorImpl this$0, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
