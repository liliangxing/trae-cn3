...
public final class TimeZoneSerializer implements KSerializer<TimeZone> {
    ...
    public TimeZone deserialize(Decoder decoder) {
        ...
        return TimeZone.INSTANCE.m61of(decoder.decodeString());
    }
