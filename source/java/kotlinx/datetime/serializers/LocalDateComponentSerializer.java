...
public final class LocalDateComponentSerializer implements KSerializer<LocalDate> {
    ...
    private static final SerialDescriptor descriptor = SerialDescriptorsKt.buildClassSerialDescriptor("kotlinx.datetime.LocalDate", new SerialDescriptor[0], new Function1() { // from class: kotlinx.datetime.serializers.LocalDateComponentSerializer$$ExternalSyntheticLambda0
