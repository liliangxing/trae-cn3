...
public final class DayBasedDateTimeUnitSerializer implements KSerializer<DateTimeUnit.DayBased> {
    ...
    private static final Lazy descriptor = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0() { // from class: kotlinx.datetime.serializers.DayBasedDateTimeUnitSerializer$$ExternalSyntheticLambda1
    ...
    public static final SerialDescriptor descriptor_delegate$lambda$1() {
        return SerialDescriptorsKt.buildClassSerialDescriptor("kotlinx.datetime.DayBased", new SerialDescriptor[0], new Function1() { // from class: kotlinx.datetime.serializers.DayBasedDateTimeUnitSerializer$$ExternalSyntheticLambda0
