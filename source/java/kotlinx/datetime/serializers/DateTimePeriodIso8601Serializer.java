...
public final class DateTimePeriodIso8601Serializer implements KSerializer<DateTimePeriod> {
    ...
    private DateTimePeriodIso8601Serializer() {
    }
    ...
    public DateTimePeriod deserialize(Decoder decoder) {
        ...
        return DateTimePeriod.INSTANCE.parse(decoder.decodeString());
    }
