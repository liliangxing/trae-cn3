...
public final class MonthDirective extends UnsignedIntFieldFormatDirective<DateFieldContainer> {
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "monthNumber()" : "monthNumber(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }

    public boolean equals(Object other) {
        return (other instanceof MonthDirective) && this.padding == ((MonthDirective) other).padding;
    }
