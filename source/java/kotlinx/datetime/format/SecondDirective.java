...
public final class SecondDirective extends UnsignedIntFieldFormatDirective<TimeFieldContainer> {
    ...
    public SecondDirective(Padding padding) {
        super(TimeFields.INSTANCE.getSecond(), padding == Padding.ZERO ? 2 : 1, padding == Padding.SPACE ? 2 : null);
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "second()" : "second(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }

    public boolean equals(Object other) {
        return (other instanceof SecondDirective) && this.padding == ((SecondDirective) other).padding;
    }
