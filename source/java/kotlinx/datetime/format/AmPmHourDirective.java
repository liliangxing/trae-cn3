...
public final class AmPmHourDirective extends UnsignedIntFieldFormatDirective<TimeFieldContainer> {
    ...
    public AmPmHourDirective(Padding padding) {
        super(TimeFields.INSTANCE.getHourOfAmPm(), padding == Padding.ZERO ? 2 : 1, padding == Padding.SPACE ? 2 : null);
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "amPmHour()" : "amPmHour(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }

    public boolean equals(Object other) {
        return (other instanceof AmPmHourDirective) && this.padding == ((AmPmHourDirective) other).padding;
    }
