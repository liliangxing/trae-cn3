...
public final class DayDirective extends UnsignedIntFieldFormatDirective<DateFieldContainer> {
    ...
    public DayDirective(Padding padding) {
        super(DateFields.INSTANCE.getDayOfMonth(), padding == Padding.ZERO ? 2 : 1, padding == Padding.SPACE ? 2 : null);
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "dayOfMonth()" : "dayOfMonth(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }

    public boolean equals(Object other) {
        return (other instanceof DayDirective) && this.padding == ((DayDirective) other).padding;
    }
