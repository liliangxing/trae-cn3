...
public final class HourDirective extends UnsignedIntFieldFormatDirective<TimeFieldContainer> {
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "hour()" : "hour(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }
