...
public final class UtcOffsetSecondOfMinuteDirective extends UnsignedIntFieldFormatDirective<UtcOffsetFieldContainer> {
    ...
    public UtcOffsetSecondOfMinuteDirective(Padding padding) {
        super(OffsetFields.INSTANCE.getSecondsOfMinute(), padding == Padding.ZERO ? 2 : 1, padding == Padding.SPACE ? 2 : null);
    ...
    public String getBuilderRepresentation() {
        return WhenMappings.$EnumSwitchMapping$0[this.padding.ordinal()] == 1 ? "offsetSecondsOfMinute()" : "offsetSecondsOfMinute(" + DateTimeFormatKt.toKotlinCode(this.padding) + ')';
    }
