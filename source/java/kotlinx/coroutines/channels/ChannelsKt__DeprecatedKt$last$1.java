...
@DebugMetadata(m41c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m42f = "Deprecated.kt", m43i = {0, 0, 1, 1, 1}, m44l = {127, 130}, m45m = "last", m46n = {"$this$consume$iv", "iterator", "$this$consume$iv", "iterator", "last"}, m47s = {"L$0", "L$1", "L$0", "L$1", "L$2"})
