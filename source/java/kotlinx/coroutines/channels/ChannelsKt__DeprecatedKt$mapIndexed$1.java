...
@DebugMetadata(m41c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$mapIndexed$1", m42f = "Deprecated.kt", m43i = {0, 0, 1, 1, 2, 2}, m44l = {374, 375, 375}, m45m = "invokeSuspend", m46n = {"$this$produce", ClassOf.INDEX, "$this$produce", ClassOf.INDEX, "$this$produce", ClassOf.INDEX}, m47s = {"L$0", "I$0", "L$0", "I$0", "L$0", "I$0"})
