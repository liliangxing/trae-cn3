...
@DebugMetadata(m41c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", m42f = "Deprecated.kt", m43i = {0, 1, 1, 2}, m44l = {228, 229, 229}, m45m = "invokeSuspend", m46n = {"$this$produce", "$this$produce", "e", "$this$produce"}, m47s = {"L$0", "L$0", "L$2", "L$0"})
