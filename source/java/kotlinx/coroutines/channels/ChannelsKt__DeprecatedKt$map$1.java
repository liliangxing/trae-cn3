...
@DebugMetadata(m41c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$map$1", m42f = "Deprecated.kt", m43i = {0, 0, 1, 1, 2, 2}, m44l = {517, 363, 363}, m45m = "invokeSuspend", m46n = {"$this$produce", "$this$consume$iv$iv", "$this$produce", "$this$consume$iv$iv", "$this$produce", "$this$consume$iv$iv"}, m47s = {"L$0", "L$2", "L$0", "L$2", "L$0", "L$2"})
