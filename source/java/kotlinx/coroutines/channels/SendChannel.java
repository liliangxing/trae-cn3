...
public interface SendChannel<E> {
    ...
    Object mo11765trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo11765trySendJP2dKIU = sendChannel.mo11765trySendJP2dKIU(e);
            if (ChannelResult.m11786isSuccessimpl(mo11765trySendJP2dKIU)) {
                return true;
            }
            Throwable m11780exceptionOrNullimpl = ChannelResult.m11780exceptionOrNullimpl(mo11765trySendJP2dKIU);
            if (m11780exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m11780exceptionOrNullimpl);
        }
    }
}
