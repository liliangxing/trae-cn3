...
public class BufferedChannel<E> implements Channel<E> {
    ...
    private static /* synthetic */ void m59x1df74ada() {
    }
    ...
    public Object mo1884receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1882receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(sendException)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:51:0x00bf, code lost:
    
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m1906successJP2dKIU(kotlin.Unit.INSTANCE);
     */
    @Override // kotlinx.coroutines.channels.SendChannel
    ...
    */
    public Object mo1880trySendJP2dKIU(E element) {
        Object obj;
        ChannelSegment channelSegment;
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.INSTANCE.m1905failurePtdJZtk();
        }
        ...
        return ChannelResult.INSTANCE.m1904closedJP2dKIU(getSendException());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: BufferedChannel.kt */
    @Metadata(m4d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0013\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0005J\u001d\u0010\b\u001a\u00020\t2\n\u0010\n\u001a\u0006\u0012\u0002\b\u00030\u000b2\u0006\u0010\f\u001a\u00020\rH\u0096\u0001R\u0017\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000e"}, m5d2 = {"Lkotlinx/coroutines/channels/BufferedChannel$SendBroadcast;", "Lkotlinx/coroutines/Waiter;", "cont", "Lkotlinx/coroutines/CancellableContinuation;", BuildConfig.FLAVOR, "(Lkotlinx/coroutines/CancellableContinuation;)V", "getCont", "()Lkotlinx/coroutines/CancellableContinuation;", "invokeOnCancellation", BuildConfig.FLAVOR, "segment", "Lkotlinx/coroutines/internal/Segment;", ClassOf.INDEX, BuildConfig.FLAVOR, "kotlinx-coroutines-core"}, m6k = 1, m7mv = {1, 9, 0}, m9xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    ...
    public final Object m1886trySendDropOldestJP2dKIU(E element) {
        ChannelSegment channelSegment;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m1891boximpl = ChannelResult.m1891boximpl(ChannelResult.INSTANCE.m1906successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m1891boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
            return tryResume02;
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static /* synthetic */ <E> Object m1882receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof BufferedChannel$receiveCatching$1) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (updateCellReceive != symbol) {
                        ...
                        if (updateCellReceive != symbol2) {
                            ...
                            if (updateCellReceive == symbol3) {
                                ...
                                Object m1883receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m1883receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                                return m1883receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : m1883receiveCatchingOnNoWaiterSuspendGKJJFZk;
                            }
                            channelSegment.cleanPrev();
                            return ChannelResult.INSTANCE.m1906successJP2dKIU(updateCellReceive);
                        }
                        if (andIncrement < bufferedChannel.getSendersCounter$kotlinx_coroutines_core()) {
                            channelSegment.cleanPrev();
                        }
                ...
                return ChannelResult.INSTANCE.m1904closedJP2dKIU(bufferedChannel.getCloseCause());
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m1883receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        int i2;
        Symbol symbol;
        Symbol symbol2;
        ChannelResult m1891boximpl;
        Symbol symbol3;
        Symbol symbol4;
        Symbol symbol5;
                    ...
                    try {
                        ...
                        if (updateCellReceive != symbol) {
                            ...
                            if (updateCellReceive == symbol2) {
                                ...
                                while (true) {
                                    ...
                                    if (updateCellReceive2 != symbol3) {
                                        ...
                                        if (updateCellReceive2 != symbol4) {
                                            ...
                                            m1891boximpl = ChannelResult.m1891boximpl(ChannelResult.INSTANCE.m1906successJP2dKIU(updateCellReceive2));
                                            Function1<E, Unit> function12 = this.onUndeliveredElement;
                                            if (function12 != null) {
                                ...
                                channelSegment.cleanPrev();
                                m1891boximpl = ChannelResult.m1891boximpl(ChannelResult.INSTANCE.m1906successJP2dKIU(updateCellReceive));
                            ...
                            orCreateCancellableContinuation.resume(m1891boximpl, function1);
                        } else {
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m378constructorimpl(ChannelResult.m1891boximpl(ChannelResult.INSTANCE.m1904closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo1885tryReceivePtdJZtk() {
        Object obj;
        ChannelSegment channelSegment;
        Symbol symbol;
        Symbol symbol2;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m1904closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1891boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m1904closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m1906successJP2dKIU(selectResult));
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m378constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    protected boolean closeOrCancelImpl(Throwable cause, boolean cancel) {
        ...
        symbol = BufferedChannelKt.NO_CLOSE_CAUSE;
        boolean m39m = UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater, this, symbol, cause);
        if (cancel) {
            markCancelled();
        } else {
            markClosed();
    ...
    private final void invokeCloseHandler() {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater, this, obj, obj == null ? BufferedChannelKt.CLOSE_HANDLER_CLOSED : BufferedChannelKt.CLOSE_HANDLER_INVOKED));
        if (obj == null) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        Symbol symbol3;
        Symbol symbol4;
        if (UByte$$ExternalSyntheticBackport0.m39m(closeHandler$volatile$FU, this, (Object) null, handler)) {
            return;
        }
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater, this, symbol3, symbol4));
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object m1926constructorimpl$default = InlineList.m1926constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol2 || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                m1926constructorimpl$default = InlineList.m1931plusFjFbRPM(m1926constructorimpl$default, waiter);
        ...
        if (m1926constructorimpl$default != null) {
            if (!(m1926constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) m1926constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(m1926constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) m1926constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core != null) {
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m1926constructorimpl$default = InlineList.m1931plusFjFbRPM(m1926constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                ...
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m1926constructorimpl$default = InlineList.m1931plusFjFbRPM(m1926constructorimpl$default, state$kotlinx_coroutines_core);
                                    lastSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            }
        ...
        if (m1926constructorimpl$default != null) {
            if (!(m1926constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m1926constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m1926constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) m1926constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m378constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m378constructorimpl(ChannelResult.m1891boximpl(ChannelResult.INSTANCE.m1904closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        do {
            ...
            if (SegmentOrClosed.m1943isClosedimpl(findSegmentInternal)) {
                break;
            }
            Segment m1941getSegmentimpl = SegmentOrClosed.m1941getSegmentimpl(findSegmentInternal);
            while (true) {
                Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                if (segment.id >= m1941getSegmentimpl.id) {
                    break;
                }
                ...
                if (UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater, this, segment, m1941getSegmentimpl)) {
                    if (segment.decPointers$kotlinx_coroutines_core()) {
                        segment.remove();
                    }
                } else if (m1941getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m1941getSegmentimpl(findSegmentInternal);
    ...
    public final ChannelSegment<E> findSegmentReceive(long id, ChannelSegment<E> startFrom) {
        ...
        if (!isRendezvousOrUnlimited() && id <= getBufferEndCounter() / BufferedChannelKt.SEGMENT_SIZE) {
            ...
            while (true) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater2, this, segment2, channelSegment2)) {
            ...
            if (!startFrom.isRemoved() || (channelSegment = (ChannelSegment) startFrom.getNext()) == null) {
                ...
                while (true) {
                    ...
                    if (!channelSegment3.tryIncPointers$kotlinx_coroutines_core()) {
                        z = false;
                        break;
                    } else if (UByte$$ExternalSyntheticBackport0.m39m(atomicReferenceFieldUpdater, this, segment, channelSegment3)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
    ...
    */
        ...
        loop2: while (true) {
            ...
            while (true) {
                ...
                if (element$kotlinx_coroutines_core != null) {
                    sb.append("(" + obj + AbstractJsonLexerKt.COMMA + element$kotlinx_coroutines_core + "),");
                } else {
                    sb.append(obj + AbstractJsonLexerKt.COMMA);
                }
                i4++;
            }
            i2 = 0;
    ...
    public final String toStringDebug$kotlinx_coroutines_core() {
        ...
        ChannelSegment channelSegment3 = (ChannelSegment) next;
        do {
            StringBuilder append = new StringBuilder().append(DebugStringsKt.getHexAddress(channelSegment3)).append("=[").append(channelSegment3.isRemoved() ? "*" : BuildConfig.FLAVOR).append(channelSegment3.id).append(",prev=");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:111:0x0202 A[SYNTHETIC] */
    ...
    */
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m378constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            cancellableContinuationImpl.resumeWith(m378constructorimpl);
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            }
            if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00c8, code lost:
        ...
        r11.resumeWith(kotlin.Result.m378constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuationImpl2.resumeWith(Result.m378constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
