...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m1908trySendImplMj0NB7M = conflatedBufferedChannel.m1908trySendImplMj0NB7M(e, true);
        if (m1908trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1895exceptionOrNullimpl(m1908trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m1908trySendImplMj0NB7M = conflatedBufferedChannel.m1908trySendImplMj0NB7M(e, true);
        if (!(m1908trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1880trySendJP2dKIU(E element) {
        return m1908trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1908trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1907trySendDropLatestMj0NB7M(element, isSendOp) : m1886trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1907trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo1880trySendJP2dKIU = super.mo1880trySendJP2dKIU(element);
        if (ChannelResult.m1901isSuccessimpl(mo1880trySendJP2dKIU) || ChannelResult.m1899isClosedimpl(mo1880trySendJP2dKIU)) {
            return mo1880trySendJP2dKIU;
        }
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo1880trySendJP2dKIU = mo1880trySendJP2dKIU(element);
        if (!(mo1880trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo1880trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1895exceptionOrNullimpl(mo1880trySendJP2dKIU);
