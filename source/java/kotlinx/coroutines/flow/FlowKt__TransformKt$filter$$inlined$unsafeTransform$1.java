...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    public static final class C00602<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m6k = 3, m7mv = {1, 9, 0}, m9xi = 176)
        @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m42f = "Transform.kt", m43i = {0, 0}, m44l = {219, 219}, m45m = "emit", m46n = {"value", "$this$filter_u24lambda_u240"}, m47s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C00602.this.emit(null, this);
            }
        }

        public C00602(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C00602(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C00602 c00602 = new C00602(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c00602, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
