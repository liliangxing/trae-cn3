...
public final class C0051xdf1aa1b6<T> implements FlowCollector<T> {
    final /* synthetic */ FlowCollector $$this$flow$inlined;
    final /* synthetic */ Function3 $transform$inlined;

    /* compiled from: Limit.kt */
    @Metadata(m6k = 3, m7mv = {1, 9, 0}, m9xi = 48)
    @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", m42f = "Limit.kt", m43i = {0}, m44l = {139}, m45m = "emit", m46n = {"this"}, m47s = {"L$0"})
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return C0051xdf1aa1b6.this.emit(null, this);
        }
    }

    public C0051xdf1aa1b6(Function3 function3, FlowCollector flowCollector) {
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        Object obj;
        int i;
        C0051xdf1aa1b6<T> c0051xdf1aa1b6;
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    c0051xdf1aa1b6 = (C0051xdf1aa1b6) anonymousClass1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                if (((Boolean) obj).booleanValue()) {
                    throw new AbortFlowException(c0051xdf1aa1b6);
                }
