...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", m42f = "Builders.kt", m43i = {0}, m44l = {114}, m45m = "collect", m46n = {"$this$asFlow_u24lambda_u243"}, m47s = {"L$0"})
        ...
        if (continuation instanceof C00311) {
            ...
            if ((c00311.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    it = (Iterator) c00311.L$1;
                    FlowCollector flowCollector3 = (FlowCollector) c00311.L$0;
                    ResultKt.throwOnFailure(obj);
                    flowCollector2 = flowCollector3;
                }
                while (it.hasNext()) {
                    T next = it.next();
                    c00311.L$0 = flowCollector2;
                    c00311.L$1 = it;
                    c00311.label = 1;
                    if (flowCollector2.emit(next, c00311) == coroutine_suspended) {
