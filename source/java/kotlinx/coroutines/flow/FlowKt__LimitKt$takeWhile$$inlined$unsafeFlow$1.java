...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1", m42f = "Limit.kt", m43i = {0}, m44l = {123}, m45m = "collect", m46n = {"collector$iv"}, m47s = {"L$0"})
        ...
        if (continuation instanceof C00491) {
            ...
            if ((c00491.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        c00491.L$0 = flowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$12;
                        c00491.label = 1;
                        if (flow.collect(flowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$12, c00491) == coroutine_suspended) {
                    ...
                    flowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1 = (FlowKt__LimitKt$takeWhile$lambda$6$$inlined$collectWhile$1) c00491.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
