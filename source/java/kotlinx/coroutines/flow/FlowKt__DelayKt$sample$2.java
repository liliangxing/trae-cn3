...
@DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", m42f = "Delay.kt", m43i = {0, 0, 0, 0}, m44l = {415}, m45m = "invokeSuspend", m46n = {"downstream", "values", "lastValue", "ticker"}, m47s = {"L$0", "L$1", "L$2", "L$3"})
...
public final class FlowKt__DelayKt$sample$2<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (objectRef.element != NullSurrogateKt.DONE) {
            SelectImplementation selectImplementation = new SelectImplementation(flowKt__DelayKt$sample$2.get$context());
            SelectImplementation selectImplementation2 = selectImplementation;
            selectImplementation2.invoke(receiveChannel.getOnReceiveCatching(), new FlowKt__DelayKt$sample$2$1$1(objectRef, fixedPeriodTicker, null));
            selectImplementation2.invoke(fixedPeriodTicker.getOnReceive(), new FlowKt__DelayKt$sample$2$1$2(objectRef, flowCollector, null));
