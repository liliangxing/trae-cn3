...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    public static final class C00702<T> implements FlowCollector {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m6k = 3, m7mv = {1, 9, 0}, m9xi = 176)
        @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m42f = "Transform.kt", m43i = {0}, m44l = {219, 220}, m45m = "emit", m46n = {"$this$mapNotNull_u24lambda_u246"}, m47s = {"L$0"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C00702.this.emit(null, this);
            }
        }

        public C00702(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new C00702(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C00702 c00702 = new C00702(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c00702, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
