...
@DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m42f = "Delay.kt", m43i = {}, m44l = {204}, m45m = "invokeSuspend", m46n = {}, m47s = {})
...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class C00391<T> implements FlowCollector {
        ...
        C00391(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_debounceInternal.collect(new C00391(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
