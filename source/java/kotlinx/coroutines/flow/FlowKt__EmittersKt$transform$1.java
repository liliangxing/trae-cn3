...
@DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1", m42f = "Emitters.kt", m43i = {}, m44l = {EACTags.APPLICATION_EXPIRATION_DATE}, m45m = "invokeSuspend", m46n = {}, m47s = {})
...
public final class FlowKt__EmittersKt$transform$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* compiled from: Emitters.kt */
    @Metadata(m4d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m5d2 = {"<anonymous>", BuildConfig.FLAVOR, "T", "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m6k = 3, m7mv = {1, 9, 0}, m9xi = 176)
    ...
    public static final class C00451<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public C00451(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
            this.$transform = function3;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_transform.collect(new C00451(this.$transform, flowCollector), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector flowCollector = (FlowCollector) this.L$0;
        InlineMarker.mark(0);
        this.$this_transform.collect(new C00451(this.$transform, flowCollector), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
