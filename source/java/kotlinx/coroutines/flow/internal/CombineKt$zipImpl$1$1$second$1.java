...
@Metadata(m4d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u008a@"}, m5d2 = {"<anonymous>", BuildConfig.FLAVOR, "T1", "T2", "R", "Lkotlinx/coroutines/channels/ProducerScope;", BuildConfig.FLAVOR}, m6k = 3, m7mv = {1, 9, 0}, m9xi = 48)
@DebugMetadata(m41c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1", m42f = "Combine.kt", m43i = {}, m44l = {86}, m45m = "invokeSuspend", m46n = {}, m47s = {})
...
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    public static final class C00951<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C00951(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$flow2.collect(new C00951(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
