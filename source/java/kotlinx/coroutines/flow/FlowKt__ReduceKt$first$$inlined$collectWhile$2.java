...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m41c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m42f = "Reduce.kt", m43i = {0, 0}, m44l = {139}, m45m = "emit", m46n = {"this", "it"}, m47s = {"L$0", "L$1"})
        ...
        if (continuation instanceof C00541) {
            ...
            if ((c00541.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    t = (T) c00541.L$1;
                    flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c00541.L$0;
                    ResultKt.throwOnFailure(obj);
                }
