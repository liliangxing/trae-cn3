...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, cause, 15, null))) {
                    completedContinuation.invokeHandlers(this, cause);
                    return;
                }
            } else if (UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, null, null, null, cause, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        UByte$$ExternalSyntheticBackport0.m39m(_parentHandle$volatile$FU, this, (Object) null, invokeOnCompletion$default);
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, handler)) {
                    return;
                }
            } else {
                if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                    ...
                    if (obj instanceof CompletedContinuation) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, resumeMode, onCancellation, null)));
        detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m39m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, this.resumeMode, onCancellation, idempotent)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
