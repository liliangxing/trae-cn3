...
public final class ConcurrentLinkedListKt {
    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(S s, long j, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.id >= j && !s.isRemoved()) {
                return SegmentOrClosed.m11823constructorimpl(s);
            }
            Object nextOrClosed = s.getNextOrClosed();
            if (nextOrClosed == CLOSED) {
                return SegmentOrClosed.m11823constructorimpl(CLOSED);
            }
    ...
    public static final /* synthetic */ <S extends Segment<S>> boolean moveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, S s) {
        while (true) {
            ...
            if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, obj, segment, s)) {
    ...
    public static final /* synthetic */ <S extends Segment<S>> boolean moveForward$atomicfu$array(AtomicReferenceArray atomicReferenceArray, int i, S s) {
        while (true) {
            ...
            if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceArray, i, segment, s)) {
                if (segment.decPointers$kotlinx_coroutines_core()) {
                    segment.remove();
                }
                return true;
    ...
    public static final /* synthetic */ <S extends Segment<S>> Object findSegmentAndMoveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, long j, S s, Function2<? super Long, ? super S, ? extends S> function2) {
        ...
        do {
            ...
            if (!SegmentOrClosed.m11828isClosedimpl(findSegmentInternal)) {
                Segment m11826getSegmentimpl = SegmentOrClosed.m11826getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(obj);
                    z = true;
                    if (segment.id >= m11826getSegmentimpl.id) {
                        break;
                    }
                    if (!m11826getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        z = false;
                        break;
                    }
                    if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, obj, segment, m11826getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m11826getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m11826getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        do {
            ...
            if (!SegmentOrClosed.m11828isClosedimpl(findSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceArray, i, segment, m11826getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m11826getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
