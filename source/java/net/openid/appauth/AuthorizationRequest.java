...
public class AuthorizationRequest {
    ...
    private static final Set<String> BUILT_IN_PARAMS = AdditionalParamsProcessor.builtInParams("client_id", PARAM_CODE_CHALLENGE, PARAM_CODE_CHALLENGE_METHOD, "display", "login_hint", "prompt", PARAM_REDIRECT_URI, PARAM_RESPONSE_MODE, PARAM_RESPONSE_TYPE, "scope", "state");
    ...
    public static AuthorizationRequest jsonDeserialize(JSONObject jSONObject) throws JSONException {
        ...
        Builder additionalParameters = new Builder(AuthorizationServiceConfiguration.fromJson(jSONObject.getJSONObject(KEY_CONFIGURATION)), JsonUtil.getString(jSONObject, KEY_CLIENT_ID), JsonUtil.getString(jSONObject, KEY_RESPONSE_TYPE), JsonUtil.getUri(jSONObject, KEY_REDIRECT_URI)).setDisplay(JsonUtil.getStringIfDefined(jSONObject, "display")).setLoginHint(JsonUtil.getStringIfDefined(jSONObject, "login_hint")).setPrompt(JsonUtil.getStringIfDefined(jSONObject, "prompt")).setState(JsonUtil.getStringIfDefined(jSONObject, "state")).setCodeVerifier(JsonUtil.getStringIfDefined(jSONObject, KEY_CODE_VERIFIER), JsonUtil.getStringIfDefined(jSONObject, KEY_CODE_VERIFIER_CHALLENGE), JsonUtil.getStringIfDefined(jSONObject, KEY_CODE_VERIFIER_CHALLENGE_METHOD)).setResponseMode(JsonUtil.getStringIfDefined(jSONObject, KEY_RESPONSE_MODE)).setAdditionalParameters(JsonUtil.getStringMap(jSONObject, KEY_ADDITIONAL_PARAMETERS));
