...
public class RegistrationRequest {
    ...
    public static final class Builder {
        ...
        public RegistrationRequest build() {
            ...
            return new RegistrationRequest(authorizationServiceConfiguration, unmodifiableList, list2, list3, this.mSubjectType, this.mTokenEndpointAuthenticationMethod, Collections.unmodifiableMap(this.mAdditionalParameters));
        }
    }
