...
public final class UriUtil {
    ...
    public static String formUrlEncode(Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            arrayList.add(entry.getKey() + ContainerUtils.KEY_VALUE_DELIMITER + formUrlEncodeValue(entry.getValue()));
        }
    ...
    public static List<Pair<String, String>> formUrlDecode(String str) {
        ...
        for (String str2 : split) {
            ...
            try {
                arrayList.add(Pair.create(split2[0], URLDecoder.decode(split2[1], Constant.CHARSET_UTF_8)));
