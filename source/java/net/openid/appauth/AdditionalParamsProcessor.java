...
class AdditionalParamsProcessor {
    ...
    public static Set<String> builtInParams(String... strArr) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Map<String, String> checkAdditionalParams(Map<String, String> map, Set<String> set) {
        if (map == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Map<String, String> extractAdditionalParams(JSONObject jSONObject, Set<String> set) throws JSONException {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Map<String, String> extractAdditionalParams(Uri uri, Set<String> set) {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
