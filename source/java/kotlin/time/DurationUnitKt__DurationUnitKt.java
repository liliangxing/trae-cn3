    ...
    public static final String shortName(DurationUnit durationUnit) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[durationUnit.ordinal()]) {
            ...
            case 4:
                return "s";
            case 5:
                return AirActionConstant.ActionId.ACTION_ID_MEMBER;
            case 6:
    ...
    public static final DurationUnit durationUnitByShortName(String shortName) {
        ...
        if (hashCode != 100) {
            if (hashCode != 104) {
                ...
                } else if (shortName.equals(AirActionConstant.ActionId.ACTION_ID_MEMBER)) {
                    return DurationUnit.MINUTES;
                }
            } else if (shortName.equals(RXScreenCaptureService.KEY_HEIGHT)) {
                return DurationUnit.HOURS;
            }
        } else if (shortName.equals(AirActionConstant.ActionId.ACTION_ID_DEFAULT_VALUE)) {
