...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m10253constructorimpl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m10253constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m10253constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m10253constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable m10256exceptionOrNullimpl = Result.m10256exceptionOrNullimpl(obj);
        return m10256exceptionOrNullimpl == null ? obj : onFailure.invoke(m10256exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m10259isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return onFailure.invoke(m10256exceptionOrNullimpl);
    }

    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m10260isSuccessimpl(obj)) {
            return Result.m10253constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m10253constructorimpl(transform.invoke(obj));
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m10253constructorimpl(transform.invoke(m10256exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable m10256exceptionOrNullimpl = Result.m10256exceptionOrNullimpl(obj);
        if (m10256exceptionOrNullimpl != null) {
            action.invoke(m10256exceptionOrNullimpl);
        }
        return obj;
    }
