...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1590getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m377boximpl(result);
