...
public final class RealCall implements Call {
    ...
    private RealCall(OkHttpClient okHttpClient, Request request, boolean z) {
        ...
        AsyncTimeout asyncTimeout = new AsyncTimeout() { // from class: okhttp3.RealCall.1
            ...
            protected void timedOut() {
                RealCall.this.cancelWithError(TTOkHttpConstants.ERR_TTNET_REQUEST_TIMED_OUT);
            }
        };
    ...
    @Override // okhttp3.Call
    public void cancel() {
        cancelWithError(TTOkHttpConstants.ERR_TTNET_UNKNOWN);
    }

    public void cancelWithError(int i) {
        this.retryAndFollowUpInterceptor.cancel(i);
    }
    ...
    Response getResponseWithInterceptorChain() throws IOException {
        ...
        throw new IOException("Canceled#Reason=" + this.retryAndFollowUpInterceptor.canceledReason());
    }
}
