...
public final class ConnectionSpec {
    ...
    private static final TlsVersion[] tlsVersionsAll;
    private static final TlsVersion[] tlsVersionsWithout1_1;
    ...
    static {
        ...
        tlsVersionsAll = tlsVersionArr;
        TlsVersion[] tlsVersionArr2 = {TlsVersion.TLS_1_3, TlsVersion.TLS_1_2};
        tlsVersionsWithout1_1 = tlsVersionArr2;
        Builder cipherSuites = new Builder(true).cipherSuites(cipherSuiteArr2);
        if (!TTConfigManager.inst().enableTls1_1()) {
            tlsVersionArr = tlsVersionArr2;
        }
        MODERN_TLS = cipherSuites.tlsVersions(tlsVersionArr).supportsTlsExtensions(true).build();
