...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private static boolean shouldParseAuthority(int i, String str) {
            if (i < 2) {
                return false;
            }
            if (TTConfigManager.isIgnoreSlashEnabled()) {
                return !TextUtils.isEmpty(str) && (str.startsWith("https://") || str.startsWith(ResManager.HTTP_SCHEME));
            }
            return true;
        }
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            char c = '?';
            char c2 = '#';
            if (shouldParseAuthority(slashCount, str) || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                boolean z = false;
                boolean z2 = false;
                ...
                while (true) {
                    ...
                    if (charAt == '@') {
                        if (!z) {
                            int delimiterOffset2 = Util.delimiterOffset(str, i2, delimiterOffset, AbstractJsonLexerKt.COLON);
                            i = delimiterOffset;
        ...
        private boolean isDot(String str) {
            return str.equals(LibrarianImpl.Constants.DOT) || str.equalsIgnoreCase("%2e");
        }

        private boolean isDotDot(String str) {
            return str.equals(DownloadConstants.VULNERABILITY_PATH) || str.equalsIgnoreCase("%2e.") || str.equalsIgnoreCase(".%2e") || str.equalsIgnoreCase("%2e%2e");
        }
