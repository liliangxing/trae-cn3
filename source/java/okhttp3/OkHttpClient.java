...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    OkHttpClient(Builder builder) {
        ...
        this.ttnetDns = builder.ttnetDns;
        this.enableBoe = builder.enableBoe;
    ...
    public int pingIntervalMillisWithHostPort(String str, int i) {
        if (!TextUtils.isEmpty(str)) {
            StringBuilder sb = new StringBuilder();
            sb.append(str).append(":").append(i);
            if (TTConfigManager.inst().getPingKeepAliveHosts().contains(sb.toString())) {
                return TTConfigManager.inst().getPingKeepAliveInterval();
            }
        }
        return this.pingInterval;
    }
    ...
    public TTNetDns ttnetDns() {
        return this.ttnetDns;
    }
    ...
    public static final class Builder {
        ...
        Builder(OkHttpClient okHttpClient) {
            ...
            this.ttnetDns = okHttpClient.ttnetDns;
            this.enableBoe = okHttpClient.enableBoe;
        }
        ...
        public Builder ttnetDns(TTNetDns tTNetDns) {
            if (tTNetDns == null) {
                throw new NullPointerException("ttnetDns == null");
            }
            this.ttnetDns = tTNetDns;
            return this;
        }

        public Builder enableBoe(boolean z) {
            this.enableBoe = z;
            return this;
        }
