...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f30id == -1 || solverVariable.f30id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f30id] == null) {
                if (solverVariable.f30id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f30id = i;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f30id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f30id] = true;
            }
            if (pivotCandidate != null) {
