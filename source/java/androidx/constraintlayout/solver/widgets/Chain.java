    ...
    static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        while (true) {
            ...
            if (z6) {
                ...
                linearSystem.addGreaterThan(r6.mListAnchors[i2].mSolverVariable, constraintWidgetContainer.mListAnchors[i2].mSolverVariable, i7, 8);
            }
                    ...
                    while (i5 < size) {
                        ...
                        if (f8 == f6) {
                            ...
                            if (constraintWidget14 != null) {
                                ...
                                arrayList2 = arrayList;
                                SolverVariable solverVariable10 = constraintWidget15.mListAnchors[i12].mSolverVariable;
                                i6 = size;
                    ...
                    if (z13 && constraintWidget8 != null) {
                        ...
                        while (constraintWidget != null) {
                            ...
                            if (constraintWidget == constraintWidget8 || constraintWidget == constraintWidget9 || constraintWidget17 == null) {
                                ...
                                int i15 = i2 + 1;
                                SolverVariable solverVariable15 = constraintWidget16.mListAnchors[i15].mSolverVariable;
                    ...
                    while (constraintWidget19 != null) {
                        ...
                        if (constraintWidget21 != null || constraintWidget19 == constraintWidget9) {
                            ...
                            if (solverVariable16 != null && solverVariable17 != null && solverVariable3 != null && solverVariable4 != null) {
                                ...
                                linearSystem.addCentering(solverVariable16, solverVariable17, i21, 0.5f, solverVariable3, solverVariable4, constraintWidget19 == constraintWidget9 ? constraintWidget9.mListAnchors[i20].getMargin() : margin5, z15 ? 8 : 5);
