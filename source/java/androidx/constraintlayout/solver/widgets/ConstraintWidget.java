...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f34mX + ", " + this.f35mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }

    public int getX() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f34mX;
        }
        return this.f34mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f35mY;
        }
        return this.f35mY;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public int getRootX() {
        return this.f34mX + this.mOffsetX;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public int getRootY() {
        return this.f35mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C00971.f36x4c44d048[type.ordinal()];
        if (i2 == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C00971.f36x4c44d048[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (z16 || this.resolvedVertical) {
            if (z16) {
                linearSystem.addEquality(createObjectVariable, this.f34mX);
                linearSystem.addEquality(createObjectVariable2, this.f34mX + this.mWidth);
            ...
            if (this.resolvedVertical) {
                linearSystem.addEquality(createObjectVariable3, this.f35mY);
                linearSystem.addEquality(createObjectVariable4, this.f35mY + this.mHeight);
                if (this.mBaseline.hasDependents()) {
                    linearSystem.addEquality(createObjectVariable5, this.f35mY + this.mBaselineDistance);
                }
                                            ...
                                            if ((constraintWidget3.mVerticalResolution == 2 ? i9 : i11) != 0 || constraintWidget3.resolvedVertical) {
                                                ...
                                                if (constraintWidget3.mBaselineDistance > 0 || constraintWidget3.mVisibility == i8) {
                                                    if (constraintWidget3.mBaseline.mTarget != null) {
                                                        ...
                                                        solverVariable9 = solverVariable7;
                                                        solverVariable10 = solverVariable8;
                                                        applyConstraints(linearSystem, false, z12, z11, z23, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr2[i10], z22, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.f35mY, i5, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[i10], constraintWidget3.mVerticalBiasPercent, z20, dimensionBehaviourArr2[0] != DimensionBehaviour.MATCH_CONSTRAINT, z4, z5, z192, i2, i3, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z14);
                                                ...
                                                solverVariable9 = solverVariable7;
                                                solverVariable10 = solverVariable8;
                                                applyConstraints(linearSystem, false, z12, z11, z232, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr22[i10], z22, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.f35mY, i5, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[i10], constraintWidget3.mVerticalBiasPercent, z20, dimensionBehaviourArr22[0] != DimensionBehaviour.MATCH_CONSTRAINT, z4, z5, z192, i2, i3, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z14);
                                            }
                                            if (z13) {
    ...
    */
    private void applyConstraints(LinearSystem linearSystem, boolean z, boolean z2, boolean z3, boolean z4, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z5, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, int i6, int i7, int i8, float f2, boolean z11) {
        ...
        int i41 = z6 ? 3 : i5;
        int i42 = C00971.f37xdde91696[dimensionBehaviour.ordinal()];
    ...
    public static /* synthetic */ class C00971 {
        ...
        static {
            ...
            try {
                f37xdde91696[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f37xdde91696[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f37xdde91696[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f36x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f36x4c44d048[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f34mX = constraintWidget.f34mX;
        this.f35mY = constraintWidget.f35mY;
