...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C00991 {
        ...
        static final /* synthetic */ int[] f41xbf6f0c8e;
        ...
        static {
            ...
            try {
                f41xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f41xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    */
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C00991.f41xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 == 1) {
