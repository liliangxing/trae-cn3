...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = (motionPaths2.f28x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f29y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f28x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f29y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 2;
        this.f28x = (int) (((motionPaths.f28x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f29y = (int) (((motionPaths.f29y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f28x;
        float f9 = motionPaths.f29y;
        float f10 = motionPaths2.f28x + (f4 / 2.0f);
        float f11 = motionPaths2.f29y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f28x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f29y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = (motionPaths2.f28x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f29y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f28x, motionPaths.f28x) | z;
        zArr[2] = z | diff(this.f29y, motionPaths.f29y) | zArr[2];
