...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f28x;
        rectF.top = this.mStartMotionPath.f29y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f28x;
        rectF2.top = this.mEndMotionPath.f29y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f28x - this.mStartMotionPath.f28x;
        float f4 = this.mEndMotionPath.f29y - this.mStartMotionPath.f29y;
        float f5 = this.mStartMotionPath.f28x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f29y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (motionPathsArr[i5].attributes.containsKey(str6)) {
                    int[] iArr = this.mAttributeInterpCount;
                    iArr[i4] = iArr[i4] + motionPathsArr[i5].attributes.get(str6).noOfInterpValues();
                    break;
                }
                i5++;
            }
        ...
        while (true) {
            ...
            while (i15 < size) {
                if (motionPathsArr[i15].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        int[] iArr4 = new int[2];
                        iArr4[c] = motionPathsArr[i15].getCustomDataCount(str8);
                        iArr4[0] = size;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                iArr5[i17] = motionPathsArr[i17].mPathMotionArc;
                dArr5[i17] = motionPathsArr[i17].time;
                dArr6[i17][0] = motionPathsArr[i17].f28x;
                dArr6[i17][1] = motionPathsArr[i17].f29y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f28x + " y: " + this.mStartMotionPath.f29y + " end: x: " + this.mEndMotionPath.f28x + " y: " + this.mEndMotionPath.f29y;
    }
    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f2 = this.mStartMotionPath.f28x + ((this.mEndMotionPath.f28x - this.mStartMotionPath.f28x) * adjustedPosition);
            float f3 = this.mStartMotionPath.f29y + ((this.mEndMotionPath.f29y - this.mStartMotionPath.f29y) * adjustedPosition);
            float f4 = f2 + 0.5f;
            int i3 = (int) f4;
            float f5 = f3 + 0.5f;
            int i4 = (int) f5;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f28x - this.mStartMotionPath.f28x;
        float f6 = this.mEndMotionPath.f29y - this.mStartMotionPath.f29y;
