...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual(savedStateEncoder.getKey(), "")) {
            SavedStateWriter.m3114putAllimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), value);
        } else {
            SavedStateWriter.m3137putSavedStateimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
        }
    }

    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public Bundle m3163deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m3080getSavedStateimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
