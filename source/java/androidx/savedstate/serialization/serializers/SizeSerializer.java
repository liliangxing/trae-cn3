...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m3140putSizeimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public Size m3165deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m3086getSizeimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
