...
public abstract class ParcelableSerializer<T extends Parcelable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m3134putParcelableimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public final T m3162deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m3069getParcelableimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
