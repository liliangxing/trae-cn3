...
public final class SparseArraySerializer<T> implements KSerializer<SparseArray<T>> {
    ...
    public SparseArraySerializer(KSerializer<T> kSerializer) {
        ...
        KSerializer<SparseArraySurrogate<T>> serializer = SparseArraySurrogate.INSTANCE.serializer(kSerializer);
    ...
    public SparseArray<T> m3166deserialize(Decoder decoder) {
