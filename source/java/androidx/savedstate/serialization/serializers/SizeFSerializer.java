...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    private static final SerialDescriptor descriptor = SerialDescriptorsKt.buildClassSerialDescriptor$default("android.util.SizeF", new SerialDescriptor[0], (Function1) null, 4, (Object) null);
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m3141putSizeFimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public SizeF m3164deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m3087getSizeFimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
