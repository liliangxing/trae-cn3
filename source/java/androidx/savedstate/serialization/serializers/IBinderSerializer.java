...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m3115putBinderimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }

    /* renamed from: deserialize, reason: merged with bridge method [inline-methods] */
    public IBinder m3157deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m3030getBinderimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
