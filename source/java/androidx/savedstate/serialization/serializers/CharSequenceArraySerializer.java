...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    private static final SerialDescriptor descriptor = SerialDescriptorsKt.buildClassSerialDescriptor$default("kotlin.Array<kotlin.CharSequence>", new SerialDescriptor[0], (Function1) null, 4, (Object) null);
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m3121putCharSequenceArrayimpl(SavedStateWriter.m3110constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m3041getCharSequenceArrayimpl(SavedStateReader.m3023constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
