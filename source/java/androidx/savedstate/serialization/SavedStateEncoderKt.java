...
public final class SavedStateEncoderKt {
    public static final <T> Bundle encodeToSavedState(SerializationStrategy<? super T> serializationStrategy, T t) {
        ...
        Intrinsics.checkNotNullParameter(t, StrategyConstants.VALUE);
