...
public final class MutableStateSerializer<T> implements KSerializer<MutableState<T>> {
    ...
    public MutableState<T> m3149deserialize(Decoder decoder) {
