...
public abstract class VersionedParcel {
    ...
    private Method getReadMethod(String str) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Method declaredMethod = Class.forName(str, true, VersionedParcel.class.getClassLoader()).getDeclaredMethod(SettingV2Monitor.REPORT_TYPE_READ, VersionedParcel.class);
