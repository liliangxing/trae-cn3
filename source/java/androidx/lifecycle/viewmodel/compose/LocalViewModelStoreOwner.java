...
public final class LocalViewModelStoreOwner {
    ...
    private static final ProvidableCompositionLocal<ViewModelStoreOwner> LocalViewModelStoreOwner = CompositionLocalKt.compositionLocalOf$default((SnapshotMutationPolicy) null, new Function0() { // from class: androidx.lifecycle.viewmodel.compose.LocalViewModelStoreOwner$$ExternalSyntheticLambda0
    ...
    public final ViewModelStoreOwner getCurrent(Composer composer, int i) {
        ...
        CompositionLocal compositionLocal = LocalViewModelStoreOwner;
        ...
        if (viewModelStoreOwner == null) {
            ...
            viewModelStoreOwner = LocalViewModelStoreOwner_androidKt.findDefaultViewModelStoreOwner(composer, 0);
        } else {
