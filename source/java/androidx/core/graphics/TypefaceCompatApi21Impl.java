...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
        ...
        try {
            ...
            try {
                ...
                if (file != null && file.canRead()) {
                    Typeface m26xfc14ebfc = m26xfc14ebfc(file);
                    if (openFileDescriptor != null) {
                        openFileDescriptor.close();
                    }
                    return m26xfc14ebfc;
    ...
    /* renamed from: INVOKESTATIC_androidx_core_graphics_TypefaceCompatApi21Impl_com_bytedance_sysoptimizer_TypeFaceLancet_createFromFile */
    public static Typeface m26xfc14ebfc(File file) {
        String path;
