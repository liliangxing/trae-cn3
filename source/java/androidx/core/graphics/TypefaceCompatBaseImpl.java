...
public class TypefaceCompatBaseImpl {
    ...
    public Typeface createFromInputStream(Context context, InputStream inputStream) {
        ...
        try {
            if (TypefaceCompatUtil.copyToFile(tempFile, inputStream)) {
                return m27x5a09830(tempFile.getPath());
            }
            return null;
    ...
    /* renamed from: INVOKESTATIC_androidx_core_graphics_TypefaceCompatBaseImpl_com_bytedance_sysoptimizer_TypeFaceLancet_createFromFile */
    public static Typeface m27x5a09830(String str) {
