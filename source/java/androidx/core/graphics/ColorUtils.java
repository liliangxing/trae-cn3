...
import com.bytedance.mt.protector.impl.color.ColorUtilsLancet;
...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_RGBToXYZ(i, i2, i3, dArr);
    }

    public static void XYZToLAB(double d, double d2, double d3, double[] dArr) {
        androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_XYZToLAB(d, d2, d3, dArr);
    }

    public static void blendHSL(float[] fArr, float[] fArr2, float f, float[] fArr3) {
        androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_blendHSL(fArr, fArr2, f, fArr3);
    }

    public static void blendLAB(double[] dArr, double[] dArr2, double d, double[] dArr3) {
        androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_blendLAB(dArr, dArr2, d, dArr3);
    }

    public static double calculateContrast(int i, int i2) {
        return androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_calculateContrast(i, i2);
    }

    public static int calculateMinimumAlpha(int i, int i2, float f) {
        return androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_calculateMinimumAlpha(i, i2, f);
    }

    public static Color compositeColors(Color color, Color color2) {
        return androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_compositeColors(color, color2);
    }
    ...
    public static double androidx_core_graphics_ColorUtils__calculateContrast$___twin___(int i, int i2) {
    ...
    public static int androidx_core_graphics_ColorUtils__calculateMinimumAlpha$___twin___(int i, int i2, float f) {
        int i3 = 255;
        if (Color.alpha(i2) != 255) {
            throw new IllegalArgumentException("background can not be translucent: #" + Integer.toHexString(i2));
        }
    ...
    public static void androidx_core_graphics_ColorUtils__RGBToXYZ$___twin___(int i, int i2, int i3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void androidx_core_graphics_ColorUtils__XYZToLAB$___twin___(double d, double d2, double d3, double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void androidx_core_graphics_ColorUtils__blendHSL$___twin___(float[] fArr, float[] fArr2, float f, float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void androidx_core_graphics_ColorUtils__blendLAB$___twin___(double[] dArr, double[] dArr2, double d, double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    public static int androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_calculateMinimumAlpha(int i, int i2, float f) {
        if (Protector.enable()) {
            try {
                return androidx_core_graphics_ColorUtils__calculateMinimumAlpha$___twin___(i, i2, f);
            } catch (Throwable th) {
                Integer num = (Integer) ColorUtilsLancet.tryProtect(th, Integer.class);
                if (num == null) {
                    throw th;
                }
                return num.intValue();
    ...
    public static double androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_calculateContrast(int i, int i2) {
        if (Protector.enable()) {
            try {
                return androidx_core_graphics_ColorUtils__calculateContrast$___twin___(i, i2);
            } catch (Throwable th) {
                Double d = (Double) ColorUtilsLancet.tryProtect(th, Double.class);
                if (d == null) {
                    throw th;
                }
    ...
    public static Color androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_compositeColors(Color color, Color color2) {
        if (Protector.enable()) {
            try {
    ...
    @TargetClass("androidx.core.graphics.ColorUtils")
    @Insert("RGBToXYZ")
    public static void androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        if (Protector.enable()) {
            try {
                androidx_core_graphics_ColorUtils__RGBToXYZ$___twin___(i, i2, i3, dArr);
            } catch (Throwable th) {
    ...
    @TargetClass("androidx.core.graphics.ColorUtils")
    @Insert("XYZToLAB")
    public static void androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_XYZToLAB(double d, double d2, double d3, double[] dArr) {
        if (Protector.enable()) {
            try {
                androidx_core_graphics_ColorUtils__XYZToLAB$___twin___(d, d2, d3, dArr);
            } catch (Throwable th) {
                if (Protector.disposeThrowable(ProtectorType.CAST_COLOR, th) == null) {
                    throw th;
                }
    ...
    @TargetClass("androidx.core.graphics.ColorUtils")
    @Insert("blendHSL")
    public static void androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_blendHSL(float[] fArr, float[] fArr2, float f, float[] fArr3) {
        if (Protector.enable()) {
            try {
                androidx_core_graphics_ColorUtils__blendHSL$___twin___(fArr, fArr2, f, fArr3);
            } catch (Throwable th) {
                if (Protector.disposeThrowable(ProtectorType.CAST_COLOR, th) == null) {
                    throw th;
                }
    ...
    @TargetClass("androidx.core.graphics.ColorUtils")
    @Insert("blendLAB")
    public static void androidx_core_graphics_ColorUtils_com_bytedance_mt_protector_impl_color_ColorUtilsLancet_blendLAB(double[] dArr, double[] dArr2, double d, double[] dArr3) {
        if (Protector.enable()) {
            try {
                androidx_core_graphics_ColorUtils__blendLAB$___twin___(dArr, dArr2, d, dArr3);
            } catch (Throwable th) {
                if (Protector.disposeThrowable(ProtectorType.CAST_COLOR, th) == null) {
                    throw th;
                }
