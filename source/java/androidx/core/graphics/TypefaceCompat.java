...
public class TypefaceCompat {
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, Resources resources, int i, String str, int i2, int i3, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z) {
        ...
        if (familyResourceEntry instanceof FontResourcesParserCompat.ProviderResourceEntry) {
            ...
            if (providerResourceEntry.getFallbackRequest() != null) {
                m = UByte$.ExternalSyntheticBackport0.m(providerResourceEntry.getRequest(), providerResourceEntry.getFallbackRequest());
            } else {
                m = UByte$.ExternalSyntheticBackport0.m(providerResourceEntry.getRequest());
            }
            createFromFontFamilyFilesResourceEntry = FontsContractCompat.requestFont(context, (List<FontRequest>) m, i3, z2, timeout, handler2, resourcesCallbackAdapter);
        } else {
    ...
    public static class ResourcesCallbackAdapter extends FontsContractCompat.FontRequestCallback {
        ...
        public void onTypefaceRetrieved(Typeface typeface) {
            ...
            if (fontCallback != null) {
                fontCallback.m9x46c88379(typeface);
            }
        }
