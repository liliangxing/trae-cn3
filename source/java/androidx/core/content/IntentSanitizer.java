...
public class IntentSanitizer {
    ...
    public Intent sanitize(Intent intent, Consumer<String> consumer) {
        ...
        if (extras != null) {
            for (String str3 : extras.keySet()) {
                ...
                } else if (str3.equals(BridgeDataConverterHolder.TYPE_OUTPUT) && ((~this.mAllowedFlags) & 3) != 0) {
    ...
    public static final class Builder {
        ...
        public Builder allowExtraOutput(final String str) {
            allowExtra(BridgeDataConverterHolder.TYPE_OUTPUT, Uri.class, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda8
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
                    equals = str.equals(((Uri) obj).getAuthority());
        ...
        public Builder allowExtraOutput(Predicate<Uri> predicate) {
            allowExtra(BridgeDataConverterHolder.TYPE_OUTPUT, Uri.class, predicate);
            return this;
        }
