...
public final class NotificationManagerCompat {
    ...
    private static String m2x684cb0a5(ContentResolver contentResolver, String str) {
    ...
    public static Set<String> getEnabledListenerPackages(Context context) {
        Set<String> set;
        String m2x684cb0a5 = m2x684cb0a5(context.getContentResolver(), SETTING_ENABLED_NOTIFICATION_LISTENERS);
        synchronized (sEnabledNotificationListenersLock) {
            if (m2x684cb0a5 != null) {
                if (!m2x684cb0a5.equals(sEnabledNotificationListeners)) {
                    String[] split = m2x684cb0a5.split(":", -1);
                    ...
                    sEnabledNotificationListeners = m2x684cb0a5;
                }
            }
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(", id:").append(this.f51id);
    ...
    private static class CancelTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(this.packageName);
            sb.append(", id:").append(this.f50id);
            sb.append(", tag:").append(this.tag);
