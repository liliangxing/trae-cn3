...
public final class RemoteInput {
    ...
    public static Map<String, Uri> getDataResultsFromIntent(Intent intent, String str) {
        ...
        for (String str2 : clipDataIntentFromIntent.getExtras().keySet()) {
            if (str2.startsWith(EXTRA_DATA_TYPE_RESULTS_DATA)) {
                ...
                if (!substring.isEmpty() && (string = INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra(clipDataIntentFromIntent, str2).getString(str)) != null && !string.isEmpty()) {
    ...
    public static void addDataResultToIntent(RemoteInput remoteInput, Intent intent, Map<String, Uri> map) {
        ...
        for (Map.Entry<String, Uri> entry : map.entrySet()) {
            ...
            if (key != null) {
                Bundle INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra = INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra(clipDataIntentFromIntent, getExtraResultsKeyForData(key));
                if (INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra == null) {
                    INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra = new Bundle();
                }
                INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra.putString(remoteInput.getResultKey(), value.toString());
                clipDataIntentFromIntent.putExtra(getExtraResultsKeyForData(key), INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra);
            }
        }
    ...
    public static Bundle INVOKEVIRTUAL_androidx_core_app_RemoteInput_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra(Intent intent, String str) {
