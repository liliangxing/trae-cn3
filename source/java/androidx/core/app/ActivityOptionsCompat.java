...
public class ActivityOptionsCompat {
    ...
    static class Api33Impl {
        ...
        static void setPendingIntentBackgroundActivityLaunchAllowed(ActivityOptions activityOptions, boolean z) {
    ...
    static class Api34Impl {
        ...
        static ActivityOptions setPendingIntentBackgroundActivityStartMode(ActivityOptions activityOptions, int i) {
