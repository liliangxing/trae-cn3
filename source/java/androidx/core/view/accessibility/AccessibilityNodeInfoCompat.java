...
public class AccessibilityNodeInfoCompat {
    ...
    public static class Api35Impl {
        ...
        public static CollectionInfoCompat buildCollectionInfoCompat(int i, int i2, boolean z, int i3, int i4, int i5) {
            return new CollectionInfoCompat.Builder().setRowCount(i).setColumnCount(i2).setHierarchical(z).setSelectionMode(i3).setItemCount(i4).setImportantForAccessibilityItemCount(i5).build();
        }
    }
}
