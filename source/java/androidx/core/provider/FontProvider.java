...
public class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            ArrayList arrayList = new ArrayList();
            Uri build = new Uri.Builder().scheme(StrategyConstants.CONTENT).authority(str).build();
            Uri build2 = new Uri.Builder().scheme(StrategyConstants.CONTENT).authority(str).appendPath(Utils_commonKt.SCHEME_FILE).build();
