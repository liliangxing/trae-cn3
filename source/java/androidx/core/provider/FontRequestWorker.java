...
public class FontRequestWorker {
    ...
    public static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWrapper callbackWrapper, final int i, int i2) {
        final String createCacheId = createCacheId(UByte$.ExternalSyntheticBackport0.m$1(fontRequest), i);
        ...
        if (i2 == -1) {
            TypefaceResult fontSync = getFontSync(createCacheId, context, UByte$.ExternalSyntheticBackport0.m$1(fontRequest), i);
        ...
        try {
            TypefaceResult typefaceResult = (TypefaceResult) RequestExecutor.submit(DEFAULT_EXECUTOR_SERVICE, new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.1
                ...
                public TypefaceResult call() {
                    return FontRequestWorker.getFontSync(createCacheId, context, UByte$.ExternalSyntheticBackport0.m$2(fontRequest), i);
                }
            }, i2);
