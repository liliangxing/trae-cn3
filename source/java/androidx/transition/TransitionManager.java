...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo3169clone = transition.mo3169clone();
        mo3169clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo3169clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo3169clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo3169clone);
    }
    ...
    /* renamed from: go */
    public static void m81go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m82go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo3169clone = transition.mo3169clone();
        sceneChangeSetup(viewGroup, mo3169clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo3169clone);
    }
