        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i9, BasicMeasure.EXACTLY);
                } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i5 = i10;
                                    int makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i12, BasicMeasure.EXACTLY);
