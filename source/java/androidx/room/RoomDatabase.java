...
public abstract class RoomDatabase {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda0
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m3018lambda$beginTransaction$0$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ Object m3018lambda$beginTransaction$0$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalBeginTransaction();
        return null;
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda1
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m3019lambda$endTransaction$1$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ Object m3019lambda$endTransaction$1$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalEndTransaction();
        return null;
    }
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            if (this.mAutoCloseTimeout > 0) {
                ...
                factory = new AutoClosingRoomOpenHelperFactory(factory, new AutoCloser(this.mAutoCloseTimeout, this.mAutoCloseTimeUnit, this.mTransactionExecutor));
            }
            ...
            SupportSQLiteOpenHelper.Factory queryInterceptorOpenHelperFactory = this.mQueryCallback != null ? new QueryInterceptorOpenHelperFactory(factory, this.mQueryCallback, this.mQueryCallbackExecutor) : factory;
