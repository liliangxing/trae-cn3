...
public final class TableInfo {
    ...
    private static Set<ForeignKey> readForeignKeys(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            int columnIndex2 = query.getColumnIndex(OnekeyLoginConstants.CU_KEY_SEQ);
    ...
    private static List<ForeignKeyWithSequence> readForeignKeyFieldMappings(Cursor cursor) {
        ...
        int columnIndex2 = cursor.getColumnIndex(OnekeyLoginConstants.CU_KEY_SEQ);
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1) {
                HashSet hashSet = new HashSet();
                while (query.moveToNext()) {
                    if (AirActionConstant.ActionId.ACTION_ID_CALL.equals(query.getString(columnIndex2))) {
                        String string = query.getString(columnIndex);
                        boolean z = true;
    ...
    public static final class Column {
        ...
        private static boolean containsSurroundingParenthesis(String str) {
            if (str.length() == 0) {
                return false;
            }
            int i = 0;
    ...
    public static final class Index {
        ...
        public String toString() {
            return "Index{name='" + this.name + "', unique=" + this.unique + ", columns=" + this.columns + ", orders=" + this.orders + AbstractJsonLexerKt.END_OBJ;
        }
    }
}
