...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    public void beginTransaction() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda8
            ...
            public final void run() {
                QueryInterceptorDatabase.this.m3008lambda$beginTransaction$0$androidxroomQueryInterceptorDatabase();
            }
        });
    ...
    public /* synthetic */ void m3008lambda$beginTransaction$0$androidxroomQueryInterceptorDatabase() {
    ...
    public void beginTransactionNonExclusive() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m69x9d2bf0fa();
            }
        });
    ...
    public /* synthetic */ void m69x9d2bf0fa() {
    ...
    public void beginTransactionWithListener(SQLiteTransactionListener sQLiteTransactionListener) {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m70xe4527eb0();
            }
        });
    ...
    public /* synthetic */ void m70xe4527eb0() {
        this.mQueryCallback.onQuery("BEGIN EXCLUSIVE TRANSACTION", Collections.emptyList());
    }
    ...
    public void beginTransactionWithListenerNonExclusive(SQLiteTransactionListener sQLiteTransactionListener) {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m71xa78c463e();
            }
        });
    ...
    public /* synthetic */ void m71xa78c463e() {
        this.mQueryCallback.onQuery("BEGIN DEFERRED TRANSACTION", Collections.emptyList());
    }
    ...
    public void endTransaction() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3009lambda$endTransaction$4$androidxroomQueryInterceptorDatabase();
            }
        });
    ...
    public /* synthetic */ void m3009lambda$endTransaction$4$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m72x7d646086() {
    ...
    public void setTransactionSuccessful() {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m72x7d646086();
            }
        });
    ...
    public /* synthetic */ void m3012lambda$query$6$androidxroomQueryInterceptorDatabase(String str) {
    ...
    public Cursor query(final String str) {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3012lambda$query$6$androidxroomQueryInterceptorDatabase(str);
            }
        });
    ...
    public Cursor query(final String str, Object[] objArr) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3013lambda$query$7$androidxroomQueryInterceptorDatabase(str, arrayList);
            }
        });
    ...
    public /* synthetic */ void m3013lambda$query$7$androidxroomQueryInterceptorDatabase(String str, List list) {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3014lambda$query$8$androidxroomQueryInterceptorDatabase(supportSQLiteQuery, queryInterceptorProgram);
            }
        });
    ...
    public /* synthetic */ void m3014lambda$query$8$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3015lambda$query$9$androidxroomQueryInterceptorDatabase(supportSQLiteQuery, queryInterceptorProgram);
            }
        });
        return this.mDelegate.query(supportSQLiteQuery);
    }
    ...
    public /* synthetic */ void m3015lambda$query$9$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
        this.mQueryCallback.onQuery(supportSQLiteQuery.getSql(), queryInterceptorProgram.getBindArgs());
    }
    ...
    public void execSQL(final String str) throws SQLException {
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3010lambda$execSQL$10$androidxroomQueryInterceptorDatabase(str);
            }
        });
    ...
    public /* synthetic */ void m3010lambda$execSQL$10$androidxroomQueryInterceptorDatabase(String str) {
    ...
    public void execSQL(final String str, Object[] objArr) throws SQLException {
        ...
        this.mQueryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.this.m3011lambda$execSQL$11$androidxroomQueryInterceptorDatabase(str, arrayList);
            }
        });
    ...
    public /* synthetic */ void m3011lambda$execSQL$11$androidxroomQueryInterceptorDatabase(String str, List list) {
        this.mQueryCallback.onQuery(str, list);
    }
