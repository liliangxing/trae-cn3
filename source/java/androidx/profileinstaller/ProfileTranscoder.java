...
public class ProfileTranscoder {
    ...
    private static void writeMethodBitmapForS(OutputStream outputStream, int i, DexProfileData dexProfileData) throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : dexProfileData.methods.entrySet()) {
            ...
            for (int i3 = 1; i3 <= 4; i3 <<= 1) {
                if (i3 != 1 && (i3 & i) != 0) {
                    if ((i3 & intValue2) == i3) {
                        int i4 = (dexProfileData.numMethodIds * i2) + intValue;
                        int i5 = i4 / 8;
    ...
    private static String generateDexKey(String str, String str2, byte[] bArr) {
        ...
        return str2.endsWith(com.ss.android.socialbase.appdownloader.constants.Constants.APK_SUFFIX) ? str2 : str + ProfileVersion.dexKeySeparator(bArr) + str2;
    }
