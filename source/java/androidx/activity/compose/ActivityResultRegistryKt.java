...
public final class ActivityResultRegistryKt {
    /* JADX WARN: Code restructure failed: missing block: B:12:0x00b5, code lost:
        ...
        if (r1 == androidx.compose.runtime.Composer.INSTANCE.getEmpty()) goto L14;
     */
    /*
    ...
    */
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> activityResultContract, Function1<? super O, Unit> function1, Composer composer, int i) {
        ...
        String str = (String) RememberSaveableKt.m4241rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        Object obj2 = (Function1) new ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1(activityResultLauncherHolder, activityResultRegistry, str, activityResultContract, rememberUpdatedState2);
        composer.updateRememberedValue(obj2);
        obj = obj2;
        composer.endReplaceableGroup();
        EffectsKt.DisposableEffect(activityResultRegistry, str, activityResultContract, (Function1) obj, composer, (i << 6) & 896);
        composer.endReplaceableGroup();
