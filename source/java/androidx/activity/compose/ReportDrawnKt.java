...
public final class ReportDrawnKt {
    public static final void ReportDrawnWhen(final Function0<Boolean> function0, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            boolean changed = startRestartGroup.changed(fullyDrawnReporter) | startRestartGroup.changed(function0);
    ...
    public static final void ReportDrawnAfter(final Function1<? super Continuation<? super Unit>, ? extends Object> function1, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):ReportDrawn.kt#9igjgp");
            boolean changed = startRestartGroup.changed(fullyDrawnReporter) | startRestartGroup.changed(function1);
