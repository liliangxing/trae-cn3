...
public final class LongObjectMapKt {
    ...
    public static final <V> LongObjectMap<V> buildLongObjectMap(Function1<? super MutableLongObjectMap<V>, Unit> function1) {
    ...
    public static final <V> LongObjectMap<V> buildLongObjectMap(int i, Function1<? super MutableLongObjectMap<V>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
