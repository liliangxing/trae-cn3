                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append((CharSequence) function2.invoke(Long.valueOf(j2), obj2));
                            i6++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr4;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Long.valueOf(j2), obj));
                            i2++;
                        } else {
                            jArr2 = jArr3;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) function2.invoke(Long.valueOf(j2), obj));
                            i3++;
                        } else {
                            jArr2 = jArr3;
                        }
