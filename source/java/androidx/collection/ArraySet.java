        ...
        if (i <= 1) {
            ...
            if (getHashes().length > 8 && get_size$collection() < getHashes().length / 3) {
                ...
                if (index < i2) {
                    int i4 = index + 1;
                    int i5 = i2 + 1;
                    ArraysKt.copyInto(hashes, getHashes(), index, i4, i5);
                    ArraysKt.copyInto(array, getArray(), index, i4, i5);
                }
            } else {
                if (index < i2) {
                    int i6 = index + 1;
                    int i7 = i2 + 1;
                    ArraysKt.copyInto(getHashes(), getHashes(), index, i6, i7);
                    ArraysKt.copyInto(getArray(), getArray(), index, i6, i7);
                }
                getArray()[i2] = null;
            }
