...
public final class ArraySetKt {
    ...
    public static final <E> void addAllInternal(ArraySet<E> arraySet, ArraySet<? extends E> arraySet2) {
        ...
        if (i > 0) {
            ArraysKt.copyInto$default(arraySet2.getHashes(), arraySet.getHashes(), 0, 0, i, 6, (Object) null);
            ArraysKt.copyInto$default(arraySet2.getArray(), arraySet.getArray(), 0, 0, i, 6, (Object) null);
            if (arraySet.get_size$collection() != 0) {
                throw new ConcurrentModificationException();
            }
        ...
        if (i2 <= 1) {
            ...
            if (arraySet.getHashes().length > 8 && arraySet.get_size$collection() < arraySet.getHashes().length / 3) {
                ...
                if (i < i3) {
                    int i5 = i + 1;
                    int i6 = i3 + 1;
                    ArraysKt.copyInto(hashes, arraySet.getHashes(), i, i5, i6);
                    ArraysKt.copyInto(array, arraySet.getArray(), i, i5, i6);
                }
            } else {
                if (i < i3) {
                    int i7 = i + 1;
                    int i8 = i3 + 1;
                    ArraysKt.copyInto(arraySet.getHashes(), arraySet.getHashes(), i, i7, i8);
                    ArraysKt.copyInto(arraySet.getArray(), arraySet.getArray(), i, i7, i8);
                }
    ...
    public static final <E> boolean retainAllInternal(ArraySet<E> arraySet, Collection<? extends E> collection) {
        ...
        for (int i = arraySet.get_size$collection() - 1; -1 < i; i--) {
            if (!CollectionsKt.contains(collection, arraySet.getArray()[i])) {
                arraySet.removeAt(i);
                z = true;
            }
        }
