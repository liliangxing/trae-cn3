                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(obj, Float.valueOf(f)));
                            i2++;
                        } else {
                            objArr2 = objArr3;
                        }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i3 < i2) {
                    if ((255 & j) < 128 ? z : false) {
                        ...
                        float f = fArr[i4];
                        int findKeyIndex = objectFloatMap.findKeyIndex(obj);
                        if (findKeyIndex < 0) {
                            break loop0;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) function2.invoke(obj, Float.valueOf(f)));
                            i3++;
                        } else {
                            objArr2 = objArr3;
                        }
