    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        while (i3 < i) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableLongFloatMap.findFirstAvailableSlot(i4 >>> 7);
                long j2 = i4 & 127;
