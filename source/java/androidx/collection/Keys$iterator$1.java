...
final class Keys$iterator$1<K> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super K>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> keys$iterator$1 = new Keys$iterator$1<>(this.this$0, continuation);
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        long[] jArr;
        int length;
        Keys$iterator$1<K> keys$iterator$1;
        int i;
        long j;
        ...
        Keys$iterator$1<K> keys$iterator$12 = this;
        Keys$iterator$1<K> keys$iterator$13 = keys$iterator$12;
        long[] jArr3 = jArr2;
        Keys$iterator$1<K> keys$iterator$14 = keys$iterator$13;
        j2 >>= 8;
        i3++;
        if (i3 < i4) {
            if (i4 == 8) {
                length = i5;
                keys$iterator$1 = keys$iterator$14;
                jArr = jArr3;
                objArr = objArr3;
                ...
                if (i != length) {
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        i3 = 0;
                        jArr3 = jArr;
                        keys$iterator$14 = keys$iterator$1;
                        i4 = 8 - ((~(i - length)) >>> 31);
                        objArr3 = objArr;
                        i5 = length;
                        j2 = j;
                        if (i3 < i4) {
                            if ((255 & j2) < 128) {
                                if (1 != 0) {
                                    ...
                                    keys$iterator$14.L$0 = sequenceScope3;
                                    keys$iterator$14.L$1 = objArr3;
                                    keys$iterator$14.L$2 = jArr3;
                                    keys$iterator$14.I$0 = i5;
                                    keys$iterator$14.I$1 = i;
                                    keys$iterator$14.J$0 = j2;
                                    keys$iterator$14.I$2 = i4;
                                    keys$iterator$14.I$3 = i3;
                                    keys$iterator$14.label = 1;
                                    if (sequenceScope3.yield(obj2, keys$iterator$14) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                    long[] jArr4 = jArr3;
                                    keys$iterator$12 = keys$iterator$14;
                                    jArr2 = jArr4;
                                    Keys$iterator$1<K> keys$iterator$132 = keys$iterator$12;
                                    long[] jArr32 = jArr2;
                                    Keys$iterator$1<K> keys$iterator$142 = keys$iterator$132;
                                }
                            }
                            j2 >>= 8;
                            i3++;
