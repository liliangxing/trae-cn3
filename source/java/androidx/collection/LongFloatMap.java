...
public abstract class LongFloatMap {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sb.append((CharSequence) function2.invoke(valueOf, Float.valueOf(f)));
                            i6++;
                            i3 = 8;
                        } else {
                            jArr2 = jArr4;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i2++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            long j2 = jArr[i6];
                            float f = fArr[i6];
                            int findKeyIndex = longFloatMap.findKeyIndex(j2);
                            if (findKeyIndex < 0) {
                                break loop0;
                            }
                            if (!(f == longFloatMap.values[findKeyIndex])) {
                                break loop0;
                            }
                            i3 = 8;
                        } else {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i4]), Float.valueOf(fArr[i4]))).booleanValue()) {
                                return false;
                            }
                        }
                        j >>= 8;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            if (((Boolean) predicate.invoke(Long.valueOf(jArr[i6]), Float.valueOf(fArr[i6]))).booleanValue()) {
                                i3++;
                            }
                        }
                        j >>= 8;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((255 & j) < 128) {
                            int i6 = (i2 << 3) + i5;
                            i3 += Float.hashCode(fArr[i6]) ^ Long.hashCode(jArr[i6]);
                        }
                        j >>= 8;
                    }
                    if (i4 != 8) {
    ...
    */
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, Function2<? super Long, ? super Float, ? extends CharSequence> function2) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            sb.append((CharSequence) function2.invoke(Long.valueOf(j2), Float.valueOf(f)));
                            i3++;
                        }
                        j >>= 8;
                        i6++;
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, Function2<? super Long, ? super Float, ? extends CharSequence> function2) {
        CharSequence charSequence4 = charSequence;
        Intrinsics.checkNotNullParameter(charSequence4, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, Function2<? super Long, ? super Float, ? extends CharSequence> function2) {
    ...
    public final String joinToString(CharSequence charSequence, Function2<? super Long, ? super Float, ? extends CharSequence> function2) {
        int i;
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(function2, "transform");
        StringBuilder sb = new StringBuilder();
    ...
    public final String joinToString(Function2<? super Long, ? super Float, ? extends CharSequence> function2) {
        int i;
        Intrinsics.checkNotNullParameter(function2, "transform");
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
