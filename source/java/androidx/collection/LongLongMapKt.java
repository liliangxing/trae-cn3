...
public final class LongLongMapKt {
    ...
    public static final LongLongMap buildLongLongMap(Function1<? super MutableLongLongMap, Unit> function1) {
    ...
    public static final LongLongMap buildLongLongMap(int i, Function1<? super MutableLongLongMap, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
