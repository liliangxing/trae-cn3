        ...
        if (i2 <= 1) {
            ...
            if (iArr.length > 8 && i2 < iArr.length / 3) {
                ...
                if (index < i3) {
                    int i5 = index + 1;
                    int i6 = i3 + 1;
                    ArraysKt.copyInto(iArr, this.hashes, index, i5, i6);
                    ArraysKt.copyInto(objArr, this.array, i, i5 << 1, i6 << 1);
                }
            } else {
                if (index < i3) {
                    int i7 = index + 1;
                    int i8 = i3 + 1;
                    ArraysKt.copyInto(iArr, iArr, index, i7, i8);
                    Object[] objArr2 = this.array;
                    ArraysKt.copyInto(objArr2, objArr2, i, i7 << 1, i8 << 1);
                }
                Object[] objArr3 = this.array;
                int i9 = i3 << 1;
                objArr3[i9] = null;
