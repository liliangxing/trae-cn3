...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long put(float key, long value, long r7) {
        int findInsertIndex = findInsertIndex(key);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
