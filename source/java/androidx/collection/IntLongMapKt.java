...
public final class IntLongMapKt {
    ...
    public static final IntLongMap buildIntLongMap(Function1<? super MutableIntLongMap, Unit> function1) {
    ...
    public static final IntLongMap buildIntLongMap(int i, Function1<? super MutableIntLongMap, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
