...
public class IncompatibleApkWebViewProviderFactory implements WebViewProviderFactory {
    ...
    @Override // androidx.webkit.internal.WebViewProviderFactory
    public void startUpWebView(WebViewStartUpConfig webViewStartUpConfig, WebViewOutcomeReceiver<WebViewStartUpResult, WebViewStartupException> webViewOutcomeReceiver) {
        throw new UnsupportedOperationException(UNSUPPORTED_EXCEPTION_EXPLANATION);
    }
}
