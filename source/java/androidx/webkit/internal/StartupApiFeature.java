...
public abstract class StartupApiFeature {
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m84of(640L)).metaData;
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    public static class C0587P extends StartupApiFeature {
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0587P(String str, String str2) {
            super(str, str2);
        }
