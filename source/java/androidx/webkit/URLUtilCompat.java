...
public final class URLUtilCompat {
    ...
    public static String guessFileName(String str, String str2, String str3) {
        ...
        return (replacePathSeparators.indexOf(46) < 0 || extensionDifferentFromMimeType(replacePathSeparators, str3)) ? replacePathSeparators + suggestExtensionFromMimeType(str3) : replacePathSeparators;
    }
    ...
    private static String suggestExtensionFromMimeType(String str) {
        ...
        return (lowerCase.equals("application/octet-stream") || (extensionFromMimeType = MimeTypeMap.getSingleton().getExtensionFromMimeType(lowerCase)) == null) ? "" : LibrarianImpl.Constants.DOT + extensionFromMimeType;
    }
