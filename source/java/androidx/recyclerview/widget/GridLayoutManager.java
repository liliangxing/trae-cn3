    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i11 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i21, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i20, BasicMeasure.EXACTLY);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i21, BasicMeasure.EXACTLY);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i20, layoutParams.height, false);
                    i11 = makeMeasureSpec;
                }
