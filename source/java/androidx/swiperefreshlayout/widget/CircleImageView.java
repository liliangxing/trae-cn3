...
import androidx.swiperefreshlayout.C0483R;
...
class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0483R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0483R.styleable.f89xaa980688, DEFAULT_BACKGROUND_COLOR);
