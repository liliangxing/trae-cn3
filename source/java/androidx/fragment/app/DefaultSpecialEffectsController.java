...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            int i = C023210.f76xe493b431[operation3.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
    ...
    static /* synthetic */ class C023210 {
        ...
        static {
            ...
            try {
                f76xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f76xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f76xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, final boolean z, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
            ...
            if (!next.hasSharedElementTransition() || operation5 == null || operation6 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    if (arrayList5.isEmpty()) {
                        ...
                        i = 0;
                        View view12 = (View) arrayMap3.get(arrayList5.get(0));
        ...
        while (it4.hasNext()) {
            ...
            if (next2.isVisibilityUnchanged()) {
                hashMap.put(next2.getOperation(), Boolean.valueOf(z4));
