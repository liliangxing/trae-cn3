...
import androidx.fragment.C0228R;
...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        public final void accept(Object obj) {
            FragmentManager.this.m2978lambda$new$0$androidxfragmentappFragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda1
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m2979lambda$new$1$androidxfragmentappFragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda2
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m2980lambda$new$2$androidxfragmentappFragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda3
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m2981lambda$new$3$androidxfragmentappFragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    public /* synthetic */ void m2978lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m2979lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    public /* synthetic */ void m2980lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m2981lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0228R.id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z && this.mCurState >= 1) {
            for (int i4 = i; i4 < i2; i4++) {
                Iterator<FragmentTransaction.C0275Op> it = arrayList.get(i4).mOps.iterator();
                while (it.hasNext()) {
        ...
        for (int i5 = i; i5 < i2; i5++) {
            ...
            if (booleanValue) {
                ...
                Iterator<FragmentTransaction.C0275Op> it2 = backStackRecord2.mOps.iterator();
                while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0275Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C0228R.id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0228R.id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0228R.id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mBeingSaved) {
                Iterator<FragmentTransaction.C0275Op> it2 = next.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C0275Op next2 = it2.next();
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = findBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            Iterator<FragmentTransaction.C0275Op> it = backStackRecord2.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0275Op next = it.next();
    ...
    public Parcelable saveAllState() {
        ...
        Bundle m2977lambda$attachController$4$androidxfragmentappFragmentManager = m2977lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m2977lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
            return null;
        }
        return m2977lambda$attachController$4$androidxfragmentappFragmentManager;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: saveAllStateInternal, reason: merged with bridge method [inline-methods] */
    public Bundle m2977lambda$attachController$4$androidxfragmentappFragmentManager() {
        ...
        if (allSavedState.isEmpty()) {
            ...
            bundle.putParcelable(StrategyConstants.STATE, fragmentManagerState);
            ...
            while (it.hasNext()) {
                ...
                bundle2.putParcelable(StrategyConstants.STATE, next);
    ...
    public void restoreSaveStateInternal(Parcelable parcelable) {
        ...
        for (String str2 : bundle3.keySet()) {
            if (str2.startsWith(FRAGMENT_NAME_PREFIX) && (bundle = bundle3.getBundle(str2)) != null) {
                ...
                arrayList.add((FragmentState) bundle.getParcelable(StrategyConstants.STATE));
            }
        }
        this.mFragmentStore.restoreSaveState(arrayList);
        FragmentManagerState fragmentManagerState = (FragmentManagerState) bundle3.getParcelable(StrategyConstants.STATE);
    ...
    public void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if (fragment != null) {
            ...
            this.mNonConfig = FragmentManagerViewModel.getInstance(((ViewModelStoreOwner) fragmentHostCallback).get_viewModelStore());
        } else {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda4
                ...
                public final Bundle saveState() {
                    return FragmentManager.this.m2977lambda$attachController$4$androidxfragmentappFragmentManager();
                }
            });
        ...
        if (obj2 instanceof OnConfigurationChangedProvider) {
            ((OnConfigurationChangedProvider) obj2).addOnConfigurationChangedListener(this.mOnConfigurationChangedListener);
        }
        Object obj3 = this.mHost;
        if (obj3 instanceof OnTrimMemoryProvider) {
            ((OnTrimMemoryProvider) obj3).addOnTrimMemoryListener(this.mOnTrimMemoryListener);
        }
    ...
    public static class FragmentIntentSenderContract extends ActivityResultContract<IntentSenderRequest, ActivityResult> {
        ...
        public Intent createIntent(Context context, IntentSenderRequest intentSenderRequest) {
            ...
            if (fillInIntent != null && (m58x973fbc59 = m58x973fbc59(fillInIntent, "androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE")) != null) {
                intent.putExtra("androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE", m58x973fbc59);
            ...
            intent.putExtra("androidx.activity.result.contract.extra.INTENT_SENDER_REQUEST", (Parcelable) intentSenderRequest);
        ...
        public ActivityResult m2982parseResult(int i, Intent intent) {
            return new ActivityResult(i, intent);
        }

        @Proxy("getBundleExtra")
        @TargetClass("android.content.Intent")
        /* renamed from: INVOKEVIRTUAL_androidx_fragment_app_FragmentManager$FragmentIntentSenderContract_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra */
        public static Bundle m58x973fbc59(Intent intent, String str) {
