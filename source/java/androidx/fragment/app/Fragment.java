...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, get_viewModelStore());
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m2977lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m2977lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m2977lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m2977lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
        ...
        return prepareCallInternal(activityResultContract, new Function<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.7
            public ActivityResultRegistry apply(Void r1) {
                if (Fragment.this.mHost instanceof ActivityResultRegistryOwner) {
                    return Fragment.this.mHost.getActivityResultRegistry();
                }
