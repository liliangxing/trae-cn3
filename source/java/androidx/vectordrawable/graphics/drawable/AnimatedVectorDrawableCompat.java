...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private AnimatedVectorDrawableCompat(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Resources resources) {
        ...
        if (animatedVectorDrawableCompatState != null) {
            ...
            this.mAnimatedVectorState = new AnimatedVectorDrawableCompatState(context, null, callback, resources);
        }
    }
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int i) {
        ...
        ObjectsCompat.requireNonNull(animatedVectorDrawableCompat, "Failed to load drawable");
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId != 0) {
                        ...
                        ObjectsCompat.requireNonNull(create, "Failed to load drawable");
    ...
    private static boolean unregisterPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        return Api23Impl.unregisterAnimationCallback(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }
    ...
    private static void registerPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        Api23Impl.registerAnimationCallback(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }
    ...
    public void clearAnimationCallbacks() {
        if (this.mDelegateDrawable != null) {
            Api23Impl.clearAnimationCallbacks(this.mDelegateDrawable);
            return;
        }
        removeAnimatorSetListener();
        ArrayList<Animatable2Compat.AnimationCallback> arrayList = this.mAnimationCallbacks;
    ...
    public static class Api23Impl {
        ...
        static boolean unregisterAnimationCallback(Object obj, Object obj2) {
        ...
        static void registerAnimationCallback(Object obj, Object obj2) {
