...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        Log.v(LOGTAG, ((Object) sb) + "current group is :" + vGroup.getGroupName() + " rotation is " + vGroup.mRotate);
        Log.v(LOGTAG, ((Object) sb) + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    public static abstract class VPath extends VObject {
        ...
        public void printVPath(int i) {
            ...
            Log.v(VectorDrawableCompat.LOGTAG, ((Object) sb) + "current path is :" + this.mPathName + " pathData is " + nodesToString(this.mNodes));
        }

        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            StringBuilder sb = new StringBuilder(" ");
            for (PathParser.PathDataNode pathDataNode : pathDataNodeArr) {
                sb.append(pathDataNode.getType()).append(":");
