...
public final /* data */ class VectorizedKeyframeSpecElementInfo<V extends AnimationVector> {
    ...
    public static /* synthetic */ VectorizedKeyframeSpecElementInfo m226copy2NF0KzA$default(VectorizedKeyframeSpecElementInfo vectorizedKeyframeSpecElementInfo, AnimationVector animationVector, Easing easing, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return vectorizedKeyframeSpecElementInfo.m228copy2NF0KzA(animationVector, easing, i);
    }
    ...
    public final VectorizedKeyframeSpecElementInfo<V> m228copy2NF0KzA(V vectorValue, Easing easing, int arcMode) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.vectorValue, vectorizedKeyframeSpecElementInfo.vectorValue) && Intrinsics.areEqual(this.easing, vectorizedKeyframeSpecElementInfo.easing) && ArcMode.m163equalsimpl0(this.arcMode, vectorizedKeyframeSpecElementInfo.arcMode);
    }

    public int hashCode() {
        return (((this.vectorValue.hashCode() * 31) + this.easing.hashCode()) * 31) + ArcMode.m164hashCodeimpl(this.arcMode);
    }

    public String toString() {
        return "VectorizedKeyframeSpecElementInfo(vectorValue=" + this.vectorValue + ", easing=" + this.easing + ", arcMode=" + ((Object) ArcMode.m165toStringimpl(this.arcMode)) + ')';
    }
    ...
    public final int m229getArcMode9TMq4() {
        return this.arcMode;
    }
}
