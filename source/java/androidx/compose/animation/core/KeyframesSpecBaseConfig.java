...
public abstract class KeyframesSpecBaseConfig<T, E extends KeyframeBaseEntity<T>> {
    ...
    public E atFraction(T t, float f) {
        return mo12at(t, Math.round(this.durationMillis * f));
    }
