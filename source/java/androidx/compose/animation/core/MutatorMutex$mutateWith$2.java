...
@DebugMetadata(c = "androidx.compose.animation.core.MutatorMutex$mutateWith$2", f = "InternalMutatorMutex.kt", i = {0, 0, 1, 1}, l = {177, 165}, m = "invokeSuspend", n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class MutatorMutex$mutateWith$2<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> mutatorMutex$mutateWith$2 = new MutatorMutex$mutateWith$2<>(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
                ...
                if (r1 == 0) {
                    ...
                    if (r1 != 1) {
                        ...
                        try {
                            ...
                            UByte$.ExternalSyntheticBackport0.m(atomicReference2, mutator2, (Object) null);
                            mutex2.unlock((Object) null);
                            return obj;
                        } catch (Throwable th2) {
                            th = th2;
                            atomicReference = mutatorMutex2.currentMutator;
                            UByte$.ExternalSyntheticBackport0.m(atomicReference, mutator2, (Object) null);
                            throw th;
                        }
                    }
