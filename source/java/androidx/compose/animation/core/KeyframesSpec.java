...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        /* renamed from: at */
        public /* bridge */ /* synthetic */ KeyframeBaseEntity mo12at(Object obj, int i) {
            return mo12at((KeyframesSpecConfig<T>) obj, i);
        }
        ...
        @Override // androidx.compose.animation.core.KeyframesSpecBaseConfig
        /* renamed from: at */
        public KeyframeEntity<T> mo12at(T t, int i) {
        ...
        public KeyframeEntity<T> atFraction(T t, float f) {
            return mo12at((KeyframesSpecConfig<T>) t, Math.round(getDurationMillis() * f));
        }
        ...
        public final KeyframeEntity<T> m303usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m302setArcModeRur9ykg$animation_core(i);
            return keyframeEntity;
        }
    }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> converter) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            mutableIntObjectMap.set(i7, new VectorizedKeyframeSpecElementInfo((AnimationVector) converter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core()), keyframeEntity.getEasing(), keyframeEntity.getArcMode(), null));
                            i = 8;
                        } else {
                            jArr2 = jArr3;
                            iArr2 = iArr3;
        ...
        mutableIntList.sort();
        return new VectorizedKeyframesSpec<>(mutableIntList, mutableIntObjectMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.INSTANCE.m295getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.INSTANCE.m295getArcLinear9TMq4() : i, null);
        }
        ...
        public final void m302setArcModeRur9ykg$animation_core(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core(), getValue$animation_core()) && Intrinsics.areEqual(keyframeEntity.getEasing(), getEasing()) && ArcMode.m289equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }

        public int hashCode() {
            T value$animation_core = getValue$animation_core();
            return ((((value$animation_core != null ? value$animation_core.hashCode() : 0) * 31) + ArcMode.m290hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}
