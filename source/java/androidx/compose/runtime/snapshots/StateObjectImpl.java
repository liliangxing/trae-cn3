...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3821recordReadInh_f27i8$runtime(int reader) {
        int m3799constructorimpl;
        do {
            m3799constructorimpl = ReaderKind.m3799constructorimpl(this.readerKind.get());
            if ((m3799constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(m3799constructorimpl, ReaderKind.m3799constructorimpl(m3799constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime, reason: not valid java name */
    public final boolean m3820isReadInh_f27i8$runtime(int reader) {
        return (reader & ReaderKind.m3799constructorimpl(this.readerKind.get())) != 0;
    }
}
