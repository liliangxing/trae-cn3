...
public final class ReadonlySnapshot extends Snapshot {
    ...
    public Snapshot takeNestedSnapshot(Function1<Object, Unit> readObserver) {
        ...
        if (access$getObservers$p != null) {
            Pair<SnapshotInstanceObservers, Map<SnapshotObserver, SnapshotInstanceObservers>> mergeObservers = SnapshotObserverKt.mergeObservers(access$getObservers$p, readonlySnapshot, true, readObserver, null);
    ...
    public void dispose() {
        ...
        ReadonlySnapshot readonlySnapshot = this;
        mo4250nestedDeactivated$runtime(readonlySnapshot);
        super.dispose();
