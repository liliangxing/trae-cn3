...
final class RecomposerKt$withRunningRecomposer$2<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            BuildersKt.launch$default(coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new C07451(recomposer, null), 3, (Object) null);
    ...
    public static final class C07451 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07451(Recomposer recomposer, Continuation<? super C07451> continuation) {
            super(2, continuation);
            this.$recomposer = recomposer;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C07451(this.$recomposer, continuation);
        }
