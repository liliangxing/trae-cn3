...
public abstract class Operation {
    ...
    public String mo4121objectParamName31yXWZQ(int parameter) {
    ...
    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0087@\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0002HÖ\u0003J\t\u0010\f\u001a\u00020\u0004HÖ\u0001J\t\u0010\r\u001a\u00020\u000eHÖ\u0001R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b\u0088\u0001\u0003¨\u0006\u000f"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$ObjectParameter;", "T", "", "offset", "", "constructor-impl", "(I)I", "getOffset", "()I", "equals", "", "other", "hashCode", "toString", "", "runtime"}, k = 1, mv = {2, 0, 0}, xi = 48)
    @JvmInline
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
    public static final class ObjectParameter<T> {
        ...
        public static final /* synthetic */ ObjectParameter m4146boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m4147constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4148equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m4152unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4149equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4150hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m4151toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object other) {
            return m4148equalsimpl(this.offset, other);
        }

        public int hashCode() {
            return m4150hashCodeimpl(this.offset);
        }

        public String toString() {
            return m4151toStringimpl(this.offset);
        }
    ...
    public static final class Downs extends Operation {
        ...
        */
        ...
        public final int m4134getNodesHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "nodes" : super.mo4121objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        */
        ...
        public final int m4159getEffectHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "effect" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        */
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "value" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.remembering((RememberObserverHolder) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class RememberPausingScope extends Operation {
        ...
        */
        ...
        public final int m4158getScopeHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "scope" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.rememberPausingScope((RecomposeScopeImpl) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class StartResumingScope extends Operation {
        ...
        */
        ...
        /* renamed from: getScope-HpuvwBQ, reason: not valid java name */
        public final int m4160getScopeHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.startResumingScope((RecomposeScopeImpl) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class EndResumingScope extends Operation {
        ...
        */
        ...
        /* renamed from: getScope-HpuvwBQ, reason: not valid java name */
        public final int m4137getScopeHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.endResumingScope((RecomposeScopeImpl) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m4123getValueHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "anchor" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "value" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            Object mo4168getObject31yXWZQ = operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            if (mo4168getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) mo4168getObject31yXWZQ);
            }
            slotWriter.appendSlot(anchor, mo4168getObject31yXWZQ);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        */
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m4167getValueHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object mo4168getObject31yXWZQ = operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            int i = operationArgContainer.getInt(0);
            if (mo4168getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) mo4168getObject31yXWZQ);
            }
            Object obj = slotWriter.set(slotWriter.getCurrentGroup(), i, mo4168getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting((RememberObserverHolder) obj);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m4163getValueHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4162getAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "value" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "anchor" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object mo4168getObject31yXWZQ = operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            int i = operationArgContainer.getInt(0);
            if (mo4168getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) mo4168getObject31yXWZQ);
            }
            Object obj = slotWriter.set(slotWriter.anchorIndex(anchor), i, mo4168getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting((RememberObserverHolder) obj);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        */
        ...
        public final int m4164getDataHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "data" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.updateAux(operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        */
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4138getAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "anchor" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m4135getActionHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m4136getCompositionHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "anchor" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "composition" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ((Function1) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0))).invoke((Composition) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m4166getValueHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m4165getBlockHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "value" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "block" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            applier.apply((Function2) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1)), operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4141getAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m4142getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "anchor" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "from" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4143getAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m4145getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m4144getFixupsHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "anchor" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "from" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(2)) ? "fixups" : super.mo4121objectParamName31yXWZQ(parameter);
        }
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ...
            SlotTable slotTable = (SlotTable) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m4139getFactoryHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4140getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "factory" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "groupAnchor" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object invoke = ((Function0) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            int i = operationArgContainer.getInt(0);
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        */
        ...
        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4153getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "groupAnchor" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
        }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m4133getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m4132getAnchorHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "anchor" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            int positionToInsert;
            IntRef intRef = (IntRef) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m4126getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m4127getNodesHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "nodes" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            int element = ((IntRef) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m4130getResolvedStateHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m4129getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m4128getFromHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m4131getToHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "resolvedState" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(2)) ? "from" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(3)) ? "to" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            MovableContentState movableContentState = (MovableContentState) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m4154getCompositionHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m4155getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m4156getReferenceHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "composition" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(2)) ? "reference" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ControlledComposition controlledComposition = (ControlledComposition) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(2));
            ((CompositionContext) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1))).movableContentStateReleased$runtime(movableContentStateReference, ComposerKt.extractMovableContentAtCurrent(controlledComposition, movableContentStateReference, slotWriter, null), applier);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m4124getChangesHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m4125getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m4147constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo4121objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(0)) ? "changes" : ObjectParameter.m4149equalsimpl0(parameter, ObjectParameter.m4147constructorimpl(1)) ? "effectiveNodeIndex" : super.mo4121objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            IntRef intRef = (IntRef) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo4168getObject31yXWZQ(ObjectParameter.m4147constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m4146boximpl(ObjectParameter.m4147constructorimpl(i4)));
            }
