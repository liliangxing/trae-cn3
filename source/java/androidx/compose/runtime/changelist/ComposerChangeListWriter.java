...
public final class ComposerChangeListWriter {
    ...
    private final ArrayList<T> pendingDownNodes = Stack.m4093constructorimpl$default(null, 1, null);
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m4099isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m4102popimpl(this.pendingDownNodes);
            return;
        }
    ...
    public final void moveDown(Object node) {
        realizeNodeMovementOperations();
        Stack.m4103pushimpl(this.pendingDownNodes, node);
    }
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m4099isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m4104toArrayimpl(this.pendingDownNodes));
            Stack.m4091clearimpl(this.pendingDownNodes);
        }
    }
