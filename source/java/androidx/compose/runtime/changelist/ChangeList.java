...
public final class ChangeList extends OperationsDebugStringFormattable {
    ...
    public final void pushRememberPausingScope(RecomposeScopeImpl scope) {
        ...
        Operations.WriteScope.m4180setObjectDKhxnng(m4172constructorimpl, Operation.ObjectParameter.m4147constructorimpl(0), scope);
    ...
    public final void pushUpdateValue(Object value, int groupSlotIndex) {
        ...
        m4172constructorimpl.intArgs[(m4172constructorimpl.intArgsSize - m4172constructorimpl.opCodes[m4172constructorimpl.opCodesSize - 1].getInts()) + 0] = groupSlotIndex;
    ...
    public final void pushUpdateAnchoredValue(Object value, Anchor anchor, int groupSlotIndex) {
        ...
        int m4147constructorimpl = Operation.ObjectParameter.m4147constructorimpl(0);
        Operation.UpdateAnchoredValue updateAnchoredValue3 = Operation.UpdateAnchoredValue.INSTANCE;
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, value, Operation.ObjectParameter.m4147constructorimpl(1), anchor);
    ...
    public final void pushAppendValue(Anchor anchor, Object value) {
        ...
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, anchor, Operation.ObjectParameter.m4147constructorimpl(1), value);
    ...
    public final void pushTrimValues(int count) {
        ...
        m4172constructorimpl.intArgs[(m4172constructorimpl.intArgsSize - m4172constructorimpl.opCodes[m4172constructorimpl.opCodesSize - 1].getInts()) + 0] = count;
    ...
    public final void pushUpdateAuxData(Object data) {
        ...
        Operations.WriteScope.m4180setObjectDKhxnng(m4172constructorimpl, Operation.ObjectParameter.m4147constructorimpl(0), data);
    ...
    public final void pushEnsureGroupStarted(Anchor anchor) {
        ...
        Operations.WriteScope.m4180setObjectDKhxnng(m4172constructorimpl, Operation.ObjectParameter.m4147constructorimpl(0), anchor);
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from) {
        ...
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, anchor, Operation.ObjectParameter.m4147constructorimpl(1), from);
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from, FixupList fixups) {
        ...
        int m4147constructorimpl2 = Operation.ObjectParameter.m4147constructorimpl(1);
        Operation.InsertSlotsWithFixups insertSlotsWithFixups4 = Operation.InsertSlotsWithFixups.INSTANCE;
        Operations.WriteScope.m4183setObjectst7hvbck(m4172constructorimpl, m4147constructorimpl, anchor, m4147constructorimpl2, from, Operation.ObjectParameter.m4147constructorimpl(2), fixups);
    ...
    public final void pushMoveCurrentGroup(int offset) {
        ...
        m4172constructorimpl.intArgs[(m4172constructorimpl.intArgsSize - m4172constructorimpl.opCodes[m4172constructorimpl.opCodesSize - 1].getInts()) + 0] = offset;
    ...
    public final void pushEndCompositionScope(Function1<? super Composition, Unit> action, Composition composition) {
        ...
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, action, Operation.ObjectParameter.m4147constructorimpl(1), composition);
    ...
    public final <T, V> void pushUpdateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, value, m4147constructorimpl2, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2));
    ...
    public final void pushRemoveNode(int removeFrom, int moveCount) {
        ...
        int ints = m4172constructorimpl.intArgsSize - m4172constructorimpl.opCodes[m4172constructorimpl.opCodesSize - 1].getInts();
        int[] iArr = m4172constructorimpl.intArgs;
        iArr[ints + 0] = removeFrom;
    ...
    public final void pushAdvanceSlotsBy(int distance) {
        ...
        m4172constructorimpl.intArgs[(m4172constructorimpl.intArgsSize - m4172constructorimpl.opCodes[m4172constructorimpl.opCodesSize - 1].getInts()) + 0] = distance;
    ...
    public final void pushDowns(Object[] nodes) {
        if (!(nodes.length == 0)) {
            ...
            Operations.WriteScope.m4180setObjectDKhxnng(m4172constructorimpl, Operation.ObjectParameter.m4147constructorimpl(0), nodes);
    ...
    public final void pushSideEffect(Function0<Unit> effect) {
        ...
        Operations.WriteScope.m4180setObjectDKhxnng(m4172constructorimpl, Operation.ObjectParameter.m4147constructorimpl(0), effect);
    ...
    public final void pushDetermineMovableContentNodeIndex(IntRef effectiveNodeIndexOut, Anchor anchor) {
        ...
        Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, effectiveNodeIndexOut, Operation.ObjectParameter.m4147constructorimpl(1), anchor);
    ...
    public final void pushCopyNodesToNewAnchorLocation(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        if (!nodes.isEmpty()) {
            ...
            Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, nodes, Operation.ObjectParameter.m4147constructorimpl(0), effectiveNodeIndex);
    ...
    public final void pushCopySlotTableToAnchorLocation(MovableContentState resolvedState, CompositionContext parentContext, MovableContentStateReference from, MovableContentStateReference to) {
        ...
        int m4147constructorimpl3 = Operation.ObjectParameter.m4147constructorimpl(3);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation5 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m4182setObjectsOGa0p1M(m4172constructorimpl, m4147constructorimpl, resolvedState, m4147constructorimpl2, parentContext, m4147constructorimpl3, to, Operation.ObjectParameter.m4147constructorimpl(2), from);
    ...
    public final void pushReleaseMovableGroupAtCurrent(ControlledComposition composition, CompositionContext parentContext, MovableContentStateReference reference) {
        ...
        Operations.WriteScope.m4183setObjectst7hvbck(m4172constructorimpl, m4147constructorimpl, composition, m4147constructorimpl2, parentContext, Operation.ObjectParameter.m4147constructorimpl(2), reference);
    ...
    public final void pushExecuteOperationsIn(ChangeList changeList, IntRef effectiveNodeIndex) {
        if (changeList.isNotEmpty()) {
            ...
            Operations.WriteScope.m4181setObjects4uCC6AY(m4172constructorimpl, m4147constructorimpl, changeList, Operation.ObjectParameter.m4147constructorimpl(1), effectiveNodeIndex);
