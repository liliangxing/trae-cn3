...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    private final int determineNewSize(int currentSize, int requiredSize) {
        return RangesKt.coerceAtLeast(currentSize + RangesKt.coerceAtMost(currentSize, Fields.RotationZ), requiredSize);
    }

    private final void resizeOpCodes() {
        int coerceAtMost = RangesKt.coerceAtMost(this.opCodesSize, Fields.RotationZ);
        int i = this.opCodesSize;
        Operation[] operationArr = new Operation[coerceAtMost + i];
        System.arraycopy(this.opCodes, 0, operationArr, 0, i - 0);
    ...
    private final void resizeObjectArgs(int currentSize, int requiredSize) {
        ...
        System.arraycopy(this.objectArgs, 0, objArr, 0, currentSize - 0);
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        pushOp(operation);
        args.invoke(WriteScope.m4171boximpl(WriteScope.m4172constructorimpl(this)));
    ...
    private final String exceptionMessageForOperationPushWithScope(Operation operation) {
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) == 0) {
                ...
                sb3.append(operation.mo4121objectParamName31yXWZQ(Operation.ObjectParameter.m4147constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m4171boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Operations m4172constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m4173equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).getStack());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m4174equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m4176hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m4184toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object other) {
            return m4173equalsimpl(this.stack, other);
        }

        public int hashCode() {
            return m4176hashCodeimpl(this.stack);
        }

        public String toString() {
            return m4184toStringimpl(this.stack);
        }
        ...
        public static final void m4177setIntimpl(Operations operations, int i, int i2) {
        ...
        public static final void m4178setIntsimpl(Operations operations, int i, int i2, int i3, int i4) {
        ...
        /* renamed from: setInts-impl, reason: not valid java name */
        public static final void m4179setIntsimpl(Operations operations, int i, int i2, int i3, int i4, int i5, int i6) {
            int ints = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] iArr = operations.intArgs;
            iArr[i + ints] = i2;
            iArr[i3 + ints] = i4;
        ...
        public static final <T> void m4180setObjectDKhxnng(Operations operations, int i, T t) {
        ...
        public static final <T, U> void m4181setObjects4uCC6AY(Operations operations, int i, T t, int i2, U u) {
        ...
        public static final <T, U, V> void m4183setObjectst7hvbck(Operations operations, int i, T t, int i2, U u, int i3, V v) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final <T, U, V, W> void m4182setObjectsOGa0p1M(Operations operations, int i, T t, int i2, U u, int i3, V v, int i4, W w) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public <T> T mo4168getObject31yXWZQ(int parameter) {
    ...
    public final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int m4147constructorimpl = Operation.ObjectParameter.m4147constructorimpl(i2);
            String mo4121objectParamName31yXWZQ = operation.mo4121objectParamName31yXWZQ(m4147constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append(...)");
            sb.append(indent);
            sb.append(mo4121objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo4168getObject31yXWZQ(m4147constructorimpl), indent));
        }
        Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append(...)");
        sb.append(str);
        sb.append(")");
    ...
    private final <T> String toCollectionString(Iterable<? extends T> iterable, final String str) {
        return CollectionsKt.joinToString$default(iterable, ", ", "[", "]", 0, (CharSequence) null, new Function1() { // from class: androidx.compose.runtime.changelist.Operations$$ExternalSyntheticLambda0
