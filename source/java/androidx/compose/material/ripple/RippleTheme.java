...
public interface RippleTheme {
    ...
    long mo2169defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m2179defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m4891luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m4876getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m2178defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m4891luminance8_81llA(contentColor) > 0.5d) {
