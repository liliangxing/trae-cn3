...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo2169defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m2179defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2179defaultRippleColor5vOe2sY(Color.INSTANCE.m4865getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2179defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m2178defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2178defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4865getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2178defaultRippleAlphaDxMtmZc;
    }
}
