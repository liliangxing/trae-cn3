...
public final class RippleAnimationKt {
    ...
    public static final float m2172getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m4662getWidthimpl(j), Size.m4659getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m2171getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        float m4591getDistanceimpl = Offset.m4591getDistanceimpl(OffsetKt.Offset(Size.m4662getWidthimpl(j), Size.m4659getHeightimpl(j))) / 2.0f;
        return z ? m4591getDistanceimpl + density.toPx-0680j_4(BoundedRippleExtraRadius) : m4591getDistanceimpl;
    }
}
