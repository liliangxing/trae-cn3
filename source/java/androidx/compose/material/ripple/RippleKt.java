...
public final class RippleKt {
    ...
    public static final Indication m2177rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        if ((i2 & 4) != 0) {
            j = Color.INSTANCE.m4875getUnspecified0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, i, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:80)");
        }
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4829boximpl(j), composer, (i >> 6) & 14);
