...
final class StateLayer {
    ...
    public final void handleInteraction(Interaction interaction, CoroutineScope scope) {
        ...
        if (interaction2 != null) {
            ...
            BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new StateLayer$handleInteraction$1(this, draggedAlpha, RippleKt.access$incomingStateLayerAnimationSpecFor(interaction2), null), 3, (Object) null);
        } else {
            BuildersKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new StateLayer$handleInteraction$2(this, RippleKt.access$outgoingStateLayerAnimationSpecFor(this.currentInteraction), null), 3, (Object) null);
        }
        this.currentInteraction = interaction2;
    }

    /* renamed from: drawStateLayer-H2RKhps, reason: not valid java name */
    public final void m2181drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float f2;
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m2171getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.m5417getSizeNHjbRc());
        } else {
            f2 = drawScope.toPx-0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m4838copywmQWz5c$default = Color.m4838copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m5398drawCircleVaOC9Bg$default(drawScope, m4838copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
