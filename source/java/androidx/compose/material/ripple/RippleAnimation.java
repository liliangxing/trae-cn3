...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m2170draw4WTKRHQ(DrawScope drawScope, long j) {
        Float valueOf;
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m2172getRippleStartRadiusuvyYCjk(drawScope.m5417getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                valueOf = Float.valueOf(RippleAnimationKt.m2171getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.m5417getSizeNHjbRc()));
            } else {
                valueOf = Float.valueOf(drawScope.toPx-0680j_4(this.radius));
            }
            this.targetRadius = valueOf;
        }
        if (this.origin == null) {
            this.origin = Offset.m4582boximpl(drawScope.m5416getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m4582boximpl(OffsetKt.Offset(Size.m4662getWidthimpl(drawScope.m5417getSizeNHjbRc()) / 2.0f, Size.m4659getHeightimpl(drawScope.m5417getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m4593getXimpl = Offset.m4593getXimpl(offset.m4603unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m4593getXimpl, Offset.m4593getXimpl(offset2.m4603unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m4594getYimpl = Offset.m4594getYimpl(offset3.m4603unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m4594getYimpl, Offset.m4594getYimpl(offset4.m4603unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long m4838copywmQWz5c$default = Color.m4838copywmQWz5c$default(j, Color.m4841getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m5398drawCircleVaOC9Bg$default(drawScope, m4838copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, 120, null);
            return;
        }
        ...
        drawContext.getTransform().mo5341clipRectN_I0leg(0.0f, 0.0f, m4662getWidthimpl, m4659getHeightimpl, m4828getIntersectrtfAjoo);
        DrawScope.m5398drawCircleVaOC9Bg$default(drawScope, m4838copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, 120, null);
