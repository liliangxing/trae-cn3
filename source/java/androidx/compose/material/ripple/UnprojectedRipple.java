...
public final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2183setColorDxMtmZc(long color, float alpha) {
        long m2182calculateRippleColor5vOe2sY = m2182calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m4840equalsimpl0(color2.m4849unboximpl(), m2182calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m4829boximpl(m2182calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m4893toArgb8_81llA(m2182calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2182calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m4838copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
