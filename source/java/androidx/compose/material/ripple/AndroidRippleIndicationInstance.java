...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> state, State<RippleAlpha> state2, ViewGroup viewGroup) {
        ...
        this.rippleSize = Size.INSTANCE.m4671getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int i;
        this.rippleSize = contentDrawScope.m5417getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m2171getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.m5417getSizeNHjbRc()));
        } else {
            i = contentDrawScope.roundToPx-0680j_4(this.radius);
        }
        this.rippleRadius = i;
        ...
        if (rippleHostView != null) {
            rippleHostView.m2175updateRipplePropertiesbiQXAtU(contentDrawScope.m5417getSizeNHjbRc(), this.rippleRadius, m4849unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m2174addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4849unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
