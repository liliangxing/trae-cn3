...
public final class ArrowBackKt {
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.ArrowBack", replaceWith = @ReplaceWith(expression = "Icons.AutoMirrored.Sharp.ArrowBack", imports = {"androidx.compose.material.icons.automirrored.sharp.ArrowBack"}))
    ...
    public static final ImageVector getArrowBack(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ArrowBack", Dp.constructor-impl(24.0f), Dp.constructor-impl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
