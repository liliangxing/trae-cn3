...
public final class MagnifierElement extends ModifierNodeElement<MagnifierNode> {
    ...
    public MagnifierNode m474create() {
    ...
    public void update(MagnifierNode node) {
        node.m483update5F03MCQ(this.sourceCenter, this.magnifierCenter, this.zoom, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, this.onSizeChanged, this.platformMagnifierFactory);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.sourceCenter == magnifierElement.sourceCenter && this.magnifierCenter == magnifierElement.magnifierCenter) {
            return ((this.zoom > magnifierElement.zoom ? 1 : (this.zoom == magnifierElement.zoom ? 0 : -1)) == 0) && this.useTextDefault == magnifierElement.useTextDefault && DpSize.equals-impl0(this.size, magnifierElement.size) && Dp.equals-impl0(this.cornerRadius, magnifierElement.cornerRadius) && Dp.equals-impl0(this.elevation, magnifierElement.elevation) && this.clippingEnabled == magnifierElement.clippingEnabled && this.onSizeChanged == magnifierElement.onSizeChanged && Intrinsics.areEqual(this.platformMagnifierFactory, magnifierElement.platformMagnifierFactory);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((((((hashCode + (function1 != null ? function1.hashCode() : 0)) * 31) + Float.hashCode(this.zoom)) * 31) + Boolean.hashCode(this.useTextDefault)) * 31) + DpSize.hashCode-impl(this.size)) * 31) + Dp.hashCode-impl(this.cornerRadius)) * 31) + Dp.hashCode-impl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31;
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("size", DpSize.box-impl(this.size));
        inspectorInfo.getProperties().set("cornerRadius", Dp.box-impl(this.cornerRadius));
