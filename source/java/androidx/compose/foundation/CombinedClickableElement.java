...
public final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m459create() {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m460update2tQrsxU(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((hashCode + (indicationNodeFactory != null ? indicationNodeFactory.hashCode() : 0)) * 31) + Boolean.hashCode(this.useLocalIndication)) * 31) + Boolean.hashCode(this.enabled)) * 31;
        String str = this.onClickLabel;
        int hashCode3 = (hashCode2 + (str != null ? str.hashCode() : 0)) * 31;
        Role role = this.role;
        int i = (((hashCode3 + (role != null ? Role.hashCode-impl(role.unbox-impl()) : 0)) * 31) + this.onClick.hashCode()) * 31;
