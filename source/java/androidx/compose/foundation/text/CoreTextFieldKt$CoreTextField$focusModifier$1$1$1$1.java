...
@DebugMetadata(c = "androidx.compose.foundation.text.CoreTextFieldKt$CoreTextField$focusModifier$1$1$1$1", f = "CoreTextField.kt", i = {}, l = {342}, m = "invokeSuspend", n = {}, s = {})
...
public final class CoreTextFieldKt$CoreTextField$focusModifier$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (CoreTextFieldKt.bringSelectionEndIntoView(this.$bringIntoViewRequester, this.$value, this.$state.getTextDelegate(), this.$layoutResult.getValue(), this.$offsetMapping, (Continuation) this) == coroutine_suspended) {
