...
public final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo955measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo6318measureBRTryo0 = measurable.mo6318measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.getMaxHeight-impl(j)) < Constraints.getMaxWidth-impl(j) ? j : Constraints.copy-Zbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null));
        final int min = Math.min(mo6318measureBRTryo0.getWidth(), Constraints.getMaxWidth-impl(j));
        return MeasureScope.layout$default(measureScope, min, mo6318measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = HorizontalScrollLayoutModifier.measure_3p2s80s$lambda$0(HorizontalScrollLayoutModifier.this, measureScope, mo6318measureBRTryo0, min, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(HorizontalScrollLayoutModifier horizontalScrollLayoutModifier, MeasureScope measureScope, Placeable placeable, int i, Placeable.PlacementScope placementScope) {
        ...
        cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(placementScope2, i2, transformedText, textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeable.getWidth());
