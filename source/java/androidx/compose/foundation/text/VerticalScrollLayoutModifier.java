...
public final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo955measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6318measureBRTryo0.getWidth(), min, null, new Function1() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = VerticalScrollLayoutModifier.measure_3p2s80s$lambda$0(VerticalScrollLayoutModifier.this, mo6318measureBRTryo0, min, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(VerticalScrollLayoutModifier verticalScrollLayoutModifier, Placeable placeable, int i, Placeable.PlacementScope placementScope) {
        ...
        cursorRectInScroller = TextFieldScrollKt.getCursorRectInScroller(placementScope2, i2, transformedText, textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, false, placeable.getWidth());
