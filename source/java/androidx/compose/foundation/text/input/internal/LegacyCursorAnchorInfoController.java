...
public final class LegacyCursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.localToScreen.invoke(Matrix.m5080boximpl(this.matrix));
        ...
        Matrix.m5103translateimpl(fArr, f, -rect2.getTop(), 0.0f);
