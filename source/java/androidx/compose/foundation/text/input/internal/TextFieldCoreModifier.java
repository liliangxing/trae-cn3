...
public final /* data */ class TextFieldCoreModifier extends ModifierNodeElement<TextFieldCoreModifierNode> {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((((Boolean.hashCode(this.isFocused) * 31) + Boolean.hashCode(this.isDragHovered)) * 31) + this.textLayoutState.hashCode()) * 31) + this.textFieldState.hashCode()) * 31) + this.textFieldSelectionState.hashCode()) * 31) + this.cursorBrush.hashCode()) * 31) + Boolean.hashCode(this.writeable)) * 31) + this.scrollState.hashCode()) * 31) + this.orientation.hashCode()) * 31) + this.toolbarRequester.hashCode()) * 31;
        PlatformSelectionBehaviors platformSelectionBehaviors = this.platformSelectionBehaviors;
        return hashCode + (platformSelectionBehaviors == null ? 0 : platformSelectionBehaviors.hashCode());
    }
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m1845create() {
