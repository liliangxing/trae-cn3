...
public final class TextFieldTextLayoutModifier extends ModifierNodeElement<TextFieldTextLayoutModifierNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m1879create() {
    ...
    public int hashCode() {
        int hashCode = ((((((Boolean.hashCode(this.singleLine) * 31) + this.textLayoutState.hashCode()) * 31) + this.textFieldState.hashCode()) * 31) + this.textStyle.hashCode()) * 31;
        Function2<Density, Function0<TextLayoutResult>, Unit> function2 = this.onTextLayout;
        return ((hashCode + (function2 != null ? function2.hashCode() : 0)) * 31) + this.keyboardOptions.hashCode();
    }
}
