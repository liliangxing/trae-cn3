...
public final class C0460xc459376b implements TextInputSession, ImeEditCommandScope {
    ...
    public long mo1769mapFromTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1769mapFromTransformedGEjPoXI(range);
    }

    @Override // androidx.compose.foundation.text.input.internal.ImeEditCommandScope
    /* renamed from: mapToTransformed-GEjPoXI, reason: not valid java name */
    public long mo1770mapToTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1770mapToTransformedGEjPoXI(range);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C0460xc459376b(DefaultImeEditCommandScope defaultImeEditCommandScope, TransformedTextFieldState transformedTextFieldState, ComposeInputMethodManager composeInputMethodManager, Function1<? super ImeAction, Unit> function1, ReceiveContentConfiguration receiveContentConfiguration, CursorAnchorInfoController cursorAnchorInfoController, TextLayoutState textLayoutState, Function0<Unit> function0, ViewConfiguration viewConfiguration) {
    ...
    public void mo1771onImeActionKlQnJC8(int imeAction) {
