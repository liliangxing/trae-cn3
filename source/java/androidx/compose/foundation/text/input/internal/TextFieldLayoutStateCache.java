...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final void updateNonMeasureInputs(TransformedTextFieldState textFieldState, TextStyle textStyle, boolean singleLine, boolean softWrap, KeyboardOptions keyboardOptions) {
        setNonMeasureInputs(new NonMeasureInputs(textFieldState, textStyle, singleLine, softWrap, KeyboardType.equals-impl0(keyboardOptions.getKeyboardType(), KeyboardType.Companion.getPhone-PjHm6EE())));
    }

    /* renamed from: layoutWithNewMeasureInputs--hBUhpc, reason: not valid java name */
    public final TextLayoutResult m1873layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) {
        ...
        mergeNullableLists = TextFieldLayoutStateCacheKt.mergeNullableLists(visualText.getComposingAnnotations(), visualText.getOutputAnnotations());
        ...
        if (layoutResult != null) {
            CharSequence visualText2 = cacheRecord.getVisualText();
            if ((visualText2 != null && StringsKt.contentEquals(visualText2, visualText)) && Intrinsics.areEqual(cacheRecord.getAnnotations(), mergeNullableLists) && Intrinsics.areEqual(cacheRecord.getComposition(), visualText.getComposition()) && cacheRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cacheRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cacheRecord.getLayoutDirection() == measureInputs.getLayoutDirection()) {
                if (cacheRecord.getDensityValue() == measureInputs.getDensity().getDensity()) {
                    if ((cacheRecord.getFontScale() == measureInputs.getDensity().getFontScale()) && Constraints.equals-impl0(cacheRecord.getConstraints(), measureInputs.getConstraints()) && Intrinsics.areEqual(cacheRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver()) && !layoutResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts()) {
        ...
        if (!Intrinsics.areEqual(computeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.setVisualText(visualText);
                    cacheRecord3.setAnnotations(mergeNullableLists);
                    cacheRecord3.m1876setCompositionOEnZFl4(visualText.getComposition());
                    ...
                    cacheRecord3.m1877setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private final TextLayoutResult computeLayout(TextFieldCharSequence visualText, List<AnnotatedString.Range<AnnotatedString.Annotation>> annotations, NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) {
        ...
        return TextMeasurer.measure-xDpz5zY$default(obtainTextMeasurer, new AnnotatedString(visualText.toString(), annotations == null ? CollectionsKt.emptyList() : annotations), textStyle, 0, nonMeasureInputs.getSoftWrap(), nonMeasureInputs.getSingleLine() ? 1 : Integer.MAX_VALUE, (List) null, measureInputs.getConstraints(), measureInputs.getLayoutDirection(), measureInputs.getDensity(), measureInputs.getFontFamilyResolver(), false, 1060, (Object) null);
    }
    ...
    public static final class CacheRecord extends StateRecord {
        ...
        public final void m1876setCompositionOEnZFl4(TextRange textRange) {
        ...
        public final void m1877setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    public static final class NonMeasureInputs {
        ...
        private static final SnapshotMutationPolicy<NonMeasureInputs> mutationPolicy = new SnapshotMutationPolicy<NonMeasureInputs>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldLayoutStateCache$NonMeasureInputs$Companion$mutationPolicy$1
            ...
            public boolean equivalent(TextFieldLayoutStateCache.NonMeasureInputs a, TextFieldLayoutStateCache.NonMeasureInputs b) {
                ...
                } else if (a.getTextFieldState() == b.getTextFieldState() && Intrinsics.areEqual(a.getTextStyle(), b.getTextStyle()) && a.getSingleLine() == b.getSingleLine() && a.getSoftWrap() == b.getSoftWrap() && a.getIsKeyboardTypePhone() == b.getIsKeyboardTypePhone()) {
                    return true;
                }
                return false;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: TextFieldLayoutStateCache.kt */
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\f\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u0000 \u001d2\u00020\u0001:\u0001\u001dB'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0006\u0010\b\u001a\u00020\t¢\u0006\u0004\b\n\u0010\u000bJ\b\u0010\u001b\u001a\u00020\u001cH\u0016R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0013\u0010\b\u001a\u00020\t¢\u0006\n\n\u0002\u0010\u0014\u001a\u0004\b\u0012\u0010\u0013R\u0011\u0010\u0015\u001a\u00020\u0016¢\u0006\b\n\u0000\u001a\u0004\b\u0017\u0010\u0018R\u0011\u0010\u0019\u001a\u00020\u0016¢\u0006\b\n\u0000\u001a\u0004\b\u001a\u0010\u0018¨\u0006\u001e"}, d2 = {"Landroidx/compose/foundation/text/input/internal/TextFieldLayoutStateCache$MeasureInputs;", "", "density", "Landroidx/compose/ui/unit/Density;", "layoutDirection", "Landroidx/compose/ui/unit/LayoutDirection;", "fontFamilyResolver", "Landroidx/compose/ui/text/font/FontFamily$Resolver;", "constraints", "Landroidx/compose/ui/unit/Constraints;", "<init>", "(Landroidx/compose/ui/unit/Density;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/text/font/FontFamily$Resolver;JLkotlin/jvm/internal/DefaultConstructorMarker;)V", "getDensity", "()Landroidx/compose/ui/unit/Density;", "getLayoutDirection", "()Landroidx/compose/ui/unit/LayoutDirection;", "getFontFamilyResolver", "()Landroidx/compose/ui/text/font/FontFamily$Resolver;", "getConstraints-msEJaDk", "()J", "J", "densityValue", "", "getDensityValue", "()F", "fontScale", "getFontScale", "toString", "", "Companion", "foundation_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
    public static final class MeasureInputs {
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                if (a == null || b == null) {
                    ...
                    if (a.getDensityValue() == b.getDensityValue()) {
                        if ((a.getFontScale() == b.getFontScale()) && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.equals-impl0(a.getConstraints(), b.getConstraints())) {
                            return true;
                        }
                    }
                }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.toString-impl(this.constraints)) + ')';
        }
