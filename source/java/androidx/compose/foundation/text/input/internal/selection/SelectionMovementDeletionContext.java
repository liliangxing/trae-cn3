...
public final class SelectionMovementDeletionContext {
    ...
    public final void m1927setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorUpByLine() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtLeast(jumpByLinesOffset, 0), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
            }
            if (m1915component2impl != null) {
                setWedgeAffinity(m1915component2impl);
            }
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorDownByLine() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtMost(jumpByLinesOffset, this.text.length()), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.getEnd-impl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.getEnd-impl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            ...
            if (TextRange.getEnd-impl(j) > i) {
                return TextRange.getEnd-impl(j);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            ...
            if (TextRange.getStart-impl(j) < i) {
                return TextRange.getStart-impl(j);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.getMin-impl(selectionMovementDeletionContext.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.getMax-impl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int i2 = TextRange.getEnd-impl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(i2).getLeft());
        }
        ...
        return textLayoutResult.getOffsetForPosition-k-4lQ0M(Offset.m4585constructorimpl((Float.floatToRawIntBits(cachedX) << 32) | (Float.floatToRawIntBits(lineBottom) & 4294967295L)));
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int i = TextRange.getEnd-impl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return i;
        }
        Rect translate = this.textLayoutResult.getCursorRect(i).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(translate.getTop() - lineBottom) > Math.abs(translate.getBottom() - lineBottom)) {
            return this.textLayoutResult.getOffsetForPosition-k-4lQ0M(translate.m4628getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.getOffsetForPosition-k-4lQ0M(translate.m4621getBottomLeftF1C5BW0());
    }
    ...
    public final SelectionMovementDeletionContext deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.getEnd-impl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext collapseLeftOr(Function1<? super SelectionMovementDeletionContext, Unit> or) {
        ...
        if (this.text.length() > 0) {
            if (TextRange.getCollapsed-impl(this.selection)) {
                ...
                this.selection = TextRangeKt.TextRange(TextRange.getMin-impl(this.selection));
            } else {
                this.selection = TextRangeKt.TextRange(TextRange.getMax-impl(this.selection));
            }
        }
        return this;
    }
    ...
    private final SelectionMovementDeletionContext moveCursorTo(boolean resetCachedX, Function0<Integer> proposedCursorMovement) {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(((Number) proposedCursorMovement.invoke()).intValue(), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    static /* synthetic */ SelectionMovementDeletionContext moveCursorTo$default(SelectionMovementDeletionContext selectionMovementDeletionContext, boolean z, Function0 function0, int i, Object obj) {
        ...
        if (selectionMovementDeletionContext.text.length() > 0) {
            int i2 = TextRange.getEnd-impl(selectionMovementDeletionContext.getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(((Number) function0.invoke()).intValue(), i2, selectionMovementDeletionContext.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i2 || !TextRange.getCollapsed-impl(selectionMovementDeletionContext.getSelection())) {
                selectionMovementDeletionContext.m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
            }
            if (m1915component2impl != null) {
                selectionMovementDeletionContext.setWedgeAffinity(m1915component2impl);
            }
        }
        return selectionMovementDeletionContext;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByCodePointOrEmoji() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.text, TextRange.getEnd-impl(this.selection), -1), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByChar() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.getEnd-impl(this.selection)), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByChar() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.getEnd-impl(this.selection)), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToHome() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(0, i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToEnd() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(this.text.length(), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByWord() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getNextWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByWord() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getPrevWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            int findParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.getMin-impl(this.selection));
            if (findParagraphStart == TextRange.getMin-impl(this.selection) && findParagraphStart != 0) {
                findParagraphStart = StringHelpersKt.findParagraphStart(this.text, findParagraphStart - 1);
            }
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(findParagraphStart, i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.getMax-impl(this.selection));
            if (findParagraphEnd == TextRange.getMax-impl(this.selection) && findParagraphEnd != this.text.length()) {
                findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, findParagraphEnd + 1);
            }
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(findParagraphEnd, i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineStart() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineStartByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineEnd() {
        ...
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineEndByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorUpByPage() {
        if (this.text.length() > 0) {
            int i = TextRange.getEnd-impl(getSelection());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(jumpByPagesOffset(-1), i, this.state);
            int m1914component1impl = CursorAndWedgeAffinity.m1914component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1915component2impl = CursorAndWedgeAffinity.m1915component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1914component1impl != i || !TextRange.getCollapsed-impl(getSelection())) {
                m1927setSelection5zctL8(TextRangeKt.TextRange(m1914component1impl));
    ...
    public final SelectionMovementDeletionContext selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.getStart-impl(this.initialValue.getSelection()), TextRange.getEnd-impl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext deleteMovement() {
        if (this.text.length() > 0) {
            if (!TextRange.getCollapsed-impl(this.initialValue.getSelection())) {
                this.state.deleteSelectedText();
            } else {
                TransformedTextFieldState.m1899replaceTextM8tDOmk$default(this.state, "", TextRangeKt.TextRange(TextRange.getStart-impl(this.initialValue.getSelection()), TextRange.getEnd-impl(this.selection)), null, !this.isFromSoftKeyboard, 4, null);
            }
