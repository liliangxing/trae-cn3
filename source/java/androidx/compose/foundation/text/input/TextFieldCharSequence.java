...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair<TextHighlightType, TextRange> pair, List<AnnotatedString.Range<AnnotatedString.Annotation>> list, List<AnnotatedString.Range<AnnotatedString.Annotation>> list2) {
        ...
        this.selection = TextRangeKt.m6526coerceIn8ffj60Q(j, 0, charSequence.length());
        this.composition = textRange != null ? TextRange.m6508boximpl(TextRangeKt.m6526coerceIn8ffj60Q(textRange.getPackedValue(), 0, charSequence.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m6508boximpl(TextRangeKt.m6526coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, charSequence.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair pair, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : charSequence, (i & 2) != 0 ? TextRange.INSTANCE.m6525getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (i & 8) != 0 ? null : pair, (i & 16) != 0 ? null : list, (i & 32) == 0 ? list2 : null, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return TextRange.m6513equalsimpl0(this.selection, textFieldCharSequence.selection) && Intrinsics.areEqual(this.composition, textFieldCharSequence.composition) && Intrinsics.areEqual(this.highlight, textFieldCharSequence.highlight) && Intrinsics.areEqual(this.composingAnnotations, textFieldCharSequence.composingAnnotations) && contentEquals(textFieldCharSequence.text);
    }

    public int hashCode() {
        int hashCode = ((this.text.hashCode() * 31) + TextRange.m6521hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        int m6521hashCodeimpl = (hashCode + (textRange != null ? TextRange.m6521hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
        Pair<TextHighlightType, TextRange> pair = this.highlight;
        int hashCode2 = (m6521hashCodeimpl + (pair != null ? pair.hashCode() : 0)) * 31;
