...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long mo1733getOriginalRangejx7JFs = changeList.mo1733getOriginalRangejx7JFs(0);
            long mo1734getRangejx7JFs = changeList.mo1734getRangejx7JFs(0);
            if (TextRange.getCollapsed-impl(mo1733getOriginalRangejx7JFs) && TextRange.getCollapsed-impl(mo1734getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.getMin-impl(mo1733getOriginalRangejx7JFs), TextRangeKt.substring-FDrldGo(textFieldCharSequence, mo1733getOriginalRangejx7JFs), TextRangeKt.substring-FDrldGo(textFieldCharSequence2, mo1734getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
