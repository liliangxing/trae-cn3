...
public final class ProcessText_androidKt {
    ...
    public static final void m1677addProcessedTextContextMenuItemsUAq72N0(TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context, final boolean z, final CharSequence charSequence, final long j) {
        if (!ComposeFoundationFlags.isSmartSelectionEnabled || TextRange.getCollapsed-impl(j)) {
            return;
        }
        ...
        List<ResolveInfo> queryProcessTextActivities = ProcessTextApi23Impl.INSTANCE.queryProcessTextActivities(context);
        ...
        for (int i = 0; i < size; i++) {
            final ResolveInfo resolveInfo = queryProcessTextActivities.get(i);
            TextContextMenuBuilderScope_androidKt.item$default(textContextMenuBuilderScope, new ProcessTextKey(i), resolveInfo.loadLabel(packageManager).toString(), 0, new Function1() { // from class: androidx.compose.foundation.text.contextmenu.ProcessText_androidKt$$ExternalSyntheticLambda0
                public final Object invoke(Object obj) {
                    ...
                    addProcessedTextContextMenuItems_UAq72N0$lambda$1$lambda$0 = ProcessText_androidKt.addProcessedTextContextMenuItems_UAq72N0$lambda$1$lambda$0(context, resolveInfo, z, charSequence, j, (TextContextMenuSession) obj);
    ...
    public static final Unit addProcessedTextContextMenuItems_UAq72N0$lambda$1$lambda$0(Context context, ResolveInfo resolveInfo, boolean z, CharSequence charSequence, long j, TextContextMenuSession textContextMenuSession) {
        ProcessTextApi23Impl.INSTANCE.getOnClickProcessTextItem().invoke(context, resolveInfo, Boolean.valueOf(z), charSequence, TextRange.box-impl(j));
