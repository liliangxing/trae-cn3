...
public final class TextContextMenuModifierKt {
    ...
    public static final Modifier appendTextContextMenuComponents(Modifier modifier, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        return modifier.then((Modifier) new AddTextContextMenuDataComponentsElement(function1));
    }
    ...
    public static final Modifier filterTextContextMenuComponents(Modifier modifier, Function1<? super TextContextMenuComponent, Boolean> function1) {
        return modifier.then((Modifier) new FilterTextContextMenuDataComponentsElement(function1));
    }
    ...
    private static final void traverseTextContextMenuDataNodes(DelegatableNode delegatableNode, final Function1<? super Function1<? super TextContextMenuComponent, Boolean>, Unit> function1, final Function1<? super Function1<? super TextContextMenuBuilderScope, Unit>, Unit> function12) {
        TraversableNodeKt.traverseAncestors(delegatableNode, TextContextMenuDataTraverseKey.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.contextmenu.modifier.TextContextMenuModifierKt$$ExternalSyntheticLambda1
            public final Object invoke(Object obj) {
                ...
                traverseTextContextMenuDataNodes$lambda$0 = TextContextMenuModifierKt.traverseTextContextMenuDataNodes$lambda$0(function12, function1, (TraversableNode) obj);
    ...
    public static final TextContextMenuData collectTextContextMenuData(DelegatableNode delegatableNode) {
        ...
        traverseTextContextMenuDataNodes(delegatableNode, new TextContextMenuModifierKt$collectTextContextMenuData$1$1(textContextMenuBuilderScope), new Function1() { // from class: androidx.compose.foundation.text.contextmenu.modifier.TextContextMenuModifierKt$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
