...
final class FloatingTextActionModeCallback extends ActionMode.Callback2 implements ActionMode.Callback {
    ...
    public void onGetContentRect(ActionMode mode, View view, Rect outRect) {
        androidx.compose.ui.geometry.Rect onGetContentRect = this.textActionModeCallback.onGetContentRect(mode, view);
        outRect.set(Math.round(onGetContentRect.getLeft()), Math.round(onGetContentRect.getTop()), Math.round(onGetContentRect.getRight()), Math.round(onGetContentRect.getBottom()));
    }
}
