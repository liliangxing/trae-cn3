...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public final void m1695setPreviousWindowSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1693setPreviousPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1694setPreviousPositionfg0MpWk(IntOffset intOffset) {
        this.previousPosition = intOffset;
    }

    /* renamed from: calculatePosition-llwVHH4, reason: not valid java name */
    public long m1689calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        IntOffset intOffset = this.previousPosition;
        if (intOffset != null) {
            IntSize intSize = this.previousWindowSize;
            if ((intSize == null ? false : IntSize.equals-impl0(intSize.unbox-impl(), windowSize)) && this.previousLayoutDirection == layoutDirection) {
                IntSize intSize2 = this.previousPopupContentSize;
                if (intSize2 != null ? IntSize.equals-impl0(intSize2.unbox-impl(), popupContentSize) : false) {
                    return intOffset.unbox-impl();
                }
            }
        }
        long j = this.popupPositionProvider.calculatePosition-llwVHH4(anchorBounds, windowSize, layoutDirection, popupContentSize);
        this.previousWindowSize = IntSize.box-impl(windowSize);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.box-impl(popupContentSize);
        this.previousPosition = IntOffset.box-impl(j);
        return j;
    }
}
