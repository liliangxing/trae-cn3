...
public final class HandwritingDetectorNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    public static final ComposeInputMethodManager composeImm_delegate$lambda$0(HandwritingDetectorNode handwritingDetectorNode) {
        return ComposeInputMethodManager_androidKt.ComposeInputMethodManager(DelegatableNode_androidKt.requireView((DelegatableNode) handwritingDetectorNode));
    }
    ...
    public void m1718onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputNode.m1722onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public long m1717getTouchBoundsExpansionRZrCHBk() {
        return this.pointerInputNode.m1721getTouchBoundsExpansionRZrCHBk();
    }
}
