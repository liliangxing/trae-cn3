...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m4609getZeroF1C5BW0();
            ...
            public void mo1625onStartk4lQ0M(long startPoint) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    selectionRegistrar2.mo2130notifySelectionUpdateStartubNVwUQ(layoutCoordinates, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
            ...
            public void mo1624onDragk4lQ0M(long delta) {
                ...
                if (layoutCoordinates != null) {
                    ...
                    if (layoutCoordinates.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                        ...
                        long m4598plusMKHz9U2 = Offset.m4598plusMKHz9U(this.lastPosition, m4598plusMKHz9U);
                        if (selectionRegistrar2.mo2129notifySelectionUpdatenjBpvok(layoutCoordinates, m4598plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getWord(), true)) {
                            this.lastPosition = m4598plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m4609getZeroF1C5BW0();
                        }
                    }
                }
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo1964onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo2129notifySelectionUpdatenjBpvok(layoutCoordinates, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo1965onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo2129notifySelectionUpdatenjBpvok(layoutCoordinates, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
            ...
            public boolean mo1966onStart9KIMszo(long downPosition, SelectionAdjustment adjustment, int clickCount) {
                ...
                selectionRegistrar2.mo2130notifySelectionUpdateStartubNVwUQ(layoutCoordinates, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo1963onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo2129notifySelectionUpdatenjBpvok(layoutCoordinates, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
