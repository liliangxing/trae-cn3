...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final void m2051setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.getOffsetForPosition-k-4lQ0M(Offset.m4585constructorimpl((Float.floatToRawIntBits(r2.floatValue()) << 32) | (Float.floatToRawIntBits(lineBottom) & 4294967295L))));
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        if (getText$foundation_release().length() > 0) {
            if (TextRange.getCollapsed-impl(this.selection)) {
                ...
                setCursor(TextRange.getMin-impl(this.selection));
            } else {
                setCursor(TextRange.getMax-impl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T moveCursorPrevByParagraph() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            int findParagraphStart = StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.getMin-impl(this.selection));
    ...
    public final T moveCursorNextByParagraph() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.getMax-impl(this.selection));
            if (findParagraphEnd == TextRange.getMax-impl(this.selection) && findParagraphEnd != getText$foundation_release().length()) {
