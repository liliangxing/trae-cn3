...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        if (changedInstance || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$$ExternalSyntheticLambda0
        ...
        if (changed || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$$ExternalSyntheticLambda1
                public final Object invoke(Object obj) {
                    Modifier invoke$lambda$9$lambda$8;
                    invoke$lambda$9$lambda$8 = TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$9$lambda$8(density, mutableState, (Function0) obj);
    ...
    public static final Offset invoke$lambda$4$lambda$3(TextFieldSelectionManager textFieldSelectionManager, MutableState mutableState) {
        return Offset.m4582boximpl(TextFieldSelectionManagerKt.m2157calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, invoke$lambda$1(mutableState)));
    }
    ...
    public static final Modifier invoke$lambda$9$lambda$8(final Density density, final MutableState mutableState, final Function0 function0) {
        return Magnifier_androidKt.m487magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$$ExternalSyntheticLambda2
            public final Object invoke(Object obj) {
                Offset invoke$lambda$9$lambda$8$lambda$5;
                invoke$lambda$9$lambda$8$lambda$5 = TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$9$lambda$8$lambda$5(function0, (Density) obj);
                return invoke$lambda$9$lambda$8$lambda$5;
            }
        }, null, new Function1() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$$ExternalSyntheticLambda3
            public final Object invoke(Object obj) {
                Unit invoke$lambda$9$lambda$8$lambda$7;
                invoke$lambda$9$lambda$8$lambda$7 = TextFieldSelectionManager_androidKt$textFieldMagnifier$1.invoke$lambda$9$lambda$8$lambda$7(density, mutableState, (DpSize) obj);
