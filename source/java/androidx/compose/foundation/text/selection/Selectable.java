...
public interface Selectable {
    ...
    long mo2054getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo2055getRangeOfLineContainingjx7JFs(int offset);
