...
final /* data */ class PercentCornerSize implements CornerSize, InspectableValue {
    ...
    public float mo1463toPxTmRCtEA(long shapeSize, Density density) {
        return Size.m4661getMinDimensionimpl(shapeSize) * (this.percent / 100.0f);
    }
