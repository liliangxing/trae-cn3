...
public final class FlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final FlowRowOverflow expandIndicator(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> content) {
            return new FlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandIndicator, 0, 0, new Function1() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$$ExternalSyntheticLambda0
                public final Object invoke(Object obj) {
                    Function2 expandIndicator$lambda$0;
                    expandIndicator$lambda$0 = FlowRowOverflow.Companion.expandIndicator$lambda$0(content, (FlowLayoutOverflowState) obj);
        ...
        public static final Function2 expandIndicator$lambda$0(final Function3 function3, final FlowLayoutOverflowState flowLayoutOverflowState) {
            return ComposableLambdaKt.composableLambdaInstance(-982932461, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1$1
                ...
                public final void invoke(Composer composer, int i) {
                    ...
                    function3.invoke(new FlowRowOverflowScopeImpl(FlowLayoutOverflowState.this), composer, 0);
                    if (ComposerKt.isTraceInProgress()) {
        ...
        public final FlowRowOverflow m994expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int i, float f, Composer composer, int i2, int i3) {
            ...
            if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = new FlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i4, i5, new Function1() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$$ExternalSyntheticLambda1
                    public final Object invoke(Object obj) {
                        Function2 expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$2;
                        expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$2 = FlowRowOverflow.Companion.expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$2(function3, (FlowLayoutOverflowState) obj);
                        return expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$2;
                    }
                }, new Function1() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$$ExternalSyntheticLambda2
                    public final Object invoke(Object obj) {
                        Function2 expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$3;
                        expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$3 = FlowRowOverflow.Companion.expandOrCollapseIndicator__jt2gSs$lambda$4$lambda$3(function32, (FlowLayoutOverflowState) obj);
