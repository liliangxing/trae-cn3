...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo147measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.getHasFixedWidth-impl(j) ? Constraints.getMaxWidth-impl(j) : 0, Constraints.getHasFixedHeight-impl(j) ? Constraints.getMaxHeight-impl(j) : 0, null, new Function1() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$$ExternalSyntheticLambda0
    ...
    public static final Unit measure_3p2s80s$lambda$1$lambda$0(Placeable.PlacementScope placementScope) {
