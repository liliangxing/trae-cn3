...
public final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    public AlignmentLineOffsetTextUnitNode m890create() {
        return new AlignmentLineOffsetTextUnitNode(this.alignmentLine, this.before, this.after, null);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.hashCode-impl(this.before)) * 31) + TextUnit.hashCode-impl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.equals-impl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.equals-impl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m895setBeforeR2X_6o(this.before);
        node.m894setAfterR2X_6o(this.after);
    }
}
