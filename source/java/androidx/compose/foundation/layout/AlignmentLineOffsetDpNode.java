...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m887setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m886setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult m885measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m871alignmentLineOffsetMeasuretjqqzMA;
        m871alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m871alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j);
