...
public final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult m1027measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo6318measureBRTryo0 = measurable.mo6318measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo6318measureBRTryo0.getWidth(), mo6318measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetPxNode$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = OffsetPxNode.measure_3p2s80s$lambda$0(OffsetPxNode.this, mo6318measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetPxNode offsetPxNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        long j = ((IntOffset) offsetPxNode.offset.invoke(placementScope)).unbox-impl();
        if (offsetPxNode.rtlAware) {
            Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeable, IntOffset.getX-impl(j), IntOffset.getY-impl(j), 0.0f, (Function1) null, 12, (Object) null);
        } else {
            Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.getX-impl(j), IntOffset.getY-impl(j), 0.0f, (Function1) null, 12, (Object) null);
        }
