...
public final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult m1073measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo6318measureBRTryo0 = measurable.mo6318measureBRTryo0(ConstraintsKt.offset-NN6Ew-U(j, -i, -i2));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.constrainWidth-K40F9xA(j, mo6318measureBRTryo0.getWidth() + i), ConstraintsKt.constrainHeight-K40F9xA(j, mo6318measureBRTryo0.getHeight() + i2), null, new Function1() { // from class: androidx.compose.foundation.layout.PaddingNode$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = PaddingNode.measure_3p2s80s$lambda$0(PaddingNode.this, mo6318measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(PaddingNode paddingNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        if (paddingNode.rtlAware) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, placementScope.roundToPx-0680j_4(paddingNode.start), placementScope.roundToPx-0680j_4(paddingNode.top), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default(placementScope, placeable, placementScope.roundToPx-0680j_4(paddingNode.start), placementScope.roundToPx-0680j_4(paddingNode.top), 0.0f, 4, null);
        }
