...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m1152onlybOOhFvg(WindowInsets windowInsets, int i) {
    ...
    public static final WindowInsets m1150WindowInsetsa9UjIt4(float f, float f2, float f3, float f4) {
        return new FixedDpInsets(f, f2, f3, f4, null);
    }

    /* renamed from: WindowInsets-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ WindowInsets m1151WindowInsetsa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1150WindowInsetsa9UjIt4(f, f2, f3, f4);
    }
}
