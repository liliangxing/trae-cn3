...
public final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1022setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: setY-0680j_4, reason: not valid java name */
    public final void m1023setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public final void m1024updateMdfbLM(float x, float y, boolean rtlAware) {
    ...
    public MeasureResult m1021measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo6318measureBRTryo0 = measurable.mo6318measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo6318measureBRTryo0.getWidth(), mo6318measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetNode$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = OffsetNode.measure_3p2s80s$lambda$0(OffsetNode.this, mo6318measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetNode offsetNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        if (offsetNode.rtlAware) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, placementScope.roundToPx-0680j_4(offsetNode.x), placementScope.roundToPx-0680j_4(offsetNode.y), 0.0f, 4, null);
        } else {
            Placeable.PlacementScope.place$default(placementScope, placeable, placementScope.roundToPx-0680j_4(offsetNode.x), placementScope.roundToPx-0680j_4(offsetNode.y), 0.0f, 4, null);
        }
