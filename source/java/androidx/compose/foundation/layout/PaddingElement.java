...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final void m1053setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m1054setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m1052setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m1051setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public PaddingNode m1055create() {
    ...
    public int hashCode() {
        return (((((((Dp.hashCode-impl(this.start) * 31) + Dp.hashCode-impl(this.top)) * 31) + Dp.hashCode-impl(this.end)) * 31) + Dp.hashCode-impl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }
