...
public final /* data */ class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo147measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        measure = RowColumnMeasurePolicyKt.measure(this, Constraints.getMinWidth-impl(j), Constraints.getMinHeight-impl(j), Constraints.getMaxWidth-impl(j), Constraints.getMaxHeight-impl(j), measureScope.roundToPx-0680j_4(this.horizontalArrangement.getSpacing()), measureScope, list, new Placeable[list.size()], 0, list.size(), (r28 & Fields.RotationZ) != 0 ? null : null, (r28 & Fields.CameraDistance) != 0 ? 0 : 0);
        return measure;
    }
    ...
    public long mo947createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing) {
    ...
    private final int getCrossAxisPosition(Placeable placeable, RowColumnParentData parentData, int crossAxisLayoutSize, int beforeCrossAxisAlignmentLine) {
        ...
        if (crossAxisAlignment != null) {
            return crossAxisAlignment.align$foundation_layout(crossAxisLayoutSize - placeable.getHeight(), LayoutDirection.Ltr, placeable, beforeCrossAxisAlignmentLine);
        }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, i, intrinsicMeasureScope.roundToPx-0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.p002ui.layout.MeasurePolicy
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, i, intrinsicMeasureScope.roundToPx-0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.p002ui.layout.MeasurePolicy
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, i, intrinsicMeasureScope.roundToPx-0680j_4(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.p002ui.layout.MeasurePolicy
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, i, intrinsicMeasureScope.roundToPx-0680j_4(this.horizontalArrangement.getSpacing()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit placeHelper$lambda$3$lambda$2(Placeable[] placeableArr, RowMeasurePolicy rowMeasurePolicy, int i, int i2, int[] iArr, Placeable.PlacementScope placementScope) {
