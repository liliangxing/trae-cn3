...
final class AspectRatioElement extends ModifierNodeElement<AspectRatioNode> {
    ...
    public AspectRatioNode m927create() {
    ...
    public boolean equals(Object other) {
        ...
        return ((this.aspectRatio > aspectRatioElement.aspectRatio ? 1 : (this.aspectRatio == aspectRatioElement.aspectRatio ? 0 : -1)) == 0) && this.matchHeightConstraintsFirst == ((AspectRatioElement) other).matchHeightConstraintsFirst;
    }
