...
public final class AndroidOverscroll_androidKt {
    ...
    public static final OverscrollFactory m394rememberPlatformOverscrollFactory3JVO9M(long j, PaddingValues paddingValues, Composer composer, int i, int i2) {
    ...
    public static final OverscrollEffect rememberPlatformOverscrollEffect(Composer composer, int i) {
        ...
        if (overscrollConfiguration == null) {
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = new AndroidEdgeEffectOverscrollEffect(context, density, overscrollConfiguration.getGlowColor(), overscrollConfiguration.getDrawPadding(), null);
    ...
    public static final float m393destretchMultiplierGyEprt8(int i) {
        return NestedScrollSource.m6020equalsimpl0(i, NestedScrollSource.INSTANCE.m6031getSideEffectWNlRxjI()) ? 4.0f : 1.0f;
    }
}
