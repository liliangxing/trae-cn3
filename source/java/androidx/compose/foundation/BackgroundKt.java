...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m397backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m396backgroundbw27NRU(modifier, j, shape);
    }
    ...
    public static final Modifier background(Modifier modifier, final Brush brush, final Shape shape, final float f) {
        return modifier.then((Modifier) new BackgroundElement(0L, brush, f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background$$inlined$debugInspectorInfo$1
    ...
    public static final Modifier m396backgroundbw27NRU(Modifier modifier, final long j, final Shape shape) {
        return modifier.then((Modifier) new BackgroundElement(j, null, 1.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("background");
                inspectorInfo.setValue(Color.m4829boximpl(j));
                inspectorInfo.getProperties().set("color", Color.m4829boximpl(j));
                inspectorInfo.getProperties().set("shape", shape);
            }
