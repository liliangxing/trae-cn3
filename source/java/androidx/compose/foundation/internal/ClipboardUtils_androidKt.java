...
public final class ClipboardUtils_androidKt {
    ...
    public static final Object readText(ClipEntry clipEntry, Continuation<? super String> continuation) {
        return ClipboardUtils.readText(clipEntry);
    }

    public static final Object readAnnotatedString(ClipEntry clipEntry, Continuation<? super AnnotatedString> continuation) {
