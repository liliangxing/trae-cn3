...
final class BasicTooltipStateImpl$show$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        try {
            if (i == 0) {
                ...
                if (this.this$0.getIsPersistent()) {
                    ...
                    this.label = 2;
                    if (TimeoutKt.withTimeout(1500L, new C02231(this.$cancellableShow, null), (Continuation) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            } else {
    ...
    public static final class C02231 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02231(Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C02231> continuation) {
            super(2, continuation);
            this.$cancellableShow = function1;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02231(this.$cancellableShow, continuation);
        }
