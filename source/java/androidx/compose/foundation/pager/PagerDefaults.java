...
public final class PagerDefaults {
    ...
    public final TargetedFlingBehavior flingBehavior(final PagerState pagerState, PagerSnapDistance pagerSnapDistance, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, final float f, Composer composer, int i, int i2) {
        ComposerKt.sourceInformationMarkerStart(composer, 1559769181, "C(flingBehavior)N(state,pagerSnapDistance,decayAnimationSpec,snapAnimationSpec,snapPositionalThreshold)410@22228L26,422@22828L7,423@22887L7,424@22910L1058:Pager.kt#g6yjnt");
        boolean z = true;
        if ((i2 & 2) != 0) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1559769181, i, -1, "androidx.compose.foundation.pager.PagerDefaults.flingBehavior (Pager.kt:417)");
        }
        if (!(0.0f <= f && f <= 1.0f)) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        final Enum r0 = (LayoutDirection) consume2;
        ...
        boolean changed2 = changed | z | composer.changed(density) | composer.changed(r0.ordinal());
        ...
        if (changed2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = SnapFlingBehaviorKt.snapFlingBehavior(PagerSnapLayoutInfoProviderKt.SnapLayoutInfoProvider(pagerState, pagerSnapDistance, new Function3() { // from class: androidx.compose.foundation.pager.PagerDefaults$$ExternalSyntheticLambda0
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    ...
                    calculateFinalSnappingBound = PagerSnapLayoutInfoProviderKt.calculateFinalSnappingBound(PagerState.this, r0, f, ((Float) obj).floatValue(), ((Float) obj2).floatValue(), ((Float) obj3).floatValue());
    ...
    public final NestedScrollConnection pageNestedScrollConnection(PagerState pagerState, Orientation orientation, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, 877583120, "C(pageNestedScrollConnection)N(state,orientation)467@24439L107:Pager.kt#g6yjnt");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(877583120, i, -1, "androidx.compose.foundation.pager.PagerDefaults.pageNestedScrollConnection (Pager.kt:466)");
        }
