...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m434create() {
    ...
    public void update(ClickableNode node) {
        node.m457updateO2vRcR0(this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.hashCode-impl(role.unbox-impl()) : 0)) * 31) + this.onClick.hashCode();
    }
}
