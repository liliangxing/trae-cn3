...
public final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m488boximpl(i2), null, 2, null);
        this.animationMode = mutableStateOf$default3;
        this.offset = AnimatableKt.Animatable$default(0.0f, 0.0f, 2, null);
        this.spacingPx = SnapshotStateKt.derivedStateOf(new Function0() { // from class: androidx.compose.foundation.MarqueeModifierNode$$ExternalSyntheticLambda1
    ...
    public final int m505getAnimationModeZbEOnfQ() {
    ...
    public final void m507setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m488boximpl(i));
    }
    ...
    public final void m508updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m507setAnimationMode97h66l8(animationMode);
    ...
    public MeasureResult m506measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.constrainWidth-K40F9xA(j, mo6318measureBRTryo0.getWidth()));
        setContentWidth(mo6318measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), mo6318measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.MarqueeModifierNode$$ExternalSyntheticLambda0
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        float f = spacingPx;
        float intBitsToFloat = Float.intBitsToFloat((int) (contentDrawScope.m5417getSizeNHjbRc() & 4294967295L));
        GraphicsLayer graphicsLayer = this.marqueeLayer;
        if (graphicsLayer != null) {
            contentDrawScope.m5418recordJVtK1S4(graphicsLayer, IntSize.constructor-impl((getContentWidth() << 32) | (MathKt.roundToInt(intBitsToFloat) & 4294967295L)), new Function1() { // from class: androidx.compose.foundation.MarqueeModifierNode$$ExternalSyntheticLambda2
                public final Object invoke(Object obj) {
        ...
        float intBitsToFloat2 = Float.intBitsToFloat((int) (4294967295L & contentDrawScope2.m5417getSizeNHjbRc()));
        ...
        try {
            drawContext.getTransform().mo5341clipRectN_I0leg(floatValue, 0.0f, containerWidth, intBitsToFloat2, m4828getIntersectrtfAjoo);
    ...
    private final void restartAnimation() {
        ...
        if (getIsAttached()) {
            this.animationJob = BuildersKt.launch$default(getCoroutineScope(), (CoroutineContext) null, (CoroutineStart) null, new MarqueeModifierNode$restartAnimation$1(job, this, null), 3, (Object) null);
        }
    }
