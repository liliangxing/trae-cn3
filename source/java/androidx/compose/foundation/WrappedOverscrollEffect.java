...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo372applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo372applyToScrollRhakbz0(delta, source, performScroll);
        }
    ...
    public Object mo371applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object mo371applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo371applyToFlingBMRW4eQ(j, function2, continuation);
