...
public final class BringIntoViewRequestPriorityQueue {
    ...
    public final boolean enqueue(final ContentInViewNode.Request request) {
        ...
        if (first <= last) {
            while (true) {
                Rect rect2 = (Rect) this.requests.content[last].getCurrentBounds().invoke();
                if (rect2 != null) {
    ...
    public final void resumeAndRemoveAll() {
        ...
        if (first <= last) {
            while (true) {
                Continuation continuation = this.requests.content[first].getContinuation();
    ...
    public final void resumeAndRemoveWhile(Function1<? super Rect, Boolean> block) {
        while (true) {
            if (!(this.requests.getSize() != 0) || !((Boolean) block.invoke(((ContentInViewNode.Request) this.requests.last()).getCurrentBounds().invoke())).booleanValue()) {
                return;
            }
