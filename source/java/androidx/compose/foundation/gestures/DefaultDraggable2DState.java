...
final class DefaultDraggable2DState implements Draggable2DState {
    ...
    private final Drag2DScope drag2DScope = new Drag2DScope() { // from class: androidx.compose.foundation.gestures.DefaultDraggable2DState$drag2DScope$1
        ...
        public void mo653dragByk4lQ0M(long pixels) {
            DefaultDraggable2DState.this.getOnDelta().invoke(Offset.m4582boximpl(pixels));
        }
    };
    ...
    public void mo652dispatchRawDeltak4lQ0M(long delta) {
        this.onDelta.invoke(Offset.m4582boximpl(delta));
    }
}
