...
public final class Draggable2DKt {
    private static final Function1<Offset, Unit> NoOpOnDragStart = new Function1() { // from class: androidx.compose.foundation.gestures.Draggable2DKt$$ExternalSyntheticLambda0
    ...
    private static final Function1<Velocity, Unit> NoOpOnDragStop = new Function1() { // from class: androidx.compose.foundation.gestures.Draggable2DKt$$ExternalSyntheticLambda1
        public final Object invoke(Object obj) {
    ...
    public static final Draggable2DState rememberDraggable2DState(Function1<? super Offset, Unit> function1, Composer composer, int i) {
        ...
        if (rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = Draggable2DState(new Function1() { // from class: androidx.compose.foundation.gestures.Draggable2DKt$$ExternalSyntheticLambda2
                public final Object invoke(Object obj) {
    ...
    public static final Modifier draggable2D(Modifier modifier, Draggable2DState draggable2DState, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function1<? super Offset, Unit> function1, Function1<? super Velocity, Unit> function12, boolean z3) {
        return modifier.then((Modifier) new Draggable2DElement(draggable2DState, z, mutableInteractionSource, z2, function1, function12, z3));
    }
