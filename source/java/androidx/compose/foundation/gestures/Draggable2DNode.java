...
public final class Draggable2DNode extends DragGestureNode {
    ...
    public void mo624onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStarted.invoke(Offset.m4582boximpl(startedPosition));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    /* renamed from: onDragStopped-TH1AsA0 */
    public void mo625onDragStoppedTH1AsA0(long velocity) {
        this.onDragStopped.invoke(Velocity.box-impl(velocity));
    }
    ...
    public final void update(Draggable2DState state, Function1<? super PointerInputChange, Boolean> canDrag, boolean enabled, MutableInteractionSource interactionSource, boolean startDragImmediately, boolean reverseDirection, Function1<? super Offset, Unit> onDragStarted, Function1<? super Velocity, Unit> onDragStopped) {
        boolean z;
        boolean z2;
    ...
    private final long m692reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m4585constructorimpl(j ^ (-9223372034707292160L)) : j;
    }
}
