...
public final class DraggableNode extends DragGestureNode {
    ...
    public void mo625onDragStoppedTH1AsA0(long velocity) {
        ...
        if (isAttached()) {
            ...
            BuildersKt.launch$default(getCoroutineScope(), (CoroutineContext) null, CoroutineStart.UNDISPATCHED, new DraggableNode$onDragStopped$1(this, velocity, null), 1, (Object) null);
        }
    }
    ...
    public final long m704reverseIfNeededAH228Gc(long j) {
        return Velocity.times-adjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m705reverseIfNeededMKHz9U(long j) {
        return Offset.m4600timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
