...
public final class Scrollable2DElement extends ModifierNodeElement<Scrollable2DNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m763create() {
    ...
    public Scrollable2DNode create() {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((hashCode + (overscrollEffect != null ? overscrollEffect.hashCode() : 0)) * 31) + Boolean.hashCode(this.enabled)) * 31;
        FlingBehavior flingBehavior = this.flingBehavior;
        int hashCode3 = (hashCode2 + (flingBehavior != null ? flingBehavior.hashCode() : 0)) * 31;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        return hashCode3 + (mutableInteractionSource != null ? mutableInteractionSource.hashCode() : 0);
    }
