...
public final class Scrollable2DKt {
    ...
    public static final Modifier scrollable2D(Modifier modifier, Scrollable2DState scrollable2DState, boolean z, OverscrollEffect overscrollEffect, FlingBehavior flingBehavior, MutableInteractionSource mutableInteractionSource) {
        return modifier.then((Modifier) new Scrollable2DElement(scrollable2DState, overscrollEffect, z, flingBehavior, mutableInteractionSource));
    }
    ...
    */
    public static final Object m769semanticsScrollByd4ec7I(ScrollingLogic2D scrollingLogic2D, long j, Continuation<? super Offset> continuation) {
        ...
        if (continuation instanceof Scrollable2DKt$semanticsScrollBy$1) {
            ...
            if ((scrollable2DKt$semanticsScrollBy$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Scrollable2DKt$semanticsScrollBy$2 scrollable2DKt$semanticsScrollBy$2 = new Scrollable2DKt$semanticsScrollBy$2(j, longRef2, null);
        ...
        Object obj2 = scrollable2DKt$semanticsScrollBy$1.result;
    ...
    public static final float m768getMagnitudeTH1AsA0(long j) {
        double d = 2;
        return (float) Math.sqrt(((float) Math.pow(Velocity.getX-impl(j), d)) + ((float) Math.pow(Velocity.getY-impl(j), d)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getAngle-TH1AsA0, reason: not valid java name */
    public static final float m767getAngleTH1AsA0(long j) {
        return (float) Math.atan2(Velocity.getY-impl(j), Velocity.getX-impl(j));
    }
}
