...
import androidx.compose.p002ui.draganddrop.DragAndDropSourceModifierNode;
import androidx.compose.p002ui.draganddrop.DragAndDropStartTransferScope;
...
public final class DragAndDropSourceNode extends DelegatingNode implements LayoutAwareModifierNode {
    ...
    private final DragAndDropSourceModifierNode dragAndDropModifierNode = delegate((DelegatableNode) DragAndDropNodeKt.DragAndDropSourceModifierNode(new Function2() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceNode$$ExternalSyntheticLambda0
    ...
    public static final Unit dragAndDropModifierNode$lambda$0(DragAndDropSourceNode dragAndDropSourceNode, DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
        DragAndDropTransferData dragAndDropTransferData = (DragAndDropTransferData) dragAndDropSourceNode.transferData.invoke(offset);
        if (dragAndDropTransferData != null) {
            dragAndDropStartTransferScope.mo4319startDragAndDropTransfer12SF9DM(dragAndDropTransferData, IntSizeKt.toSize-ozmzZPI(dragAndDropSourceNode.size), dragAndDropSourceNode.drawDragDecoration);
        }
    ...
    public void onAttach() {
        if (this.dragAndDropModifierNode.isRequestDragAndDropTransferRequired()) {
            this.inputModifierNode = delegate((DelegatableNode) SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceNode$onAttach$1
                ...
                /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
                public static final class C02431 implements DragAndDropStartDetectorScope, PointerInputScope {
                    ...
                    public int m577roundToPxR2X_6o(long j) {
                        return this.$$delegate_0.roundToPx--R2X_6o(j);
                    }

                    /* renamed from: roundToPx-0680j_4, reason: not valid java name */
                    public int m578roundToPx0680j_4(float f) {
                    ...
                    public long m585toSizeXkaWNTQ(long j) {
                        return this.$$delegate_0.toSize-XkaWNTQ(j);
                    }

                    /* renamed from: toSp-0xMU5do, reason: not valid java name */
                    public long m586toSp0xMU5do(float f) {
                        return this.$$delegate_0.toSp-0xMU5do(f);
                    }

                    /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
                    public long m587toSpkPz2Gy4(float f) {
                        return this.$$delegate_0.toSp-kPz2Gy4(f);
                    }

                    /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
                    public long m588toSpkPz2Gy4(int i) {
                        return this.$$delegate_0.toSp-kPz2Gy4(i);
                    }

                    C02431(PointerInputScope pointerInputScope, DragAndDropSourceNode dragAndDropSourceNode) {
                    ...
                    public void mo576requestDragAndDropTransferk4lQ0M(long offset) {
                        ...
                        dragAndDropSourceModifierNode.mo4323requestDragAndDropTransferk4lQ0M(offset);
                    }
                }

                @Override // androidx.compose.p002ui.input.pointer.PointerInputEventHandler
                public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
                    Object invoke = DragAndDropSourceNode.this.getDetectDragStart().invoke(new C02431(pointerInputScope, DragAndDropSourceNode.this), continuation);
    ...
    public void onDetach() {
        ...
        if (pointerInputModifierNode != null) {
            undelegate((DelegatableNode) pointerInputModifierNode);
        }
    }
    ...
    public void m573onRemeasuredozmzZPI(long size) {
        this.size = size;
        this.dragAndDropModifierNode.onRemeasured-ozmzZPI(size);
    }
}
