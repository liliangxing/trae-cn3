...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m1453create() {
    ...
    public void update(TriStateToggleableNode node) {
        node.m1454updateO2vRcR0(this.state, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
