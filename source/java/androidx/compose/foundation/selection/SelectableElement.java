...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m1430create() {
    ...
    public void update(SelectableNode node) {
        node.m1438updateO2vRcR0(this.selected, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
