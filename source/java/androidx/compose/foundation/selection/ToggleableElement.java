...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public /* bridge */ /* synthetic */ Modifier.Node m1439create() {
    ...
    public void update(ToggleableNode node) {
        node.m1452updateO2vRcR0(this.value, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onValueChange);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.hashCode-impl(role.unbox-impl()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
