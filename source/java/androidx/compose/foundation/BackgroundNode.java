...
public final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    public final void m399setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m4670getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m4840equalsimpl0(this.color, Color.INSTANCE.m4875getUnspecified0d7_KjU())) {
            DrawScope.m5411drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m5410drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m4840equalsimpl0(this.color, Color.INSTANCE.m4875getUnspecified0d7_KjU())) {
            OutlineKt.m5111drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m5109drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        Outline outline;
        if (Size.m4658equalsimpl0(contentDrawScope.m5417getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
        ...
        this.lastSize = contentDrawScope.m5417getSizeNHjbRc();
    ...
    public static final Unit getOutline$lambda$2(BackgroundNode backgroundNode, ContentDrawScope contentDrawScope) {
        backgroundNode.tmpOutline = backgroundNode.shape.mo469createOutlinePq9zytI(contentDrawScope.m5417getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
