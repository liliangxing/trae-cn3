...
public final class LazyLayoutStickyItemsKt {
    ...
    public static final <T extends LazyLayoutMeasuredItem> List<T> applyStickyItems(StickyItemsPlacement stickyItemsPlacement, int i, int i2, List<T> list, IntList intList, int i3, int i4, int i5, int i6, Function1<? super Integer, ? extends T> function1) {
        ...
        if (stickyItemsPlacement != null) {
            ...
            if (!list2.isEmpty()) {
                if (intList._size != 0) {
                    IntList stickingIndices = stickyItemsPlacement.getStickingIndices(i, i2, intList);
                    ...
                    int i8 = 0;
                    for (int i9 = stickingIndices._size; i8 < i9; i9 = i9) {
                        int i10 = iArr[i8];
                        ...
                        if (i11 == -1) {
                            remove = (T) function1.invoke(Integer.valueOf(i10));
                        } else {
                            remove = list.remove(i11);
                        }
                        T t2 = remove;
                        int calculateStickingItemOffset = stickyItemsPlacement.calculateStickingItemOffset(arrayList3, i10, t2.getMainAxisSizeWithSpacings(), i11 == -1 ? Integer.MIN_VALUE : getMainAxisOffset(t2), i3, i4, i5, i6);
