...
public interface NestedPrefetchScope {
    ...
    void mo1066schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    default void m1073schedulePrefetch0kLqBqw(int index, long constraints) {
        mo1066schedulePrecompositionAndPremeasure0kLqBqw(index, constraints);
    }
}
