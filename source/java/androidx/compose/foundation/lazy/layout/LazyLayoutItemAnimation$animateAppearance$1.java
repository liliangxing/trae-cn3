...
public final class LazyLayoutItemAnimation$animateAppearance$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LazyLayoutItemAnimation$animateAppearance$1(LazyLayoutItemAnimation lazyLayoutItemAnimation, Continuation<? super LazyLayoutItemAnimation$animateAppearance$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (animatable.snapTo(Boxing.boxFloat(1.0f), (Continuation) this) == coroutine_suspended) {
