...
public final class Averages {
    ...
    private final int calculateAverageCount(int r2, int current) {
        return current == -1 ? r2 : ((current * 3) + r2) / 4;
    }
