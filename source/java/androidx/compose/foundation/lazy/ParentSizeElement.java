...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public ParentSizeNode m1221create() {
    ...
    public boolean equals(Object other) {
        ...
        return ((this.fraction > parentSizeElement.fraction ? 1 : (this.fraction == parentSizeElement.fraction ? 0 : -1)) == 0) && Intrinsics.areEqual(this.widthState, parentSizeElement.widthState) && Intrinsics.areEqual(this.heightState, parentSizeElement.heightState);
    }
