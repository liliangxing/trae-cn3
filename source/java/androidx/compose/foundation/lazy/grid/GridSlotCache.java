...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo1232invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlots2 = (LazyGridSlots) this.calculation.invoke(density, Constraints.box-impl(constraints));
