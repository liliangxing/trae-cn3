...
public final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public static final Unit Item$lambda$0(LazyGridItemProviderImpl lazyGridItemProviderImpl, int i, Object obj, int i2, Composer composer, int i3) {
    ...
    public void Item(final int i, final Object obj, Composer composer, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(obj, i, this.state.getPinnedItems(), ComposableLambdaKt.rememberComposableLambda(726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    ComposerKt.sourceInformation(composer2, "C*82@3156L39:LazyGridItemProvider.kt#7791vq");
                    if (composer2.shouldExecute((i4 & 3) != 2, i4 & 1)) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(726189336, i4, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.<anonymous> (LazyGridItemProvider.kt:81)");
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$$ExternalSyntheticLambda0
                public final Object invoke(Object obj2, Object obj3) {
                    Unit Item$lambda$0;
                    Item$lambda$0 = LazyGridItemProviderImpl.Item$lambda$0(LazyGridItemProviderImpl.this, i, obj, i2, (Composer) obj2, ((Integer) obj3).intValue());
