...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult m1223measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int i = round != Integer.MAX_VALUE ? round : Constraints.getMinWidth-impl(j);
        int i2 = round2 != Integer.MAX_VALUE ? round2 : Constraints.getMinHeight-impl(j);
        if (round == Integer.MAX_VALUE) {
            round = Constraints.getMaxWidth-impl(j);
        }
        if (round2 == Integer.MAX_VALUE) {
            round2 = Constraints.getMaxHeight-impl(j);
        }
        final Placeable mo6318measureBRTryo0 = measurable.mo6318measureBRTryo0(ConstraintsKt.Constraints(i, round, i2, round2));
        return MeasureScope.layout$default(measureScope, mo6318measureBRTryo0.getWidth(), mo6318measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$$ExternalSyntheticLambda0
