...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1347invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.equals-impl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlots2 = (LazyStaggeredGridSlots) this.calculation.invoke(density, Constraints.box-impl(constraints));
