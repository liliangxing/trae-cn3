...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo1199createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.getMaxWidth-impl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.getMaxHeight-impl(j) : Integer.MAX_VALUE, 5, (Object) null);
    }
    ...
    public LazyListMeasuredItem mo1210getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1211getAndMeasure0kLqBqw(index, constraints);
    }

    /* renamed from: getAndMeasure-0kLqBqw$default, reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m1209getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj != null) {
        ...
        return lazyListMeasuredItemProvider.m1211getAndMeasure0kLqBqw(i, j);
    }

    /* renamed from: getAndMeasure-0kLqBqw, reason: not valid java name */
    public final LazyListMeasuredItem m1211getAndMeasure0kLqBqw(int index, long constraints) {
        return mo1199createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1308getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
