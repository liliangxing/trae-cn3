    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Float.intBitsToFloat((int) (this.overscrollEffect.m373displacementF1C5BW0$foundation_release() & 4294967295L)));
            }
        } else {
            z = false;
        }
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Float.intBitsToFloat((int) (this.overscrollEffect.m373displacementF1C5BW0$foundation_release() >> 32)));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Float.intBitsToFloat((int) (this.overscrollEffect.m373displacementF1C5BW0$foundation_release() & 4294967295L)));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Float.intBitsToFloat((int) (this.overscrollEffect.m373displacementF1C5BW0$foundation_release() >> 32)));
            }
            z = z2;
        }
        if (z) {
        ...
        androidx.compose.p002ui.graphics.Canvas Canvas = AndroidCanvas_androidKt.Canvas(beginRecording);
        long j = contentDrawScope.m5417getSizeNHjbRc();
        ...
        androidx.compose.p002ui.graphics.Canvas canvas = contentDrawScope2.getDrawContext().getCanvas();
        long mo5338getSizeNHjbRc = contentDrawScope2.getDrawContext().mo5338getSizeNHjbRc();
