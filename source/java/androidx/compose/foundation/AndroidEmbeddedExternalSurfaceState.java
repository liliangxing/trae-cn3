...
public final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public final void m376setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.equals-impl0(this.surfaceSize, IntSize.Companion.getZero-YbymL2g())) {
            long j = this.surfaceSize;
            int i = (int) (j >> 32);
            height = (int) (j & 4294967295L);
