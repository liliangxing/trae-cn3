...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    @Override // androidx.compose.p002ui.draganddrop.DragAndDropManager
    ...
    public void mo4316requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        node.m4325startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            @Override // androidx.compose.p002ui.draganddrop.DragAndDropStartTransferScope
            /* renamed from: startDragAndDropTransfer-12SF9DM, reason: not valid java name */
            public boolean mo4319startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                Function3 function3;
                Ref.BooleanRef booleanRef2 = booleanRef;
                function3 = this.startDrag;
                booleanRef2.element = ((Boolean) function3.invoke(transferData, Size.m4650boximpl(decorationSize), drawDragDecoration)).booleanValue();
            ...
            public final Boolean m4318invoke() {
