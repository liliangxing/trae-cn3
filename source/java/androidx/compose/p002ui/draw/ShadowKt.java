...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m4427shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        ...
        return m4426shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m4426shadowziNgDLE(Modifier modifier, float f, Shape shape, boolean z) {
        return m4424shadows4CzXII(modifier, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default, reason: not valid java name */
    public static /* synthetic */ Modifier m4425shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m4424shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }

    public static final Modifier dropShadow(Modifier modifier, Shape shape, Shadow shadow) {
        return modifier.then((Modifier) new SimpleDropShadowElement(shape, shadow));
    }

    public static final Modifier dropShadow(Modifier modifier, Shape shape, Function1<? super DropShadowScope, Unit> function1) {
        return modifier.then((Modifier) new BlockDropShadowElement(shape, function1));
    }

    public static final Modifier innerShadow(Modifier modifier, Shape shape, Shadow shadow) {
        return modifier.then((Modifier) new SimpleInnerShadowElement(shape, shadow));
    }

    public static final Modifier innerShadow(Modifier modifier, Shape shape, Function1<? super InnerShadowScope, Unit> function1) {
        return modifier.then((Modifier) new BlockInnerShadowElement(shape, function1));
    }

    /* renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m4424shadows4CzXII(Modifier modifier, float f, Shape shape, boolean z, long j, long j2) {
        return (Dp.compareTo-0680j_4(f, Dp.constructor-impl((float) 0)) > 0 || z) ? modifier.then((Modifier) new ShadowGraphicsLayerElement(f, shape, z, j, j2, null)) : modifier;
    }
}
