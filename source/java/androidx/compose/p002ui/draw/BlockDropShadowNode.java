...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    private final DropShadowPainter obtainPainter() {
        ...
        if (!this.blockRead) {
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.ui.draw.BlockDropShadowNode$obtainPainter$1
                ...
                public final void m4336invoke() {
                    Function1 function1;
                    function1 = BlockDropShadowNode.this.block;
                    function1.invoke(BlockDropShadowNode.this);
                }
            });
        }
        ...
        if (dropShadowPainter != null && shadow2 != null && Dp.equals-impl0(shadow2.getRadius(), f) && Dp.equals-impl0(shadow2.getSpread(), f2) && Color.m4840equalsimpl0(shadow2.getColor(), getColor()) && Intrinsics.areEqual(shadow2.getBrush(), brush)) {
        ...
        DropShadowPainter createDropShadowPainter = DelegatableNodeKt.requireGraphicsContext(this).getShadowContext().createDropShadowPainter(this.shape, shadow);
    ...
    public boolean equals(Object other) {
        ...
        if (!(getAlpha() == blockDropShadowNode.getAlpha()) || !Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) || this.block != blockDropShadowNode.block) {
            return false;
        }
        if (getRadius() == blockDropShadowNode.getRadius()) {
            return ((getSpread() > blockDropShadowNode.getSpread() ? 1 : (getSpread() == blockDropShadowNode.getSpread() ? 0 : -1)) == 0) && Offset.m4590equalsimpl0(getOffset(), blockDropShadowNode.getOffset()) && Color.m4840equalsimpl0(getColor(), blockDropShadowNode.getColor()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m4747equalsimpl0(getBlendMode(), blockDropShadowNode.getBlendMode());
        }
        return false;
    }
