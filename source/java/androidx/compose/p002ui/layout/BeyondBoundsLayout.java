...
public interface BeyondBoundsLayout {
    ...
    <T> T mo1273layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m6298constructorimpl(1);
        private static final int After = m6298constructorimpl(2);
        private static final int Left = m6298constructorimpl(3);
        private static final int Right = m6298constructorimpl(4);
        private static final int Above = m6298constructorimpl(5);
        private static final int Below = m6298constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m6297boximpl(int i) {
        ...
        public boolean equals(Object other) {
            return m6299equalsimpl(this.value, other);
        }
        ...
        public static final class Companion {
            ...
            public final int m6306getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m6305getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m6308getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m6309getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m6304getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m6307getBelowhoxUOeE() {
        ...
        public static String m6302toStringimpl(int i) {
            return m6300equalsimpl0(i, Before) ? "Before" : m6300equalsimpl0(i, After) ? "After" : m6300equalsimpl0(i, Left) ? "Left" : m6300equalsimpl0(i, Right) ? "Right" : m6300equalsimpl0(i, Above) ? "Above" : m6300equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
