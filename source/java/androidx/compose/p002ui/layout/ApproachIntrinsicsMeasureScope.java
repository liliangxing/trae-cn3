...
public final class ApproachIntrinsicsMeasureScope implements ApproachMeasureScope, ApproachIntrinsicMeasureScope {
    ...
    public long mo6266getLookaheadConstraintsmsEJaDk() {
        return this.$$delegate_0.mo6266getLookaheadConstraintsmsEJaDk();
    }

    @Override // androidx.compose.p002ui.layout.ApproachIntrinsicMeasureScope
    /* renamed from: getLookaheadSize-YbymL2g */
    public long mo6267getLookaheadSizeYbymL2g() {
        return this.$$delegate_0.mo6267getLookaheadSizeYbymL2g();
    }
    ...
    public long m6276toSizeXkaWNTQ(long j) {
        return this.$$delegate_0.toSize-XkaWNTQ(j);
    }

    /* renamed from: toSp-0xMU5do, reason: not valid java name */
    public long m6277toSp0xMU5do(float f) {
        return this.$$delegate_0.toSp-0xMU5do(f);
    }

    /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
    public long m6278toSpkPz2Gy4(float f) {
        return this.$$delegate_0.toSp-kPz2Gy4(f);
    }

    /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
    public long m6279toSpkPz2Gy4(int i) {
    ...
    public MeasureResult layout(final int width, final int height, final Map<AlignmentLine, Integer> alignmentLines, final Function1<? super RulerScope, Unit> rulers, Function1<? super Placeable.PlacementScope, Unit> placementBlock) {
        ...
        return new MeasureResult() { // from class: androidx.compose.ui.layout.ApproachIntrinsicsMeasureScope$layout$1
            ...
            public int getF162$w() {
                return width;
            }

            @Override // androidx.compose.p002ui.layout.MeasureResult
            /* renamed from: getHeight, reason: from getter */
            public int getF161$h() {
                return height;
            }
