...
final class OnVisibilityChangedElement extends ModifierNodeElement<OnVisibilityChangedNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (this.minDurationMs != onVisibilityChangedElement.minDurationMs) {
            return false;
        }
        return ((this.minFractionVisible > onVisibilityChangedElement.minFractionVisible ? 1 : (this.minFractionVisible == onVisibilityChangedElement.minFractionVisible ? 0 : -1)) == 0) && Intrinsics.areEqual(this.viewportBounds, onVisibilityChangedElement.viewportBounds) && this.callback == onVisibilityChangedElement.callback;
    }

    public int hashCode() {
        int hashCode = ((Long.hashCode(this.minDurationMs) * 31) + Float.hashCode(this.minFractionVisible)) * 31;
        LayoutBoundsHolder layoutBoundsHolder = this.viewportBounds;
        return ((hashCode + (layoutBoundsHolder != null ? layoutBoundsHolder.hashCode() : 0)) * 31) + this.callback.hashCode();
    }
}
