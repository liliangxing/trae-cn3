...
public abstract class Placeable implements Measured {
    ...
    private long apparentToRealOffset = IntOffset.Companion.getZero-nOcc-ac();

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno */
    public abstract void mo6319placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);

    public Placeable() {
        long j = 0;
        this.measuredSize = IntSize.constructor-impl((j & 4294967295L) | (j << 32));
    }
    ...
    public final void m6423setMeasuredSizeozmzZPI(long j) {
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn((int) (this.measuredSize >> 32), Constraints.getMinWidth-impl(this.measurementConstraints), Constraints.getMaxWidth-impl(this.measurementConstraints));
        this.height = RangesKt.coerceIn((int) (this.measuredSize & 4294967295L), Constraints.getMinHeight-impl(this.measurementConstraints), Constraints.getMaxHeight-impl(this.measurementConstraints));
        int i = this.width;
        long j = this.measuredSize;
        this.apparentToRealOffset = IntOffset.constructor-impl((((i - ((int) (j >> 32))) / 2) << 32) | (4294967295L & ((r0 - ((int) (j & 4294967295L))) / 2)));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* renamed from: placeAt-f8xVGno, reason: not valid java name */
    public void m6422placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        mo6319placeAtf8xVGno(position, zIndex, (Function1<? super GraphicsLayerScope, Unit>) null);
    }
    ...
    protected final void m6424setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.equals-impl0(this.measurementConstraints, j)) {
            return;
        }
    ...
    public static abstract class PlacementScope implements Density {
        ...
        public static /* synthetic */ void m6426placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m6436placeRelative70tqf50(placeable, j, f);
        }
        ...
        public static /* synthetic */ void m6425place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m6431place70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m6427placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m6437placeRelativeWithLayeraW9wM(placeable, j, f2, (Function1<? super GraphicsLayerScope, Unit>) function1);
        }
        ...
        public static /* synthetic */ void m6429placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m6439placeWithLayeraW9wM(placeable, j, f2, (Function1<? super GraphicsLayerScope, Unit>) function1);
        }
        ...
        /* renamed from: placeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m6430placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, GraphicsLayer graphicsLayer, float f, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: placeWithLayer-aW-9-wM");
            }
            if ((i & 4) != 0) {
            ...
            placementScope.m6440placeWithLayeraW9wM(placeable, j, graphicsLayer, f);
        }
        ...
        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m6428placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, GraphicsLayer graphicsLayer, float f, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: placeRelativeWithLayer-aW-9-wM");
            }
            if ((i & 4) != 0) {
            ...
            placementScope.m6438placeRelativeWithLayeraW9wM(placeable, j, graphicsLayer, f);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m6435placeAutoMirroredaW9wM$ui_release(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, function1);
                return;
            }
            long j2 = IntOffset.constructor-impl((IntOffset.getY-impl(j) & 4294967295L) | (((getParentWidth() - placeable.getWidth()) - IntOffset.getX-impl(j)) << 32));
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j2, placeable.apparentToRealOffset), f, function1);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m6434placeAutoMirroredaW9wM$ui_release(Placeable placeable, long j, float f, GraphicsLayer graphicsLayer) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.m6422placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
                return;
            }
            long j2 = IntOffset.constructor-impl((IntOffset.getY-impl(j) & 4294967295L) | (((getParentWidth() - placeable.getWidth()) - IntOffset.getX-impl(j)) << 32));
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.m6422placeAtf8xVGno(IntOffset.plus-qkQi6aY(j2, placeable.apparentToRealOffset), f, graphicsLayer);
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m6433placeApparentToRealOffsetaW9wM$ui_release(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, function1);
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m6432placeApparentToRealOffsetaW9wM$ui_release(Placeable placeable, long j, float f, GraphicsLayer graphicsLayer) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.m6422placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
        }
        ...
        public final void m6436placeRelative70tqf50(Placeable placeable, long j, float f) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
                return;
            }
            long j2 = IntOffset.constructor-impl((IntOffset.getY-impl(j) & 4294967295L) | (((getParentWidth() - placeable.getWidth()) - IntOffset.getX-impl(j)) << 32));
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j2, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            long j = IntOffset.constructor-impl((i << 32) | (i2 & 4294967295L));
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
            } else {
                long j2 = IntOffset.constructor-impl((((getParentWidth() - placeable.getWidth()) - IntOffset.getX-impl(j)) << 32) | (IntOffset.getY-impl(j) & 4294967295L));
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j2, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
            }
        }
        ...
        public final void place(Placeable placeable, int i, int i2, float f) {
            long j = IntOffset.constructor-impl((i2 & 4294967295L) | (i << 32));
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        /* renamed from: place-70tqf50, reason: not valid java name */
        public final void m6431place70tqf50(Placeable placeable, long j, float f) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, (Function1<? super GraphicsLayerScope, Unit>) null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m6437placeRelativeWithLayeraW9wM(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, function1);
                return;
        ...
        public final void m6439placeWithLayeraW9wM(Placeable placeable, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.mo6319placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, function1);
        }
        ...
        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m6440placeWithLayeraW9wM(Placeable placeable, long j, GraphicsLayer graphicsLayer, float f) {
            handleMotionFrameOfReferencePlacement(placeable);
            placeable.m6422placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
        }
        ...
        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m6438placeRelativeWithLayeraW9wM(Placeable placeable, long j, GraphicsLayer graphicsLayer, float f) {
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                handleMotionFrameOfReferencePlacement(placeable);
                placeable.m6422placeAtf8xVGno(IntOffset.plus-qkQi6aY(j, placeable.apparentToRealOffset), f, graphicsLayer);
                return;
