...
public final class ValueInsets {
    ...
    public static final /* synthetic */ ValueInsets m6471boximpl(long j) {
        return new ValueInsets(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m6472constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m6473equalsimpl(long j, Object obj) {
        return (obj instanceof ValueInsets) && j == ((ValueInsets) obj).m6481unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m6474equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getBottom-impl, reason: not valid java name */
    public static final int m6475getBottomimpl(long j) {
        return (int) (j & 65535);
    }

    /* renamed from: getLeft-impl, reason: not valid java name */
    public static final int m6476getLeftimpl(long j) {
        return (int) ((j >>> 48) & 65535);
    }

    /* renamed from: getRight-impl, reason: not valid java name */
    public static final int m6477getRightimpl(long j) {
        return (int) ((j >>> 16) & 65535);
    }

    /* renamed from: getTop-impl, reason: not valid java name */
    public static final int m6478getTopimpl(long j) {
        return (int) ((j >>> 32) & 65535);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m6479hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m6473equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m6479hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m6481unboximpl() {
    ...
    public String toString() {
        return m6480toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m6480toStringimpl(long j) {
