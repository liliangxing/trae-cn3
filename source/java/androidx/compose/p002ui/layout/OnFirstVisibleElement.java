...
final class OnFirstVisibleElement extends ModifierNodeElement<OnFirstVisibleNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (this.minDurationMs != onFirstVisibleElement.minDurationMs) {
            return false;
        }
        return ((this.minFractionVisible > onFirstVisibleElement.minFractionVisible ? 1 : (this.minFractionVisible == onFirstVisibleElement.minFractionVisible ? 0 : -1)) == 0) && Intrinsics.areEqual(this.viewportBounds, onFirstVisibleElement.viewportBounds) && this.callback == onFirstVisibleElement.callback;
    }
