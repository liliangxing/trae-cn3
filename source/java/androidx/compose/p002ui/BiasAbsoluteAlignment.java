...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo4279alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long j = IntSize.constructor-impl(((((int) (space >> 32)) - ((int) (size >> 32))) << 32) | ((((int) (space & 4294967295L)) - ((int) (size & 4294967295L))) & 4294967295L));
        float f = 1;
        float f2 = (((int) (j >> 32)) / 2.0f) * (this.horizontalBias + f);
        float f3 = (((int) (j & 4294967295L)) / 2.0f) * (f + this.verticalBias);
        return IntOffset.constructor-impl((Math.round(f2) << 32) | (Math.round(f3) & 4294967295L));
    }
}
