...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m4532oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m4531generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4468getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (i2 != 1) {
                if (i2 == 2 || i2 == 3) {
                    return m4531generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4469getPreviousdhqQ8s(), function1);
                }
                if (i2 != 4) {
                    throw new NoWhenBranchMatchedException();
                }
            ...
            if (!backwardFocusSearch(activeChild, function1) && !m4531generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4469getPreviousdhqQ8s(), function1) && (!activeChild.fetchFocusProperties$ui_release().getCanFocus() || !((Boolean) function1.invoke(activeChild)).booleanValue())) {
                return false;
            }
        } else {
            if (i == 2 || i == 3) {
    ...
    private static final boolean m4531generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m4533searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4454searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m4533searchChildren4C6V_qg;
                boolean z = true;
                if (FocusTargetNode.this == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    m4533searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m4533searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1);
                    Boolean valueOf = Boolean.valueOf(m4533searchChildren4C6V_qg);
    ...
    public static final boolean m4533searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (child == null) {
            DelegatableNodeKt.access$addLayoutNodeChildren(mutableVector2, focusTargetNode3.getNode(), false);
        } else {
        ...
        if (FocusDirection.m4460equalsimpl0(i, FocusDirection.INSTANCE.m4468getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return ((Boolean) function1.invoke(focusTargetNode)).booleanValue();
    }
                    ...
                    if ((parent.getKindSet() & i) != 0) {
                        ...
                        while (node2 != null) {
                            ...
                            if (((node2.getKindSet() & i) != 0) && (node2 instanceof DelegatingNode)) {
                                int i2 = 0;
                                for (Modifier.Node delegate$ui_release = ((DelegatingNode) node2).getDelegate$ui_release(); delegate$ui_release != null; delegate$ui_release = delegate$ui_release.getChild()) {
    ...
    private static final boolean pickChildForForwardSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            FocusTargetNode focusTargetNode3 = (FocusTargetNode) objArr[i3];
