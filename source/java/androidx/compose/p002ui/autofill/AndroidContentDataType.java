...
public final class AndroidContentDataType implements ContentDataType {
    ...
    public static final /* synthetic */ AndroidContentDataType m4309boximpl(int i) {
    ...
    public static boolean m4311equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidContentDataType) && i == ((AndroidContentDataType) obj).m4315unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4312equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4313hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4314toStringimpl(int i) {
        return "AndroidContentDataType(androidAutofillType=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4311equalsimpl(this.androidAutofillType, obj);
    }

    public int hashCode() {
        return m4313hashCodeimpl(this.androidAutofillType);
    }

    public String toString() {
        return m4314toStringimpl(this.androidAutofillType);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m4315unboximpl() {
