...
public final class AndroidPathIterator implements PathIterator {
    ...
    @Override // androidx.compose.p002ui.graphics.PathIterator
    public Path getPath() {
        return this.path;
    }
    ...
    @Override // androidx.compose.p002ui.graphics.PathIterator, java.util.Iterator
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x000c, code lost:
        ...
        r1 = androidx.compose.p002ui.graphics.AndroidPathIterator_androidKt.toPathSegmentType(r11.implementation.next(r0, 0));
     */
    @Override // java.util.Iterator
    /*
    ...
    */
    public PathSegment next() {
        ...
        if (fArr.length >= 8 && pathSegmentType != PathSegment.Type.Done) {
