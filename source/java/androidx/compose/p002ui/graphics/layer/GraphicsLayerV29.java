...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m4671getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m5533applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m5497getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5526setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m4685toAndroidBlendModes9anfk8(i));
    ...
    public void mo5525setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4893toArgb8_81llA(j));
    }
    ...
    public void mo5531setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4893toArgb8_81llA(j));
    }
    ...
    private final void m5533applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m5493equalsimpl0(i, CompositingStrategy.INSTANCE.m5499getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5493equalsimpl0(i, CompositingStrategy.INSTANCE.m5498getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5533applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m5499getOffscreenke2Ky5w());
        } else {
            m5533applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo5339setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5493equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5499getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
