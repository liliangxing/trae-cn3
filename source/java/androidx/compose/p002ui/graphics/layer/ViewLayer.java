...
public final class ViewLayer extends View {
    ...
    private static final ViewOutlineProvider LayerOutlineProvider = new ViewOutlineProvider() { // from class: androidx.compose.ui.graphics.layer.ViewLayer$Companion$LayerOutlineProvider$1
        /* JADX WARN: Code restructure failed: missing block: B:3:0x0004, code lost:
            ...
            r2 = ((androidx.compose.p002ui.graphics.layer.ViewLayer) r2).layerOutline;
         */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        androidx.compose.p002ui.graphics.Canvas canvas2 = canvasDrawScope.getDrawContext().getCanvas();
        ...
        drawContext.mo5339setSizeuvyYCjk(m4653constructorimpl);
