...
public final class PathHitTester {
    ...
    public final boolean m5136containsk4lQ0M(long position) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m4619containsk4lQ0M(position)) {
            ...
            if (PathFillType.m5130equalsimpl0(this.path.mo4726getFillTypeRgk1Os(), PathFillType.INSTANCE.m5134getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
