...
public final class ColorSpaceKt {
    ...
    private static final Connector m5279createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.INSTANCE.identity$ui_graphics_release(colorSpace);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m5266equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw()) && ColorModel.m5266equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m5278connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m5295getPerceptualuksYyKA();
        }
        return m5277connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m5277connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        int id = colorSpace.getId();
        int id2 = colorSpace2.getId();
        if ((id | id2) < 0) {
            return m5279createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m5279createConnectorYBCOT_4(colorSpace, colorSpace2, i);
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (!ColorModel.m5266equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw())) {
            return colorSpace;
        }
        Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
