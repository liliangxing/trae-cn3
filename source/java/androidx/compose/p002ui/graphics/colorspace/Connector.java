...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m5266equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m5266equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m5284computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        */
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m5285computeTransformYBCOT_4(rgb, rgb2, i);
        }

        @Override // androidx.compose.p002ui.graphics.colorspace.Connector
        public float[] transform(float[] v) {
        ...
        private final float[] m5285computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m5290equalsimpl0(intent, RenderIntent.INSTANCE.m5294getAbsoluteuksYyKA())) {
        ...
        public long mo5282transformToColorl2rxGTc$ui_graphics_release(long color) {
            float m4845getRedimpl = Color.m4845getRedimpl(color);
            float m4844getGreenimpl = Color.m4844getGreenimpl(color);
            float m4842getBlueimpl = Color.m4842getBlueimpl(color);
            float m4841getAlphaimpl = Color.m4841getAlphaimpl(color);
            float invoke = (float) this.mSource.getEotfFunc().invoke(m4845getRedimpl);
            float invoke2 = (float) this.mSource.getEotfFunc().invoke(m4844getGreenimpl);
            float invoke3 = (float) this.mSource.getEotfFunc().invoke(m4842getBlueimpl);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc().invoke((fArr[0] * invoke) + (fArr[3] * invoke2) + (fArr[6] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[1] * invoke) + (fArr[4] * invoke2) + (fArr[7] * invoke3)), (float) this.mDestination.getOetfFunc().invoke((fArr[2] * invoke) + (fArr[5] * invoke2) + (fArr[8] * invoke3)), m4841getAlphaimpl, this.mDestination);
        }
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m5284computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m5290equalsimpl0(intent, RenderIntent.INSTANCE.m5294getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m5266equalsimpl0 = ColorModel.m5266equalsimpl0(source.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw());
            boolean m5266equalsimpl02 = ColorModel.m5266equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m5273getRgbxdoWZVw());
            if (m5266equalsimpl0 && m5266equalsimpl02) {
                return null;
            }
            if (!m5266equalsimpl0 && !m5266equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m5266equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m5266equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int m5296getRelativeuksYyKA = RenderIntent.INSTANCE.m5296getRelativeuksYyKA();
            return new Connector(source, m5296getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.p002ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    return v;
                }
                ...
                {
                    super(source, source, m5296getRelativeuksYyKA, null);
                }
            };
        }
    }
    ...
    public long mo5282transformToColorl2rxGTc$ui_graphics_release(long color) {
        ...
        float m4842getBlueimpl = Color.m4842getBlueimpl(color);
        float m4841getAlphaimpl = Color.m4841getAlphaimpl(color);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(m4845getRedimpl, m4844getGreenimpl, m4842getBlueimpl);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(m4845getRedimpl, m4844getGreenimpl, m4842getBlueimpl);
        float[] fArr = this.transform;
        if (fArr != null) {
        ...
        return this.transformDestination.mo5276xyzaToColorJlNiLsg$ui_graphics_release(f, intBitsToFloat2, z$ui_graphics_release, m4841getAlphaimpl, this.destination);
    }
}
