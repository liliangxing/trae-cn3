...
final class ColorSpaceVerificationHelper {
            ...
            if (transferParameters2 != null) {
                ...
                DoubleUnaryOperator doubleUnaryOperator = new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda0
                    ...
                    public final double applyAsDouble(double d) {
                        ...
                        androidColorSpace$lambda$0 = ColorSpaceVerificationHelper.androidColorSpace$lambda$0(oetf, d);
                ...
                rgb = new ColorSpace.Rgb(name, primaries, xyz$ui_graphics_release, doubleUnaryOperator, new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda1
                    ...
                    public final double applyAsDouble(double d) {
                        ...
                        androidColorSpace$lambda$1 = ColorSpaceVerificationHelper.androidColorSpace$lambda$1(eotf, d);
    ...
    public static final androidx.compose.p002ui.graphics.colorspace.ColorSpace composeColorSpace(final ColorSpace colorSpace) {
        ...
        if (Build.VERSION.SDK_INT >= 34) {
            androidx.compose.p002ui.graphics.colorspace.ColorSpace obtainComposeColorSpaceFromId = ColorSpaceVerificationHelperV34.obtainComposeColorSpaceFromId(colorSpace.getId());
