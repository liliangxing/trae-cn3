...
public final class AndroidPath implements Path {
    ...
    */
    ...
    public int mo4726getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m5134getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m5135getNonZeroRgk1Os();
    }

    @Override // androidx.compose.p002ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo4728setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        Path path = this.internalPath;
        if (PathFillType.m5130equalsimpl0(i, PathFillType.INSTANCE.m5134getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = Float.intBitsToFloat((int) (roundRect.m4643getTopLeftCornerRadiuskKHJgLs() >> 32));
        fArr[1] = Float.intBitsToFloat((int) (roundRect.m4643getTopLeftCornerRadiuskKHJgLs() & 4294967295L));
        fArr[2] = Float.intBitsToFloat((int) (roundRect.m4644getTopRightCornerRadiuskKHJgLs() >> 32));
        fArr[3] = Float.intBitsToFloat((int) (roundRect.m4644getTopRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[4] = Float.intBitsToFloat((int) (roundRect.m4642getBottomRightCornerRadiuskKHJgLs() >> 32));
        fArr[5] = Float.intBitsToFloat((int) (roundRect.m4642getBottomRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[6] = Float.intBitsToFloat((int) (roundRect.m4641getBottomLeftCornerRadiuskKHJgLs() >> 32));
        fArr[7] = Float.intBitsToFloat((int) (roundRect.m4641getBottomLeftCornerRadiuskKHJgLs() & 4294967295L));
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo4725addPathUv8p0NA(Path path, long offset) {
    ...
    public void mo4730translatek4lQ0M(long offset) {
    ...
    public void mo4729transform58bKbWc(float[] matrix) {
    ...
    public boolean mo4727opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m5140equalsimpl0(operation, PathOperation.INSTANCE.m5144getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m5140equalsimpl0(operation, PathOperation.INSTANCE.m5145getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m5140equalsimpl0(operation, PathOperation.INSTANCE.m5146getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m5140equalsimpl0(operation, PathOperation.INSTANCE.m5147getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
