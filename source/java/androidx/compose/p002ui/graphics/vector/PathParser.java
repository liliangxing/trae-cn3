...
public final class PathParser {
    ...
    public final ArrayList<PathNode> pathStringToNodes(String pathData, ArrayList<PathNode> nodes) {
        ...
        int i3 = 0;
        while (i3 < length && Intrinsics.compare(pathData.charAt(i3), 32) <= 0) {
            i3++;
        }
        while (length > i3 && Intrinsics.compare(pathData.charAt(length - 1), 32) <= 0) {
            length--;
        }
        int i4 = 0;
        while (i3 < length) {
            ...
            if (charAt != 0) {
                if ((charAt | ' ') != 122) {
                    i4 = 0;
                    while (true) {
                        if (i >= length || Intrinsics.compare(pathData.charAt(i), 32) > 0) {
                            long nextFloat = FastFloatParserKt.nextFloat(pathData, i, length);
                            i2 = (int) (nextFloat >>> 32);
                ...
                PathNodeKt.addPathNodes(charAt, nodes, this.nodeData, i4);
            }
            i3 = i;
        }
        return nodes;
