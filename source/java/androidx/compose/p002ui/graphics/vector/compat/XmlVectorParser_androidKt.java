...
import androidx.compose.p002ui.graphics.vector.PathParser;
...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5614getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m5211getButtKaPHkGw();
        }
        return m5613getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m5613getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m5211getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m5213getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m5212getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m5616getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m5222getMiterLxFBmk8();
        }
        return m5615getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m5615getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m5222getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m5221getBevelLxFBmk8();
        }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m4875getUnspecified0d7_KjU = Color.INSTANCE.m4875getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m4875getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m4875getUnspecified0d7_KjU = Color.INSTANCE.m4875getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m4875getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4776getSrcIn0nO6VwU();
        } else if (i == 3) {
            m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4778getSrcOver0nO6VwU();
        } else if (i == 5) {
            m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4776getSrcIn0nO6VwU();
        } else if (i == 9) {
            m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4775getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4767getModulate0nO6VwU();
                    break;
                case 15:
                    m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4772getScreen0nO6VwU();
                    break;
                case 16:
                    m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4770getPlus0nO6VwU();
                    break;
                default:
                    m4776getSrcIn0nO6VwU = BlendMode.INSTANCE.m4776getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m4776getSrcIn0nO6VwU;
        float f = Dp.constructor-impl(dimension / resources.getDisplayMetrics().density);
        float f2 = Dp.constructor-impl(dimension2 / resources.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, f, f2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ArrayList pathStringToNodes$default;
        TypedArray obtainAttributes = androidVectorParser.obtainAttributes(resources, theme, attributeSet, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH());
        ...
        String str = string;
        String string2 = androidVectorParser.getString(obtainAttributes, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_PATH_DATA());
        if (string2 == null) {
            pathStringToNodes$default = VectorKt.getEmptyPath();
        } else {
            pathStringToNodes$default = PathParser.pathStringToNodes$default(androidVectorParser.pathParser, string2, null, 2, null);
        }
        ...
        int m5613getStrokeLineCapCSYIeUk = m5613getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m5211getButtKaPHkGw());
        int m5615getStrokeLineJoinkLtJ_vA = m5615getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m5221getBevelLxFBmk8());
        ...
        builder.m5575addPathoIyEayM(list, namedInt == 0 ? companion.m5135getNonZeroRgk1Os() : companion.m5134getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m5613getStrokeLineCapCSYIeUk, m5615getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
    ...
    public static final void parseClipPath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) {
        ...
        String str = string;
        String string2 = androidVectorParser.getString(obtainAttributes, AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_CLIP_PATH_PATH_DATA());
        ...
        obtainAttributes.recycle();
        builder.addGroup((r20 & 1) != 0 ? "" : str, (r20 & 2) != 0 ? 0.0f : 0.0f, (r20 & 4) != 0 ? 0.0f : 0.0f, (r20 & 8) != 0 ? 0.0f : 0.0f, (r20 & 16) != 0 ? 1.0f : 0.0f, (r20 & 32) == 0 ? 0.0f : 1.0f, (r20 & 64) != 0 ? 0.0f : 0.0f, (r20 & Fields.SpotShadowColor) == 0 ? 0.0f : 0.0f, (r20 & Fields.RotationX) != 0 ? VectorKt.getEmptyPath() : emptyPath);
    }
