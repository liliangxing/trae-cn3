...
public final class VectorPath extends VectorNode {
    ...
    public /* synthetic */ VectorPath(String str, List list, int i, Brush brush, float f, Brush brush2, float f2, float f3, int i2, int i3, float f4, float f5, float f6, float f7, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? "" : str, list, i, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f, (i4 & 32) != 0 ? null : brush2, (i4 & 64) != 0 ? 1.0f : f2, (i4 & Fields.SpotShadowColor) != 0 ? 0.0f : f3, (i4 & Fields.RotationX) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & Fields.RotationY) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & Fields.RotationZ) != 0 ? 4.0f : f4, (i4 & Fields.CameraDistance) != 0 ? 0.0f : f5, (i4 & Fields.TransformOrigin) != 0 ? 1.0f : f6, (i4 & Fields.Shape) != 0 ? 0.0f : f7, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m5207equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m5217equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        if (this.trimPathEnd == vectorPath.trimPathEnd) {
            return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m5130equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((hashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m5208hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m5218hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m5131hashCodeimpl(this.pathFillType);
    }
}
