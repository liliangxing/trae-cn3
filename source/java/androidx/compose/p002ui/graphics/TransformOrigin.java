...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m5236boximpl(long j) {
    ...
    public static boolean m5242equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5243equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m5246hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5247toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object other) {
        return m5242equalsimpl(this.packedValue, other);
    }

    public int hashCode() {
        return m5246hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5247toStringimpl(this.packedValue);
    }
    ...
    public static final float m5237component1impl(long j) {
        return m5244getPivotFractionXimpl(j);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m5238component2impl(long j) {
        return m5245getPivotFractionYimpl(j);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m5241copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m5244getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m5245getPivotFractionYimpl(j);
        }
        return m5240copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m5240copyzey9I6w(long j, float f, float f2) {
    ...
    public static final class Companion {
        ...
        public final long m5249getCenterSzJe1aQ() {
            return TransformOrigin.Center;
        }
    }

    /* renamed from: getPivotFractionX-impl, reason: not valid java name */
    public static final float m5244getPivotFractionXimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m5245getPivotFractionYimpl(long j) {
