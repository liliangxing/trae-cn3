...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m5249getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4929getAutoNrFUSI();
    private long size = Size.INSTANCE.m4670getUnspecifiedNHjbRc();
    ...
    public void mo5038setAmbientShadowColor8_81llA(long j) {
        if (Color.m4840equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo5041setSpotShadowColor8_81llA(long j) {
        if (Color.m4840equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo5042setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5243equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo5040setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4925equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m5164setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void mo5039setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo5038setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo5041setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo5042setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m5249getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo5039setBlendModes9anfk8(BlendMode.INSTANCE.m4778getSrcOver0nO6VwU());
        mo5040setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4929getAutoNrFUSI());
        m5164setSizeuvyYCjk(Size.INSTANCE.m4670getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo469createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
