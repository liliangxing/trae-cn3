...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m5540BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.Companion.getZero-nOcc-ac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
            j2 = IntSize.constructor-impl((imageBitmap.getHeight() & 4294967295L) | (imageBitmap.getWidth() << 32));
        }
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.INSTANCE.m4940getLowfv9h1I();
        }
        return m5539BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY, reason: not valid java name */
    public static final BitmapPainter m5539BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j, j2, null);
        bitmapPainter.m5538setFilterQualityvDHp3xo$ui_graphics_release(i);
