...
final /* data */ class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scaleX, graphicsLayerElement.scaleX) == 0 && Float.compare(this.scaleY, graphicsLayerElement.scaleY) == 0 && Float.compare(this.alpha, graphicsLayerElement.alpha) == 0 && Float.compare(this.translationX, graphicsLayerElement.translationX) == 0 && Float.compare(this.translationY, graphicsLayerElement.translationY) == 0 && Float.compare(this.shadowElevation, graphicsLayerElement.shadowElevation) == 0 && Float.compare(this.rotationX, graphicsLayerElement.rotationX) == 0 && Float.compare(this.rotationY, graphicsLayerElement.rotationY) == 0 && Float.compare(this.rotationZ, graphicsLayerElement.rotationZ) == 0 && Float.compare(this.cameraDistance, graphicsLayerElement.cameraDistance) == 0 && TransformOrigin.m5243equalsimpl0(this.transformOrigin, graphicsLayerElement.transformOrigin) && Intrinsics.areEqual(this.shape, graphicsLayerElement.shape) && this.clip == graphicsLayerElement.clip && Intrinsics.areEqual(this.renderEffect, graphicsLayerElement.renderEffect) && Color.m4840equalsimpl0(this.ambientShadowColor, graphicsLayerElement.ambientShadowColor) && Color.m4840equalsimpl0(this.spotShadowColor, graphicsLayerElement.spotShadowColor) && CompositingStrategy.m4925equalsimpl0(this.compositingStrategy, graphicsLayerElement.compositingStrategy) && BlendMode.m4747equalsimpl0(this.blendMode, graphicsLayerElement.blendMode) && Intrinsics.areEqual(this.colorFilter, graphicsLayerElement.colorFilter);
    }

    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m5246hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31;
        RenderEffect renderEffect = this.renderEffect;
        int hashCode2 = (((((((((hashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m4846hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m4846hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m4926hashCodeimpl(this.compositingStrategy)) * 31) + BlendMode.m4748hashCodeimpl(this.blendMode)) * 31;
    ...
    public String toString() {
        ...
        sb.append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append((Object) TransformOrigin.m5247toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append((Object) Color.m4847toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append((Object) Color.m4847toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append((Object) CompositingStrategy.m4927toStringimpl(this.compositingStrategy)).append(", blendMode=").append((Object) BlendMode.m4749toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(')');
        return sb.toString();
    }
    ...
    public final long m4999getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m4995getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU, reason: not valid java name */
    public final long m4998getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getCompositingStrategy--NrFUSI, reason: not valid java name */
    public final int m4997getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: getBlendMode-0nO6VwU, reason: not valid java name */
    public final int m4996getBlendMode0nO6VwU() {
        return this.blendMode;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m5192setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m5188setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m5191setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m5190setCompositingStrategyaDBOjCE(this.compositingStrategy);
        node.m5189setBlendModes9anfk8(this.blendMode);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m5236boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m4829boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m4829boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m4922boximpl(this.compositingStrategy));
        inspectorInfo.getProperties().set("blendMode", BlendMode.m4744boximpl(this.blendMode));
