...
final class RenderEffectVerificationHelper {
    ...
    public final RenderEffect m5162createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        if (radiusX == 0.0f) {
            if (radiusY == 0.0f) {
        ...
        if (inputRenderEffect == null) {
            return RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m4741toAndroidTileMode0vamqd0(edgeTreatment));
        }
        return RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m4741toAndroidTileMode0vamqd0(edgeTreatment));
    }

    /* renamed from: createOffsetEffect-Uv8p0NA, reason: not valid java name */
    public final RenderEffect m5163createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        if (inputRenderEffect == null) {
            return RenderEffect.createOffsetEffect(Float.intBitsToFloat((int) (offset >> 32)), Float.intBitsToFloat((int) (offset & 4294967295L)));
        }
        return RenderEffect.createOffsetEffect(Float.intBitsToFloat((int) (offset >> 32)), Float.intBitsToFloat((int) (offset & 4294967295L)), inputRenderEffect.asAndroidRenderEffect());
    }
}
