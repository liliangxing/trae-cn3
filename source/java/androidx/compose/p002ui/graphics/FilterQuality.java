...
public final class FilterQuality {
    ...
    private static final int Low = m4933constructorimpl(1);
    private static final int Medium = m4933constructorimpl(2);
    private static final int High = m4933constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4932boximpl(int i) {
    ...
    public static boolean m4934equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4938unboximpl();
    }
    ...
    public boolean equals(Object other) {
        return m4934equalsimpl(this.value, other);
    }
    ...
    public static final class Companion {
        ...
        public final int m4942getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I, reason: not valid java name */
        public final int m4940getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I, reason: not valid java name */
        public final int m4941getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I, reason: not valid java name */
        public final int m4939getHighfv9h1I() {
    ...
    public static String m4937toStringimpl(int i) {
        return m4935equalsimpl0(i, None) ? "None" : m4935equalsimpl0(i, Low) ? "Low" : m4935equalsimpl0(i, Medium) ? "Medium" : m4935equalsimpl0(i, High) ? "High" : "Unknown";
    }
}
