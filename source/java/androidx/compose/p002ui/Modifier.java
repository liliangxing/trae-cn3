...
public interface Modifier {
    ...
    public static abstract class Node implements DelegatableNode {
        ...
        public final CoroutineScope getCoroutineScope() {
            ...
            Node node = this;
            CoroutineScope CoroutineScope = CoroutineScopeKt.CoroutineScope(DelegatableNodeKt.requireOwner(node).getCoroutineContext().plus(JobKt.Job(DelegatableNodeKt.requireOwner(node).getCoroutineContext().get(Job.Key))));
        ...
        public final boolean m4295isKindH91voCI$ui_release(int kind) {
