...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m5651boximpl(i), null, 2, null);
    ...
    public int mo5660getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode.getValue()).getValue();
    }

    /* renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m5662setInputModeiuPiT84(int i) {
        this.inputMode.setValue(InputMode.m5651boximpl(i));
    }

    @Override // androidx.compose.p002ui.input.InputModeManager
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo5661requestInputModeiuPiT84(int inputMode) {
        return ((Boolean) this.onRequestInputModeChange.invoke(InputMode.m5651boximpl(inputMode))).booleanValue();
    }
}
