...
public final class PointerHoverIconModifierNode extends HoverIconModifierNode {
    ...
    public boolean mo6068isRelevantPointerTypeuerMTgs(int pointerType) {
        return (PointerType.m6215equalsimpl0(pointerType, PointerType.INSTANCE.m6221getStylusT8wyACA()) || PointerType.m6215equalsimpl0(pointerType, PointerType.INSTANCE.m6219getEraserT8wyACA())) ? false : true;
    }
