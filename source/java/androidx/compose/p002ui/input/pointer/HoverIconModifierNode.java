...
public abstract class HoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public abstract boolean mo6068isRelevantPointerTypeuerMTgs(int pointerType);
    ...
    public void m6069onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            while (true) {
                ...
                if (mo6068isRelevantPointerTypeuerMTgs(changes.get(i).getType())) {
                    z = true;
                    break;
                }
                i++;
            ...
            if (z) {
                if (PointerEventType.m6091equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m6095getEnter7fucELk())) {
                    onEnter();
                } else if (PointerEventType.m6091equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m6096getExit7fucELk())) {
                    onExit();
                }
            }
        }
    ...
    public long m6067getTouchBoundsExpansionRZrCHBk() {
