...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m6157copyrc8HELY(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean activeHover, List<HistoricalChange> historical, long scrollDelta, long originalEventPosition) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m6126equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m4590equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m4590equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m6215equalsimpl0(this.type, pointerInputEventData.type) && this.activeHover == pointerInputEventData.activeHover && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m4590equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta) && Offset.m4590equalsimpl0(this.originalEventPosition, pointerInputEventData.originalEventPosition);
    }

    public int hashCode() {
        return (((((((((((((((((((PointerId.m6127hashCodeimpl(this.id) * 31) + Long.hashCode(this.uptime)) * 31) + Offset.m4595hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m4595hashCodeimpl(this.position)) * 31) + Boolean.hashCode(this.down)) * 31) + Float.hashCode(this.pressure)) * 31) + PointerType.m6216hashCodeimpl(this.type)) * 31) + Boolean.hashCode(this.activeHover)) * 31) + this.historical.hashCode()) * 31) + Offset.m4595hashCodeimpl(this.scrollDelta)) * 31) + Offset.m4595hashCodeimpl(this.originalEventPosition);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("PointerInputEventData(id=");
        sb.append((Object) PointerId.m6128toStringimpl(this.id)).append(", uptime=").append(this.uptime).append(", positionOnScreen=").append((Object) Offset.m4601toStringimpl(this.positionOnScreen)).append(", position=").append((Object) Offset.m4601toStringimpl(this.position)).append(", down=").append(this.down).append(", pressure=").append(this.pressure).append(", type=").append((Object) PointerType.m6217toStringimpl(this.type)).append(", activeHover=").append(this.activeHover).append(", historical=").append(this.historical).append(", scrollDelta=").append((Object) Offset.m4601toStringimpl(this.scrollDelta)).append(", originalEventPosition=").append((Object) Offset.m4601toStringimpl(this.originalEventPosition)).append(')');
        return sb.toString();
    }
    ...
    public final long m6158getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m6161getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m6160getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m6163getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & Fields.SpotShadowColor) != 0 ? false : z2, (i2 & Fields.RotationX) != 0 ? new ArrayList() : list, (i2 & Fields.RotationY) != 0 ? Offset.INSTANCE.m4609getZeroF1C5BW0() : j5, (i2 & Fields.RotationZ) != 0 ? Offset.INSTANCE.m4609getZeroF1C5BW0() : j6, null);
    }
    ...
    public final long m6162getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }

    /* renamed from: getOriginalEventPosition-F1C5BW0, reason: not valid java name */
    public final long m6159getOriginalEventPositionF1C5BW0() {
        return this.originalEventPosition;
    }
}
