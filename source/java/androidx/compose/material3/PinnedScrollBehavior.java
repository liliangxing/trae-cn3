...
final class PinnedScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public /* synthetic */ PinnedScrollBehavior(TopAppBarState topAppBarState, C06721 c06721, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, (i & 2) != 0 ? new Function0<Boolean>() { // from class: androidx.compose.material3.PinnedScrollBehavior.1
            ...
            public final Boolean m2782invoke() {
                return true;
            }
        } : c06721);
    }
