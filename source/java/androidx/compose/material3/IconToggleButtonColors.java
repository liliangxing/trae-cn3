...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m4840equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m4840equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m4840equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m4840equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m4840equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m4846hashCodeimpl(this.containerColor) * 31) + Color.m4846hashCodeimpl(this.contentColor)) * 31) + Color.m4846hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4846hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4846hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m4846hashCodeimpl(this.checkedContentColor);
    }
}
