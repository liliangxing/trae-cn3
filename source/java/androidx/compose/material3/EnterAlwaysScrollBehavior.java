...
final class EnterAlwaysScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public /* synthetic */ EnterAlwaysScrollBehavior(TopAppBarState topAppBarState, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, C06231 c06231, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, animationSpec, decayAnimationSpec, (i & 8) != 0 ? new Function0<Boolean>() { // from class: androidx.compose.material3.EnterAlwaysScrollBehavior.1
            ...
            public final Boolean m2559invoke() {
                return true;
            }
        } : c06231);
    }
