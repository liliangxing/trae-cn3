...
public final class TooltipDefaults {
    ...
    private static final CaretProperties caretProperties = new CaretProperties(Dp.constructor-impl(8), Dp.constructor-impl(16), null);
    ...
    public final RichTooltipColors m3350richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2823copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2823copyjRlVdoo(m4875getUnspecified0d7_KjU, m4875getUnspecified0d7_KjU2, m4875getUnspecified0d7_KjU3, m4875getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2823copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m3348rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        final int i3 = ((Density) consume).roundToPx-0680j_4(f);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long m3351calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.getWidth-impl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.getHeight-impl(popupContentSize)) - i3;
                    if (top < 0) {
                        top = i3 + anchorBounds.getBottom();
                    }
    ...
    public final PopupPositionProvider m3349rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                /* renamed from: calculatePosition-llwVHH4, reason: not valid java name */
                public long m3352calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int right = anchorBounds.getRight();
                    if (IntSize.getWidth-impl(popupContentSize) + right > IntSize.getWidth-impl(windowSize) && (right = anchorBounds.getLeft() - IntSize.getWidth-impl(popupContentSize)) < 0) {
                        right = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.getWidth-impl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.getHeight-impl(popupContentSize)) - i3;
                    if (top < 0) {
                        top = i3 + anchorBounds.getBottom();
