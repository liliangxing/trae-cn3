...
final class ScrollableTabData {
    ...
    public final void onLaidOut(Density density, int edgeOffset, List<TabPosition> tabPositions, int selectedTab) {
        ...
        BuildersKt.launch$default(this.coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new ScrollableTabData$onLaidOut$1$1(this, calculateTabOffset, null), 3, (Object) null);
    }

    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int i2 = density.roundToPx-0680j_4(((TabPosition) CollectionsKt.last(list)).m3093getRightD9Ej5fM()) + i;
        int maxValue = i2 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.roundToPx-0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.roundToPx-0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(i2 - maxValue, 0));
    }
}
