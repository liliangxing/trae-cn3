...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m4840equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m4840equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m4840equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m4846hashCodeimpl(this.containerColor) * 31) + Color.m4846hashCodeimpl(this.contentColor)) * 31) + Color.m4846hashCodeimpl(this.titleContentColor)) * 31) + Color.m4846hashCodeimpl(this.actionContentColor);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RichTooltipColors m2823copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
        return new RichTooltipColors((containerColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (contentColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (contentColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? contentColor : this.contentColor, (titleContentColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (titleContentColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? titleContentColor : this.titleContentColor, actionContentColor != Color.INSTANCE.m4875getUnspecified0d7_KjU() ? actionContentColor : this.actionContentColor, null);
    }
}
