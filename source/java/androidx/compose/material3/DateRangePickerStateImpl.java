...
final class DateRangePickerStateImpl extends BaseDatePickerStateImpl implements DateRangePickerState {
    ...
    private DateRangePickerStateImpl(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        setSelection(l, l2);
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m2529boximpl(i), null, 2, null);
    ...
    public int mo2519getDisplayModejFl4v0() {
        return this._displayMode.getValue().getValue();
    }

    @Override // androidx.compose.material3.DateRangePickerState
    /* renamed from: setDisplayMode-vCnGnXg */
    public void mo2520setDisplayModevCnGnXg(int i) {
        ...
        this._displayMode.setValue(DisplayMode.m2529boximpl(i));
    }
        ...
        public final Saver<DateRangePickerStateImpl, Object> Saver(final SelectableDates selectableDates, final Locale locale) {
            return ListSaverKt.listSaver(new Function2<SaverScope, DateRangePickerStateImpl, List<? extends Object>>() { // from class: androidx.compose.material3.DateRangePickerStateImpl$Companion$Saver$1
                public final List<Object> invoke(SaverScope saverScope, DateRangePickerStateImpl dateRangePickerStateImpl) {
                    return CollectionsKt.listOf(new Object[]{dateRangePickerStateImpl.getSelectedStartDateMillis(), dateRangePickerStateImpl.getSelectedEndDateMillis(), Long.valueOf(dateRangePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getLast()), Integer.valueOf(dateRangePickerStateImpl.mo2519getDisplayModejFl4v0())});
                }
                ...
                public final DateRangePickerStateImpl invoke(List<? extends Object> list) {
                    ...
                    return new DateRangePickerStateImpl(l, l2, l3, intRange, DisplayMode.m2530constructorimpl(((Integer) obj3).intValue()), SelectableDates.this, locale, null);
                }
            });
        }
    }
