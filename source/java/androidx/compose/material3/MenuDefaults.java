...
public final class MenuDefaults {
    ...
    public final MenuItemColors m2684itemColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        MenuItemColors m2686copytNS2XkQ = getDefaultMenuItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2686copytNS2XkQ(m4875getUnspecified0d7_KjU, m4875getUnspecified0d7_KjU2, m4875getUnspecified0d7_KjU3, m4875getUnspecified0d7_KjU4, m4875getUnspecified0d7_KjU5, m4875getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2686copytNS2XkQ;
    }
    ...
    public final MenuItemColors getDefaultMenuItemColors$material3_release(ColorScheme colorScheme) {
        ...
        MenuItemColors menuItemColors = new MenuItemColors(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemLeadingIconColor()), ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemTrailingIconColor()), Color.m4838copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4838copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledLeadingIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4838copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledTrailingIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    static {
        ...
        DropdownMenuItemContentPadding = PaddingKt.m1058PaddingValuesYgX7TsA(f, Dp.constructor-impl(0));
    }
}
