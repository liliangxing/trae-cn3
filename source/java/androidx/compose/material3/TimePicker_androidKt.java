...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m3253getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3252getHorizontalQJTpgSE();
        } else {
            m3253getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3253getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m3253getVerticalQJTpgSE;
    }
}
