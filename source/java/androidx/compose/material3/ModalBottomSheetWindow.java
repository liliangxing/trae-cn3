...
public final class ModalBottomSheetWindow extends AbstractComposeView implements ViewTreeObserver.OnGlobalLayoutListener, ViewRootForInspector {
    ...
    public ModalBottomSheetWindow(ModalBottomSheetProperties modalBottomSheetProperties, Function0<Unit> function0, View view, UUID uuid) {
        ...
        layoutParams.setTitle(view.getContext().getResources().getString(C0754R.string.default_popup_window_title));
        layoutParams.token = view.getApplicationWindowToken();
        layoutParams.flags &= -163841;
        layoutParams.flags |= Fields.RotationY;
        ...
        if (shouldApplySecureFlag) {
            layoutParams.flags |= Fields.Shape;
        } else {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2417getLambda2$material3_release(), null, 2, null);
