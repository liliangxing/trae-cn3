...
final class DateRangePickerKt$VerticalMonthsList$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DateRangePickerKt$VerticalMonthsList$2$1(LazyListState lazyListState, Function1<? super Long, Unit> function1, CalendarModel calendarModel, IntRange intRange, Continuation<? super DateRangePickerKt$VerticalMonthsList$2$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (DatePickerKt.updateDisplayedMonth(this.$lazyListState, this.$onDisplayedMonthChange, this.$calendarModel, this.$yearRange, (Continuation) this) == coroutine_suspended) {
