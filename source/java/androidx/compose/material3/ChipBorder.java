...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m432BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m4840equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.equals-impl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return (((Color.m4846hashCodeimpl(this.borderColor) * 31) + Color.m4846hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.hashCode-impl(this.borderWidth);
    }
}
