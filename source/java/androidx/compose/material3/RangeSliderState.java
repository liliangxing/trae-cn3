...
public final class RangeSliderState {
    ...
    public RangeSliderState(float f, float f2, int i, Function0<Unit> function0, ClosedFloatingPointRange<Float> closedFloatingPointRange) {
        ...
        this.isRtl = mutableStateOf$default;
    ...
    public final void setActiveRangeStart(float f) {
        setActiveRangeStartState(SliderKt.access$snapValueToTick(RangesKt.coerceIn(f, ((Number) this.valueRange.getStart()).floatValue(), getActiveRangeEnd()), this.tickFractions, ((Number) this.valueRange.getStart()).floatValue(), ((Number) this.valueRange.getEndInclusive()).floatValue()));
    }
    ...
    public final void setActiveRangeEnd(float f) {
        setActiveRangeEndState(SliderKt.access$snapValueToTick(RangesKt.coerceIn(f, getActiveRangeStart(), ((Number) this.valueRange.getEndInclusive()).floatValue()), this.tickFractions, ((Number) this.valueRange.getStart()).floatValue(), ((Number) this.valueRange.getEndInclusive()).floatValue()));
    }
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long m2821scaleToUserValueowVgs5E = m2821scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), SliderRange);
        if (SliderRange.m2942equalsimpl0(m2821scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2944getStartimpl(m2821scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2943getEndInclusiveimpl(m2821scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2939boximpl(m2821scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2821scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m2929access$scaleziovWd0(minPx, maxPx, offset, ((Number) this.valueRange.getStart()).floatValue(), ((Number) this.valueRange.getEndInclusive()).floatValue());
    }
