...
public final class DateInputValidator {
    ...
    public /* synthetic */ DateInputValidator(IntRange intRange, SelectableDates selectableDates, DateInputFormat dateInputFormat, DatePickerFormatter datePickerFormatter, String str, String str2, String str3, String str4, Long l, Long l2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(intRange, selectableDates, dateInputFormat, datePickerFormatter, str, str2, str3, str4, (i & Fields.RotationX) != 0 ? null : l, (i & Fields.RotationY) != 0 ? null : l2);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x009e, code lost:
        ...
        if (r0 < (r13 != null ? r13.longValue() : androidx.compose.runtime.snapshots.SnapshotId_jvmKt.SnapshotIdMax)) goto L23;
     */
    /* renamed from: validate-XivgLIo, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final String m2439validateXivgLIo(CalendarDate dateToValidate, int inputIdentifier, Locale locale) {
        ...
        if (!this.yearRange.contains(dateToValidate.getYear())) {
            String format2 = String.format(this.errorDateOutOfYearRange, Arrays.copyOf(new Object[]{ActualJvm_jvmKt.toLocalString$default(this.yearRange.getFirst(), 0, 0, false, 7, null), ActualJvm_jvmKt.toLocalString$default(this.yearRange.getLast(), 0, 0, false, 7, null)}, 2));
        ...
        if (!selectableDates.isSelectableYear(dateToValidate.getYear()) || !selectableDates.isSelectableDate(dateToValidate.getUtcTimeMillis())) {
            String format3 = String.format(this.errorInvalidNotAllowed, Arrays.copyOf(new Object[]{DatePickerFormatter.formatDate$default(this.dateFormatter, Long.valueOf(dateToValidate.getUtcTimeMillis()), locale, false, 4, null)}, 1));
            Intrinsics.checkNotNullExpressionValue(format3, "format(this, *args)");
            return format3;
        }
        if (InputIdentifier.m2639equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m2645getStartDateInputJ2x2o4M())) {
            long utcTimeMillis = dateToValidate.getUtcTimeMillis();
            Long l = this.currentEndDateMillis;
        }
        if (!InputIdentifier.m2639equalsimpl0(inputIdentifier, InputIdentifier.INSTANCE.m2643getEndDateInputJ2x2o4M())) {
            return "";
        }
