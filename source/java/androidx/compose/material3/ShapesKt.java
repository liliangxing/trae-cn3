...
public final class ShapesKt {
    private static final ProvidableCompositionLocal<Shapes> LocalShapes = CompositionLocalKt.staticCompositionLocalOf(new Function0<Shapes>() { // from class: androidx.compose.material3.ShapesKt$LocalShapes$1
        ...
        public final Shapes m2906invoke() {
    ...
    public static final Shape getValue(ShapeKeyTokens shapeKeyTokens, Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, 1629172543, "C192@7777L6:Shapes.kt#uh7d8r");
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), null, null, CornerSizeKt.m1464CornerSize0680j_4(Dp.constructor-impl(f)), 6, null);
    }
}
