...
final class AnchoredDraggableKt$restartable$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (SnapshotStateKt.snapshotFlow(this.$inputs).collect(new C05581(objectRef, coroutineScope, this.$block), (Continuation) this) == coroutine_suspended) {
    ...
    /* renamed from: androidx.compose.material3.AnchoredDraggableKt$restartable$2$1 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
    public static final class C05581<T> implements FlowCollector {
        final /* synthetic */ CoroutineScope $$this$coroutineScope;
        final /* synthetic */ Function2<I, Continuation<? super Unit>, Object> $block;
        final /* synthetic */ Ref.ObjectRef<Job> $previousDrag;

        /* JADX WARN: Multi-variable type inference failed */
        C05581(Ref.ObjectRef<Job> objectRef, CoroutineScope coroutineScope, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2) {
            ...
            if (continuation instanceof AnchoredDraggableKt$restartable$2$1$emit$1) {
                ...
                if ((anchoredDraggableKt$restartable$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i2 != 0) {
                        ...
                        c05581 = (C05581) anchoredDraggableKt$restartable$2$1$emit$1.L$0;
                        ResultKt.throwOnFailure(obj2);
                        obj = obj3;
                    }
                    c05581.$previousDrag.element = BuildersKt.launch$default(c05581.$$this$coroutineScope, (CoroutineContext) null, CoroutineStart.UNDISPATCHED, new AnonymousClass2(c05581.$block, obj, c05581.$$this$coroutineScope, null), 1, (Object) null);
                    return Unit.INSTANCE;
                }
            }
