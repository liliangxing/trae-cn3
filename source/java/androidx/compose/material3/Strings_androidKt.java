...
public final class Strings_androidKt {
    ...
    public static final String m3033getStringNWtq28(int i, Composer composer, int i2) {
    ...
    public static final String m3034getStringiSCLEhQ(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String m3033getStringNWtq28 = m3033getStringNWtq28(i, composer, i2 & 14);
        ProvidableCompositionLocal localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        String format = String.format(locale, m3033getStringNWtq28, Arrays.copyOf(copyOf, copyOf.length));
