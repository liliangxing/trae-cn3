...
public final class IconButtonColors {
    ...
    public final long m2605containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2606contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m4840equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m4840equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m4840equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m4846hashCodeimpl(this.containerColor) * 31) + Color.m4846hashCodeimpl(this.contentColor)) * 31) + Color.m4846hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4846hashCodeimpl(this.disabledContentColor);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final IconButtonColors m2607copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
        return new IconButtonColors((containerColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (contentColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (contentColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? contentColor : this.contentColor, (disabledContainerColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (disabledContainerColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledContainerColor : this.disabledContainerColor, disabledContentColor != Color.INSTANCE.m4875getUnspecified0d7_KjU() ? disabledContentColor : this.disabledContentColor, null);
    }
}
