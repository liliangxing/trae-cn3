...
final class DatePickerStateImpl extends BaseDatePickerStateImpl implements DatePickerState {
    ...
    private DatePickerStateImpl(Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m2529boximpl(i), null, 2, null);
    ...
    public int mo2499getDisplayModejFl4v0() {
        return this._displayMode.getValue().getValue();
    }

    @Override // androidx.compose.material3.DatePickerState
    /* renamed from: setDisplayMode-vCnGnXg */
    public void mo2500setDisplayModevCnGnXg(int i) {
        ...
        public final Saver<DatePickerStateImpl, Object> Saver(final SelectableDates selectableDates, final Locale locale) {
            return ListSaverKt.listSaver(new Function2<SaverScope, DatePickerStateImpl, List<? extends Object>>() { // from class: androidx.compose.material3.DatePickerStateImpl$Companion$Saver$1
                public final List<Object> invoke(SaverScope saverScope, DatePickerStateImpl datePickerStateImpl) {
                    return CollectionsKt.listOf(new Object[]{datePickerStateImpl.getSelectedDateMillis(), Long.valueOf(datePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(datePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(datePickerStateImpl.getYearRange().getLast()), Integer.valueOf(datePickerStateImpl.mo2499getDisplayModejFl4v0())});
                }
                ...
                public final DatePickerStateImpl invoke(List<? extends Object> list) {
                    ...
                    return new DatePickerStateImpl(l, l2, intRange, DisplayMode.m2530constructorimpl(((Integer) obj3).intValue()), SelectableDates.this, locale, null);
                }
            });
        }
    }
