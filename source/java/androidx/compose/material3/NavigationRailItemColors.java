...
public final class NavigationRailItemColors {
    ...
    public final long m2757getSelectedIndicatorColor0d7_KjU() {
    ...
    public final State<Color> iconColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(iconColor)P(1)424@19150L132:NavigationRail.kt#uh7d8r");
    ...
    public final State<Color> textColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(textColor)P(1)443@19780L132:NavigationRail.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m4840equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m4840equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m4840equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m4840equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m4840equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m4840equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }
