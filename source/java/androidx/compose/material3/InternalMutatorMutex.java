...
public final class InternalMutatorMutex {
    ...
    public final void tryMutateOrCancel(Mutator mutator) {
        ...
        } while (!UByte$.ExternalSyntheticBackport0.m(this.currentMutator, mutator2, mutator));
        if (mutator2 != null) {
            mutator2.cancel();
        }
    }
    ...
    public final boolean tryMutate(Function0<Unit> block) {
        boolean tryLock$default = Mutex.DefaultImpls.tryLock$default(this.mutex, (Object) null, 1, (Object) null);
        if (tryLock$default) {
            try {
                block.invoke();
            } finally {
