...
public final class WindowAlignmentMarginPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo2187position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.getWidth-impl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterHorizontally().align(menuWidth, IntSize.getWidth-impl(windowSize), layoutDirection);
            }
            return RangesKt.coerceIn(this.alignment.align(menuWidth, IntSize.getWidth-impl(windowSize), layoutDirection), this.margin, (IntSize.getWidth-impl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo2188positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.getHeight-impl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterVertically().align(menuHeight, IntSize.getHeight-impl(windowSize));
            }
            return RangesKt.coerceIn(this.alignment.align(menuHeight, IntSize.getHeight-impl(windowSize)), this.margin, (IntSize.getHeight-impl(windowSize) - this.margin) - menuHeight);
        }
    }
}
