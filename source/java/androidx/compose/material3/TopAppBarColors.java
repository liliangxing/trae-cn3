...
public final class TopAppBarColors {
    ...
    public final long m3358containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m4890lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4840equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m4840equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m4840equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m4840equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m4840equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m4846hashCodeimpl(this.containerColor) * 31) + Color.m4846hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4846hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4846hashCodeimpl(this.titleContentColor)) * 31) + Color.m4846hashCodeimpl(this.actionIconContentColor);
    }

    /* renamed from: copy-t635Npw, reason: not valid java name */
    public final TopAppBarColors m3359copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
        return new TopAppBarColors((containerColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (scrolledContainerColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (scrolledContainerColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? scrolledContainerColor : this.scrolledContainerColor, (navigationIconContentColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (navigationIconContentColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? navigationIconContentColor : this.navigationIconContentColor, (titleContentColor > Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 1 : (titleContentColor == Color.INSTANCE.m4875getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? titleContentColor : this.titleContentColor, actionIconContentColor != Color.INSTANCE.m4875getUnspecified0d7_KjU() ? actionIconContentColor : this.actionIconContentColor, null);
    }
}
