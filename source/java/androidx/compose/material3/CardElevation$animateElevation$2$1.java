        ...
        if (i == 0) {
            ...
            if (!Dp.equals-impl0(this.$animatable.getTargetValue().unbox-impl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m2557animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, (Continuation) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
