...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m2558animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m2557animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ, reason: not valid java name */
    public static final Object m2557animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float f, Interaction interaction, Interaction interaction2, Continuation<? super Unit> continuation) {
        ...
        if (animationSpec != null) {
            Object animateTo$default = Animatable.animateTo$default(animatable, Dp.box-impl(f), animationSpec, null, null, continuation, 12, null);
    ...
    static {
        ...
        DefaultOutgoingSpec = new TweenSpec<>(150, i, cubicBezierEasing, i2, defaultConstructorMarker);
        HoveredOutgoingSpec = new TweenSpec<>(120, i, cubicBezierEasing, i2, defaultConstructorMarker);
    }
}
