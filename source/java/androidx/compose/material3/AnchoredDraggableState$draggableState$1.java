...
public final class AnchoredDraggableState$draggableState$1 implements DraggableState {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [androidx.compose.material3.AnchoredDraggableState$draggableState$1$dragScope$1<T>, androidx.compose.material3.AnchoredDraggableState$draggableState$1$dragScope$1] */
    public AnchoredDraggableState$draggableState$1(final AnchoredDraggableState<T> anchoredDraggableState) {
        ...
        this.dragScope = new DragScope() { // from class: androidx.compose.material3.AnchoredDraggableState$draggableState$1$dragScope$1
            ...
            public void dragBy(float pixels) {
                ...
                AnchoredDragScope.dragTo$default(anchoredDragScope, anchoredDraggableState.newOffsetForDelta$material3_release(pixels), 0.0f, 2, null);
            }
        };
    }
