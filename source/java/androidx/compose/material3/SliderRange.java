...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2939boximpl(long j) {
        return new SliderRange(j);
    }

    /* renamed from: constructor-impl */
    public static long m2940constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl */
    public static boolean m2941equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2947unboximpl();
    }

    /* renamed from: equals-impl0 */
    public static final boolean m2942equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2945hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m2941equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2945hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl */
    public final /* synthetic */ long m2947unboximpl() {
    ...
    public static final float m2944getStartimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m2943getEndInclusiveimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2948getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2949getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    /* renamed from: toString-impl */
    public static String m2946toStringimpl(long j) {
        return SliderKt.m2931isSpecifiedIf1S1O4(j) ? m2944getStartimpl(j) + ".." + m2943getEndInclusiveimpl(j) : "FloatRange.Unspecified";
    }

    public String toString() {
        return m2946toStringimpl(this.packedValue);
    }
}
