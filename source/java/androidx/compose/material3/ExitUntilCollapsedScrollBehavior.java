...
final class ExitUntilCollapsedScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public /* synthetic */ ExitUntilCollapsedScrollBehavior(TopAppBarState topAppBarState, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, C06251 c06251, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, animationSpec, decayAnimationSpec, (i & 8) != 0 ? new Function0<Boolean>() { // from class: androidx.compose.material3.ExitUntilCollapsedScrollBehavior.1
            ...
            public final Boolean m2561invoke() {
                return true;
            }
        } : c06251);
    }
