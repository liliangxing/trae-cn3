...
public final class InternalMutatorMutex$mutateWith$2<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> internalMutatorMutex$mutateWith$2 = new InternalMutatorMutex$mutateWith$2<>(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
        ...
        try {
            try {
                if (r1 == 0) {
                    ...
                    InternalMutatorMutex.Mutator mutator3 = new InternalMutatorMutex.Mutator(mutatePriority, job);
