...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m7063constructorimpl((float) 112.0d);
    ...
    public final float m3507getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3508getContainerHeightD9Ej5fM() {
    ...
    public final float m3509getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3510getTrailingIconSizeD9Ej5fM() {
