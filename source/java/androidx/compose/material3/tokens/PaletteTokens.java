...
public final class PaletteTokens {
    ...
    private static final long Error50 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_FASTOPEN_LIVE_STREAM, 54, 46, 0, 8, null);
    ...
    private static final long Error80 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAG_RANGE, 184, 181, 0, 8, null);
    private static final long Error90 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM_TOKEN, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_DECODER_ERROR, MediaPlayer.MEDIA_PLAYER_OPTION_FASTOPEN_LIVE_STREAM, 0, 8, null);
    private static final long Error95 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF, 238, 238, 0, 8, null);
    private static final long Error99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM_TOKEN, 0, 8, null);
    ...
    private static final long Neutral70 = ColorKt.Color$default(174, PropertyIDConstants.MaskImage, 174, 0, 8, null);
    private static final long Neutral80 = ColorKt.Color$default(201, 197, 202, 0, 8, null);
    private static final long Neutral87 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_ERROR, 216, MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_ERROR, 0, 8, null);
    private static final long Neutral90 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_NETWORK_TRY_COUNT, JfifUtil.MARKER_APP1, 229, 0, 8, null);
    private static final long Neutral92 = ColorKt.Color$default(236, MediaPlayer.MEDIA_PLAYER_OPTION_ALOG_WRITE_FUNC_ADDR, 236, 0, 8, null);
    private static final long Neutral94 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE, 236, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE, 0, 8, null);
    private static final long Neutral95 = ColorKt.Color$default(244, 239, 244, 0, 8, null);
    private static final long Neutral96 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_LOOPER_TIMEOUT, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAG_RANGE, MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_LOOPER_TIMEOUT, 0, 8, null);
    private static final long Neutral98 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_ACCURATE_LAYOUT, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SEEK_INTERRUPT, MediaPlayer.MEDIA_PLAYER_OPTION_ACCURATE_LAYOUT, 0, 8, null);
    private static final long Neutral99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, 254, 0, 8, null);
    ...
    private static final long NeutralVariant70 = ColorKt.Color$default(174, PropertyIDConstants.InsetInlineEnd, 180, 0, 8, null);
    private static final long NeutralVariant80 = ColorKt.Color$default(202, 196, 208, 0, 8, null);
    private static final long NeutralVariant90 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_ALOG_WRITE_FUNC_ADDR, MediaPlayer.MEDIA_PLAYER_OPTION_CLOCK_RESUME_RESET_EOF, 236, 0, 8, null);
    private static final long NeutralVariant95 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_ERROR, 238, 250, 0, 8, null);
    private static final long NeutralVariant99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, 254, 0, 8, null);
    ...
    private static final long Primary70 = ColorKt.Color$default(182, 157, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SEEK_INTERRUPT, 0, 8, null);
    private static final long Primary80 = ColorKt.Color$default(208, 188, 255, 0, 8, null);
    private static final long Primary90 = ColorKt.Color$default(234, MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_ERROR, 255, 0, 8, null);
    private static final long Primary95 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_HIJACK_EXIT, 237, 255, 0, 8, null);
    private static final long Primary99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, 254, 0, 8, null);
    ...
    private static final long Secondary80 = ColorKt.Color$default(204, 194, MediaPlayer.MEDIA_PLAYER_OPTION_FASTOPEN_LIVE_STREAM, 0, 8, null);
    private static final long Secondary90 = ColorKt.Color$default(232, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_DECODER_ERROR, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SEEK_INTERRUPT, 0, 8, null);
    private static final long Secondary95 = ColorKt.Color$default(MediaPlayer.MEDIA_PLAYER_OPTION_HIJACK_EXIT, 237, 255, 0, 8, null);
    private static final long Secondary99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, 254, 0, 8, null);
    ...
    private static final long Tertiary95 = ColorKt.Color$default(255, 236, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE, 0, 8, null);
    private static final long Tertiary99 = ColorKt.Color$default(255, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR, 250, 0, 8, null);
