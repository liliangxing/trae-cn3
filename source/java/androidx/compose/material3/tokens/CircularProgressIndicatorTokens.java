...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m7063constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m7063constructorimpl((float) 48.0d);
    ...
    public final float m2991getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2992getSizeD9Ej5fM() {
        return Size;
    }
}
