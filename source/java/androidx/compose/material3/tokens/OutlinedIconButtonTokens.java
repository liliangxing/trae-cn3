...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7063constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7063constructorimpl((float) 24.0d);
    ...
    public final float m3315getContainerSizeD9Ej5fM() {
    ...
    public final float m3316getSizeD9Ej5fM() {
        return Size;
    }
