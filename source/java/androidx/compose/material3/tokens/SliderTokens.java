...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m3128getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m3129getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m3128getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m7063constructorimpl((float) 28.0d);
    ...
    private static final float StateLayerSize = Dp.m7063constructorimpl((float) 40.0d);
    private static final float TrackElevation = ElevationTokens.INSTANCE.m3128getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m7063constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m7063constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m7063constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m7063constructorimpl(f2);
        HandleWidth = Dp.m7063constructorimpl(f2);
        InactiveTrackHeight = Dp.m7063constructorimpl(f);
    }
    ...
    public final float m3441getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3442getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m3443getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m3444getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3445getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3446getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3447getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3448getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m3450getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m3452getTrackElevationD9Ej5fM() {
    ...
    public final float m3449getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m3451getTickMarksContainerSizeD9Ej5fM() {
