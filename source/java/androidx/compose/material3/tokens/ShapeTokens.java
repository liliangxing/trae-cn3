...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m1475RoundedCornerShape0680j_4(Dp.constructor-impl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m1475RoundedCornerShape0680j_4(Dp.constructor-impl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m1475RoundedCornerShape0680j_4(Dp.constructor-impl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m1476RoundedCornerShapea9UjIt4(Dp.constructor-impl(f), Dp.constructor-impl(f), Dp.constructor-impl(f2), Dp.constructor-impl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m1475RoundedCornerShape0680j_4(Dp.constructor-impl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m1476RoundedCornerShapea9UjIt4(Dp.constructor-impl(f3), Dp.constructor-impl(f3), Dp.constructor-impl(f2), Dp.constructor-impl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m1475RoundedCornerShape0680j_4(Dp.constructor-impl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m1476RoundedCornerShapea9UjIt4(Dp.constructor-impl(f2), Dp.constructor-impl(f4), Dp.constructor-impl(f4), Dp.constructor-impl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m1476RoundedCornerShapea9UjIt4(Dp.constructor-impl(f4), Dp.constructor-impl(f4), Dp.constructor-impl(f2), Dp.constructor-impl(f2));
    }
}
