...
public final class TypeScaleTokens {
    ...
    static {
        ...
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.getRawType-impl(sp), -TextUnit.getValue-impl(sp));
