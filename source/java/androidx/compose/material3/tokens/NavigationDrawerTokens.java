...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m7063constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m7063constructorimpl((float) 336.0d);
    ...
    private static final float ContainerWidth = Dp.m7063constructorimpl((float) 360.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m3129getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m3128getLevel0D9Ej5fM();
    ...
    public final float m3281getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3282getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m3283getContainerWidthD9Ej5fM() {
    ...
    public final float m3284getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m3285getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m3286getStandardContainerElevationD9Ej5fM() {
