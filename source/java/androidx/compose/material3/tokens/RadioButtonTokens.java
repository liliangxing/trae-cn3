...
public final class RadioButtonTokens {
    ...
    private static final float IconSize = Dp.m7063constructorimpl((float) 20.0d);
    ...
    public final float m3424getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m3425getStateLayerSizeD9Ej5fM() {
