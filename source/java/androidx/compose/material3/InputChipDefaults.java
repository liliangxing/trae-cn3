...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m3696getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m3698getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m3694getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m2631getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2632getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getAvatarSize-D9Ej5fM, reason: not valid java name */
    public final float m2630getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final SelectableChipColors m2634inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        SelectableChipColors m2884copydaRQuJA = getDefaultInputChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2884copydaRQuJA(m4875getUnspecified0d7_KjU, m4875getUnspecified0d7_KjU2, m4875getUnspecified0d7_KjU3, m4875getUnspecified0d7_KjU4, m4875getUnspecified0d7_KjU5, m4875getUnspecified0d7_KjU6, m4875getUnspecified0d7_KjU7, m4875getUnspecified0d7_KjU8, m4875getUnspecified0d7_KjU9, m4875getUnspecified0d7_KjU10, m4875getUnspecified0d7_KjU11, m4875getUnspecified0d7_KjU12, m4875getUnspecified0d7_KjU13);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipElevation m2635inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m3695getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m3695getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m3695getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m3695getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m3695getContainerElevationD9Ej5fM : f4;
        float m3697getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m3697getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m3695getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1580)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(m3695getContainerElevationD9Ej5fM, f7, f8, f9, m3697getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke m2633inputChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m4838copywmQWz5c$default = (i2 & 16) != 0 ? Color.m4838copywmQWz5c$default(ColorSchemeKt.getValue(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m4874getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.INSTANCE.m4874getTransparent0d7_KjU() : j4;
        float m3701getUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? InputChipTokens.INSTANCE.m3701getUnselectedOutlineWidthD9Ej5fM() : f;
        float m3699getSelectedOutlineWidthD9Ej5fM = (i2 & Fields.SpotShadowColor) != 0 ? InputChipTokens.INSTANCE.m3699getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (z2) {
            m3701getUnselectedOutlineWidthD9Ej5fM = m3699getSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke m432BorderStrokecXLIe8U = BorderStrokeKt.m432BorderStrokecXLIe8U(m3701getUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
