...
public final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float getTop() {
        return Dp.constructor-impl(this.topPadding.getValue().unbox-impl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float getBottom() {
        return Dp.constructor-impl(SearchBar_androidKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
