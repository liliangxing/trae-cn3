...
public final class TextFieldDefaultsKt {
    ...
    public static final /* synthetic */ State m3187access$animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        return m3188animateBorderStrokeAsStateNuRrP5Q(z, z2, interactionSource, textFieldColors, f, f2, composer, i);
    }

    /* renamed from: animateBorderStrokeAsState-NuRrP5Q */
    public static final State<BorderStroke> m3188animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = AnimateAsStateKt.m271animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
        ...
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().unbox-impl(), new SolidColor(indicatorColor$material3_release.getValue().m4849unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
