...
public final class MaterialTheme {
    ...
    public final ColorScheme getColorScheme(Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -561618718, "C86@3799L7:MaterialTheme.kt#uh7d8r");
    ...
    public final Typography getTypography(Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, -942794935, "C94@4023L7:MaterialTheme.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final Shapes getShapes(Composer composer, int i) {
        ComposerKt.sourceInformationMarkerStart(composer, 419509830, "C102@4231L7:MaterialTheme.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
