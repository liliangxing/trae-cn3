...
public final class TimePickerState$update$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Selection.m2900equalsimpl0(this.this$0.m3255getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m2904getHourJiIwxys())) {
            ...
            if (this.$fromTap) {
                this.label = 1;
                if (this.this$0.getCurrentAngle$material3_release().snapTo(Boxing.boxFloat(this.this$0.getMinuteAngle$material3_release()), (Continuation) this) == coroutine_suspended) {
                ...
                this.label = 2;
                if (currentAngle$material3_release.snapTo(Boxing.boxFloat(offsetHour), (Continuation) this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
