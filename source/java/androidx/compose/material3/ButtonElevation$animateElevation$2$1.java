        ...
        if (i == 0) {
            ...
            if (!Dp.equals-impl0(this.$animatable.getTargetValue().unbox-impl(), this.$target)) {
                if (!this.$enabled) {
                    ...
                    float f4 = this.$animatable.getTargetValue().unbox-impl();
                    f = this.this$0.pressedElevation;
                    FocusInteraction.Focus focus = null;
                    if (Dp.equals-impl0(f4, f)) {
                        focus = new PressInteraction.Press(Offset.INSTANCE.m4609getZeroF1C5BW0(), null);
                    } else {
                        f2 = this.this$0.hoveredElevation;
                        if (Dp.equals-impl0(f4, f2)) {
                            focus = new HoverInteraction.Enter();
                        } else {
                            f3 = this.this$0.focusedElevation;
                            if (Dp.equals-impl0(f4, f3)) {
                                focus = new FocusInteraction.Focus();
                            }
                        }
                    }
                    this.label = 2;
                    if (ElevationKt.m2557animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, (Continuation) this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            }
