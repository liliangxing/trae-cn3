...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00152\u00020\u0001:\u0001\u0015B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\b\u001a\u00020\tH\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u001a\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u000f\u0010\u0010J\u0010\u0010\u0011\u001a\u00020\u0012HÖ\u0001¢\u0006\u0004\b\u0013\u0010\u0014R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u0016"}, d2 = {"Landroidx/compose/ui/input/key/Key;", "", "keyCode", "", "constructor-impl", "(J)J", "getKeyCode", "()J", "toString", "", "toString-impl", "(J)Ljava/lang/String;", "equals", "", PreloadConfig.KEY_OTHER, "equals-impl", "(JLjava/lang/Object;)Z", "hashCode", "", "hashCode-impl", "(J)I", "Companion", "ui_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
@JvmInline
...
public final class Key {
    ...
    private static final long NavigatePrevious = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_RANGE_TIME);
    ...
    private static final long f1102J = Key_androidKt.Key(38);
    ...
    private static final long MediaAudioTrack = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_DECODER_ERROR);
    private static final long MediaEject = Key_androidKt.Key(PropertyIDConstants.CaretColor);
    ...
    private static final long ZoomIn = Key_androidKt.Key(PropertyIDConstants.InsetInlineStart);
    private static final long ZoomOut = Key_androidKt.Key(PropertyIDConstants.InsetInlineEnd);
    private static final long Tv = Key_androidKt.Key(PropertyIDConstants.MaskImage);
    ...
    private static final long Henkan = Key_androidKt.Key(Constants.UPLOAD_DISASTER_ESCAPE);
    ...
    private static final long BrightnessDown = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_FASTOPEN_LIVE_STREAM);
    private static final long BrightnessUp = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_ERROR);
    private static final long Sleep = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_OUTPUT_LOG);
    private static final long WakeUp = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_CLOCK_RESUME_RESET_EOF);
    ...
    private static final long TvDataService = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_NETWORK_TRY_COUNT);
    private static final long VoiceAssist = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_ALOG_WRITE_FUNC_ADDR);
    ...
    private static final long TvNetwork = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE);
    private static final long TvAntennaCable = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAG_RANGE);
    private static final long TvInputHdmi1 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RANGE_SIZE);
    private static final long TvInputHdmi2 = Key_androidKt.Key(244);
    private static final long TvInputHdmi3 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_ERROR);
    private static final long TvInputHdmi4 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_HIJACK_EXIT);
    private static final long TvInputComposite1 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_LOOPER_TIMEOUT);
    private static final long TvInputComposite2 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SEEK_INTERRUPT);
    private static final long TvInputComponent1 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM_TOKEN);
    private static final long TvInputComponent2 = Key_androidKt.Key(250);
    private static final long TvInputVga1 = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR);
    private static final long TvAudioDescription = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF);
    private static final long TvAudioDescriptionMixingVolumeUp = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_ACCURATE_LAYOUT);
    ...
    private static final long TvTimerProgramming = Key_androidKt.Key(MediaPlayer.MEDIA_PLAYER_OPTION_RANGE_MODE);
    ...
    public static String m5182toStringimpl(long j) {
        return "Key code: " + j;
    }

    public String toString() {
        return m5182toStringimpl(this.keyCode);
    }
}
