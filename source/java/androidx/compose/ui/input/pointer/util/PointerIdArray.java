...
public final class PointerIdArray {
    ...
    public final long m5726get_I2yYro(int index) {
        return PointerId.m5612constructorimpl(this.internalArray[index]);
    }

    /* renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m5727remove0FcD4WY(long pointerId) {
    ...
    public final boolean m5724add0FcD4WY(long pointerId) {
    ...
    public final void m5728setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m5725contains0FcD4WY(long pointerId) {
