...
public final class Float16Kt {
    ...
    private static final int toCompareValue(short s) {
        return (s & ShortCompanionObject.MIN_VALUE) != 0 ? 32768 - (s & 65535) : s & 65535;
    }
    ...
    public static final short floatToHalf(float f) {
        ...
        int i5 = floatToRawIntBits & Fp32SignificandMask;
        int i6 = 31;
        int i7 = 0;
        if (i4 == 255) {
            if (i5 != 0) {
    ...
    public static final short m4493minAoSsdG0(short s, short s2) {
        if (Float16.m4465isNaNimpl(s) || Float16.m4465isNaNimpl(s2)) {
            return Float16.Companion.m4487getNaNslo4al4();
        }
        return Float16.m4452compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4492maxAoSsdG0(short s, short s2) {
        if (Float16.m4465isNaNimpl(s) || Float16.m4465isNaNimpl(s2)) {
            return Float16.Companion.m4487getNaNslo4al4();
        }
        return Float16.m4452compareTo41bOqos(s, s2) >= 0 ? s : s2;
    ...
    public static final float halfToFloat(short s) {
        ...
        if (i6 != 0) {
            ...
            if (i7 != 0) {
                float intBitsToFloat = Float.intBitsToFloat(i7 + Fp32DenormalMagic) - Fp32DenormalFloat;
