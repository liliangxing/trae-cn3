...
public final /* data */ class DpTouchBoundsExpansion {
    ...
    public static /* synthetic */ DpTouchBoundsExpansion m5931copylDy3nrA$default(DpTouchBoundsExpansion dpTouchBoundsExpansion, float f, float f2, float f3, float f4, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return dpTouchBoundsExpansion.m5936copylDy3nrA(f, f5, f6, f7, z);
    }
    ...
    public final DpTouchBoundsExpansion m5936copylDy3nrA(float start, float top, float end, float bottom, boolean isLayoutDirectionAware) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7068equalsimpl0(this.start, dpTouchBoundsExpansion.start) && Dp.m7068equalsimpl0(this.top, dpTouchBoundsExpansion.top) && Dp.m7068equalsimpl0(this.end, dpTouchBoundsExpansion.end) && Dp.m7068equalsimpl0(this.bottom, dpTouchBoundsExpansion.bottom) && this.isLayoutDirectionAware == dpTouchBoundsExpansion.isLayoutDirectionAware;
    }

    public int hashCode() {
        return (((((((Dp.m7069hashCodeimpl(this.start) * 31) + Dp.m7069hashCodeimpl(this.top)) * 31) + Dp.m7069hashCodeimpl(this.end)) * 31) + Dp.m7069hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.isLayoutDirectionAware);
    }

    public String toString() {
        return "DpTouchBoundsExpansion(start=" + ((Object) Dp.m7074toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7074toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7074toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7074toStringimpl(this.bottom)) + ", isLayoutDirectionAware=" + this.isLayoutDirectionAware + ')';
    }
    ...
    public final float m5939getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m5940getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: getEnd-D9Ej5fM, reason: not valid java name */
    public final float m5938getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m5937getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public final long m5941roundToTouchBoundsExpansionTW6G1oQ(Density density) {
        return TouchBoundsExpansion.m6136constructorimpl(TouchBoundsExpansion.INSTANCE.pack$ui_release(density.mo429roundToPx0680j_4(this.start), density.mo429roundToPx0680j_4(this.top), density.mo429roundToPx0680j_4(this.end), density.mo429roundToPx0680j_4(this.bottom), this.isLayoutDirectionAware));
    }
    ...
    public static final class Companion {
        ...
        public final DpTouchBoundsExpansion m5943Absolutea9UjIt4(float left, float top, float right, float bottom) {
        ...
        public static /* synthetic */ DpTouchBoundsExpansion m5942Absolutea9UjIt4$default(Companion companion, float f, float f2, float f3, float f4, int i, Object obj) {
            if ((i & 1) != 0) {
                f = Dp.m7063constructorimpl(0);
            }
            if ((i & 2) != 0) {
                f2 = Dp.m7063constructorimpl(0);
            }
            if ((i & 4) != 0) {
                f3 = Dp.m7063constructorimpl(0);
            }
            if ((i & 8) != 0) {
                f4 = Dp.m7063constructorimpl(0);
            }
            return companion.m5943Absolutea9UjIt4(f, f2, f3, f4);
        }
    }
}
