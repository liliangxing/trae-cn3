...
public final /* data */ class FixedScale implements ContentScale {
    ...
    public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
        float f = this.value;
        return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(f) << 32) | (BodyPartID.bodyIdMax & Float.floatToRawIntBits(f)));
    }
}
