...
public interface ContentScale {
    ...
    long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5757computeFillMaxDimensioniLBOSCw;
                m5757computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5757computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(m5757computeFillMaxDimensioniLBOSCw) << 32) | (BodyPartID.bodyIdMax & Float.floatToRawIntBits(m5757computeFillMaxDimensioniLBOSCw)));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5758computeFillMinDimensioniLBOSCw;
                m5758computeFillMinDimensioniLBOSCw = ContentScaleKt.m5758computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(m5758computeFillMinDimensioniLBOSCw) << 32) | (BodyPartID.bodyIdMax & Float.floatToRawIntBits(m5758computeFillMinDimensioniLBOSCw)));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float intBitsToFloat = Float.intBitsToFloat((int) (dstSize & BodyPartID.bodyIdMax)) / Float.intBitsToFloat((int) (srcSize & BodyPartID.bodyIdMax));
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & BodyPartID.bodyIdMax));
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float intBitsToFloat = Float.intBitsToFloat((int) (dstSize >> 32)) / Float.intBitsToFloat((int) (srcSize >> 32));
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & BodyPartID.bodyIdMax));
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                if (Float.intBitsToFloat((int) (srcSize >> 32)) > Float.intBitsToFloat((int) (dstSize >> 32)) || Float.intBitsToFloat((int) (srcSize & BodyPartID.bodyIdMax)) > Float.intBitsToFloat((int) (dstSize & BodyPartID.bodyIdMax))) {
                    m5758computeFillMinDimensioniLBOSCw = ContentScaleKt.m5758computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(m5758computeFillMinDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m5758computeFillMinDimensioniLBOSCw) & BodyPartID.bodyIdMax));
                }
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(1.0f) << 32) | (Float.floatToRawIntBits(1.0f) & BodyPartID.bodyIdMax));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo5753computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float intBitsToFloat = Float.intBitsToFloat((int) (dstSize >> 32)) / Float.intBitsToFloat((int) (srcSize >> 32));
                float intBitsToFloat2 = Float.intBitsToFloat((int) (dstSize & BodyPartID.bodyIdMax)) / Float.intBitsToFloat((int) (srcSize & BodyPartID.bodyIdMax));
                return ScaleFactor.m5844constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & BodyPartID.bodyIdMax));
            }
        };
