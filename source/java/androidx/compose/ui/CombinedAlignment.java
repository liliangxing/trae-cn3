...
public final class CombinedAlignment implements Alignment {
    ...
    public long mo3824alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        return IntOffset.m7185constructorimpl((this.horizontal.align((int) (size >> 32), (int) (space >> 32), layoutDirection) << 32) | (this.vertical.align((int) (size & BodyPartID.bodyIdMax), (int) (space & BodyPartID.bodyIdMax)) & BodyPartID.bodyIdMax));
    }
}
