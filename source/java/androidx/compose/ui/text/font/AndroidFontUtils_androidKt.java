...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6584getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m6635equalsimpl0(i, FontStyle.INSTANCE.m6641getItalic_LCdwA()));
    }
}
