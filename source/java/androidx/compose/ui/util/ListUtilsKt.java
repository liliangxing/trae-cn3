...
public final class ListUtilsKt {
    ...
    public static final <T, R> List<R> fastMapIndexedNotNull(List<? extends T> list, Function2<? super Integer, ? super T, ? extends R> function2) {
        ...
        int size = list.size();
        for (int i = 0; i < size; i++) {
            R invoke = function2.invoke(Integer.valueOf(i), list.get(i));
            if (invoke != null) {
    ...
    public static final <T, R> List<R> fastZipWithNext(List<? extends T> list, Function2<? super T, ? super T, ? extends R> function2) {
        ...
        int i = 0;
        WebcastContainerInitializer$initializeWithBulletContextInWeb$1 webcastContainerInitializer$initializeWithBulletContextInWeb$1 = list.get(0);
        int lastIndex = CollectionsKt.getLastIndex(list);
        while (i < lastIndex) {
            i++;
            T t = list.get(i);
            arrayList.add(function2.invoke(webcastContainerInitializer$initializeWithBulletContextInWeb$1, t));
            webcastContainerInitializer$initializeWithBulletContextInWeb$1 = t;
        }
        return arrayList;
    }
