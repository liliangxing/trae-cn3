...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo3824alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long m7229constructorimpl = IntSize.m7229constructorimpl(((((int) (space >> 32)) - ((int) (size >> 32))) << 32) | ((((int) (space & BodyPartID.bodyIdMax)) - ((int) (size & BodyPartID.bodyIdMax))) & BodyPartID.bodyIdMax));
        float f = ((int) (m7229constructorimpl >> 32)) / 2.0f;
        float f2 = 1;
        float f3 = f * (this.horizontalBias + f2);
        float f4 = (((int) (m7229constructorimpl & BodyPartID.bodyIdMax)) / 2.0f) * (f2 + this.verticalBias);
        return IntOffset.m7185constructorimpl((Math.round(f3) << 32) | (Math.round(f4) & BodyPartID.bodyIdMax));
    }
}
