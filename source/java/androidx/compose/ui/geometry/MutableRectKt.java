...
public final class MutableRectKt {
    ...
    public static final MutableRect m4089MutableRecttz77jQw(long j, long j2) {
        int i = (int) (j >> 32);
        float intBitsToFloat = Float.intBitsToFloat(i);
        int i2 = (int) (j & BodyPartID.bodyIdMax);
        return new MutableRect(intBitsToFloat, Float.intBitsToFloat(i2), Float.intBitsToFloat(i) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 & BodyPartID.bodyIdMax)));
    }

    /* renamed from: MutableRect-0a9Yr6o, reason: not valid java name */
    public static final MutableRect m4087MutableRect0a9Yr6o(long j, long j2) {
        return new MutableRect(Float.intBitsToFloat((int) (j >> 32)), Float.intBitsToFloat((int) (j & BodyPartID.bodyIdMax)), Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat((int) (j2 & BodyPartID.bodyIdMax)));
    }

    /* renamed from: MutableRect-3MmeM6k, reason: not valid java name */
    public static final MutableRect m4088MutableRect3MmeM6k(long j, float f) {
        int i = (int) (j >> 32);
        float intBitsToFloat = Float.intBitsToFloat(i) - f;
        int i2 = (int) (j & BodyPartID.bodyIdMax);
        return new MutableRect(intBitsToFloat, Float.intBitsToFloat(i2) - f, Float.intBitsToFloat(i) + f, Float.intBitsToFloat(i2) + f);
    }
}
