...
public final class RectManagerKt {
    ...
    public static final boolean m6292isSetgyyYBs(long j) {
        return !IntOffset.m7190equalsimpl0(j, IntOffset.INSTANCE.m7201getMaxnOccac());
    }
    ...
    */
    public static final int m6291analyzeComponents58bKbWc(float[] fArr) {
        int i;
        int i2 = 0;
        if (fArr.length < 16) {
            return 0;
