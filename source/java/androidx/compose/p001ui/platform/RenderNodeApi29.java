...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.getAuto--NrFUSI();
    private int blendMode = BlendMode.Companion.getSrcOver-0nO6VwU();
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m1815applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.Companion.getOffscreen--NrFUSI());
        } else {
            m1815applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }
    ...
    private final void m1815applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
