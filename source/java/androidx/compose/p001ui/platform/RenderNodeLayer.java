...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    /* compiled from: RenderNodeLayer.android.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/platform/RenderNodeLayer$UniqueDrawingIdApi29;", "", "<init>", "()V", "getUniqueDrawingId", "", "view", "Landroid/view/View;", "ui_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.getPivotFractionX-impl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.getPivotFractionY-impl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & mutatedFields$ui_release) != 0) {
            this.renderNode.mo1749setBlendModes9anfk8(scope.getBlendMode-0nO6VwU());
        }
        if ((32768 & mutatedFields$ui_release) != 0) {
            this.renderNode.mo1750setCompositingStrategyaDBOjCE(scope.getCompositingStrategy--NrFUSI());
        }
    ...
    public void mo1623resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.getPivotFractionX-impl(this.transformOrigin) * i);
        this.renderNode.setPivotY(TransformOrigin.getPivotFractionY-impl(this.transformOrigin) * i2);
    ...
    public void mo1622movegyyYBs(long position) {
        ...
        if (left == m2808getXimpl && top == m2809getYimpl) {
            return;
        }
        if (left != m2808getXimpl) {
            this.renderNode.offsetLeftAndRight(m2808getXimpl - left);
        }
        if (top != m2809getYimpl) {
            this.renderNode.offsetTopAndBottom(m2809getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.concat-58bKbWc(this.matrixCache.m1774calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo1618getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m1774calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo1621mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m1776mapInverseR5De75A(this.renderNode, point);
        }
        return this.matrixCache.m1775mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo1624transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.timesAssign-58bKbWc(matrix, this.matrixCache.m1774calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.p001ui.node.OwnedLayer
    /* renamed from: inverseTransform-58bKbWc */
    public void mo1619inverseTransform58bKbWc(float[] matrix) {
        float[] m1773calculateInverseMatrixbWbORWo = this.matrixCache.m1773calculateInverseMatrixbWbORWo(this.renderNode);
