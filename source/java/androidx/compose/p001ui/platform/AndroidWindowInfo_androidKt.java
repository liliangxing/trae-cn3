...
public final class AndroidWindowInfo_androidKt {
    ...
    public static final long calculateWindowSize(AndroidComposeView androidComposeView) {
        ...
        if (findActivity != null) {
            ...
            return IntSize.m2846constructorimpl((currentWindowBounds.height() & 4294967295L) | (currentWindowBounds.width() << 32));
        }
        Configuration configuration = context.getResources().getConfiguration();
        return IntSize.m2846constructorimpl((Math.round(configuration.screenHeightDp * r7) & 4294967295L) | (Math.round(configuration.screenWidthDp * context.getResources().getDisplayMetrics().density) << 32));
    }
