...
public final class DepthSortedSetsForDifferentPasses {
    ...
    public final void popEach(Function3<? super LayoutNode, ? super Boolean, ? super Boolean, Unit> block) {
        ...
        while (true) {
            ...
            block.invoke(pop, Boolean.valueOf(z), Boolean.valueOf(r1));
        }
    }
    ...
    public final boolean getAffectsLookaheadMeasure() {
        return (this.approachSet.isEmpty() ^ true) && (this.lookaheadAndAncestorMeasureSet.isEmpty() ^ true);
    }
