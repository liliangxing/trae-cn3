...
public final class NodeChainKt {
    ...
    public static final MutableVector<Modifier.Element> fillVector(Modifier modifier, final MutableVector<Modifier.Element> mutableVector, MutableVector<Modifier> mutableVector2) {
        ...
        while (true) {
            ...
            CombinedModifier combinedModifier = (Modifier) mutableVector2.removeAt(mutableVector2.getSize() - 1);
            if (combinedModifier instanceof CombinedModifier) {
                CombinedModifier combinedModifier2 = combinedModifier;
                mutableVector2.add(combinedModifier2.getInner$ui_release());
                mutableVector2.add(combinedModifier2.getOuter$ui_release());
            } else if (combinedModifier instanceof Modifier.Element) {
                mutableVector.add(combinedModifier);
            } else {
                if (function1 == null) {
                ...
                combinedModifier.all(function1);
                function1 = function1;
            }
        }
    }
