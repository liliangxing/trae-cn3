...
public interface OwnedLayer {
    ...
    float[] mo1618getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo1619inverseTransform58bKbWc(float[] matrix);

    boolean isFrameRateFromParent();

    /* renamed from: isInLayer-k-4lQ0M, reason: not valid java name */
    boolean mo1620isInLayerk4lQ0M(long position);

    void mapBounds(MutableRect rect, boolean inverse);

    /* renamed from: mapOffset-8S9VItk, reason: not valid java name */
    long mo1621mapOffset8S9VItk(long point, boolean inverse);

    /* renamed from: move--gyyYBs, reason: not valid java name */
    void mo1622movegyyYBs(long position);

    /* renamed from: resize-ozmzZPI, reason: not valid java name */
    void mo1623resizeozmzZPI(long size);
    ...
    void mo1624transform58bKbWc(float[] matrix);
