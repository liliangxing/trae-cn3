...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m1381removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m1382removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long m1380findBestHitDistancefn2tFes = m1380findBestHitDistancefn2tFes();
        return DistanceAndFlags.m1361getDistanceimpl(m1380findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m1364isInLayerimpl(m1380findBestHitDistancefn2tFes) && !DistanceAndFlags.m1363isInExpandedBoundsimpl(m1380findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndFlags.m1357compareTo9YPOF3E(m1380findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(distanceFromEdge, isInLayer, false, 4, null)) > 0;
    }

    /* renamed from: findBestHitDistance-fn2tFes, reason: not valid java name */
    private final long m1380findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long m1358constructorimpl = DistanceAndFlags.m1358constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m1357compareTo9YPOF3E(m1358constructorimpl, DistanceAndFlags$default) < 0) {
                    DistanceAndFlags$default = m1358constructorimpl;
                }
                if (DistanceAndFlags.m1361getDistanceimpl(DistanceAndFlags$default) < 0.0f && DistanceAndFlags.m1364isInLayerimpl(DistanceAndFlags$default)) {
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (!DistanceAndFlags.m1363isInExpandedBoundsimpl(m1380findBestHitDistancefn2tFes)) {
            if (DistanceAndFlags.m1361getDistanceimpl(m1380findBestHitDistancefn2tFes) > 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            childHitTest.invoke();
            this.hitDepth = i2;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m1363isInExpandedBoundsimpl(m1380findBestHitDistancefn2tFes())) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        long m1380findBestHitDistancefn2tFes2 = m1380findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m1357compareTo9YPOF3E(m1380findBestHitDistancefn2tFes, m1380findBestHitDistancefn2tFes2) > 0) {
            int i5 = i3 + 1;
            if (DistanceAndFlags.m1363isInExpandedBoundsimpl(m1380findBestHitDistancefn2tFes2)) {
                i = this.hitDepth + 2;
            } else {
                i = this.hitDepth + 1;
            }
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* renamed from: removeFirst, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m1383removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* renamed from: removeLast, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m1384removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        @Override // java.util.List
        public Modifier.Node get(int index) {
            Object obj = HitTestResult.this.values.get(index + this.minIndex);
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type androidx.compose.ui.Modifier.Node");
            return (Modifier.Node) obj;
        }
