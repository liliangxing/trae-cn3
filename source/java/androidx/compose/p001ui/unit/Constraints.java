...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m2608boximpl(long j) {
    ...
    private static final int m2615getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m2616getHasBoundedHeightimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m2617getHasBoundedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m2618getHasFixedHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int i3 = (1 << (18 - i2)) - 1;
        int i4 = i2 + 15;
    ...
    public static final boolean m2619getHasFixedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m2620getMaxHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m2621getMaxWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m2622getMinHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m2623getMinWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static int m2624hashCodeimpl(long j) {
    ...
    public static final boolean m2625isZeroimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public boolean equals(Object other) {
        return m2613equalsimpl(this.value, other);
    }
    ...
    public static /* synthetic */ long m2611copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m2623getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m2621getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m2622getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m2620getMaxHeightimpl(j);
        }
        return m2610copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copyMaxDimensions-msEJaDk, reason: not valid java name */
    public static final long m2612copyMaxDimensionsmsEJaDk(long j) {
        return m2609constructorimpl(j & ConstraintsKt.MaxDimensionsAndFocusMask);
    }

    public String toString() {
        return m2626toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2626toStringimpl(long j) {
        int m2621getMaxWidthimpl = m2621getMaxWidthimpl(j);
        String valueOf = m2621getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m2621getMaxWidthimpl);
        int m2620getMaxHeightimpl = m2620getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m2623getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m2622getMinHeightimpl(j) + ", maxHeight = " + (m2620getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(m2620getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ long m2628restrictConstraintsxF2OJ5Q$default(Companion companion, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
            if ((i5 & 16) != 0) {
                z = true;
            }
            return companion.m2634restrictConstraintsxF2OJ5Q(i, i2, i3, i4, z);
        }
        ...
        public final long m2634restrictConstraintsxF2OJ5Q(int minWidth, int maxWidth, int minHeight, int maxHeight, boolean prioritizeWidth) {
            if (prioritizeWidth) {
                return m2630fitPrioritizingWidthZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
            }
            return m2629fitPrioritizingHeightZbe2FdA(minWidth, maxWidth, minHeight, maxHeight);
        }

        /* renamed from: fitPrioritizingWidth-Zbe2FdA, reason: not valid java name */
        public final long m2630fitPrioritizingWidthZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int i = 262142;
        ...
        public final long m2629fitPrioritizingHeightZbe2FdA(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            int i = 262142;
        ...
        public final long m2631fixedJhjzzOo(int width, int height) {
            if (!((height >= 0) & (width >= 0))) {
        ...
        public final long m2633fixedWidthOenEA2s(int width) {
            if (!(width >= 0)) {
        ...
        public final long m2632fixedHeightOenEA2s(int height) {
            if (!(height >= 0)) {
    ...
    public static final long m2610copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
