...
public final class Placeholder {
    ...
    public static /* synthetic */ Placeholder m2009copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m2010copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m2010copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m2871equalsimpl0(this.width, placeholder.width) && TextUnit.m2871equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m2017equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m2875hashCodeimpl(this.width) * 31) + TextUnit.m2875hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m2018hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m2881toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m2881toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m2019toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
