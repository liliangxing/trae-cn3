...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m2418toAndroidJoinWw9F2mQ(this.drawStyle.getJoin-LxFBmk8()));
            textPaint.setStrokeCap(DrawStyleSpan_androidKt.m2417toAndroidCapBeK7IIE(this.drawStyle.getCap-KaPHkGw()));
