...
import androidx.compose.p001ui.text.AndroidParagraph;
import androidx.compose.p001ui.text.AnnotatedString;
import androidx.compose.p001ui.text.Paragraph;
import androidx.compose.p001ui.text.ParagraphIntrinsics;
import androidx.compose.p001ui.text.ParagraphKt;
...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z, float f, Density density, Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(androidParagraphIntrinsics, i, z ? companion.m2603getEllipsisgIe3tQ8() : companion.m2602getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f), 0, 0, 13, null), null);
    }

    /* renamed from: ActualParagraph-XGqx6AY, reason: not valid java name */
    public static final Paragraph m2389ActualParagraphXGqx6AY(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, int i2, long j, Density density, FontFamily.Resolver resolver) {
    ...
    public static final Paragraph m2388ActualParagraph4FmOz70(ParagraphIntrinsics paragraphIntrinsics, int i, int i2, long j) {
