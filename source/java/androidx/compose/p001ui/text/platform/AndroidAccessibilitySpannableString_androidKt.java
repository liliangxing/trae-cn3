...
import androidx.compose.p001ui.text.TtsAnnotation;
import androidx.compose.p001ui.text.UrlAnnotation;
...
import androidx.compose.p001ui.text.platform.extensions.TtsAnnotationExtensions_androidKt;
...
public final class AndroidAccessibilitySpannableString_androidKt {
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m2410setColorRPmYEkk(spannableString2, spanStyle.m2062getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m2411setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m2186getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m2240unboximpl() : FontStyle.INSTANCE.m2244getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.m2206resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m2254getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m2408setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
