...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo2380getNativeTypefacePYhJU0U(FontWeight fontWeight, int fontStyle, int synthesis) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m2186getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m2237equalsimpl0(fontStyle, FontStyle.INSTANCE.m2243getItalic_LCdwA()));
    }
}
