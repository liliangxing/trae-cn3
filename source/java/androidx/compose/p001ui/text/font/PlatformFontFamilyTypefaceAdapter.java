...
import androidx.compose.p001ui.text.platform.AndroidTypeface;
...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        Typeface mo2264createDefaultFO1MlWM;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            mo2264createDefaultFO1MlWM = this.platformTypefaceResolver.mo2264createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m2282getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo2264createDefaultFO1MlWM = this.platformTypefaceResolver.mo2265createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m2282getFontStyle_LCdwA());
        } else {
            ...
            mo2264createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo2380getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m2282getFontStyle_LCdwA(), typefaceRequest.m2283getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo2264createDefaultFO1MlWM, false, 2, null);
    }
}
