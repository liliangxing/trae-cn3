...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m2186getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m2237equalsimpl0(i, FontStyle.INSTANCE.m2243getItalic_LCdwA()));
    }
}
