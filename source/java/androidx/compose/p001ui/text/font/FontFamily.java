...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo2207resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis);

        /* renamed from: resolve-DPcqOEQ$default, reason: not valid java name */
        static /* synthetic */ State m2206resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
            if (obj != null) {
            ...
            if ((i3 & 8) != 0) {
                i2 = FontSynthesis.INSTANCE.m2254getAllGVVA2EU();
            }
            return resolver.mo2207resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        }
    }
