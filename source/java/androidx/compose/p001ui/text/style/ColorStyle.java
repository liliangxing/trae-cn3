...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m2436copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m2438copy8_81llA(j);
    }
    ...
    public final ColorStyle m2438copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.equals-impl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.toString-impl(this.value)) + ')';
    }
    ...
    public final long m2439getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.getAlpha-impl(mo2435getColor0d7_KjU());
    }
}
