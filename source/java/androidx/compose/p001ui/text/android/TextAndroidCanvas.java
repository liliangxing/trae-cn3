...
public final class TextAndroidCanvas extends Canvas {
    ...
    private final Canvas getNativeCanvas() {
        ...
        throw new IllegalStateException("Text drawing wrapper is missing a Canvas!".toString());
    }
