...
public final class InputMethodManagerImpl implements InputMethodManager {
    ...
    private final Lazy imm = LazyKt.lazy(LazyThreadSafetyMode.NONE, new Function0<InputMethodManager>() { // from class: androidx.compose.ui.text.input.InputMethodManagerImpl$imm$2
        ...
        public final InputMethodManager m2325invoke() {
            View view;
    ...
    @Override // androidx.compose.p001ui.text.input.InputMethodManager
