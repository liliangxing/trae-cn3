...
public class TextInputService {
    ...
    public void stopInput(TextInputSession session) {
        if (UByte$.ExternalSyntheticBackport0.m(this._currentInputSession, session, (Object) null)) {
