...
import androidx.compose.p001ui.text.android.selection.WordBoundary_androidKt;
import androidx.compose.p001ui.text.android.selection.WordIterator;
...
import androidx.compose.p001ui.text.platform.AndroidParagraphHelper_androidKt;
import androidx.compose.p001ui.text.platform.AndroidParagraphIntrinsics;
...
public final class AndroidParagraph implements Paragraph {
    ...
    /* JADX WARN: Failed to find 'out' block for switch in B:76:0x02bf. Please report as an issue. */
    ...
    */
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, int i2, long j) {
        ...
        this.overflow = i2;
        this.constraints = j;
        if ((Constraints.m2622getMinHeightimpl(j) == 0 && Constraints.m2623getMinWidthimpl(j) == 0) == false) {
        ...
        if (AndroidParagraph_androidKt.access$shouldAttachIndentationFixSpan(style, TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2603getEllipsisgIe3tQ8()))) {
        ...
        int m1918access$toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m1918access$toLayoutAlignaXe7zB0(style.m2163getTextAligne0LSkKk());
        boolean m2545equalsimpl0 = TextAlign.m2545equalsimpl0(style.m2163getTextAligne0LSkKk(), TextAlign.INSTANCE.m2551getJustifye0LSkKk());
        int m1920access$toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m1920access$toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int m1919access$toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m1919access$toLayoutBreakStrategyxImikfE(LineBreak.m2457getStrategyfcGXIks(style.m2160getLineBreakrAG3T2k()));
        int m1921access$toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m1921access$toLayoutLineBreakStylehpcqdu8(LineBreak.m2458getStrictnessusljTpc(style.m2160getLineBreakrAG3T2k()));
        int m1922access$toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m1922access$toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m2459getWordBreakjp8hJ3c(style.m2160getLineBreakrAG3T2k()));
        if (TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2603getEllipsisgIe3tQ8())) {
            truncateAt2 = TextUtils.TruncateAt.END;
        } else if (TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2604getMiddleEllipsisgIe3tQ8())) {
            truncateAt2 = TextUtils.TruncateAt.MIDDLE;
        } else {
            if (!TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2605getStartEllipsisgIe3tQ8())) {
                truncateAt = null;
                TextLayout constructTextLayout$default = constructTextLayout$default(this, m1918access$toLayoutAlignaXe7zB0, m2545equalsimpl0 ? 1 : 0, truncateAt, i, m1920access$toLayoutHyphenationFrequency3fSNIE, m1919access$toLayoutBreakStrategyxImikfE, m1921access$toLayoutLineBreakStylehpcqdu8, m1922access$toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
                if (Build.VERSION.SDK_INT < 35) {
                    if (!(getTextPaint$ui_text().getLetterSpacing() == 0.0f) && ((TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2605getStartEllipsisgIe3tQ8()) || TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2604getMiddleEllipsisgIe3tQ8())) && constructTextLayout$default.getLineEllipsisCount(0) > 0)) {
                        int lineEllipsisOffset = constructTextLayout$default.getLineEllipsisOffset(0);
                        i3 = 1;
                        constructTextLayout$default = constructTextLayout(m1918access$toLayoutAlignaXe7zB0, m2545equalsimpl0 ? 1 : 0, truncateAt, i, m1920access$toLayoutHyphenationFrequency3fSNIE, m1919access$toLayoutBreakStrategyxImikfE, m1921access$toLayoutLineBreakStylehpcqdu8, m1922access$toLayoutLineBreakWordStylewPN0Rpw, TextUtils.concat(charSequence3.subSequence(0, lineEllipsisOffset), "…", charSequence3.subSequence(constructTextLayout$default.getLineEllipsisCount(0) + lineEllipsisOffset, charSequence3.length())));
                        if (!TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2603getEllipsisgIe3tQ8()) && constructTextLayout$default.getHeight() > Constraints.m2620getMaxHeightimpl(j) && i > i3) {
                            int access$numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.access$numberOfLinesThatFitMaxHeight(constructTextLayout$default, Constraints.m2620getMaxHeightimpl(j));
                            if (access$numberOfLinesThatFitMaxHeight < 0 || access$numberOfLinesThatFitMaxHeight == i) {
                                i4 = 2;
                            } else {
                                i4 = 2;
                                constructTextLayout$default = constructTextLayout$default(this, m1918access$toLayoutAlignaXe7zB0, m2545equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(access$numberOfLinesThatFitMaxHeight, i3), m1920access$toLayoutHyphenationFrequency3fSNIE, m1919access$toLayoutBreakStrategyxImikfE, m1921access$toLayoutLineBreakStylehpcqdu8, m1922access$toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
                            }
                            this.layout = constructTextLayout$default;
                        } else {
                            i4 = 2;
                            this.layout = constructTextLayout$default;
                        }
                        getTextPaint$ui_text().m2395setBrush12SF9DM(style.getBrush(), Size.constructor-impl((Float.floatToRawIntBits(getHeight()) & 4294967295L) | (Float.floatToRawIntBits(getWidth()) << 32)), style.getAlpha());
                        ...
                        if (shaderBrushSpans != null) {
                            ...
                            while (it.hasNext()) {
                                ((ShaderBrushSpan) it.next()).m2420setSizeuvyYCjk(Size.constructor-impl((Float.floatToRawIntBits(getHeight()) & 4294967295L) | (Float.floatToRawIntBits(getWidth()) << 32)));
                            }
                        }
                        ...
                        if (charSequence2 instanceof Spanned) {
                            ...
                            for (Object obj : spans) {
                                ...
                                boolean z = lineForOffset >= this.maxLines;
                                boolean z2 = this.layout.getLineEllipsisCount(lineForOffset) > 0 && spanEnd > this.layout.getLineStart(lineForOffset) + this.layout.getLineEllipsisOffset(lineForOffset);
                                boolean z3 = spanEnd > this.layout.getLineEnd(lineForOffset);
                                if (z2 || z3 || z) {
                                    rect = null;
                                } else {
                                    int i5 = WhenMappings.$EnumSwitchMapping$0[getBidiRunDirection(spanStart).ordinal()];
                                    if (i5 == 1) {
                                    ...
                                    switch (placeholderSpan.getVerticalAlign()) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            lineTop = ((textLayout.getLineTop(lineForOffset) + textLayout.getLineBottom(lineForOffset)) - placeholderSpan.getHeightPx()) / i4;
                                            rect = new Rect(horizontalPosition, lineTop, widthPx, placeholderSpan.getHeightPx() + lineTop);
                                            break;
                                        case 4:
                                        ...
                                        case 6:
                                            ...
                                            f = ((fontMetrics.ascent + fontMetrics.descent) - placeholderSpan.getHeightPx()) / i4;
                                            lineBaseline2 = textLayout.getLineBaseline(lineForOffset);
                                            lineTop = f + lineBaseline2;
                                            rect = new Rect(horizontalPosition, lineTop, widthPx, placeholderSpan.getHeightPx() + lineTop);
                                            break;
        ...
        TextLayout constructTextLayout$default2 = constructTextLayout$default(this, m1918access$toLayoutAlignaXe7zB0, m2545equalsimpl0 ? 1 : 0, truncateAt, i, m1920access$toLayoutHyphenationFrequency3fSNIE, m1919access$toLayoutBreakStrategyxImikfE, m1921access$toLayoutLineBreakStylehpcqdu8, m1922access$toLayoutLineBreakWordStylewPN0Rpw, null, 256, null);
        if (Build.VERSION.SDK_INT < 35) {
        }
        i3 = 1;
        if (!TextOverflow.m2593equalsimpl0(i2, TextOverflow.INSTANCE.m2603getEllipsisgIe3tQ8())) {
        ...
        i4 = 2;
        this.layout = constructTextLayout$default2;
        getTextPaint$ui_text().m2395setBrush12SF9DM(style.getBrush(), Size.constructor-impl((Float.floatToRawIntBits(getHeight()) & 4294967295L) | (Float.floatToRawIntBits(getWidth()) << 32)), style.getAlpha());
        shaderBrushSpans = getShaderBrushSpans(this.layout);
        if (shaderBrushSpans != null) {
        }
    ...
    @Override // androidx.compose.p001ui.text.Paragraph
    public float getWidth() {
        return Constraints.m2621getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo1911getOffsetForPositionk4lQ0M(long position) {
    ...
    public long mo1913getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m1923access$toLayoutTextGranularityduNsdkg(granularity), new Function2() { // from class: androidx.compose.ui.text.AndroidParagraph$$ExternalSyntheticLambda0
    ...
    public void mo1909fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m2120getMinimpl(range), TextRange.m2119getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo1914getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo1916paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        textPaint$ui_text.m2397setColor8_81llA(color);
    ...
    public void mo1915paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text.m2394setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text().m2394setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.p001ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo1917painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        float width = getWidth();
        float height = getHeight();
        textPaint$ui_text.m2395setBrush12SF9DM(brush, Size.constructor-impl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), alpha);
        textPaint$ui_text.setShadow(shadow);
        textPaint$ui_text.setTextDecoration(textDecoration);
        textPaint$ui_text.setDrawStyle(drawStyle);
        textPaint$ui_text.m2394setBlendModes9anfk8(blendMode);
