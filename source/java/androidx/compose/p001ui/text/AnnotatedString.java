...
public final class AnnotatedString implements CharSequence {
    ...
    public AnnotatedString(List<? extends Range<? extends Annotation>> list, String str) {
        ...
        IntList mutableIntListOf = IntListKt.mutableIntListOf(((Range) CollectionsKt.first(sortedWith)).getEnd());
        int size2 = sortedWith.size();
        for (int i2 = 1; i2 < size2; i2++) {
            Range range2 = (Range) sortedWith.get(i2);
            while (true) {
                IntList intList = mutableIntListOf;
                if (!(intList._size != 0)) {
                    break;
                }
                int last = mutableIntListOf.last();
                if (range2.getStart() >= last) {
                    mutableIntListOf.removeAt(intList._size - 1);
    ...
    */
    ...
    public final AnnotatedString m1930subSequence5zctL8(long range) {
        return subSequence(TextRange.m2120getMinimpl(range), TextRange.m2119getMaximpl(range));
    }
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addStringAnnotation(String tag, String annotation, int start, int end) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m2070boximpl(StringAnnotation.m2071constructorimpl(annotation)), start, end, tag));
        }
        ...
        public final void m1932addBulletr9BaKPg(Bullet bullet, long indentation, int start, int end) {
            DefaultConstructorMarker defaultConstructorMarker = null;
            PlatformParagraphStyle platformParagraphStyle = null;
            this.annotations.add(new MutableRange<>(new ParagraphStyle(0, 0, 0L, new TextIndent(indentation, indentation, defaultConstructorMarker), platformParagraphStyle, (LineHeightStyle) null, 0, 0, (TextMotion) defaultConstructorMarker, HttpStatus.SC_SERVICE_UNAVAILABLE, (DefaultConstructorMarker) null), start, end, null, 8, platformParagraphStyle));
            this.annotations.add(new MutableRange<>(bullet, start, end, null, 8, null));
        }
        ...
        public static /* synthetic */ Object m1931withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.INSTANCE.m1940getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.INSTANCE.getDefault();
            }
            return builder.m1933withBulletListo2QH7mI(j, bullet, function1);
        }
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public final <R> R m1933withBulletListo2QH7mI(long indentation, Bullet bullet, Function1<? super BulletScope, ? extends R> block) {
            long j;
            int pushStyle;
            ...
            try {
                if (pair != null) {
                    ...
                    if (!TextUnitType.m2902equalsimpl0(TextUnit.m2873getTypeUIouoOA(packedValue), TextUnit.m2873getTypeUIouoOA(indentation))) {
                        InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m2881toStringimpl(packedValue)) + " and previous is " + ((Object) TextUnit.m2881toStringimpl(indentation)));
                    }
                    long m2873getTypeUIouoOA = TextUnit.m2873getTypeUIouoOA(indentation);
                    if (TextUnitType.m2902equalsimpl0(m2873getTypeUIouoOA, TextUnitType.INSTANCE.m2907getSpUIouoOA())) {
                        j = TextUnitKt.getSp(TextUnit.m2874getValueimpl(indentation) + TextUnit.m2874getValueimpl(packedValue));
                    } else if (TextUnitType.m2902equalsimpl0(m2873getTypeUIouoOA, TextUnitType.INSTANCE.m2906getEmUIouoOA())) {
                        j = TextUnitKt.getEm(TextUnit.m2874getValueimpl(indentation) + TextUnit.m2874getValueimpl(packedValue));
                    }
                    pushStyle = pushStyle(new ParagraphStyle(0, 0, 0L, new TextIndent(j, j, null), (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, HttpStatus.SC_SERVICE_UNAVAILABLE, (DefaultConstructorMarker) null));
                    this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m2864boximpl(j), bullet));
                    return (R) block.invoke(this.bulletScope);
                }
                return (R) block.invoke(this.bulletScope);
            } finally {
        ...
        public final <R> R withBulletListItem(BulletScope bulletScope, Bullet bullet, Function1<? super Builder, ? extends R> function1) {
            Bullet bullet2;
            Pair pair = (Pair) CollectionsKt.lastOrNull(bulletScope.getBulletListSettingStack$ui_text());
            long packedValue = pair != null ? ((TextUnit) pair.getFirst()).getPackedValue() : Bullet.INSTANCE.m1940getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
            } else if (pair == null || (bullet2 = (Bullet) pair.getSecond()) == null) {
                bullet2 = Bullet.INSTANCE.getDefault();
            }
            int pushStyle = bulletScope.getBuilder().pushStyle(new ParagraphStyle(0, 0, 0L, new TextIndent(packedValue, packedValue, null), (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, HttpStatus.SC_SERVICE_UNAVAILABLE, (DefaultConstructorMarker) null));
            int pushBullet = bulletScope.getBuilder().pushBullet(bullet2);
            try {
                return (R) function1.invoke(bulletScope.getBuilder());
            } finally {
                bulletScope.getBuilder().pop(pushBullet);
                bulletScope.getBuilder().pop(pushStyle);
            }
        }

        public final int pushStringAnnotation(String tag, String annotation) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m2070boximpl(StringAnnotation.m2071constructorimpl(annotation)), this.text.length(), 0, tag, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
        ...
        public final void mapAnnotations$ui_text(Function1<? super Range<? extends Annotation>, ? extends Range<? extends Annotation>> transform) {
            ...
            for (int i = 0; i < size; i++) {
                this.annotations.set(i, MutableRange.INSTANCE.fromRange((Range) transform.invoke(MutableRange.toRange$default(this.annotations.get(i), 0, 1, null))));
            }
        }
        ...
        public final void flatMapAnnotations$ui_text(Function1<? super Range<? extends Annotation>, ? extends List<? extends Range<? extends Annotation>>> transform) {
            ...
            int size = list.size();
            for (int i = 0; i < size; i++) {
                List list2 = (List) transform.invoke(MutableRange.toRange$default(list.get(i), 0, 1, null));
                ArrayList arrayList2 = new ArrayList(list2.size());
                int size2 = list2.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    arrayList2.add(MutableRange.INSTANCE.fromRange((Range) list2.get(i2)));
                }
