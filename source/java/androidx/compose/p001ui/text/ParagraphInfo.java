...
public final /* data */ class ParagraphInfo {
    ...
    public final Rect toGlobal(Rect rect) {
        float f = this.top;
        return rect.translate-k-4lQ0M(Offset.constructor-impl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
    }
    ...
    public final Path toGlobal(Path path) {
        float f = this.top;
        path.translate-k-4lQ0M(Offset.constructor-impl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m1974toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m1975toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m1975toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m2115equalsimpl0(j, TextRange.INSTANCE.m2127getZerod9O1mEE())) {
            return TextRange.INSTANCE.m2127getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m2122getStartimpl(j)), toGlobalIndex(TextRange.m2117getEndimpl(j)));
    }

    /* renamed from: toLocal-MK-Hz9U, reason: not valid java name */
    public final long m1976toLocalMKHz9U(long j) {
