...
public final class SemanticsConfiguration implements SemanticsPropertyReceiver, Iterable<Map.Entry<? extends SemanticsPropertyKey<?>, ? extends Object>>, KMappedMarker {
    ...
    @Override // androidx.compose.p001ui.semantics.SemanticsPropertyReceiver
    ...
    public final boolean containsImportantForAccessibility$ui_release() {
        ScatterMap scatterMap = this.props;
    ...
    public final void mergeChild$ui_release(SemanticsConfiguration child) {
        ScatterMap scatterMap = child.props;
        Object[] objArr = scatterMap.keys;
        Object[] objArr2 = scatterMap.values;
        long[] jArr = scatterMap.metadata;
        int length = jArr.length - 2;
    ...
    public final void collapsePeer$ui_release(SemanticsConfiguration peer) {
        ...
        ScatterMap scatterMap = peer.props;
        Object[] objArr = scatterMap.keys;
        Object[] objArr2 = scatterMap.values;
        long[] jArr = scatterMap.metadata;
        int length = jArr.length - 2;
