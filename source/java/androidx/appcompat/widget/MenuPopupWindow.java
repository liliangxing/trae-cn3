    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                SupportMenuItem item = (motionEvent.getAction() == 10 || (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (i2 = pointToPosition - i) < 0 || i2 >= menuAdapter.getCount()) ? null : menuAdapter.getItem(i2);
                SupportMenuItem supportMenuItem = this.mHoveredMenuItem;
                if (supportMenuItem != item) {
                    MenuBuilder adapterMenu = menuAdapter.getAdapterMenu();
                    if (supportMenuItem != null) {
                        this.mHoverListener.onItemHoverExit(adapterMenu, supportMenuItem);
                    }
