...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0064R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0064R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0064R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ActivityInfo activityInfo = packageManager.getActivityInfo(componentName, Fields.SpotShadowColor);
