...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0064R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        boolean z = (i & 4) == 0;
        boolean z2 = (i & Fields.RotationX) != 0;
        ...
        if ((i2 & Fields.RotationX) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean z = (ViewCompat.getWindowSystemUiVisibility(this) & Fields.RotationX) != 0;
        if (z) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0064R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0064R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0064R.id.action_bar));
        }
    }
