...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
    class C00771 implements Thread.UncaughtExceptionHandler {
        final /* synthetic */ Thread.UncaughtExceptionHandler val$defHandler;

        C00771(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private AppCompatDelegateImpl(Context context, Window window, AppCompatCallback appCompatCallback, Object obj) {
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.2
            ...
            public void run() {
                ...
                if ((AppCompatDelegateImpl.this.mInvalidatePanelMenuFeatures & Fields.TransformOrigin) != 0) {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0064R.style.Theme_AppCompat_Empty);
    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0064R.styleable.AppCompatTheme);
        if (!obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowActionBar)) {
            obtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (obtainStyledAttributes.getBoolean(C0064R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (obtainStyledAttributes.getBoolean(C0064R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (obtainStyledAttributes.getBoolean(C0064R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (obtainStyledAttributes.getBoolean(C0064R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = obtainStyledAttributes.getBoolean(C0064R.styleable.AppCompatTheme_android_windowIsFloating, false);
        obtainStyledAttributes.recycle();
        ensureWindow();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0064R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0064R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0064R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0064R.id.decor_content_parent);
            ...
            viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0064R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0064R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (viewGroup == null) {
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C0064R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0064R.id.action_bar_activity_content);
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes.dex */
    class C00804 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        C00804() {
        }
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0064R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0064R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    */
            ...
            if (actionMode == null) {
                ...
                if (this.mActionModeView == null) {
                    if (this.mIsFloating) {
                        ...
                        theme.resolveAttribute(C0064R.attr.actionBarTheme, typedValue, true);
                        if (typedValue.resourceId != 0) {
                        ...
                        PopupWindow popupWindow = new PopupWindow(context, (AttributeSet) null, C0064R.attr.actionModePopupWindowStyle);
                        this.mActionModePopup = popupWindow;
                        PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                        this.mActionModePopup.setContentView(this.mActionModeView);
                        this.mActionModePopup.setWidth(-1);
                        context.getTheme().resolveAttribute(C0064R.attr.actionBarSize, typedValue, true);
                        ...
                        ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0064R.id.action_mode_bar_stub);
    ...
    boolean onKeyDown(int i, KeyEvent keyEvent) {
        if (i == 4) {
            this.mLongPressBackDown = (keyEvent.getFlags() & Fields.SpotShadowColor) != 0;
        } else if (i == 82) {
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0064R.styleable.AppCompatTheme);
            String string = obtainStyledAttributes.getString(C0064R.styleable.AppCompatTheme_viewInflaterClass);
            obtainStyledAttributes.recycle();
            if (string == null) {
    ...
    private AppCompatActivity tryUnwrapContext() {
        for (Object obj = this.mContext; obj != null; obj = ((ContextWrapper) obj).getBaseContext()) {
    ...
    */
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme2.resolveAttribute(C0064R.attr.actionBarTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                theme = context.getResources().newTheme();
                theme.setTo(theme2);
                theme.applyStyle(typedValue.resourceId, true);
                theme.resolveAttribute(C0064R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme2.resolveAttribute(C0064R.attr.actionBarWidgetTheme, typedValue, true);
                theme = null;
            }
            if (typedValue.resourceId != 0) {
                if (theme == null) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r4v3, types: [androidx.appcompat.app.AppCompatDelegateImpl$AppCompatWindowCallback] */
    ...
    private void updateStatusGuardColor(View view) {
        int color;
        if ((ViewCompat.getWindowSystemUiVisibility(view) & Fields.Shape) != 0) {
            color = ContextCompat.getColor(this.mContext, C0064R.color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0064R.color.abc_decor_view_status_guard);
        }
    ...
    */
    ...
    private void updateActivityConfiguration(Configuration configuration) {
        LifecycleOwner lifecycleOwner = (Activity) this.mHost;
        if (lifecycleOwner instanceof LifecycleOwner) {
            if (lifecycleOwner.getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.CREATED)) {
                lifecycleOwner.onConfigurationChanged(configuration);
            }
        } else {
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            ...
            PanelFeatureState findMenuPanel = appCompatDelegateImpl.findMenuPanel(supportMenu);
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0064R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0064R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0064R.style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0064R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0064R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0064R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0064R.layout.abc_list_menu_item_layout);
    ...
    public abstract class AutoNightModeManager {
        ...
        void setup() {
            ...
            m4x98a5421f(AppCompatDelegateImpl.this.mContext, this.mReceiver, createIntentFilterForBroadcastReceiver);
        }

        void cleanup() {
            if (this.mReceiver != null) {
                try {
                    m5xe92a9778(AppCompatDelegateImpl.this.mContext, this.mReceiver);
                } catch (IllegalArgumentException unused) {
                }
                this.mReceiver = null;
            }
        ...
        /* renamed from: INVOKEVIRTUAL_androidx_appcompat_app_AppCompatDelegateImpl$AutoNightModeManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver */
        public static Intent m4x98a5421f(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        ...
        @TargetClass(scope = Scope.ALL_SELF, value = "android.content.Context")
        /* renamed from: INVOKEVIRTUAL_androidx_appcompat_app_AppCompatDelegateImpl$AutoNightModeManager_com_bytedance_sysoptimizer_ReceiverRegisterLancet_unregisterReceiver */
        public static void m5xe92a9778(Context context, BroadcastReceiver broadcastReceiver) {
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0064R.attr.homeAsUpIndicator});
