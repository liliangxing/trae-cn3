...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f1354l == hSSPrivateKeyParameters.f1354l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            ...
            long j2 = this.index;
            this.index = j + j2;
            makeCopy = makeCopy(new HSSPrivateKeyParameters(this.f1354l, new ArrayList(getKeys()), new ArrayList(getSig()), j2, j2 + j, true));
            resetKeyToIndex();
        }
        return makeCopy;
    }
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        bool = Composer.compose().u32str(0).u32str(this.f1354l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f1354l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        int hashCode = ((((((this.f1354l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31;
    ...
    */
    void resetKeyToIndex() {
        ...
        while (i < size) {
            ...
            if (i >= size - 1) {
                if (jArr[i] != lMSPrivateKeyParametersArr[i].getIndex()) {
                    z2 = false;
                }
                z2 = true;
            }
