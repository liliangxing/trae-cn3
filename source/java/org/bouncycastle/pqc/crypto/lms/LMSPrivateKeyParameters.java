...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    /* renamed from: T1 */
    private static CacheKey f1368T1;
    private static CacheKey[] internedKeys;

    /* renamed from: I */
    private final byte[] f1369I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f1370q = i;
        this.f1369I = lMSPrivateKeyParameters.f1369I;
        this.maxQ = i2;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f1370q != lMSPrivateKeyParameters.f1370q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f1369I, lMSPrivateKeyParameters.f1369I)) {
            return false;
        }
    ...
    public LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            if (this.f1370q >= this.maxQ) {
                throw new ExhaustedPrivateKeyException("ots private keys expired");
            }
            lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f1369I, this.f1370q, this.masterSecret);
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f1369I).u32str(this.f1370q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f1369I);
    }
    ...
    public LMSPublicKeyParameters getPublicKey() {
        ...
        synchronized (this) {
            if (this.publicKey == null) {
                this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f1368T1), this.f1369I);
            }
    ...
    public long getUsagesRemaining() {
        return this.maxQ - this.f1370q;
    }

    public int hashCode() {
        int hashCode = ((this.f1370q * 31) + Arrays.hashCode(this.f1369I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
