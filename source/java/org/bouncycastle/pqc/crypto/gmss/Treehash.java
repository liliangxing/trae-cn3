...
public class Treehash {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.tailLength + 3; i2++) {
            str = (getStatByte()[i2] != null ? new StringBuilder().append(str).append(new String(Hex.encode(getStatByte()[i2]))).append(" ") : new StringBuilder().append(str).append("null ")).toString();
        }
