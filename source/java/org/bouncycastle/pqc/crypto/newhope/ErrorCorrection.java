...
class ErrorCorrection {
    ...
    static int f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
        int i5 = i4 - ((12288 - (i3 - (i4 * MessageConstant.CommandId.COMMAND_REGISTER))) >> 31);
        iArr[i] = (i5 >> 1) + (i5 & 1);
        int i6 = i5 - 1;
        iArr[i2] = (i6 >> 1) + (i6 & 1);
        return abs(i3 - ((iArr[i] * 2) * MessageConstant.CommandId.COMMAND_REGISTER));
    }
    ...
    public static void rec(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i5 = i + 768;
            short s = sArr2[i5];
            int i6 = i3 - ((i4 + s) * MessageConstant.CommandId.COMMAND_REGISTER);
            int i7 = i + 256;
            int i8 = ((sArr[i7] * 8) + 196624) - (((sArr2[i7] * 2) + s) * MessageConstant.CommandId.COMMAND_REGISTER);
            int i9 = i + 512;
            int i10 = ((sArr[i9] * 8) + 196624) - (((sArr2[i9] * 2) + s) * MessageConstant.CommandId.COMMAND_REGISTER);
