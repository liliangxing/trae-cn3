...
public class DefaultSecretKeySizeProvider implements SecretKeySizeProvider {
    ...
    static {
        ...
        hashMap.put(PKCSObjectIdentifiers.id_alg_CMS3DESwrap, Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashMap.put(NISTObjectIdentifiers.id_aes192_GCM, Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashMap.put(NISTObjectIdentifiers.id_aes192_CCM, Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashMap.put(NISTObjectIdentifiers.id_aes192_wrap, Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashMap.put(NISTObjectIdentifiers.id_aes192_wrap_pad, Integers.valueOf(CertificateHolderAuthorization.CVCA));
        ...
        hashMap.put(NTTObjectIdentifiers.id_camellia192_wrap, Integers.valueOf(CertificateHolderAuthorization.CVCA));
