...
public class LongArray implements Cloneable {
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i4 >>> 8;
            i = i6 == 0 ? bitLengths[i4] + Tnaf.POW_2_WIDTH : bitLengths[i6] + 24;
        }
        return i2 + i;
    }
