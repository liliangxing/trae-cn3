...
public class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger subtract;
        BigInteger multiply = zTauElement.f1204u.multiply(zTauElement.f1204u);
        BigInteger multiply2 = zTauElement.f1204u.multiply(zTauElement.f1205v);
        BigInteger shiftLeft = zTauElement.f1205v.multiply(zTauElement.f1205v).shiftLeft(1);
        if (b == 1) {
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f1204u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(round.f1205v)), bigIntegerArr[1].multiply(round.f1204u).subtract(bigIntegerArr[0].multiply(round.f1205v)));
    }
    ...
    */
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        BigInteger bigInteger = zTauElement.f1204u;
        BigInteger bigInteger2 = zTauElement.f1205v;
        int i = 0;
        int i2 = 0;
        while (true) {
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger shiftRight = bigInteger.shiftRight(1);
        BigInteger bigInteger3 = zTauElement.f1204u;
        BigInteger bigInteger4 = zTauElement.f1205v;
        int i = 0;
        while (true) {
            ...
            if (bigInteger3.testBit(0)) {
                ...
                if (z) {
                    bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].f1204u);
                    bigInteger4 = bigInteger4.subtract(zTauElementArr[intValue].f1205v);
                } else {
                    bigInteger3 = bigInteger3.add(zTauElementArr[intValue].f1204u);
                    bigInteger4 = bigInteger4.add(zTauElementArr[intValue].f1205v);
                }
            } else {
                bArr[i] = 0;
            }
