...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f1186a;

    /* renamed from: b */
    protected ECFieldElement f1187b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public synchronized BigInteger[] getSi() {
            if (this.f1188si == null) {
                this.f1188si = Tnaf.getSi(this);
            }
            return this.f1188si;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f1187b.isOne() && (this.f1186a.isZero() || this.f1186a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f1186a).multiply(fromBigInteger).add(this.f1187b).sqrt();
            if (sqrt == null) {
                throw new IllegalArgumentException("Invalid point compression");
            }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f1186a = fromBigInteger(bigInteger);
            this.f1187b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f1186a = eCFieldElement;
            this.f1187b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.f1192m, this.f1189k1, this.f1190k2, this.f1191k3, this.f1186a, this.f1187b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
            final int i3 = (this.f1192m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f1189k1} : new int[]{this.f1189k1, this.f1190k2, this.f1191k3};
            final long[] jArr = new long[i2 * i3 * 2];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f1197x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f1197x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.ECCurve.F2m.1
                private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f1192m, iArr, new LongArray(jArr2)), new ECFieldElement.F2m(F2m.this.f1192m, iArr, new LongArray(jArr3)));
                }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f1192m, this.f1189k1, this.f1190k2, this.f1191k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f1190k2 == 0 && this.f1191k3 == 0;
        }
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    public static class C0563Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C0566Fp infinity;
        ...
        public C0563Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, null, null);
        }

        public C0563Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f1193q = bigInteger;
            this.f1194r = ECFieldElement.C0564Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C0566Fp(this, null, null);
            this.f1186a = fromBigInteger(bigInteger2);
            this.f1187b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C0563Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f1193q = bigInteger;
            this.f1194r = bigInteger2;
            this.infinity = new ECPoint.C0566Fp(this, null, null);
            this.f1186a = eCFieldElement;
            this.f1187b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        @Override // org.bouncycastle.math.ec.ECCurve
        protected ECCurve cloneCurve() {
            return new C0563Fp(this.f1193q, this.f1194r, this.f1186a, this.f1187b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C0566Fp(this, eCFieldElement, eCFieldElement2);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C0566Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C0564Fp(this.f1193q, this.f1194r, bigInteger);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        public int getFieldSize() {
            return this.f1193q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.C0566Fp(this, fromBigInteger(eCPoint.f1201x.toBigInteger()), fromBigInteger(eCPoint.f1202y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f1203zs[0].toBigInteger())});
        }
