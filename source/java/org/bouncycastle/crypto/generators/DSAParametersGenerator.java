...
public class DSAParametersGenerator {
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (subtract.bitLength() == this.f923L && isProbablePrime(subtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f924N / 8];
        int i2 = this.f923L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f924N - 1)).setBit(0).setBit(this.f924N - 1);
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f923L = i;
        this.f924N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f923L), (i2 + 1) / 2);
