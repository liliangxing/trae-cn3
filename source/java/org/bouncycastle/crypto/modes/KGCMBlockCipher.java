...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public KGCMBlockCipher(BlockCipher blockCipher) {
        ...
        this.f1000iv = new byte[blockSize];
        this.multiplier = createDefaultMultiplier(blockSize);
        this.f999b = new long[blockSize >>> 3];
        this.macBlock = null;
    }
    ...
    private void calculateMac(byte[] bArr, int i, int i2, int i3) {
        int i4 = i + i2;
        while (i < i4) {
            xorWithInput(this.f999b, bArr, i);
            this.multiplier.multiplyH(this.f999b);
            i += this.blockSize;
        }
        long j = (i3 & BodyPartID.bodyIdMax) << 3;
        long j2 = (BodyPartID.bodyIdMax & i2) << 3;
        long[] jArr = this.f999b;
        jArr[0] = j ^ jArr[0];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            byte[] bArr = this.f1000iv;
            int length = bArr.length - nonce.length;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(nonce, 0, this.f1000iv, length, nonce.length);
            ...
            byte[] bArr3 = this.f1000iv;
            int length2 = bArr3.length - iv.length;
            Arrays.fill(bArr3, (byte) 0);
            System.arraycopy(iv, 0, this.f1000iv, length2, iv.length);
            this.initialAssociatedText = null;
            this.macSize = this.blockSize;
            keyParameter = (KeyParameter) parametersWithIV.getParameters();
        }
        this.macBlock = new byte[this.blockSize];
        this.ctrEngine.init(true, new ParametersWithIV(keyParameter, this.f1000iv));
