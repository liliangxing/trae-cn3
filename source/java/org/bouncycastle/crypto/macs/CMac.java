    ...
    private static byte[] lookupPoly(int i) {
        ...
        switch (i2) {
            ...
            case 160:
                i3 = 45;
                break;
            case MediaPlayer.MEDIA_PLAYER_OPTION_CLOCK_RESUME_RESET_EOF /* 224 */:
                i3 = 777;
                break;
            case 256:
                i3 = 1061;
            ...
            case 384:
                i3 = 4109;
                break;
            case BDVideoUploaderBase.KeyIsDynamicSliceLowSize /* 448 */:
                i3 = 2129;
                break;
            case 512:
                i3 = MediaPlayer.MEDIA_PLAYER_OPTION_KEEP_FORMAT_THREAD_ALIVE;
                break;
            case 768:
                i3 = 655377;
                break;
