...
public class ThreefishEngine implements BlockCipher {
    ...
    private static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f905kw;
            long[] jArr4 = this.f906t;
        ...
        void encryptBlock(long[] jArr, long[] jArr2) {
            ...
            while (i < 20) {
                ...
                int i20 = i2 + 15;
                long j92 = i4;
                long j93 = rotlXor25 + jArr5[i20] + j92;
                long j94 = j77 + j78;
                long rotlXor33 = ThreefishEngine.rotlXor(j78, 41, j94);
                long j95 = j79 + j80;
                long rotlXor34 = ThreefishEngine.rotlXor(j80, 9, j95);
                long j96 = j81 + j82;
                long rotlXor35 = ThreefishEngine.rotlXor(j82, 37, j96);
                long j97 = j83 + j84;
                long rotlXor36 = ThreefishEngine.rotlXor(j84, 31, j97);
                long j98 = j85 + j86;
                long rotlXor37 = ThreefishEngine.rotlXor(j86, 12, j98);
                long j99 = j87 + j88;
                long rotlXor38 = ThreefishEngine.rotlXor(j88, 47, j99);
                long j100 = j89 + j90;
                long rotlXor39 = ThreefishEngine.rotlXor(j90, 44, j100);
                long j101 = j91 + j93;
                long rotlXor40 = ThreefishEngine.rotlXor(j93, 30, j101);
                long j102 = j94 + rotlXor37;
                long rotlXor41 = ThreefishEngine.rotlXor(rotlXor37, 16, j102);
                long j103 = j95 + rotlXor39;
                long rotlXor42 = ThreefishEngine.rotlXor(rotlXor39, 34, j103);
                long j104 = j97 + rotlXor38;
                long rotlXor43 = ThreefishEngine.rotlXor(rotlXor38, 56, j104);
                long j105 = j96 + rotlXor40;
                long rotlXor44 = ThreefishEngine.rotlXor(rotlXor40, 51, j105);
                long j106 = j99 + rotlXor36;
                long rotlXor45 = ThreefishEngine.rotlXor(rotlXor36, 4, j106);
                long j107 = j100 + rotlXor34;
                long rotlXor46 = ThreefishEngine.rotlXor(rotlXor34, 53, j107);
                long j108 = j101 + rotlXor35;
                long rotlXor47 = ThreefishEngine.rotlXor(rotlXor35, 42, j108);
                long j109 = j98 + rotlXor33;
                long rotlXor48 = ThreefishEngine.rotlXor(rotlXor33, 41, j109);
                long j110 = j102 + rotlXor45;
                long rotlXor49 = ThreefishEngine.rotlXor(rotlXor45, 31, j110);
                long j111 = j103 + rotlXor47;
                long rotlXor50 = ThreefishEngine.rotlXor(rotlXor47, 44, j111);
                long j112 = j105 + rotlXor46;
                long rotlXor51 = ThreefishEngine.rotlXor(rotlXor46, 47, j112);
                long j113 = j104 + rotlXor48;
                long rotlXor52 = ThreefishEngine.rotlXor(rotlXor48, 46, j113);
                long j114 = j107 + rotlXor44;
                long rotlXor53 = ThreefishEngine.rotlXor(rotlXor44, 19, j114);
                long j115 = j108 + rotlXor42;
                long rotlXor54 = ThreefishEngine.rotlXor(rotlXor42, 42, j115);
                long j116 = j109 + rotlXor43;
                long rotlXor55 = ThreefishEngine.rotlXor(rotlXor43, 44, j116);
                long j117 = j106 + rotlXor41;
                long rotlXor56 = ThreefishEngine.rotlXor(rotlXor41, 25, j117);
                long j118 = j110 + rotlXor53;
                long rotlXor57 = ThreefishEngine.rotlXor(rotlXor53, 9, j118);
                long j119 = j111 + rotlXor55;
                long rotlXor58 = ThreefishEngine.rotlXor(rotlXor55, 48, j119);
                long j120 = j113 + rotlXor54;
                long rotlXor59 = ThreefishEngine.rotlXor(rotlXor54, 35, j120);
                long j121 = j112 + rotlXor56;
                long rotlXor60 = ThreefishEngine.rotlXor(rotlXor56, 52, j121);
                long j122 = j115 + rotlXor52;
                long rotlXor61 = ThreefishEngine.rotlXor(rotlXor52, 23, j122);
                long j123 = j116 + rotlXor50;
                long rotlXor62 = ThreefishEngine.rotlXor(rotlXor50, 31, j123);
                long j124 = j117 + rotlXor51;
                long rotlXor63 = ThreefishEngine.rotlXor(rotlXor51, 37, j124);
                long j125 = j114 + rotlXor49;
                long rotlXor64 = ThreefishEngine.rotlXor(rotlXor49, 20, j125);
                long j126 = jArr5[i5] + j118;
                long j127 = rotlXor61 + jArr5[i6];
                long j128 = j119 + jArr5[i7];
                long j129 = rotlXor63 + jArr5[i8];
                long j130 = jArr5[i9] + j121;
                long j131 = rotlXor62 + jArr5[i10];
                ...
                j38 = rotlXor57 + jArr5[i2 + 16] + j92 + 1;
                j25 = j133;
                j33 = j131;
                j23 = j132;
                iArr2 = iArr4;
    ...
    private static final class Threefish512Cipher extends ThreefishCipher {
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            ...
            while (i2 >= i) {
                ...
                long xorRotr22 = ThreefishEngine.xorRotr(xorRotr20, ROTATION_2_1, j39);
    ...
    public static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f905kw;

        /* renamed from: t */
        protected final long[] f906t;
    ...
    public ThreefishEngine(int i) {
        ...
        this.f903kw = new long[(i3 * 2) + 1];
        if (i == 256) {
            threefish256Cipher = new Threefish256Cipher(this.f903kw, this.f904t);
        } else if (i == 512) {
            threefish256Cipher = new Threefish512Cipher(this.f903kw, this.f904t);
        } else {
            if (i != 1024) {
                throw new IllegalArgumentException("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            }
            threefish256Cipher = new Threefish1024Cipher(this.f903kw, this.f904t);
        }
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i >= i2) {
                long[] jArr2 = this.f903kw;
                jArr2[i2] = j;
                System.arraycopy(jArr2, 0, jArr2, i2 + 1, i2);
                return;
            } else {
                long[] jArr3 = this.f903kw;
                long j2 = jArr[i];
                jArr3[i] = j2;
                j ^= j2;
                i++;
