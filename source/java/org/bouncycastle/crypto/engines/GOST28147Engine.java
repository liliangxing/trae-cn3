...
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f859S = Sbox_Default;
    ...
    private int bytesToint(byte[] bArr, int i) {
        return ((bArr[i + 3] << 24) & (-16777216)) + ((bArr[i + 2] << Tnaf.POW_2_WIDTH) & 16711680) + ((bArr[i + 1] << 8) & 65280) + (bArr[i] & UByte.MAX_VALUE);
    }
