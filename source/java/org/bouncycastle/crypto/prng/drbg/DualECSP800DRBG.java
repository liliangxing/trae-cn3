...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _P */
    private ECPoint f1098_P;

    /* renamed from: _Q */
    private ECPoint f1099_Q;
    private ECCurve.C0563Fp _curve;
    ...
    static {
        ...
        nistPoints = r2;
        ECCurve.C0563Fp c0563Fp = (ECCurve.C0563Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C0563Fp c0563Fp2 = (ECCurve.C0563Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C0563Fp c0563Fp3 = (ECCurve.C0563Fp) NISTNamedCurves.getByName("P-521").getCurve();
        DualECPoints[] dualECPointsArr = {new DualECPoints(128, c0563Fp.createPoint(bigInteger, bigInteger2), c0563Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(CertificateHolderAuthorization.CVCA, c0563Fp2.createPoint(bigInteger5, bigInteger6), c0563Fp2.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c0563Fp3.createPoint(bigInteger9, bigInteger10), c0563Fp3.createPoint(bigInteger11, bigInteger12), 1)};
    }
    ...
    */
    public DualECSP800DRBG(DualECPoints[] dualECPointsArr, Digest digest, int i, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i > dualECPointsArr[i2].getSecurityStrength()) {
                ...
                this.f1098_P = dualECPointsArr[i2].getP();
                this.f1099_Q = dualECPointsArr[i2].getQ();
            }
        }
    }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f1100_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f1100_s);
        int i = 0;
        Arrays.fill(bArr, (byte) 0);
        int i2 = 0;
        for (int i3 = 0; i3 < length2; i3++) {
            bigInteger = getScalarMultipleXCoord(this.f1098_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f1099_Q, bigInteger).toByteArray();
        ...
        if (i2 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f1098_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f1099_Q, bigInteger).toByteArray();
        ...
        this.f1100_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f1098_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f1100_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f1100_s, this._seedlen), getEntropy(), bArr), this._seedlen);
