...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    static {
        ...
        seedlens = hashtable;
        hashtable.put("SHA-1", Integers.valueOf(UploadKeys.KeyIsEnd2EndEncryptionPublicKey));
        hashtable.put(McElieceCCA2KeyGenParameterSpec.SHA224, Integers.valueOf(UploadKeys.KeyIsEnd2EndEncryptionPublicKey));
        hashtable.put("SHA-256", Integers.valueOf(UploadKeys.KeyIsEnd2EndEncryptionPublicKey));
        hashtable.put(SPHINCSKeyParameters.SHA512_256, Integers.valueOf(UploadKeys.KeyIsEnd2EndEncryptionPublicKey));
        hashtable.put("SHA-512/224", Integers.valueOf(UploadKeys.KeyIsEnd2EndEncryptionPublicKey));
        hashtable.put(McElieceCCA2KeyGenParameterSpec.SHA384, Integers.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION));
        hashtable.put("SHA-512", Integers.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION));
    }
