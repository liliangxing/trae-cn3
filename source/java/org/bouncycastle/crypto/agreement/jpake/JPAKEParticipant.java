...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f605b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f606g;
    ...
    /* renamed from: p */
    private final BigInteger f607p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f608q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f609x1;

    /* renamed from: x2 */
    private BigInteger f610x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f607p = jPAKEPrimeOrderGroup.getP();
        this.f608q = jPAKEPrimeOrderGroup.getQ();
        this.f606g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f607p, this.f608q, this.gx4, this.f610x2, calculateS, this.f605b);
        this.f609x1 = null;
        this.f610x2 = null;
        this.f605b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f609x1 = JPAKEUtil.generateX1(this.f608q, this.random);
        this.f610x2 = JPAKEUtil.generateX2(this.f608q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f607p, this.f606g, this.f609x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f607p, this.f606g, this.f610x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f607p, this.f608q, this.f606g, this.gx1, this.f609x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f607p, this.f608q, this.f606g, this.gx2, this.f610x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger calculateGA = JPAKEUtil.calculateGA(this.f607p, this.gx1, this.gx3, this.gx4);
        BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f608q, this.f610x2, JPAKEUtil.calculateS(this.password));
        BigInteger calculateA = JPAKEUtil.calculateA(this.f607p, this.f608q, calculateGA, calculateX2s);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f607p, this.f608q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f607p, this.f608q, this.f606g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f607p, this.f608q, this.f606g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger calculateGA = JPAKEUtil.calculateGA(this.f607p, this.gx3, this.gx1, this.gx2);
        this.f605b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f607p, this.f608q, calculateGA, this.f605b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
