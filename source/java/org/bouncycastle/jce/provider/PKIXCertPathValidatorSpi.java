...
public class PKIXCertPathValidatorSpi extends CertPathValidatorSpi {
    ...
    /* JADX WARN: Type inference failed for: r9v4, types: [org.bouncycastle.asn1.x500.X500Name] */
            ...
            try {
                ...
                try {
                    ...
                    while (size2 >= 0) {
                        ...
                        int i16 = size2 == certificates.size() + (-1) ? i8 : 0;
                        try {
                            ...
                            int i20 = i8;
                            RFC3280CertPathUtilities.processCertA(certPath, build, date, provCrlRevocationChecker2, i18, r7, r8, r9, trustedCert);
                            RFC3280CertPathUtilities.processCertBC(certPath, i18, pKIXNameConstraintValidator2, this.isForCRLCheck);
                            PKIXPolicyNode processCertE = RFC3280CertPathUtilities.processCertE(certPath, i18, RFC3280CertPathUtilities.processCertD(certPath, i18, hashSet4, pKIXPolicyNode, arrayListArr3, r7, this.isForCRLCheck));
                            ...
                            if (r9 != i15) {
                                if (x509Certificate2 == null || x509Certificate2.getVersion() != i20) {
                                    ...
                                    int prepareNextCertH3 = RFC3280CertPathUtilities.prepareNextCertH3(certPath, i18, r7);
                                    i3 = RFC3280CertPathUtilities.prepareNextCertI1(certPath, i18, prepareNextCertH1);
                                    i2 = RFC3280CertPathUtilities.prepareNextCertI2(certPath, i18, prepareNextCertH2);
                                    ...
                                    i9 = RFC3280CertPathUtilities.prepareNextCertM(certPath, i18, RFC3280CertPathUtilities.prepareNextCertL(certPath, i18, i9));
                                ...
                                } else if (r9 != i20 || !x509Certificate2.equals(trustAnchor2.getTrustedCert())) {
                    ...
                    int i22 = size2;
                    int i23 = i22 + 1;
                    int wrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i23, RFC3280CertPathUtilities.wrapupCertA(i12, x509Certificate));
                    ...
                    RFC3280CertPathUtilities.wrapupCertF(certPath, i23, list5, hashSet);
                    PKIXPolicyNode wrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters3, initialPolicies, i23, arrayListArr4, pKIXPolicyNode, hashSet4);
