...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    protected byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f1120p.bitLength() + 7) / 8;
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        ...
        if (!dHPublicKey.getParams().getG().equals(this.f1119g) || !dHPublicKey.getParams().getP().equals(this.f1120p)) {
            throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
        }
        BigInteger y = dHPublicKey.getY();
        if (y != null && y.compareTo(TWO) >= 0) {
            BigInteger bigInteger = this.f1120p;
            ...
            if (y.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                ...
                BigInteger modPow = y.modPow(this.f1121x, this.f1120p);
    ...
    protected void engineInit(Key key, SecureRandom secureRandom) throws InvalidKeyException {
        ...
        this.f1120p = dHPrivateKey.getParams().getP();
        this.f1119g = dHPrivateKey.getParams().getG();
    ...
    protected void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            ...
            this.f1120p = dHParameterSpec.getP();
            this.f1119g = dHParameterSpec.getG();
