...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f1117x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f1117x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f1117x = aSN1Integer.getValue();
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement)) {
            ...
            if (dHParameter.getL() != null) {
                ...
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f1117x, new DHParameters(dHParameter.getP(), dHParameter.getG(), null, dHParameter.getL().intValue()));
            } else {
                this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f1117x, new DHParameters(dHParameter.getP(), dHParameter.getG()));
            }
        } else {
            ...
            dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f1117x, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
        }
    ...
    public BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f1117x = dHPrivateKeyParameters.getX();
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        return dHPrivateKeyParameters != null ? dHPrivateKeyParameters : this.dhSpec instanceof DHDomainParameterSpec ? new DHPrivateKeyParameters(this.f1117x, ((DHDomainParameterSpec) this.dhSpec).getDomainParameters()) : new DHPrivateKeyParameters(this.f1117x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
    }
    ...
    public String toString() {
        return DHUtil.privateKeyToString("DH", this.f1117x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
