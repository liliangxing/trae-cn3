...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        ...
        if (this.dhuSpec != null) {
            this.agreement.calculateAgreement(new XDHUPublicParameters(engineGetKeyParameters, ((BCXDHPublicKey) this.dhuSpec.getOtherPartyEphemeralKey()).engineGetKeyParameters()), this.result, 0);
            return null;
        }
