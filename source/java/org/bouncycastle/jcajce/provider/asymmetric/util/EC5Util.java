...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C0563Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C0563Fp c0563Fp = new ECCurve.C0563Fp(((ECFieldFp) field).getP(), a, b);
            return customCurves.containsKey(c0563Fp) ? (ECCurve) customCurves.get(c0563Fp) : c0563Fp;
        }
