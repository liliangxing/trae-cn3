...
class X509CRLObject extends X509CRLImpl {
    ...
    private X509CRLInternal getInternalCRL() {
        ...
        synchronized (this.cacheLock) {
            ...
            X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f1135c, this.sigAlgName, this.sigAlgParams, this.isIndirect, bArr);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f1135c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f1135c.getSignature())) {
                return false;
            }
        }
