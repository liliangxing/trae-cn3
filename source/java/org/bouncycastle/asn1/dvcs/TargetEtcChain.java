...
public class TargetEtcChain extends ASN1Object {
    ...
    public String toString() {
        ...
        stringBuffer.append("target: " + this.target + UpdateDialogNewBase.TYPE);
        if (this.chain != null) {
            stringBuffer.append("chain: " + this.chain + UpdateDialogNewBase.TYPE);
        }
        if (this.pathProcInput != null) {
            stringBuffer.append("pathProcInput: " + this.pathProcInput + UpdateDialogNewBase.TYPE);
        }
        stringBuffer.append("}\n");
