...
public class ServiceType extends ASN1Object {
    ...
    public String toString() {
        ...
        return BuildConfig.FLAVOR + intValueExact + (intValueExact == CPD.value.intValueExact() ? "(CPD)" : intValueExact == VSD.value.intValueExact() ? "(VSD)" : intValueExact == VPKC.value.intValueExact() ? "(VPKC)" : intValueExact == CCPD.value.intValueExact() ? "(CCPD)" : "?");
    }
}
