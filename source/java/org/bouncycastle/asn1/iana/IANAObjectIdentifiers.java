...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        _private = aSN1ObjectIdentifier.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        security = branch;
        SNMPv2 = aSN1ObjectIdentifier.branch("6");
        mail = aSN1ObjectIdentifier.branch("7");
        ASN1ObjectIdentifier branch2 = branch.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        hmacRIPEMD160 = branch4.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
    }
}
