...
public interface CMCObjectIdentifiers {
    ...
    static {
        ...
        id_cmc_dataReturn = branch.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        ...
        id_cmc_transactionId = branch.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        id_cmc_decryptedPOP = branch.branch(Constants.PERSONALIZED_CONTENT_RECOMMENDATION_ENABLE);
        ...
        id_cmc_publishCert = branch.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY_TEEN_MODE);
