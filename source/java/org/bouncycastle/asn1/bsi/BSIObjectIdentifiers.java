...
public interface BSIObjectIdentifiers {
    ...
    static {
        ...
        ecdsa_plain_SHA384 = branch2.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        ecdsa_plain_SHA512 = branch2.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        ecka_eg_X963kdf_SHA384 = branch4.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        ecka_eg_X963kdf_SHA512 = branch4.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        ecka_eg_SessionKDF_AES256 = branch5.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
    }
}
