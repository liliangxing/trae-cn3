...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_at_monetaryLimit = branch2.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        id_isismtt_at_declarationOfMajority = branch2.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        id_isismtt_at_requestedCertificate = branch2.branch(Constants.PERSONALIZED_CONTENT_RECOMMENDATION_ENABLE);
