...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(minMaxIPs[0], minMaxIPs[2]), min(minMaxIPs[1], minMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m234or(minMaxIPs[0], minMaxIPs[2]), m234or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m234or(byte[] bArr, byte[] bArr2) {
