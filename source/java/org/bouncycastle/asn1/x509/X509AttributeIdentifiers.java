...
public interface X509AttributeIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_pe_ac_auditIdentity = X509ObjectIdentifiers.id_pe.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
    public static final ASN1ObjectIdentifier id_pe_aaControls = X509ObjectIdentifiers.id_pe.branch("6");
    public static final ASN1ObjectIdentifier id_pe_ac_proxying = X509ObjectIdentifiers.id_pe.branch(Constants.PERSONALIZED_CONTENT_RECOMMENDATION_ENABLE);
    public static final ASN1ObjectIdentifier id_ce_targetInformation = X509ObjectIdentifiers.id_ce.branch("55");

    static {
        ASN1ObjectIdentifier branch = X509ObjectIdentifiers.id_pkix.branch(Constants.PERSONALIZED_CONTENT_RECOMMENDATION_ENABLE);
        id_aca = branch;
        id_aca_authenticationInfo = branch.branch("1");
        id_aca_accessIdentity = branch.branch("2");
        id_aca_chargingIdentity = branch.branch("3");
        id_aca_group = branch.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
