...
public interface ICAOObjectIdentifiers {
    ...
    static {
        ...
        id_icao_documentTypeList = branch2.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        id_icao_aaProtocolObject = branch2.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
