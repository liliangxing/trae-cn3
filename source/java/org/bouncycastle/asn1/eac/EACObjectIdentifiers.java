...
public interface EACObjectIdentifiers {
    ...
    static {
        ...
        id_TA_RSA_PSS_SHA_256 = branch6.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        id_TA_RSA_v1_5_SHA_512 = branch6.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
        ...
        id_TA_ECDSA_SHA_384 = branch7.branch(Constants.RECOMMEND_BASE_ON_FOLLOW_LIST);
        id_TA_ECDSA_SHA_512 = branch7.branch(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY);
