            ...
            if (charAt == ')' || charAt == '.') {
                if (i2 >= 1) {
                    ...
                    if (isSpaceTabOrEnd(charSequence, i4)) {
                        ...
                        orderedList.setOriginalStartNumber(Integer.parseInt(obj));
        ...
        public BlockStart tryStart(ParserState parserState, MatchedBlockParser matchedBlockParser) {
            ...
            if (parserState.getIndent() < Parsing.CODE_BLOCK_INDENT) {
                ...
                if (!(matchedBlockParser2 instanceof ListBlockParser) || !ListBlockParser.listsMatch((ListBlock) matchedBlockParser2.getBlock(), parseList.listBlock)) {
                    ...
                    return BlockStart.m360of(listBlockParser, listItemParser).atColumn(i);
                }
                return BlockStart.m360of(listItemParser).atColumn(i);
            }
            return BlockStart.none();
        }
    }
