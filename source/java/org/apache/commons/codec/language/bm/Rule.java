...
public class Rule {
        ...
        for (NameType nameType : NameType.values()) {
            ...
            for (RuleType ruleType : RuleType.values()) {
                ...
                if (!ruleType.equals(RuleType.RULES)) {
                    hashMap.put(SettingsManager.COMMON_SERVICE, parseRules(createScanner(nameType, ruleType, SettingsManager.COMMON_SERVICE), createResourceName(nameType, ruleType, SettingsManager.COMMON_SERVICE)));
                }
            ...
            if (z) {
                ...
                if (trim.length() == 0) {
                    ...
                    if (split.length != 4) {
                        ...
                        try {
                            arrayList.add(new Rule(stripQuotes(split[0]), stripQuotes(split[1]), stripQuotes(split[2]), parsePhonemeExpr(stripQuotes(split[3])), i, str) { // from class: org.apache.commons.codec.language.bm.Rule.2
    ...
    private static RPattern pattern(String str) {
        boolean startsWith = str.startsWith(UrlMatcher.EXTRACTOR);
        ...
        if (substring.contains("[")) {
            ...
            if (startsWith2 && endsWith2) {
                ...
                if (!substring2.contains("[")) {
                    boolean startsWith3 = substring2.startsWith(UrlMatcher.EXTRACTOR);
                    if (startsWith3) {
    ...
    public Rule(String str, String str2, String str3, PhonemeExpr phonemeExpr) {
        ...
        this.rContext = pattern(UrlMatcher.EXTRACTOR + str3);
