...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", TextAttributes.INLINE_BLOCK_PLACEHOLDER, "H", "F", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, ExifInterface.LONGITUDE_WEST, " "};
    private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = {"ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER"};
    private static final String[] L_T_K_S_N_M_B_Z = {"L", ExifInterface.GPS_DIRECTION_TRUE, "K", ExifInterface.LATITUDE_SOUTH, "N", "M", TextAttributes.INLINE_BLOCK_PLACEHOLDER, "Z"};
    ...
    private int handleCC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        int i2 = i + 2;
        if (contains(str, i2, 1, TextAttributes.INLINE_IMAGE_PLACEHOLDER, ExifInterface.LONGITUDE_EAST, "H") && !contains(str, i2, 2, "HU")) {
    ...
    private int handleD(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (contains(str, i, 2, "DG")) {
            int i2 = i + 2;
            if (contains(str, i2, 1, TextAttributes.INLINE_IMAGE_PLACEHOLDER, ExifInterface.LONGITUDE_EAST, "Y")) {
        ...
        if (charAt(str, i3) == 'N') {
            ...
            if (contains(str, i3, 2, "ER") || charAt(str, i3) == 'Y') {
                ...
                if (!contains(str, 0, 6, "DANGER", "RANGER", "MANGER")) {
                    int i4 = i - 1;
                    if (!contains(str, i4, 1, ExifInterface.LONGITUDE_EAST, TextAttributes.INLINE_IMAGE_PLACEHOLDER) && !contains(str, i4, 3, "RGY", "OGY")) {
                        doubleMetaphoneResult.append('K', 'J');
                    }
                }
            } else {
            ...
            if (contains(str, i3, 1, ExifInterface.LONGITUDE_EAST, TextAttributes.INLINE_IMAGE_PLACEHOLDER, "Y") || contains(str, i - 1, 4, "AGGI", "OGGI")) {
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (i > 0 && !isVowel(charAt(str, i - 1))) {
            ...
            if ((i <= 1 || !contains(str, i - 2, 1, TextAttributes.INLINE_BLOCK_PLACEHOLDER, "H", "D")) && ((i <= 2 || !contains(str, i - 3, 1, TextAttributes.INLINE_BLOCK_PLACEHOLDER, "H", "D")) && (i <= 3 || !contains(str, i - 4, 1, TextAttributes.INLINE_BLOCK_PLACEHOLDER, "H")))) {
                if (i > 2 && charAt(str, i - 1) == 'U' && contains(str, i - 3, 1, "C", NpthBus.UUID_SUFIX_3_1_3, "L", "R", ExifInterface.GPS_DIRECTION_TRUE)) {
                    doubleMetaphoneResult.append('F');
    ...
    private int handleP(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        doubleMetaphoneResult.append('P');
        if (contains(str, i2, 1, "P", TextAttributes.INLINE_BLOCK_PLACEHOLDER)) {
            i2 = i + 2;
        }
        return i2;
    }
    ...
    private int handleSC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        } else if (contains(str, i2, 1, TextAttributes.INLINE_IMAGE_PLACEHOLDER, ExifInterface.LONGITUDE_EAST, "Y")) {
            doubleMetaphoneResult.append('S');
        } else {
            doubleMetaphoneResult.append("SK");
        }
    ...
    private boolean conditionL0(String str, int i) {
        ...
        return (contains(str, str.length() - 2, 2, "AS", PrefetchRequestConfig.ENV_TYPE_OS) || contains(str, str.length() - 1, 1, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, "O")) && contains(str, i - 1, 4, "ALLE");
    }
