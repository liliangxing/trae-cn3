...
public final class Buffer {
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00ab A[EDGE_INSN: B:41:0x00ab->B:38:0x00ab BREAK  A[LOOP:0: B:4:0x0012->B:40:?], SYNTHETIC] */
    ...
    */
                ...
                if (charAt2 < 2048) {
                    ...
                    if (charAt2 <= 56319) {
                        if (56320 <= charAt3 && charAt3 < 57344) {
                            int i7 = (((charAt2 & 1023) << 10) | (charAt3 & 1023)) + PKIFailureInfo.notAuthorized;
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            writableSegment$okio.data[writableSegment$okio.limit] = (byte) ((i >> 6) | CertificateHolderAuthorization.CVCA);
