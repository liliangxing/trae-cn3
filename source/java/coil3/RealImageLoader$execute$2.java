...
final class RealImageLoader$execute$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ImageResult>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> realImageLoader$execute$2 = new RealImageLoader$execute$2(this.$request, this.this$0, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Deferred async$default = BuildersKt.async$default((CoroutineScope) this.L$0, Dispatchers.getMain().getImmediate(), (CoroutineStart) null, new RealImageLoader$execute$2$job$1(this.this$0, this.$request, null), 2, (Object) null);
            this.label = 1;
            obj = RealImageLoader_androidKt.getDisposable(this.$request, async$default).getJob().await((Continuation) this);
