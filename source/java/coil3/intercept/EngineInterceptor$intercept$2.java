...
@DebugMetadata(c = "coil3.intercept.EngineInterceptor$intercept$2", f = "EngineInterceptor.kt", i = {}, l = {84}, m = "invokeSuspend", n = {}, s = {})
...
public final class EngineInterceptor$intercept$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super SuccessResult>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.this$0.execute(this.$request, this.$mappedData, this.$options, this.$eventListener, (Continuation) this);
        ...
        return new SuccessResult(executeResult.getImage(), this.$request, executeResult.getDataSource(), memoryCacheService.setCacheValue(this.$cacheKey, this.$request, executeResult) ? this.$cacheKey : null, executeResult.getDiskCacheKey(), executeResult.isSampled(), Utils_commonKt.isPlaceholderCached(this.$chain));
    }
}
