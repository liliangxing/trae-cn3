...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(ImageRequest imageRequest, List<? extends Interceptor> list, int i, ImageRequest imageRequest2, Size size, SizeResolver sizeResolver, EventListener eventListener, boolean z) {
    ...
    */
    ...
    private final RealInterceptorChain copy(int index, ImageRequest request, Size size) {
        return new RealInterceptorChain(this.initialRequest, this.interceptors, index, request, size, this.sizeResolver, this.eventListener, this.isPlaceholderCached);
    }
}
