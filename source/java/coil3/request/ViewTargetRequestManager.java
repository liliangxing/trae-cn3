...
import coil3.util.Coroutines_commonKt;
...
public final class ViewTargetRequestManager implements View.OnAttachStateChangeListener {
    ...
    public final synchronized void dispose() {
        ...
        this.pendingClear = BuildersKt.launch$default(GlobalScope.INSTANCE, Dispatchers.getMain().getImmediate(), (CoroutineStart) null, new ViewTargetRequestManager$dispose$1(this, null), 2, (Object) null);
    ...
    public final synchronized ImageResult getResult() {
        ...
        return (viewTargetDisposable == null || (job = viewTargetDisposable.getJob()) == null) ? null : (ImageResult) Coroutines_commonKt.getCompletedOrNull(job);
    }
