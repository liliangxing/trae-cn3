...
final class SourceResponseBody implements NetworkResponseBody {
    ...
    public static final /* synthetic */ SourceResponseBody m3250boximpl(BufferedSource bufferedSource) {
        return new SourceResponseBody(bufferedSource);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static BufferedSource m3252constructorimpl(BufferedSource bufferedSource) {
        return bufferedSource;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3253equalsimpl(BufferedSource bufferedSource, Object obj) {
        return (obj instanceof SourceResponseBody) && Intrinsics.areEqual(bufferedSource, ((SourceResponseBody) obj).getSource());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3254equalsimpl0(BufferedSource bufferedSource, BufferedSource bufferedSource2) {
        return Intrinsics.areEqual(bufferedSource, bufferedSource2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3255hashCodeimpl(BufferedSource bufferedSource) {
        return bufferedSource.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3256toStringimpl(BufferedSource bufferedSource) {
        return "SourceResponseBody(source=" + bufferedSource + ')';
    }

    public boolean equals(Object other) {
        return m3253equalsimpl(this.source, other);
    }

    public int hashCode() {
        return m3255hashCodeimpl(this.source);
    }

    public String toString() {
        return m3256toStringimpl(this.source);
    }
    ...
    public Object writeTo(BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
        return m3257writeToimpl(this.source, bufferedSink, continuation);
    }

    /* renamed from: writeTo-impl, reason: not valid java name */
    public static Object m3257writeToimpl(BufferedSource bufferedSource, BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
    ...
    public Object writeTo(FileSystem fileSystem, Path path, Continuation<? super Unit> continuation) {
        return m3258writeToimpl(this.source, fileSystem, path, continuation);
    }

    @Override // java.lang.AutoCloseable
    public void close() {
        m3251closeimpl(this.source);
    }

    /* renamed from: close-impl, reason: not valid java name */
    public static void m3251closeimpl(BufferedSource bufferedSource) {
        bufferedSource.close();
    }

    /* renamed from: writeTo-impl, reason: not valid java name */
    public static Object m3258writeToimpl(BufferedSource bufferedSource, FileSystem fileSystem, Path path, Continuation<? super Unit> continuation) {
