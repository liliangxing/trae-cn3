...
final class ByteStringNetworkRequestBody implements NetworkRequestBody {
    ...
    public static final /* synthetic */ ByteStringNetworkRequestBody m3241boximpl(ByteString byteString) {
        return new ByteStringNetworkRequestBody(byteString);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static ByteString m3242constructorimpl(ByteString byteString) {
        return byteString;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3243equalsimpl(ByteString byteString, Object obj) {
    ...
    public static final boolean m3244equalsimpl0(ByteString byteString, ByteString byteString2) {
        return Intrinsics.areEqual(byteString, byteString2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3245hashCodeimpl(ByteString byteString) {
        return byteString.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3246toStringimpl(ByteString byteString) {
        return "ByteStringNetworkRequestBody(bytes=" + byteString + ')';
    }

    public boolean equals(Object other) {
        return m3243equalsimpl(this.bytes, other);
    }

    public int hashCode() {
        return m3245hashCodeimpl(this.bytes);
    }

    public String toString() {
        return m3246toStringimpl(this.bytes);
    }
    ...
    public Object writeTo(BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
        return m3247writeToimpl(this.bytes, bufferedSink, continuation);
    }

    /* renamed from: writeTo-impl, reason: not valid java name */
    public static Object m3247writeToimpl(ByteString byteString, BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
