    ...
    public final Pair<Fetcher, Integer> newFetcher(Object data, Options options, ImageLoader imageLoader, int startIndex) {
        ...
        while (startIndex < size) {
            ...
            if (((KClass) pair.component2()).isInstance(data)) {
                ...
                Fetcher create = factory.create(data, options, imageLoader);
                if (create != null) {
    ...
    public static final class Builder {
        ...
        public Builder(ComponentRegistry componentRegistry) {
            ...
            while (it.hasNext()) {
                ...
                arrayList.add(new Function0() { // from class: coil3.ComponentRegistry$Builder$$ExternalSyntheticLambda2
                    public final Object invoke() {
                        List listOf;
            ...
            for (final Decoder.Factory factory : decoderFactories) {
                arrayList2.add(new Function0() { // from class: coil3.ComponentRegistry$Builder$$ExternalSyntheticLambda3
                    public final Object invoke() {
                        List listOf;
        ...
        public final <T> Builder add(final Fetcher.Factory<T> factory, final KClass<T> type) {
            this.lazyFetcherFactories.add(new Function0() { // from class: coil3.ComponentRegistry$Builder$$ExternalSyntheticLambda0
                public final Object invoke() {
        ...
        public final Builder add(final Decoder.Factory factory) {
            this.lazyDecoderFactories.add(new Function0() { // from class: coil3.ComponentRegistry$Builder$$ExternalSyntheticLambda1
                public final Object invoke() {
                    List listOf;
                    listOf = CollectionsKt.listOf(Decoder.Factory.this);
                    return listOf;
