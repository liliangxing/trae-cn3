...
@DebugMetadata(c = "coil3.compose.AsyncImagePainter$onRemembered$1", f = "AsyncImagePainter.kt", i = {}, l = {297}, m = "invokeSuspend", n = {}, s = {})
...
public final class AsyncImagePainter$onRemembered$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AsyncImagePainter$onRemembered$1(Flow<AsyncImagePainter.Input> flow, AsyncImagePainter asyncImagePainter, AsyncImagePreviewHandler asyncImagePreviewHandler, Continuation<? super AsyncImagePainter$onRemembered$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AsyncImagePainter$onRemembered$1(this.$inputs, this.this$0, this.$previewHandler, continuation);
    }
    ...
    @DebugMetadata(c = "coil3.compose.AsyncImagePainter$onRemembered$1$1", f = "AsyncImagePainter.kt", i = {}, l = {296}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: coil3.compose.AsyncImagePainter$onRemembered$1$1 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    public static final class C07111 extends SuspendLambda implements Function2<AsyncImagePainter.Input, Continuation<? super AsyncImagePainter.State>, Object> {
        final /* synthetic */ AsyncImagePreviewHandler $previewHandler;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07111(AsyncImagePainter asyncImagePainter, AsyncImagePreviewHandler asyncImagePreviewHandler, Continuation<? super C07111> continuation) {
            super(2, continuation);
            this.this$0 = asyncImagePainter;
            this.$previewHandler = asyncImagePreviewHandler;
        }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c07111 = new C07111(this.this$0, this.$previewHandler, continuation);
            c07111.L$0 = obj;
            return c07111;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                updateRequest = this.this$0.updateRequest(input.getRequest(), true);
                this.label = 1;
                obj = this.$previewHandler.handle(input.getImageLoader(), updateRequest, (Continuation) this);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            if (FlowKt.mapLatest(this.$inputs, new C07111(this.this$0, this.$previewHandler, null)).collect(new C07122(this.this$0), (Continuation) this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
    ...
    /* renamed from: coil3.compose.AsyncImagePainter$onRemembered$1$2 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    public /* synthetic */ class C07122 implements FlowCollector, FunctionAdapter {
        final /* synthetic */ AsyncImagePainter $tmp0;

        C07122(AsyncImagePainter asyncImagePainter) {
