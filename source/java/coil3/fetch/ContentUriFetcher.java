...
public final class ContentUriFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) {
        ...
        return new SourceFetchResult(ImageSourceKt.ImageSource$default(Okio.buffer(Okio.source(openAssetFileDescriptor.createInputStream())), this.options.getFileSystem(), new ContentMetadata(this.data, openAssetFileDescriptor), null, 8, null), contentResolver.getType(androidUri), DataSource.DISK);
    }
    ...
    public final boolean isMusicThumbnailUri$coil_core_release(Uri data) {
        ...
        int size;
        return Intrinsics.areEqual(data.getAuthority(), "media") && (size = (pathSegments = UriKt.getPathSegments(data)).size()) >= 3 && Intrinsics.areEqual(pathSegments.get(size + (-3)), FConstants.URI_AUDIO) && Intrinsics.areEqual(pathSegments.get(size + (-2)), "albums");
    }
    ...
    private final Bundle newMusicThumbnailSizeOptions() {
        ...
        int m3269unboximpl = pixels.m3269unboximpl();
        ...
        int m3269unboximpl2 = pixels2.m3269unboximpl();
        Bundle bundle = new Bundle(1);
        bundle.putParcelable("android.content.extra.SIZE", new Point(m3269unboximpl, m3269unboximpl2));
        return bundle;
    }

    /* compiled from: ContentUriFetcher.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\"\u0010\u0005\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u0010\u0010\f\u001a\u00020\r2\u0006\u0010\u0007\u001a\u00020\u0002H\u0002¨\u0006\u000e"}, d2 = {"Lcoil3/fetch/ContentUriFetcher$Factory;", "Lcoil3/fetch/Fetcher$Factory;", "Lcoil3/Uri;", "<init>", "()V", "create", "Lcoil3/fetch/Fetcher;", Constants.KEY_DATA, "options", "Lcoil3/request/Options;", "imageLoader", "Lcoil3/ImageLoader;", "isApplicable", "", "coil-core_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    public static final class Factory implements Fetcher.Factory<Uri> {
        ...
        private final boolean isApplicable(Uri data) {
            return Intrinsics.areEqual(data.getScheme(), StrategyConstants.CONTENT);
        }
    }
}
