    ...
    public synchronized void onTrimMemory(int level) {
        ...
        if (realImageLoader != null) {
            ...
            if (level >= 40) {
                ...
                if (z && (memoryCache = realImageLoader.getMemoryCache()) != null) {
