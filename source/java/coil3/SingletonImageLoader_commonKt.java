...
public final class SingletonImageLoader_commonKt {
    private static final SingletonImageLoader.Factory DefaultSingletonImageLoaderFactory = new SingletonImageLoader.Factory() { // from class: coil3.SingletonImageLoader_commonKt$$ExternalSyntheticLambda0
        @Override // coil3.SingletonImageLoader.Factory
        public final ImageLoader newImageLoader(Context context) {
            ImageLoader DefaultSingletonImageLoaderFactory$lambda$1;
            DefaultSingletonImageLoaderFactory$lambda$1 = SingletonImageLoader_commonKt.DefaultSingletonImageLoaderFactory$lambda$1(context);
