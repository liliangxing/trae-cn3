...
public final class Instant implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static Instant ofEpochMilli(long j) {
        return create(UByte$.ExternalSyntheticBackport0.m(j, 1000), UByte$.ExternalSyntheticBackport0.m(j, 1000) * 1000000);
    }
    ...
    public static Instant parse(CharSequence charSequence) {
        return (Instant) DateTimeFormatter.ISO_INSTANT.parse(charSequence, new TemporalQuery() { // from class: bytedance.jvm.time.Instant$$ExternalSyntheticLambda0
    ...
    public int get(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            int i = C06191.$SwitchMap$bytedance$jvm$time$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
            if (i == 1) {
                return this.nanos;
            }
            if (i == 2) {
    ...
    public long getLong(TemporalField temporalField) {
        int i;
        if (temporalField instanceof ChronoField) {
            int i2 = C06191.$SwitchMap$bytedance$jvm$time$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
            if (i2 == 1) {
                i = this.nanos;
            } else if (i2 == 2) {
                i = this.nanos / 1000;
    ...
    public Instant with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ...
            int i = C06191.$SwitchMap$bytedance$jvm$time$temporal$ChronoField[chronoField.ordinal()];
            if (i == 1) {
    ...
    /* renamed from: bytedance.jvm.time.Instant$1 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
    public static /* synthetic */ class C06191 {
        ...
        static {
            ...
            try {
                $SwitchMap$bytedance$jvm$time$temporal$ChronoUnit[ChronoUnit.DAYS.ordinal()] = 8;
            ...
            try {
                $SwitchMap$bytedance$jvm$time$temporal$ChronoField[ChronoField.MICRO_OF_SECOND.ordinal()] = 2;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$bytedance$jvm$time$temporal$ChronoField[ChronoField.MILLI_OF_SECOND.ordinal()] = 3;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                $SwitchMap$bytedance$jvm$time$temporal$ChronoField[ChronoField.INSTANT_SECONDS.ordinal()] = 4;
    ...
    public Instant plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            switch (C06191.$SwitchMap$bytedance$jvm$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                case 1:
                    return plusNanos(j);
                case 2:
                ...
                case 5:
                    return plusSeconds(UByte$.ExternalSyntheticBackport0.m$1(j, 60));
                case 6:
                    return plusSeconds(UByte$.ExternalSyntheticBackport0.m$1(j, 3600));
                case 7:
                    return plusSeconds(UByte$.ExternalSyntheticBackport0.m$1(j, 43200));
                case 8:
                    return plusSeconds(UByte$.ExternalSyntheticBackport0.m$1(j, 86400));
                default:
    ...
    public Instant minusSeconds(long j) {
        if (j == Long.MIN_VALUE) {
            return plusSeconds(LocationRequestCompat.PASSIVE_INTERVAL).plusSeconds(1L);
        }
        return plusSeconds(-j);
    }
    ...
    public Instant minusMillis(long j) {
        if (j == Long.MIN_VALUE) {
            return plusMillis(LocationRequestCompat.PASSIVE_INTERVAL).plusMillis(1L);
        }
        return plusMillis(-j);
    }
    ...
    public Instant minusNanos(long j) {
        if (j == Long.MIN_VALUE) {
            return plusNanos(LocationRequestCompat.PASSIVE_INTERVAL).plusNanos(1L);
        }
        return plusNanos(-j);
    }
    ...
    public long toEpochMilli() {
        long j = this.seconds;
        if (j < 0 && this.nanos > 0) {
            return Math.addExact(UByte$.ExternalSyntheticBackport0.m$1(j + 1, 1000), (this.nanos / 1000000) - 1000);
        }
        return Math.addExact(UByte$.ExternalSyntheticBackport0.m$1(j, 1000), this.nanos / 1000000);
    }
