...
public class C0667b {
    ...
    */
    public static String m162a(Context context) {
        FileInputStream fileInputStream;
        BufferedReader bufferedReader;
        Throwable th;
        InputStreamReader inputStreamReader;
        File m166c = m166c(context);
        StringBuilder sb = new StringBuilder();
        if (m166c == null || !m166c.exists()) {
            return "";
        }
        try {
            try {
                fileInputStream = new FileInputStream(m166c);
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
    ...
    /* renamed from: a */
    public static void m163a(Context context, String str) {
        File m166c = m166c(context);
        if (m166c == null || !m166c.exists()) {
            m164a(m165b(context), str);
        } else {
            m164a(m166c, str);
        }
    }
    ...
    /* renamed from: a */
    private static void m164a(File file, String str) {
    ...
    /* renamed from: b */
    private static File m165b(Context context) {
        if (context == null) {
            return null;
        }
        try {
    ...
    /* renamed from: c */
    private static File m166c(Context context) {
        if (context != null) {
            try {
                File file = new File(context.getFilesDir() + "/eAccount/Log/");
                if (!file.exists()) {
