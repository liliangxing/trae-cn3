...
final class RequestBuilder {
    ...
    public Request build() {
        ...
        if (mediaType != null) {
            if (formBody != null) {
                formBody = new ContentTypeOverridingRequestBody(formBody, mediaType);
            } else {
                this.requestBuilder.addHeader("Content-Type", mediaType.toString());
            }
        }
        return this.requestBuilder.url(resolve).method(this.method, formBody).build();
    }
