...
public final class C1394u {
    /* renamed from: a */
    public static UPSNotificationMessage m1051a(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: b */
    public static String m1052b(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: a */
    public static InsideNotificationItem m1050a(String str) {
        InsideNotificationItem insideNotificationItem = new InsideNotificationItem();
        try {
        } catch (JSONException e) {
            C1393t.m1035a("MessageConvertUtil", "notify msg pack to obj error", e);
        }
        if (TextUtils.isEmpty(str)) {
            C1393t.m1034a("MessageConvertUtil", "notify msg pack to obj is null");
            return null;
        }
        ...
        if (jSONArray.length() > 11) {
            insideNotificationItem.setParams(C1390q.m1020a(new JSONObject(jSONArray.getString(11))));
        }
