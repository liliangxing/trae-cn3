...
public class UPSNotificationMessage {
    ...
    public String toString() {
        return "UPSNotificationMessage{mTargetType=" + this.mTargetType + ", mTragetContent='" + this.mTragetContent + "', mTitle='" + this.mTitle + "', mContent='" + this.mContent + "', mNotifyType=" + this.mNotifyType + ", mPurePicUrl='" + this.mPurePicUrl + "', mIconUrl='" + this.mIconUrl + "', mCoverUrl='" + this.mCoverUrl + "', mSkipContent='" + this.mSkipContent + "', mSkipType=" + this.mSkipType + ", mShowTime=" + this.mShowTime + ", mMsgId=" + this.mMsgId + ", mParams=" + this.mParams + ", mIsMacroReplace=" + this.mIsMacroReplace + ", mAdClickCheckUrl='" + this.mAdClickCheckUrl + "', mCompatibleType=" + this.mCompatibleType + ", mExtentStatus=" + this.mExtentStatus + ", mCustomValue='" + this.mCustomValue + "', mMsgArriveTime=" + this.mMsgArriveTime + AbstractJsonLexerKt.END_OBJ;
    }
}
