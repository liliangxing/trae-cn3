...
/* renamed from: com.vivo.push.h.l */
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes7.dex */
final class C1286l extends AbstractC1266ab {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C1286l(AbstractC1400v abstractC1400v) {
    ...
    protected final void mo702a(AbstractC1400v abstractC1400v) {
        ...
        C1393t.m1046c("OnDelTagsTask", "doTask,删除成功的标签 = " + m628e + " 删除失败的= " + m629f + " 错误码= " + m627j);
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            C1393t.m1046c("OnDelTagsTask", "doTask1,删除成功的别名 = " + arrayList + " 删除失败的别名= " + arrayList3 + " 错误码= " + m627j);
            if (arrayList.size() > 0) {
                C1306m.m762a();
                try {
                    if (arrayList.size() > 0) {
            ...
            C1357t.m916a(new RunnableC1287m(this, m627j, arrayList, arrayList3, m626i));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            C1393t.m1046c("OnDelTagsTask", "doTask1,删除成功的标签 = " + arrayList + " 删除失败的标签= " + arrayList3 + " 错误码= " + m627j);
            if (arrayList2.size() > 0) {
                C1306m.m762a().m782a(arrayList2);
            }
            C1306m.m762a().m778a(c1224u.m626i(), m627j);
            C1357t.m916a(new RunnableC1288n(this, m627j, arrayList2, arrayList4, m626i));
        }
    }
}
