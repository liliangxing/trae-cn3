...
public class UICanvas extends LynxUI<UICanvasView> {
    private static final String TAG = "UICanvas";
    ...
    public UICanvas(LynxContext lynxContext, Object obj) {
    ...
    public void setName(String str) {
        ...
        ((UICanvasView) this.mView).setup(str, ((CanvasManager) lynxKryptonHelper.getCanvasManager()).getKryptonApp());
        if (this.mName == null) {
            this.mName = str;
            String str2 = "url:" + getLynxContext().getTemplateUrl() + ", tag_name:" + str;
            LLog.m2578i(TAG, "set tag to canvas view: " + str2);
            ((UICanvasView) this.mView).setTag(str2);
        }
    }
    ...
    private CanvasManager getOrTryCreateCanvasManager() {
        ...
        LLog.m2578i(TAG, "Setup canvas environment from UICanvas in lazy mode.");
