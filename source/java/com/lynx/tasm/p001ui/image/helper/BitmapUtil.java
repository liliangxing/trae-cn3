...
public final class BitmapUtil {
    ...
    /* renamed from: com.lynx.tasm.ui.image.helper.BitmapUtil$1 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes7.dex */
    public static /* synthetic */ class C02521 {
    ...
    public static int getPixelSizeForBitmapConfig(Bitmap.Config config) {
        int i = C02521.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
