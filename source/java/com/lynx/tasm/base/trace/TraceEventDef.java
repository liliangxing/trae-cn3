...
public class TraceEventDef {
    ...
    public static final String CLEAN_REF_RUN_CLEAN_TASK_INVOKE_THREAD = "CleanupReference.InvokingThread.runCleanupTask";
    public static final String CLEAN_REF_RUN_CLEAN_TASK_REAPER_THREAD = "CleanupReference.ReaperThread.runCleanupTask";
    public static final String CLIENT_DESTORY = "Client.onDestory";
    public static final String CLIENT_FLING = "Client.onFling";
    public static final String CLIENT_LYNXVIEW_AND_JSRUNTIME_DESTORY = "Client.onLynxViewAndJSRuntimeDestroy";
    ...
    public static final String EVENT_REPORTER_REMOVE_GENERIC_INFO = "LynxEventReporter::removeGenericInfo";
    public static final String EVENT_REPORTER_UPDATE_GENERIC_INFO = "LynxEventReporter::updateGenericInfo";
    public static final String EXCEPTION = "exception";
    public static final String FETCHER_WRAPPER_USE_LAZY_BUNDLE_FETCHER = "Using DynamicComponentFetcher";
    public static final String FETCHER_WRAPPER_USE_RESOURCE_SERVICE = "Using LynxResourceServiceProvider";
    ...
    public static final String FONT_FACE_MANAGER_LOAD_TYPEFACE_WITH_GENERIC_RESOURCE_FETCHER = "FontFaceManager.loadTypefaceWithGenericLynxResourceFetcher";
    public static final String HEIGHT_MEASURE_SPEC = "heightMeasureSpec";
    public static final String IMAGE_MANAGER_UPDATE_IMAGE_SOURCE = "LynxImageManager.updateImageSource";
    public static final String IMAGE_MANAGER_UPDATE_PLACEHOLDER_SOURCE = "LynxImageManager.updatePlaceholderSource";
    public static final String IMAGE_MANAGER_UPDATE_PROPS_INTERVAL = "LynxImageManager.updatePropertiesInterval";
    ...
    public static final String INTERSECTION_OBSERVER_MANAGER_INIT = "LynxIntersectionObserverManager initialized";
    ...
    public static final String LYNX_ENGINE_POOL_REGISTER_ENGINE = "LynxEnginePool.registerReuseEngineWrapper";
    ...
    public static final String NINE_PATCH_HELPER_DRAW_NINE_PATH = "image.NinePatchHelper.drawNinePatch";
    public static final String NINE_PATCH_HELPER_DRAW_WITH_CAP_INSETS = "image.NinePatchHelper.drawWithCapInsets";
    ...
    public static final String PAINTING_CONTEXT_INSERT_LIST_ITEM = "PaintingContext.insertListItemNode.";
    public static final String PAINTING_CONTEXT_REMOVE_LIST_ITEM = "PaintingContext.removeListItemNode.";
    ...
    public static final String TEMPLATE_BUNDLE_FROM_BYTEBUFFER = "TemplateBundle.fromTemplateWithByteBuffer";
    ...
    public static final String TEMPLATE_RENDER_DETACH_LYNX_ENGINE = "TemplateRender.detachLynxEngineWrapper";
    public static final String TEMPLATE_RENDER_DISPATCH_ERROR = "TemplateRender.dispatchError";
    public static final String TEMPLATE_RENDER_FALLBACK_NEW_ENGINE = "TemplateRender.fallbackNewEngine";
    ...
    public static final String TEMPLATE_RENDER_ON_RUN_PIPELINE_FINISHED = "TemplateRender.onRunPipelineFinished";
    ...
    public static final String TEMPLATE_RENDER_RENDER_TEMPLATE_BUNDLE = "TemplateRender.renderTemplateBundle";
    ...
    public static final String TEMPLATE_RENDER_TRY_REUSE_ENGINE = "TemplateRender.tryReuseLynxEngineFromPool";
    ...
    public static final String TYPEFACE_CACHE_CATCH_FROM_FILE = "text.TypefaceCache.cacheTypefaceFromFile";
    ...
    public static final String UI_OWNER_CREATE_VIEW_ASYNC_RUNNABLE = "UIOwner.createAsyncViewRunnable.";
    public static final String UI_OWNER_CREATE_VIEW_ASYNC_RUNNABLE_AFTER = "UIOwner.AfterCreateAsyncViewRunnable.";
    ...
    public static final String UI_OWNER_INVOKE_UI_METHOD_FOR_SELECTOR_QUERY = "UIOwner.invokeUIMethodForSelectorQuery.";
