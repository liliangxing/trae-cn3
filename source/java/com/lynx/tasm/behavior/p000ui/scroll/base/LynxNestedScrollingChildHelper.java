...
public class LynxNestedScrollingChildHelper {
    ...
    public LynxNestedScrollingChildHelper(View view) {
        this.mView = view;
    }
    ...
    public ViewParent getNestedScrollingParentForType(int i) {
        return i == 0 ? this.mNestedScrollingParentTouch : this.mNestedScrollingParentNonTouch;
    }
