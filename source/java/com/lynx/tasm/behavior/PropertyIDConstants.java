...
public final class PropertyIDConstants {
    ...
    public static final String[] PROPERTY_CONSTANT = {"AUTO_INSERTED_BEGIN", "top", "left", "right", "bottom", "position", "box-sizing", "background-color", PropsConstants.BORDER_LEFT_COLOR, PropsConstants.BORDER_RIGHT_COLOR, PropsConstants.BORDER_TOP_COLOR, PropsConstants.BORDER_BOTTOM_COLOR, PropsConstants.BORDER_RADIUS, PropsConstants.BORDER_TOP_LEFT_RADIUS, PropsConstants.BORDER_BOTTOM_LEFT_RADIUS, PropsConstants.BORDER_TOP_RIGHT_RADIUS, PropsConstants.BORDER_BOTTOM_RIGHT_RADIUS, PropsConstants.BORDER_WIDTH, PropsConstants.BORDER_LEFT_WIDTH, PropsConstants.BORDER_RIGHT_WIDTH, PropsConstants.BORDER_TOP_WIDTH, PropsConstants.BORDER_BOTTOM_WIDTH, "color", "opacity", "display", PropsConstants.OVERFLOW, "height", "width", "max-width", "min-width", "max-height", "min-height", "padding", "padding-left", "padding-right", "padding-top", "padding-bottom", "margin", "margin-left", "margin-right", "margin-top", "margin-bottom", PropsConstants.WHITE_SPACE, PropsConstants.LETTER_SPACING, PropsConstants.TEXT_ALIGN, PropsConstants.LINE_HEIGHT, PropsConstants.TEXT_OVERFLOW, PropsConstants.FONT_SIZE, PropsConstants.FONT_WEIGHT, "flex", "flex-grow", "flex-shrink", "flex-basis", "flex-direction", "flex-wrap", "align-items", "align-self", "align-content", "justify-content", "background", PropsConstants.BORDER_COLOR, PropsConstants.FONT_FAMILY, PropsConstants.FONT_STYLE, "transform", PropsConstants.ANIMATION, "animation-name", "animation-duration", "animation-timing-function", "animation-delay", "animation-iteration-count", "animation-direction", "animation-fill-mode", "animation-play-state", PropsConstants.LINE_SPACING, PropsConstants.BORDER_STYLE, "order", PropsConstants.BOX_SHADOW, PropsConstants.TRANSFORM_ORIGIN, "linear-orientation", "linear-weight-sum", "linear-weight", "linear-gravity", "linear-layout-gravity", AnimationConstant.C_DURATION, AnimationConstant.C_TIMING_FUNCTION, AnimationConstant.C_DELAY, AnimationConstant.C_PROPERTY, AnimationConstant.D_DURATION, AnimationConstant.D_TIMING_FUNCTION, AnimationConstant.D_DELAY, AnimationConstant.D_PROPERTY, AnimationConstant.U_DURATION, AnimationConstant.U_TIMING_FUNCTION, AnimationConstant.U_DELAY, "adapt-font-size", "aspect-ratio", PropsConstants.TEXT_DECORATION, PropsConstants.TEXT_SHADOW, PropsConstants.BACKGROUND_IMAGE, PropsConstants.BACKGROUND_POSITION, PropsConstants.BACKGROUND_ORIGIN, PropsConstants.BACKGROUND_REPEAT, PropsConstants.BACKGROUND_SIZE, PropsConstants.BORDER, "visibility", PropsConstants.BORDER_RIGHT, PropsConstants.BORDER_LEFT, PropsConstants.BORDER_TOP, PropsConstants.BORDER_BOTTOM, AnimationConstant.TRANSITION, "transition-property", "transition-duration", "transition-delay", "transition-timing-function", "content", PropsConstants.BORDER_LEFT_STYLE, PropsConstants.BORDER_RIGHT_STYLE, PropsConstants.BORDER_TOP_STYLE, PropsConstants.BORDER_BOTTOM_STYLE, "implicit-animation", PropsConstants.OVERFLOW_X, PropsConstants.OVERFLOW_Y, PropsConstants.WORD_BREAK_STRATEGY, PropsConstants.BACKGROUND_CLIP, PropsConstants.OUTLINE, PropsConstants.OUTLINE_COLOR, PropsConstants.OUTLINE_STYLE, PropsConstants.OUTLINE_WIDTH, PropsConstants.VERTICAL_ALIGN, PropsConstants.CARET_COLOR, "direction", "relative-id", "relative-align-top", "relative-align-right", "relative-align-bottom", "relative-align-left", "relative-top-of", "relative-right-of", "relative-bottom-of", "relative-left-of", "relative-layout-once", "relative-center", PropsConstants.ENTER_TRANSITION_NAME, PropsConstants.EXIT_TRANSITION_NAME, PropsConstants.PAUSE_TRANSITION_NAME, PropsConstants.RESUME_TRANSITION_NAME, "flex-flow", PropsConstants.Z_INDEX, "text-decoration-color", "linear-cross-gravity", "margin-inline-start", "margin-inline-end", "padding-inline-start", "padding-inline-end", "border-inline-start-color", "border-inline-end-color", "border-inline-start-width", "border-inline-end-width", "border-inline-start-style", "border-inline-end-style", "border-start-start-radius", "border-end-start-radius", "border-start-end-radius", "border-end-end-radius", "relative-align-inline-start", "relative-align-inline-end", "relative-inline-start-of", "relative-inline-end-of", "inset-inline-start", "inset-inline-end", PropsConstants.MASK_IMAGE, "grid-template-columns", "grid-template-rows", "grid-auto-columns", "grid-auto-rows", "grid-column-span", "grid-row-span", "grid-column-start", "grid-column-end", "grid-row-start", "grid-row-end", "grid-column-gap", "grid-row-gap", "justify-items", "justify-self", "grid-auto-flow", "filter", "list-main-axis-gap", "list-cross-axis-gap", "linear-direction", PropsConstants.PERSPECTIVE, "cursor", PropsConstants.TEXT_INDENT, "clip-path", "text-stroke", PropsConstants.TEXT_STROKE_WIDTH, PropsConstants.TEXT_STROKE_COLOR, PropsConstants.X_AUTO_FONT_SIZE, PropsConstants.X_AUTO_FONT_SIZE_PRESET_SIZES, "mask", PropsConstants.MASK_REPEAT, PropsConstants.MASK_POSITION, PropsConstants.MASK_CLIP, PropsConstants.MASK_ORIGIN, PropsConstants.MASK_SIZE, "gap", "column-gap", "row-gap", PropsConstants.IMAGE_RENDERING, PropsConstants.HYPHENS, "-x-app-region", "AUTO_INSERTED_END"};
