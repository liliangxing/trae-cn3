...
public class C0921e1 extends AbstractC0924f1<PushTokenResult> {
    public C0921e1(String str, IMessageEntity iMessageEntity) {
    ...
    public void mo758a(ApiException apiException, Object obj) {
        ...
        if (apiException.getErrorCode() == HonorPushErrorEnum.SUCCESS.getErrorCode()) {
            if (obj instanceof PushTokenResult) {
                ...
                try {
                    C0916d.f695b.m760a(C0937l.f734e.m773a(), pushTokenResult.getPushToken());
                } catch (Exception unused) {
                }
                this.f711a.m777a((C0943n0<TResult>) pushTokenResult);
                return;
            }
