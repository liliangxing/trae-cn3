...
public class SVG {
    ...
    static class Pattern extends SvgViewBoxContainer implements NotDirectlyRendered {
        ...
        @Override // com.caverock.androidsvg.SVG.SvgObject
        String getNodeName() {
            return AddressParam.SETTING_BDWK_EXTENSION_PATTERN;
        }
    }
    ...
    public static class Length implements Cloneable {
        ...
        public float floatValueX(SVGAndroidRenderer sVGAndroidRenderer) {
            switch (C00841.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()]) {
                case 1:
                    return this.value;
                case 2:
        ...
        public float floatValue(float f) {
            int i = C00841.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes6.dex */
    public static /* synthetic */ class C00841 {
    ...
    public SvgElementBase getElementById(String str) {
        ...
        if (str.equals(this.rootElement.f41id)) {
            return this.rootElement;
        }
    ...
    private SvgElementBase getElementById(SvgContainer svgContainer, String str) {
        ...
        if (str.equals(svgElementBase.f41id)) {
            return svgElementBase;
        }
        for (Object obj : svgContainer.getChildren()) {
            if (obj instanceof SvgElementBase) {
                SvgElementBase svgElementBase2 = (SvgElementBase) obj;
                if (str.equals(svgElementBase2.f41id)) {
