...
public class SVGImageView extends ImageView {
    ...
    private void init(AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet, C0083R.styleable.SVGImageView, i, 0);
        try {
            String string = obtainStyledAttributes.getString(C0083R.styleable.SVGImageView_css);
            if (string != null) {
                this.renderOptions.css(string);
            }
            int resourceId = obtainStyledAttributes.getResourceId(C0083R.styleable.SVGImageView_svg, -1);
            if (resourceId != -1) {
                setImageResource(resourceId);
                return;
            }
            String string2 = obtainStyledAttributes.getString(C0083R.styleable.SVGImageView_svg);
            if (string2 != null) {
