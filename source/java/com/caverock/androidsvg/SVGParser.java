...
public class SVGParser {
    ...
    public static class ColourKeywords {
        ...
        static {
            ...
            hashMap.put(SccResult.LABEL_GRAY, -8355712);
    ...
    */
        ...
        try {
            switch (SVGAttr.fromString(str)) {
                ...
                case marker_end:
                    ...
                    return;
                case display:
                    if (str2.indexOf(124) >= 0 || !VALID_DISPLAY_VALUES.contains(HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str2 + '|')) {
                        return;
                    }
                    ...
                    return;
                case visibility:
                    if (str2.indexOf(124) >= 0 || !VALID_VISIBILITY_VALUES.contains(HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str2 + '|')) {
                        return;
                    }
        ...
        while (!textScanner.empty()) {
            ...
            switch (nextFunction.hashCode()) {
                case -1081239615:
                    ...
                    break;
                case -925180581:
                    if (nextFunction.equals(PropsConstants.ROTATE)) {
                        c = 1;
                        break;
                    }
                    break;
                case 109250890:
                    ...
                    break;
                case 109493390:
                    if (nextFunction.equals(PropsConstants.SKEW_X)) {
                        c = 3;
                        break;
                    }
                    break;
                case 109493391:
                    if (nextFunction.equals(PropsConstants.SKEW_Y)) {
                        c = 4;
                        break;
                    }
                    break;
    ...
    private static void parseFont(SVG.Style style, String str) {
        String nextToken;
        if ("|caption|icon|menu|message-box|small-caption|status-bar|".contains(HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str + '|')) {
            TextScanner textScanner = new TextScanner(str);
            Integer num = null;
            ...
            switch (i2) {
                ...
                case 97:
                    ...
                    if (!Float.isNaN(checkedNextFloat6) && nextFloat >= 0.0f && checkedNextFloat3 >= 0.0f) {
                        ...
                        f3 = checkedNextFloat5;
                        f4 = f3;
                        f5 = checkedNextFloat6;
                        f6 = f5;
                        textScanner.skipCommaWhitespace();
                        if (!textScanner.empty()) {
                            return pathDefinition;
                ...
                case 99:
                    ...
                    if (i2 == 99) {
                        checkedNextFloat += f3;
                        checkedNextFloat2 += f5;
                        nextFloat2 += f3;
                        checkedNextFloat7 += f5;
                        checkedNextFloat8 += f3;
                        checkedNextFloat9 += f5;
                    }
                    f = checkedNextFloat8;
                    f2 = checkedNextFloat9;
                    pathDefinition.cubicTo(nextFloat2, checkedNextFloat7, f, f2, checkedNextFloat, checkedNextFloat2);
                    f4 = f;
                    f3 = checkedNextFloat;
                    f6 = f2;
                    f5 = checkedNextFloat2;
                    textScanner.skipCommaWhitespace();
                    if (!textScanner.empty()) {
                    }
                    break;
                ...
                case 81:
                case 113:
                    f4 = textScanner.nextFloat();
                    f6 = textScanner.checkedNextFloat(f4);
                    float checkedNextFloat12 = textScanner.checkedNextFloat(f6);
                ...
                case 115:
                    ...
                    f = nextFloat6;
                    f2 = checkedNextFloat14;
                    pathDefinition.cubicTo(f9, f10, f, f2, checkedNextFloat, checkedNextFloat2);
                    f4 = f;
                    f3 = checkedNextFloat;
                    f6 = f2;
                    f5 = checkedNextFloat2;
                ...
                case 116:
                    ...
                    if (i2 == 116) {
                        nextFloat7 += f3;
                        checkedNextFloat15 += f5;
                    }
                    f3 = nextFloat7;
                    f5 = checkedNextFloat15;
                    pathDefinition.quadTo(f4, f6, f3, f5);
                    textScanner.skipCommaWhitespace();
                    if (!textScanner.empty()) {
                    }
