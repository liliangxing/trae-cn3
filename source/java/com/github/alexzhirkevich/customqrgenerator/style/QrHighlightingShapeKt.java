...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\f\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0007¨\u0006\u0003"}, d2 = {"asHighlightingShape", "Lcom/github/alexzhirkevich/customqrgenerator/style/QrHighlightingShape;", "Lcom/github/alexzhirkevich/customqrgenerator/style/QrShapeModifier;", "custom_qr_generator_release"}, k = 2, mv = {1, 6, 0}, xi = 48)
...
public final class QrHighlightingShapeKt {
    ...
    public static final QrHighlightingShape asHighlightingShape(final QrShapeModifier qrShapeModifier) {
        ...
        return qrShapeModifier instanceof QrHighlightingShape ? (QrHighlightingShape) qrShapeModifier : new QrHighlightingShape() { // from class: com.github.alexzhirkevich.customqrgenerator.style.QrHighlightingShapeKt$$ExternalSyntheticLambda0
            ...
            public final boolean invoke(int i, int i2, int i3, Neighbors neighbors) {
                boolean m2746asHighlightingShape$lambda0;
                m2746asHighlightingShape$lambda0 = QrHighlightingShapeKt.m2746asHighlightingShape$lambda0(QrShapeModifier.this, i, i2, i3, neighbors);
                return m2746asHighlightingShape$lambda0;
            }
        };
    }
    ...
    public static final boolean m2746asHighlightingShape$lambda0(QrShapeModifier qrShapeModifier, int i, int i2, int i3, Neighbors neighbors) {
        Intrinsics.checkNotNullParameter(qrShapeModifier, "$this_asHighlightingShape");
