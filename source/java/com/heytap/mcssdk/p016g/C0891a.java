package com.heytap.mcssdk.p016g;
...
public class C0891a {
    ...
    /* renamed from: a */
    public static boolean m643a(Context context, String str, DataMessage dataMessage) {
        ArrayList arrayList = new ArrayList();
    ...
    /* renamed from: a */
    public static boolean m644a(Context context, List<String> list) {
        ArrayList arrayList = new ArrayList();
        String packageName = context.getPackageName();
