...
import com.ss.android.update.UpdateStrategyManager;
import java.io.File;
...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u0000 '2\u00020\u0001:\u0001'B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\u0012\u0010\u0016\u001a\u00020\u00172\b\u0010\u0018\u001a\u0004\u0018\u00010\u0019H\u0014J\b\u0010\u001a\u001a\u00020\u0017H\u0002J\b\u0010\u001b\u001a\u00020\u0017H\u0002J\b\u0010\u001c\u001a\u00020\u0017H\u0002J\b\u0010\u001d\u001a\u00020\u0017H\u0002J\u0018\u0010\u001e\u001a\u00020\u00172\u0006\u0010\u001f\u001a\u00020 2\u0006\u0010!\u001a\u00020\u0005H\u0002J\u0010\u0010\"\u001a\u00020\u00172\u0006\u0010!\u001a\u00020\u0005H\u0002J\b\u0010#\u001a\u00020\u0005H\u0002J\b\u0010$\u001a\u00020\u0017H\u0002J\b\u0010%\u001a\u00020\u0017H\u0016J\b\u0010&\u001a\u00020\u0017H\u0017R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u000e\u0010\f\u001a\u00020\rX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u0004\u0018\u00010\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u0004\u0018\u00010\u0011X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0012\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0014\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0015\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006("}, d2 = {"Lcom/bytedance/trae/update/dialogs/UpdateDialog;", "Landroid/app/Dialog;", "ctx", "Landroid/content/Context;", "autoUpdate", "", "<init>", "(Landroid/content/Context;Z)V", "getCtx", "()Landroid/content/Context;", "getAutoUpdate", "()Z", "helper", "Lcom/ss/android/update/UpdateHelper;", "sp", "Landroid/content/SharedPreferences;", "iUpdateConfig", "Lcom/ss/android/update/IUpdateConfig;", "btConfirm", "Landroid/widget/TextView;", "btCancel", "tvContent", "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;", "initUI", "bindData", "initAction", "confirmClick", "installReadyApk", "readyApkFile", "Ljava/io/File;", "forceUpdate", "downloadApkFile", "isNetworkAvailable", "cancelClick", IMessageCallbackService.EVENT_TYPE_SHOW, "onBackPressed", "Companion", "bits-impl_mainlandRelease"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class UpdateDialog extends Dialog {
    ...
    /* compiled from: UpdateDialog.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0014\u0010\u0004\u001a\u00020\u0005X\u0086D¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/bytedance/trae/update/dialogs/UpdateDialog$Companion;", "", "<init>", "()V", "TAG", "", "getTAG", "()Ljava/lang/String;", "bits-impl_mainlandRelease"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
    ...
    private final void bindData() {
        ...
        this.sp = getContext().getSharedPreferences("upgrade_dialog.prefs", 0);
    ...
    private final void initAction() {
        ...
        if (textView != null) {
            textView.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.trae.update.dialogs.UpdateDialog$$ExternalSyntheticLambda0
        ...
        TextView textView2 = this.btConfirm;
        if (textView2 != null) {
            textView2.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.trae.update.dialogs.UpdateDialog$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    UpdateDialog.this.confirmClick();
                }
            });
        }
    }
    ...
    public final void confirmClick() {
        if (this.helper.isRealCurrentVersionOut()) {
            ...
            if (updateReadyApk != null) {
                installReadyApk(updateReadyApk, this.helper.isForceUpdate());
            } else {
                downloadApkFile(this.helper.isForceUpdate());
            }
        }
    }

    private final void installReadyApk(File readyApkFile, boolean forceUpdate) {
        this.helper.cancelNotifyReady();
        this.helper.installApk(getContext(), readyApkFile);
        this.helper.clickUpdateButton(this.autoUpdate);
        if (forceUpdate) {
            return;
        }
    ...
    private final void downloadApkFile(boolean forceUpdate) {
        ...
        if (!forceUpdate) {
            ...
            UpdateMainDialog.INSTANCE.showProcessDialog(this.autoUpdate);
        }
        this.helper.clickUpdateButton(this.autoUpdate);
        if (forceUpdate) {
            return;
    ...
    public final void cancelClick() {
        ...
        this.helper.clickCloseButton(this.autoUpdate);
        cancel();
        if (this.helper.isForceUpdate()) {
            IUpdateConfig iUpdateConfig = this.iUpdateConfig;
            if (iUpdateConfig == null || (updateConfig = iUpdateConfig.getUpdateConfig()) == null || (iUpdateForceExit = updateConfig.getiUpdateForceExit()) == null) {
                return;
            }
