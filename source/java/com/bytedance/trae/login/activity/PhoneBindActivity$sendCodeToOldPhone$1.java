...
@Metadata(d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u0016\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u0006H\u0016J\u0016\u0010\u0007\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u0006H\u0016¨\u0006\b"}, d2 = {"com/bytedance/trae/login/activity/PhoneBindActivity$sendCodeToOldPhone$1", "Lcom/bytedance/sdk/account/AccountSdkCallback;", "Lcom/bytedance/sdk/account/response/SendCodeResponseData;", "onSuccess", "", "response", "Lcom/bytedance/sdk/account/AccountSdkResponse;", "onError", "impl_mainlandRelease"}, k = 1, mv = {2, 0, 0}, xi = 48)
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
public final class PhoneBindActivity$sendCodeToOldPhone$1 implements AccountSdkCallback<SendCodeResponseData> {
    final /* synthetic */ PhoneBindActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public PhoneBindActivity$sendCodeToOldPhone$1(PhoneBindActivity phoneBindActivity) {
    ...
    public void onSuccess(AccountSdkResponse<SendCodeResponseData> response) {
        ...
        phoneBindActivity.runOnUiThreadSafe(new Function0() { // from class: com.bytedance.trae.login.activity.PhoneBindActivity$sendCodeToOldPhone$1$$ExternalSyntheticLambda1
            public final Object invoke() {
                Unit onSuccess$lambda$0;
                onSuccess$lambda$0 = PhoneBindActivity$sendCodeToOldPhone$1.onSuccess$lambda$0(PhoneBindActivity.this);
    ...
    public static final Unit onSuccess$lambda$0(PhoneBindActivity phoneBindActivity) {
        ...
        textView = phoneBindActivity.tvVerifyOldHint;
        VerifyCodeInputView verifyCodeInputView2 = null;
        if (textView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("tvVerifyOldHint");
            textView = null;
        }
        int i = C0820R.string.trae_phone_verify_old_hint;
        str = phoneBindActivity.oldPhoneNumber;
        textView.setText(phoneBindActivity.getString(i, new Object[]{str}));
        phoneBindActivity.showStep(1);
        phoneBindActivity.startCountdownOld();
        ...
        if (verifyCodeInputView == null) {
            ...
            verifyCodeInputView2 = verifyCodeInputView;
        }
    ...
    public void onError(final AccountSdkResponse<SendCodeResponseData> response) {
        Intrinsics.checkNotNullParameter(response, "response");
        PhoneBindActivity.trackSettingsPhoneBindingResult$default(this.this$0, SccResult.MESSAGE_FAIL, "send_old_code", null, response.errorMessage, 4, null);
        final PhoneBindActivity phoneBindActivity = this.this$0;
        phoneBindActivity.runOnUiThreadSafe(new Function0() { // from class: com.bytedance.trae.login.activity.PhoneBindActivity$sendCodeToOldPhone$1$$ExternalSyntheticLambda0
            public final Object invoke() {
                Unit onError$lambda$1;
                onError$lambda$1 = PhoneBindActivity$sendCodeToOldPhone$1.onError$lambda$1(PhoneBindActivity.this, response);
