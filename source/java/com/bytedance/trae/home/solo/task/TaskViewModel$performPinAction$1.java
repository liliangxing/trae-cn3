...
@DebugMetadata(c = "com.bytedance.trae.home.solo.task.TaskViewModel$performPinAction$1", f = "TaskViewModel.kt", i = {}, l = {906, 908, 916, 919, 922, 925, 935}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
public final class TaskViewModel$performPinAction$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public TaskViewModel$performPinAction$1(boolean z, String str, TaskViewModel taskViewModel, Continuation<? super TaskViewModel$performPinAction$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TaskViewModel$performPinAction$1(this.$shouldPin, this.$conversationId, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (this.$shouldPin) {
                    this.label = 1;
                    obj = IPinConversationService.INSTANCE.pinRawCall(new PinConversationRequest(this.$conversationId), (Continuation) this);
                    ...
                    if (!(httpDataResult instanceof HttpDataResult.Success)) {
                        ...
                        if (bizResp.isSuccess()) {
                            this.this$0.applyPinSuccess(this.$conversationId, this.$shouldPin, (PinConversationResponse) bizResp.getData());
                            ...
                            this.label = 4;
                            if (mutableSharedFlow4.emit(Boxing.boxInt(C0820R.string.solo_toast_pin_version_incompatible), (Continuation) this) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        ...
                        TraeLogUtil.INSTANCE.e("TaskViewModel", "performPinAction error: conversationId=" + this.$conversationId + ", shouldPin=" + this.$shouldPin + ", code=" + error.getCode() + ", msg=" + error.getMsg(), error.getThrowable());
                ...
                this.label = 2;
                obj = IPinConversationService.INSTANCE.unpinRawCall(new PinConversationRequest(this.$conversationId), (Continuation) this);
                if (obj == coroutine_suspended) {
                    return coroutine_suspended;
                }
                httpDataResult = (HttpDataResult) obj;
