...
@DebugMetadata(c = "com.bytedance.trae.home.solo.setting.viewmodel.DeviceManagementViewModel$delete$2", f = "DeviceManagementViewModel.kt", i = {}, l = {192, 193}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
public final class DeviceManagementViewModel$delete$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DeviceManagementViewModel$delete$2(DeviceManagementViewModel deviceManagementViewModel, DeviceManagementDevice deviceManagementDevice, Continuation<? super DeviceManagementViewModel$delete$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new DeviceManagementViewModel$delete$2(this.this$0, this.$device, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = deviceManagementRepository.deleteDevice(this.$device.getId(), (Continuation) this);
