...
public class IReportAlogSettings$$Impl implements IReportAlogSettings {
    ...
    public IReportAlogSettings$$Impl(Storage storage) {
    ...
    public String getReportAlogConfig() {
        ...
        return (storage == null || !storage.contains("report_alog")) ? "" : this.mStorage.getString("report_alog");
    }
