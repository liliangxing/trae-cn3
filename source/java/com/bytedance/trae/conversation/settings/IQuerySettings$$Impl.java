...
public class IQuerySettings$$Impl implements IQuerySettings {
    ...
    public IQuerySettings$$Impl(Storage storage) {
    ...
    public String getWorkAttachmentSettings() {
        ...
        return (storage == null || !storage.contains("input_limit")) ? "" : this.mStorage.getString("input_limit");
    }
