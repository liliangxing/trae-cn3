...
@DebugMetadata(c = "com.bytedance.trae.conversation.git.GitSelectionViewModel$loadMoreRepos$1", f = "GitSelectionViewModel.kt", i = {}, l = {170}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
public final class GitSelectionViewModel$loadMoreRepos$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public GitSelectionViewModel$loadMoreRepos$1(GitSelectionViewModel gitSelectionViewModel, String str, Continuation<? super GitSelectionViewModel$loadMoreRepos$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GitSelectionViewModel$loadMoreRepos$1(this.this$0, this.$pageToken, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            mutableLiveData = this.this$0._repoLoadingMore;
            mutableLiveData.setValue(Boxing.boxBoolean(true));
            this.label = 1;
            obj = GitRemoteRepository.INSTANCE.getInstance().fetchReposPage(50, this.$pageToken, (Continuation) this);
        ...
        mutableLiveData2 = this.this$0._repoLoadingMore;
        ...
        if (result.getSuccess()) {
            ...
            list = gitSelectionViewModel.cachedRepoItems;
            gitSelectionViewModel.cachedRepoItems = CollectionsKt.plus(list, arrayList2);
            mutableLiveData4 = this.this$0._repoLoadMoreResult;
