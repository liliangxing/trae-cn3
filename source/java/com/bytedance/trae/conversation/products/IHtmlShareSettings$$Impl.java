...
public class IHtmlShareSettings$$Impl implements IHtmlShareSettings {
    ...
    public IHtmlShareSettings$$Impl(Storage storage) {
    ...
    public String getHtmlShareMinIdeVersion() {
        ...
        return (storage == null || !storage.contains("cli_share_html_control")) ? "" : this.mStorage.getString("cli_share_html_control");
    }
