...
@DebugMetadata(c = "com.bytedance.trae.conversation.products.PreviewWebViewActivity$onCreate$4", f = "PreviewWebViewActivity.kt", i = {}, l = {183}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
final class PreviewWebViewActivity$onCreate$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public PreviewWebViewActivity$onCreate$4(PreviewWebViewActivity previewWebViewActivity, String str, String str2, String str3, Continuation<? super PreviewWebViewActivity$onCreate$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PreviewWebViewActivity$onCreate$4(this.this$0, this.$rawUrl, this.$chatSessionId, this.$cliType, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new PreviewWebViewActivity$onCreate$4$result$1(this.this$0, this.$rawUrl, this.$chatSessionId, this.$cliType, null), (Continuation) this);
