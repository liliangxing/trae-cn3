...
public class ITaskPinSettings$$Impl implements ITaskPinSettings {
    ...
    public ITaskPinSettings$$Impl(Storage storage) {
    ...
    public String getCliTaskPinMinIdeVersion() {
        ...
        return (storage == null || !storage.contains("cli_task_pin_min_ide_version")) ? "" : this.mStorage.getString("cli_task_pin_min_ide_version");
    }
