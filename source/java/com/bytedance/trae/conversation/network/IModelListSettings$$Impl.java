...
public class IModelListSettings$$Impl implements IModelListSettings {
    ...
    public IModelListSettings$$Impl(Storage storage) {
    ...
    public String getCliModelListMinIdeVersion() {
        ...
        return (storage == null || !storage.contains("cli_model_list_min_ide_version")) ? "" : this.mStorage.getString("cli_model_list_min_ide_version");
    }
