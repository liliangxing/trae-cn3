...
public class IPluginSettings$$Impl implements IPluginSettings {
    ...
    public IPluginSettings$$Impl(Storage storage) {
    ...
    public String getCliTaskPluginMinIdeVersion() {
        ...
        return (storage == null || !storage.contains("cli_task_plugin_min_ide_version")) ? "" : this.mStorage.getString("cli_task_plugin_min_ide_version");
    }
