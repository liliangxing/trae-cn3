...
public final class VolcRtcClient$preloadEngine$engineHandler$1 extends IRTCEngineEventHandler {
    ...
    public void onError(final int err) {
        VolcRtcClient.INSTANCE.notifyListeners(new Function1() { // from class: com.bytedance.trae.conversation.voice.rtc.VolcRtcClient$preloadEngine$engineHandler$1$$ExternalSyntheticLambda0
            public final Object invoke(Object obj) {
                Unit onError$lambda$0;
                onError$lambda$0 = VolcRtcClient$preloadEngine$engineHandler$1.onError$lambda$0(err, (VolcRtcClient.Listener) obj);
    ...
    public void onWarning(int warn) {
        FLogger.INSTANCE.w("VolcRtcClient", "RTC onWarning: " + warn);
    }
    ...
    public void onServerParamsSetResult(final int error) {
        VolcRtcClient.INSTANCE.notifyListeners(new Function1() { // from class: com.bytedance.trae.conversation.voice.rtc.VolcRtcClient$preloadEngine$engineHandler$1$$ExternalSyntheticLambda1
            public final Object invoke(Object obj) {
                Unit onServerParamsSetResult$lambda$1;
                onServerParamsSetResult$lambda$1 = VolcRtcClient$preloadEngine$engineHandler$1.onServerParamsSetResult$lambda$1(error, (VolcRtcClient.Listener) obj);
