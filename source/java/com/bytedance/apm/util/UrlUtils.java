...
public class UrlUtils {
    public static String addParamsToURL(String str, Map<String, String> map) {
        if (!TextUtils.isDigitsOnly(str) && map != null && !map.isEmpty()) {
            ...
            if (str.endsWith("?")) {
                str = str + encode("sdk_version", "UTF-8") + ContainerUtils.KEY_VALUE_DELIMITER + encode(String.valueOf(400), "UTF-8");
            } else {
                str = str + ContainerUtils.FIELD_DELIMITER + encode("sdk_version", "UTF-8") + ContainerUtils.KEY_VALUE_DELIMITER + encode(String.valueOf(400), "UTF-8");
            }
