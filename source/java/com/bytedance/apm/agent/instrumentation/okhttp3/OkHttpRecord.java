...
public class OkHttpRecord {
    ...
    public static class OtherInfo {
        ...
        public boolean is_main_process = ApmContext.isMainProcess();
    }
    ...
    private void dealHeader() {
        ...
        try {
            jSONObject.put(OkHttpEventListener.X_TT_CONTENT_ENCODING, this.headerRequest.x_tt_content_encoding);
            jSONObject.put(OkHttpEventListener.X_TT_TRACE_HOST, this.headerRequest.x_tt_trace_host);
            jSONObject.put(OkHttpEventListener.X_TT_TRACE_ID, this.headerRequest.x_tt_trace_id);
            jSONObject.put(OkHttpEventListener.X_TT_TRACE_TAG, this.headerRequest.x_tt_trace_tag);
    ...
    private void dealOther() {
        ...
        try {
            this.recordJson.put(PreloadConfig.KEY_OTHER, jSONObject);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }
    ...
    private void dealTime() {
        ...
        try {
            ...
            jSONObject3.put(CommonKey.KEY_SEND, this.timeDetailedDuration.send);
    ...
    private void fillResponse() {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(AlogMonitor.ALOG_RESULT_CODE, this.recordResponse.code);
            jSONObject.put(ApmTrafficStats.TTNET_SENT_BYTES, this.recordResponse.sent_bytes);
            jSONObject.put(ApmTrafficStats.TTNET_RECEIVED_BYTES, this.recordResponse.received_bytes);
        ...
        try {
            this.recordJson.put(ApmTrafficStats.TTNET_RESPONSE, jSONObject);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }
