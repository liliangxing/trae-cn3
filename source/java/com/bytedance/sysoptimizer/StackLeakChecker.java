...
public class StackLeakChecker {
    public static final long CHECK_INTERVAL_10_SEC = 10000000;
    private static final int LEAK_THREAD_THRESHOLD = 10;
    ...
    public static synchronized void setInterval(int i, long j) {
        synchronized (StackLeakChecker.class) {
            ...
            long j2 = j > CHECK_INTERVAL_10_SEC ? (j / CHECK_INTERVAL_10_SEC) * CHECK_INTERVAL_10_SEC : 10000000L;
