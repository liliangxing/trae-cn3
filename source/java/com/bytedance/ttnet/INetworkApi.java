...
public interface INetworkApi {
    ...
    @GET
    Call<TypedInput> doGetBytes(@AddCommonParam boolean z, @MaxLength int i, @Url String str, @QueryMap(encode = true) Map<String, String> map, @HeaderList List<Header> list, @ExtraInfo Object obj);
