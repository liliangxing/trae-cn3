...
final class DBServiceImplV4$updateUploadCursorAndDelete$1 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ List<UploadItemV4> $pendingDeleteList;
    ...
    public DBServiceImplV4$updateUploadCursorAndDelete$1(DBServiceImplV4 dBServiceImplV4, List<? extends UploadItemV4> list, List<? extends UploadItemV4> list2, SyncCursor syncCursor) {
        super(0);
        this.this$0 = dBServiceImplV4;
        this.$undistributedUploads = list;
        this.$pendingDeleteList = list2;
        this.$syncCursor = syncCursor;
    }

    /* renamed from: invoke, reason: merged with bridge method [inline-methods] */
    public final Boolean m976invoke() {
        String str;
        ...
        try {
            ...
            final List<UploadItemV4> list2 = this.$pendingDeleteList;
            final SyncCursor syncCursor = this.$syncCursor;
            return (Boolean) mDbInst.runInTransaction(new Callable() { // from class: com.bytedance.sync.v4.presistence.DBServiceImplV4$updateUploadCursorAndDelete$1$$ExternalSyntheticLambda0
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    Boolean m975invoke$lambda0;
                    m975invoke$lambda0 = DBServiceImplV4$updateUploadCursorAndDelete$1.m975invoke$lambda0(list, dBServiceImplV4, list2, syncCursor);
                    return m975invoke$lambda0;
                }
            });
        } catch (Exception e) {
            Exception exc = e;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0059, code lost:
        ...
        if (r3.updateReportCursor(r4, r6.reportCursor) > 0) goto L19;
     */
    ...
    */
    public static final Boolean m975invoke$lambda0(List list, DBServiceImplV4 dBServiceImplV4, List list2, SyncCursor syncCursor) {
        boolean z;
        BusinessDao mBusinessDao;
        UploadDaoV4 mUpStreamDao;
        UploadDaoV4 mUpStreamDao2;
        Intrinsics.checkNotNullParameter(list, "$undistributedUploads");
        Intrinsics.checkNotNullParameter(dBServiceImplV4, "this$0");
        Intrinsics.checkNotNullParameter(list2, "$pendingDeleteList");
        Intrinsics.checkNotNullParameter(syncCursor, "$syncCursor");
        boolean z2 = true;
        if (!list.isEmpty()) {
            mUpStreamDao2 = dBServiceImplV4.getMUpStreamDao();
            if (mUpStreamDao2.update(list) > 0) {
                z = true;
                if (!list2.isEmpty()) {
                    mUpStreamDao = dBServiceImplV4.getMUpStreamDao();
                    z = mUpStreamDao.deleteUploadDataList(list2) > 0;
                }
                if (z) {
