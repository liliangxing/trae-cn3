...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return String.format(Locale.ROOT, "%.4g", Double.valueOf(elapsedNanos / TimeUnit.NANOSECONDS.convert(1L, r2))) + " " + abbreviate(chooseUnit(elapsedNanos));
    }
    ...
    /* renamed from: com.bytedance.timonbase.commoncache.ratelimiter.Stopwatch$1, reason: invalid class name */
    /* loaded from: classes5.dex */
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (AnonymousClass1.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            ...
            case 7:
                return AirActionConstant.ActionId.ACTION_ID_DEFAULT_VALUE;
            default:
