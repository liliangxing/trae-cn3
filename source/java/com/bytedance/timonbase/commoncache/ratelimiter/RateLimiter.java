...
import com.bytedance.timonbase.commoncache.ratelimiter.SmoothRateLimiter;
...
public abstract class RateLimiter {
    ...
    public static abstract class SleepingStopwatch {
        ...
        public static SleepingStopwatch createFromSystemTimer() {
            return new SleepingStopwatch() { // from class: com.bytedance.timonbase.commoncache.ratelimiter.RateLimiter.SleepingStopwatch.1
                ...
                protected void sleepMicrosUninterruptibly(long j) {
                    if (j > 0) {
                        sleepUninterruptibly(j, TimeUnit.MICROSECONDS);
                    }
                }
            };
        }
