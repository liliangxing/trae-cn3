...
public abstract class SmoothRateLimiter extends RateLimiter {
    ...
    private long saturatedAdd(long j, long j2) {
        long j3 = j + j2;
    ...
    static final class SmoothWarmingUp extends SmoothRateLimiter {
        ...
        @Override // com.bytedance.timonbase.commoncache.ratelimiter.SmoothRateLimiter
    ...
    @Override // com.bytedance.timonbase.commoncache.ratelimiter.RateLimiter
    ...
    final long reserveEarliestAvailable(int i, long j) {
        ...
        this.nextFreeTicketMicros = saturatedAdd(this.nextFreeTicketMicros, storedPermitsToWaitTime(this.storedPermits, min) + ((long) ((d - min) * this.stableIntervalMicros)));
