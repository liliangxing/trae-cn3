...
public final class AnnieXLynxModelPreloadTask extends BaseModelAnnieTask {
    ...
    public AnnieXLynxModelPreloadTask(LoadFlowTask loadFlowTask) {
        super(loadFlowTask);
    ...
    public Object work(CoroutineScope coroutineScope, AnnieXModelProvider annieXModelProvider, Continuation<? super Unit> continuation) {
        BuildersKt.launch$default(coroutineScope, Dispatchers.getDefault(), (CoroutineStart) null, new AnnieXLynxModelPreloadTask$work$2(annieXModelProvider, this, null), 2, (Object) null);
