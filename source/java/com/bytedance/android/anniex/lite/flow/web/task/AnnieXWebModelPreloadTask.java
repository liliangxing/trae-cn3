...
public final class AnnieXWebModelPreloadTask extends BaseModelAnnieTask {
    ...
    public AnnieXWebModelPreloadTask(LoadFlowTask loadFlowTask) {
        super(loadFlowTask);
    ...
    public Object work(CoroutineScope coroutineScope, AnnieXModelProvider annieXModelProvider, Continuation<? super Unit> continuation) {
        BuildersKt.launch$default(coroutineScope, Dispatchers.getDefault(), (CoroutineStart) null, new AnnieXWebModelPreloadTask$work$2(annieXModelProvider, this, null), 2, (Object) null);
