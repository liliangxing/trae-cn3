...
public final class RightSheetBehavior<V extends View> extends SheetBaseBehavior<V> {
    ...
    */
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        if (!child.isShown() || (disablePullDown(event) && disablePullUp())) {
            ...
            if (target == weakReference.get()) {
                ...
                if (dx > 0) {
                    ...
                    if (i > this.collapsedOffset && !getIsHideAble()) {
                        int i2 = left - this.collapsedOffset;
                        consumed[0] = i2;
    ...
    */
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target, int type) {
        ...
        if (this.lastNestedScrollDy > 30) {
            ...
            ViewDragHelper viewDragHelper = this.viewDragHelper;
            if (viewDragHelper != null) {
                boolean smoothSlideViewTo = viewDragHelper.smoothSlideViewTo(child, i, child.getTop());
                z = true;
            }
            z = false;
            if (z) {
    ...
    /* compiled from: RightSheetBehavior.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0017\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\u0007\u001a\u00020\bH\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/bytedance/android/anniex/container/popup/RightSheetBehavior$SettleRunnable;", "Ljava/lang/Runnable;", "view", "Landroid/view/View;", "targetState", "", "(Lcom/bytedance/android/anniex/container/popup/RightSheetBehavior;Landroid/view/View;I)V", "run", "", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes2.dex */
