...
import com.bytedance.android.standard.tools.C0079R;
import com.bytedance.android.standard.tools.logging.Logger;
import com.bytedance.android.standard.tools.p001ui.UIUtils;
...
public final class DeviceUtils {
    ...
    /* renamed from: com_bytedance_android_standard_tools_device_DeviceUtils_android_net_wifi_WifiInfo_getMacAddress */
    private static String m33x317df00e(WifiInfo wifiInfo) {
    ...
    /* renamed from: com_bytedance_android_standard_tools_device_DeviceUtils_android_telephony_TelephonyManager_getDeviceId */
    private static String m34x47a4c25d(TelephonyManager telephonyManager) {
        HeliosApiHook heliosApiHook = new HeliosApiHook();
        Object[] objArr = new Object[0];
        ExtraInfo extraInfo = new ExtraInfo(false, "()Ljava/lang/String;");
    ...
    public static boolean isFoldableScreenV2(Context context) {
        ...
        if (isSamsung() && checkSamsungFoldableList()) {
            ...
            mIsFoldableScreen = 1;
        } else if (isVivoFoldableScreen()) {
            mIsFoldableScreen = 1;
        } else if (isMiui() && isMiuiFoldableScreen()) {
            mIsFoldableScreen = 1;
        }
        return mIsFoldableScreen > 0;
    }

    public static boolean isVivoFoldableScreen() {
        Method method = ReflectUtils.getMethod("android.util.FtDeviceInfo", "getDeviceType");
        if (method == null) {
            return false;
        }
        try {
    ...
    public static boolean isMiuiFoldableScreen() {
        try {
    ...
    */
    ...
    public static boolean isHonor() {
        return Build.MANUFACTURER != null && Build.MANUFACTURER.toUpperCase(Locale.getDefault()).contains(HonorKeys.NAME);
    }
                        ...
                        if (!TextUtils.isEmpty(prop5)) {
                            ...
                            if (!TextUtils.isEmpty(prop6)) {
                                ...
                                if (!TextUtils.isEmpty(prop7)) {
                                    ...
                                    String prop8 = getProp(KEY_VERSION_MAGIC);
                                    sVersion = prop8;
    ...
    public static String getProp(String str) {
        ...
        try {
            bufferedReader = new BufferedReader(new InputStreamReader(Runtime.getRuntime().exec("getprop " + str).getInputStream(), UrlUtils.UTF_8), 1024);
        ...
        synchronized (map) {
            ...
            if (StringUtils.isEmpty(str2)) {
                try {
                    ...
                    Logger.m40e(TAG, "getSystemProperties in sp error", e);
                }
            }
        }
        return str2;
    ...
    public static String getDeviceId(Context context) {
        String m34x47a4c25d = m34x47a4c25d((TelephonyManager) context.getSystemService("phone"));
        return (TextUtils.isEmpty(m34x47a4c25d) || "000000000000000".equals(m34x47a4c25d)) ? m33x317df00e(((WifiManager) context.getApplicationContext().getSystemService("wifi")).getConnectionInfo()) : m34x47a4c25d;
    }
    ...
    */
    ...
    public static int getStatusBarHeight(Context context) {
        ...
        int identifier = context.getResources().getIdentifier("status_bar_height", "dimen", Consts.OS_NAME);
    ...
    public static boolean isLargeScreenPad(Context context, int i, int i2) {
        ...
        return i >= resources.getDimensionPixelSize(C0079R.dimen.mohist_standard_tools_large_pad_min_width) && i2 >= resources.getDimensionPixelSize(C0079R.dimen.mohist_standard_tools_large_pad_min_height);
    }
    ...
    public static int getInternalDimensionSize(Context context, String str) {
        try {
            int identifier = Resources.getSystem().getIdentifier(str, "dimen", Consts.OS_NAME);
            if (identifier > 0) {
    ...
    public static boolean isMiuiV10() {
        initMiuiVersion();
        return "V10".equals(sMiuiVersion) || "v10".equals(sMiuiVersion);
    }
