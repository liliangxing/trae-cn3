...
public interface WebViewMonitorConstant {
    ...
    public interface Params {
        ...
        public static final String IS_FIRST_PAGE_STARTED = "is_first_page_started";
        ...
        public static final String TTWEBVIEW_TIMING = "ttwebview_timing";
        public static final String URL = "url";
    }
    ...
    public interface Web {
        ...
        public static final List<String> BLOCK_LIST = Arrays.asList("about:blank");
        public static final String ENGINE_TYPE = "engine_type";
        public static final String EVENT_TYPE = "event_type";
        public static final String FORMAT_URL = "format_url";
        public static final String FULL_URL = "full_url";
        public static final String IS_TTWEBVIEW = "is_ttwebview";
        ...
        public static final String RES_FORMAT_SRC = "res_format_src";
        public static final String RES_FROM = "res_from";
        public static final String RES_FULL_SRC = "res_full_src";
        public static final String RES_SIZE = "res_size";
        public static final String RES_TYPE = "res_type";
        public static final String ROOT_URL = "root_url";
        public static final String USE_TTWEB_HOOK = "use_ttweb_hook";
