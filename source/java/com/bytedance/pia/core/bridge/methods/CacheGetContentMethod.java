...
public final class CacheGetContentMethod implements PiaMethod.ICall<Params, Result> {
    public static final String CACHE_FAILED = "[Cache] PIA Cache Get Content Failed, reason: (";

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    public static final String NAME = "pia.internal.cache.getContent";
    private static final PiaMethod<Params, Result> method = new PiaMethod<>(NAME, PiaMethod.Scope.All, new IFactory() { // from class: com.bytedance.pia.core.bridge.methods.CacheGetContentMethod$Companion$method$1
        @Override // com.bytedance.pia.core.api.utils.IFactory
        public final PiaMethod.ICall<CacheGetContentMethod.Params, CacheGetContentMethod.Result> create() {
            return new CacheGetContentMethod();
        }
    });
    ...
    public static final class Companion {
        ...
        public final PiaMethod<Params, Result> getMethod() {
            return CacheGetContentMethod.method;
        }
    }
    ...
    /* compiled from: CacheGetContentMethod.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\u001f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003\u0012\u000e\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\u000b\u0010\u000b\u001a\u0004\u0018\u00010\u0003HÆ\u0003J\u0011\u0010\f\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0005HÆ\u0003J'\u0010\r\u001a\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\u0010\b\u0002\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u0005HÆ\u0001J\u0013\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0011\u001a\u00020\u0012HÖ\u0001J\t\u0010\u0013\u001a\u00020\u0003HÖ\u0001R\u001e\u0010\u0004\u001a\n\u0012\u0004\u0012\u00020\u0003\u0018\u00010\u00058\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0018\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0014"}, d2 = {"Lcom/bytedance/pia/core/bridge/methods/CacheGetContentMethod$Params;", "", "url", "", "extraVary", "", "(Ljava/lang/String;Ljava/util/List;)V", "getExtraVary", "()Ljava/util/List;", "getUrl", "()Ljava/lang/String;", "component1", "component2", "copy", "equals", "", "other", "hashCode", "", "toString", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
    ...
    /* compiled from: CacheGetContentMethod.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\b\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\f\u001a\u00020\rHÖ\u0001J\t\u0010\u000e\u001a\u00020\u0003HÖ\u0001R\u0016\u0010\u0002\u001a\u00020\u00038\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u000f"}, d2 = {"Lcom/bytedance/pia/core/bridge/methods/CacheGetContentMethod$Result;", "", "content", "", "(Ljava/lang/String;)V", "getContent", "()Ljava/lang/String;", "component1", "copy", "equals", "", "other", "hashCode", "", "toString", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
    public static final /* data */ class Result {
        ...
        public boolean equals(Object other) {
            ...
            return (other instanceof Result) && Intrinsics.areEqual(this.content, ((Result) other).content);
        }
    ...
    public void invoke2(IPiaBridge bridge, Params params, final IConsumer<Result> resolve, final IConsumer<PiaMethod.Error> reject) {
        ...
        if (str == null || str.length() == 0) {
            ...
            ThreadUtil.runOnPia(new Runnable() { // from class: com.bytedance.pia.core.bridge.methods.CacheGetContentMethod$invoke$1
                @Override // java.lang.Runnable
                public final void run() {
                    try {
                        String str2 = "";
                        if (!PIACacheManager.INSTANCE.getHasInit().get()) {
                            resolve.accept(new CacheGetContentMethod.Result(""));
                            return;
                        }
                        String str3 = null;
                        ...
                        if (queryHeaders$default != null) {
                            ...
                            if (expire != null && expire.longValue() > System.currentTimeMillis() && !TextUtils.isEmpty(version)) {
                                str3 = PIACacheManager.queryContent(normalizeUrl);
                            }
                        }
                        IConsumer<CacheGetContentMethod.Result> iConsumer = resolve;
                        if (str3 != null) {
                            str2 = str3;
                        }
                        iConsumer.accept(new CacheGetContentMethod.Result(str2));
                    } catch (Exception e) {
                        reject.accept(new PiaMethod.Error(CacheGetContentMethod.CACHE_FAILED + e.getMessage() + ')'));
                    }
                }
            });
        }
