...
public class StageEventBasic {
    ...
    public StageEventBasic(JSONObject jSONObject) {
        this(jSONObject.optString("priority_name"), jSONObject.optInt("group_id", -1), jSONObject.optString("event_name"), jSONObject.optString(SqliteDatabaseKt.colMonitorId), jSONObject.optLong("local_time_ms"), StageEventType.parse(jSONObject.optString("type")));
    }
