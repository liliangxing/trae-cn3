...
public enum EventStage {
    ...
    DATA_LIST_ADDED("06"),
    PRE_PROCESS_END("0F"),
    PROCESS_START(Constants.PERSONALIZED_CONTENT_RECOMMENDATION_ENABLE),
    TOURIST_BREAK("11"),
    ...
    NO_SESSION_DROP("16"),
    PROCESS_END("1F"),
    DB_SAVE_START(Constants.USER_EXPERIENCE_IMPROVEMENT_PLAN_ENABLE),
    ...
    DB_SAVE_FAILED("2B"),
    DB_SAVE_END("2F"),
    REPORT_START(Constants.CONTENT_RICHNESS_EXPANSION_FREQUENCY_TEEN_MODE),
    PACK_END("31"),
    ...
    public static EventStage fromLabel(String str) {
        for (EventStage eventStage : values()) {
            if (eventStage.label.equals(str)) {
                return eventStage;
            }
        }
        return UNKNOWN;
