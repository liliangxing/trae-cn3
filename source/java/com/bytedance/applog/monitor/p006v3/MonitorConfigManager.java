...
public class MonitorConfigManager {
    ...
    /* renamed from: sp */
    private SharedPreferences f58sp;
    ...
    public void init(Context context, String str) {
        ...
        this.f58sp = context.getSharedPreferences(str + "@applog_monitor_config", 0);
        loadConfigFromSp();
    }
    ...
    public void setConfig(JSONObject jSONObject) {
        ...
        SharedPreferences sharedPreferences = this.f58sp;
    ...
    private void loadConfigFromSp() {
        ...
        if (jSONObject != null && this.f58sp != null) {
            setConfig(jSONObject);
            return;
        }
        if (!this.f58sp.contains(SP_KEY_ENABLED)) {
            this.enabled = defaultEnabled;
            ...
            this.enabled = this.f58sp.getBoolean(SP_KEY_ENABLED, defaultEnabled);
            this.maxRequestBodySize = this.f58sp.getInt(SP_KEY_REQ_MAX_BODY_SIZE, defaultMaxRequestBodySizeKb * 1024);
            this.maxRequestCount = this.f58sp.getInt(SP_KEY_MAX_REQ_COUNT, defaultMaxRequestCountPerInterval);
            this.errorReportEnabled = this.f58sp.getBoolean(SP_KEY_ERROR_REPORTABLE, defaultErrorReportEnabled);
            this.reportInterval = this.f58sp.getLong(SP_KEY_INTERVAL, defaultReportInterval);
            this.coldStartReportDelay = this.f58sp.getLong(SP_KEY_COLD_START_REPORT_DELAY, defaultColdStartReportDelay);
            this.dataAliveDays = this.f58sp.getInt(SP_KEY_DATA_KEEP_ALIVE_DAYS, defaultDataAliveDays);
            this.sentryEnabled = this.f58sp.getBoolean(SP_KEY_SENTRY_ENABLED, defaultSentryEnabled);
            this.sentryColdStartSamplingRate = this.f58sp.getInt(SP_KEY_SENTRY_COLD_START_SAMPLING_RATE, defaultSentryColdStartSamplingRate);
            String string = this.f58sp.getString(SP_KEY_SENTRY_EVENTS, null);
