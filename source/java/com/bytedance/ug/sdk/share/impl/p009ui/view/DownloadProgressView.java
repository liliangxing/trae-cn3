...
public class DownloadProgressView extends LinearLayout {
    ...
    private void init() {
        ...
        int rgb = Color.rgb(HprofMemoryConstants.HPROF_HEAPDUMP_ROOT_UNKNOWN, HprofMemoryConstants.HPROF_HEAPDUMP_ROOT_UNKNOWN, HprofMemoryConstants.HPROF_HEAPDUMP_ROOT_UNKNOWN);
