...
public class LittleVideoTokenDialog extends AbsTokenDialog {
    ...
    public void initViews() {
        ...
        ShareConfigManager.getInstance().getImageBitmap(this.mTokenInfoBean.getPics().get(0).getUrl(), new GetImageCallback() { // from class: com.bytedance.ug.sdk.share.impl.ui.token.recognize.LittleVideoTokenDialog.1
            ...
            public void onSuccess(final Bitmap bitmap) {
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.bytedance.ug.sdk.share.impl.ui.token.recognize.LittleVideoTokenDialog.1.1
                    ...
                    public void run() {
                        Bitmap bitmap2;
                        if (LittleVideoTokenDialog.this.mCoverImg == null || (bitmap2 = bitmap) == null || bitmap2.isRecycled()) {
                            return;
                        }
                        LittleVideoTokenDialog.this.mCoverImg.setImageBitmap(bitmap);
                    }
                });
            }
        });
    ...
    public void initActions() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.ug.sdk.share.impl.ui.token.recognize.LittleVideoTokenDialog.2
            ...
            public void onClick(View view) {
                LittleVideoTokenDialog.this.onReadbtnClicked();
            }
        });
    }
}
