...
public class SystemOptTokenShareDialog extends SSDialog implements ISystemOptShareTokenDialog {
    ...
    private void initViews() {
        ...
        this.mCloseIcon.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.ug.sdk.share.impl.ui.token.share.SystemOptTokenShareDialog.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                SystemOptTokenShareDialog.this.dismiss();
            }
        });
        this.mToCopyBt.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.ug.sdk.share.impl.ui.token.share.SystemOptTokenShareDialog.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (SystemOptTokenShareDialog.this.mDialogCallback != null) {
                    SystemOptTokenShareDialog.this.mDialogCallback.onClick(true, SystemOptTokenShareDialog.this.mUris);
                }
            }
        });
    ...
    @Override // com.bytedance.ug.sdk.share.api.p008ui.ISystemOptShareTokenDialog
    public void initTokenDialog(ShareContent shareContent, ArrayList<Uri> arrayList, ISystemOptShareTokenDialog.ITokenDialogCallback iTokenDialogCallback) {
    ...
    public void dismiss() {
        super.dismiss();
        ISystemOptShareTokenDialog.ITokenDialogCallback iTokenDialogCallback = this.mDialogCallback;
