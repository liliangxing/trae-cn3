...
public class ProcessUtils {
    ...
    public static boolean isMainProcess(Context context) {
        ...
        if (!TextUtils.isEmpty(currentProcessName) && currentProcessName.contains(Constants.COLON_SEPARATOR)) {
            return false;
        }
        Boolean valueOf = Boolean.valueOf(currentProcessName.equals(context.getPackageName()));
        mIsMainProcess = valueOf;
