...
public final class Utils {
    ...
    public static byte[] streamToBytes(@Nullable InputStream inputStream) throws IOException {
    ...
    */
    ...
    public static boolean permitsRequestBody(String str) {
        return requiresRequestBody(str) || str.equals("OPTIONS") || str.equals("DELETE") || str.equals(OpenNetMethod.PROPFIND) || str.equals(OpenNetMethod.MKCOL) || str.equals(OpenNetMethod.LOCK);
    }
    ...
    public static TypedOutput convert(final RequestBody requestBody) {
        return new TypedOutput() { // from class: com.bytedance.retrofit2.Utils.1
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        return new IllegalArgumentException(String.format(str, objArr) + "\n    for method " + method.getDeclaringClass().getSimpleName() + LibrarianImpl.Constants.DOT + method.getName(), th);
    }
