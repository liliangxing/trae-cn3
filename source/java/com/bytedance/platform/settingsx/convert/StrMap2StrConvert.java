...
public class StrMap2StrConvert implements ITypeConverter<Map<String, String>> {
    @Override // com.bytedance.platform.settingsx.api.ITypeConverter
    public Map<String, String> to(String str) {
        if (str == null) {
            return null;
        }
        try {
    ...
    @Override // com.bytedance.platform.settingsx.api.ITypeConverter
    public String from(Map<String, String> map) {
        if (map == null) {
            return null;
        }
