...
public class IntMap2StrConvert implements ITypeConverter<Map<String, Integer>> {
    @Override // com.bytedance.platform.settingsx.api.ITypeConverter
    public Map<String, Integer> to(String str) {
        if (str == null) {
            return null;
        }
        try {
    ...
    @Override // com.bytedance.platform.settingsx.api.ITypeConverter
    public String from(Map<String, Integer> map) {
        if (map == null) {
            return null;
        }
