...
public class TypeToken<T> {
    ...
    protected TypeToken() {
        ...
        this.rawType = (Class<? super T>) Types.getRawType(superclassTypeParameter);
        this.hashCode = superclassTypeParameter.hashCode();
    }

    TypeToken(Type type) {
        Type canonicalize = Types.canonicalize((Type) Preconditions.checkNotNull(type));
        this.type = canonicalize;
        this.rawType = (Class<? super T>) Types.getRawType(canonicalize);
    ...
    public boolean isAssignableFrom(Type type) {
        ...
        if (type2 instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(Types.getRawType(type)) && isAssignableFrom(type, (GenericArrayType) this.type);
        }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof TypeToken) && Types.equals(this.type, ((TypeToken) obj).type);
    }
