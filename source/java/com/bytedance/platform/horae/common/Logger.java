...
public final class Logger {
    ...
    private static ILog sLogImpl = new ILog() { // from class: com.bytedance.platform.horae.common.Logger.1
        ...
        private int convertLevel(Level level) {
            int i = AnonymousClass2.$SwitchMap$com$bytedance$platform$horae$common$Logger$Level[level.ordinal()];
            if (i == 1) {
                return 3;
            }
            if (i == 2) {
    ...
    public static void e(boolean z, String str, String str2) {
        println(str, str2, Level.ERROR, z);
    }
    ...
    public static void println(String str, String str2, Level level, boolean z) {
        if (z) {
            if (level.ordinal() >= sLevel.ordinal()) {
                sLogImpl.println(str, str2, level, z);
                return;
            }
            return;
        }
        println(str, str2, level);
    }
    ...
    public static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$bytedance$platform$horae$common$Logger$Level;

        static {
            int[] iArr = new int[Level.values().length];
            $SwitchMap$com$bytedance$platform$horae$common$Logger$Level = iArr;
            try {
                iArr[Level.DEBUG.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$bytedance$platform$horae$common$Logger$Level[Level.ERROR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$bytedance$platform$horae$common$Logger$Level[Level.WARNING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$bytedance$platform$horae$common$Logger$Level[Level.INFO.ordinal()] = 4;
