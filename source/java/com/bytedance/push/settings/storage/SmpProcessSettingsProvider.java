...
public class SmpProcessSettingsProvider extends ContentProvider {
    ...
    private static void init(Context context) throws IllegalStateException {
        if (TextUtils.isEmpty(sShareAuthority)) {
            sShareAuthority = getProviderAuthority(context, SmpProcessSettingsProvider.class.getName());
        }
        if (TextUtils.isEmpty(sShareAuthority)) {
    ...
    public static Runnable createNotifyRunnable(final Context context, final String str, final String str2, final String str3) {
        return new Runnable() { // from class: com.bytedance.push.settings.storage.SmpProcessSettingsProvider.1
            ...
            public void run() {
                Uri contentUri = SmpProcessSettingsProvider.getContentUri(context, new Item(str, str2, "val", str3));
                if (contentUri == null) {
                    return;
                }
                try {
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        Storage create2 = SettingsManager.getStorageFactory().create(getContext(), true, create.storageKey, SharedPreferenceStorageFactory.PROCESS_SMP);
        SettingsLoggerHelper.getInstance().mo256d("query on SmpProcessSettingsProvider for " + create.storageKey + " storage class name is " + create2.getClass().getName());
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        if (sMatcher.match(uri) == 65536) {
            ...
            try {
                Storage create = SettingsManager.getStorageFactory().create(getContext(), true, str2, SharedPreferenceStorageFactory.PROCESS_SMP);
                SettingsLoggerHelper.getInstance().mo256d("insert on SmpProcessSettingsProvider for " + str2 + " storage class name is " + create.getClass().getName());
                edit = create.edit();
    ...
    public Bundle call(String str, String str2, Bundle bundle) {
        ...
        return processor.process(getContext(), str2, bundle, SharedPreferenceStorageFactory.PROCESS_SMP);
    }
