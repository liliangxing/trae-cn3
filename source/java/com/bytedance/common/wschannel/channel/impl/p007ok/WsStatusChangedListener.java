...
class WsStatusChangedListener implements WsOkClient.WsStatusListener {
    ...
    public void onMessage(ByteString byteString) {
        Logger.m190d(OkChannelImpl.TAG, "onMessage() : " + byteString.toString());
    ...
    public void onFailure(String str, int i, String str2) {
        Logger.m190d(OkChannelImpl.TAG, "onFailure() : " + str2);
        Bundle bundle = new Bundle();
        bundle.putString("url", str);
        bundle.putInt("error_code", i);
        bundle.putString("error_msg", str2);
        bundle.putString("method", "onFailure");
        WsChannelLog.onEventV3Bundle(this.mContext, OkChannelImpl.TAG, bundle);
        if (this.mWsChannelClient != null) {
            JSONObject jSONObject = new JSONObject();
            try {
    ...
    public void onClosed(String str, int i, String str2) {
        Logger.m190d(OkChannelImpl.TAG, "onClosed() : " + str2);
        if (this.mWsChannelClient != null) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("type", 0);
    ...
    public void onMessage(String str) {
        Logger.m190d(OkChannelImpl.TAG, "onMessage():" + str);
        IWsChannelClient iWsChannelClient = this.mWsChannelClient;
        if (iWsChannelClient != null) {
            try {
    ...
    public void onOpen(Response response) {
        Logger.m190d(OkChannelImpl.TAG, "onOpen(): " + response.toString());
        if (this.mWsChannelClient != null) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("type", 1);
