...
class WireConverter implements MsgConverter {
    ...
    public WsChannelMsg decode(byte[] bArr) throws IOException {
        ...
        String appendServerTiming = appendServerTiming(str3);
        if (!TextUtils.isEmpty(appendServerTiming)) {
            str3 = appendServerTiming;
        }
    ...
    private static String appendServerTiming(String str) {
        StringBuilder sb;
        int indexOf;
