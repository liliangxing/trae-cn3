...
import com.bytedance.networkstackapplib.TTNetworkStackAPI;
...
public final class NetworkUtils {
    ...
    private static TTNetworkStackAPI nqc;
    ...
    private static String com_bytedance_common_utility_NetworkUtils_android_net_wifi_WifiInfo_getMacAddress(WifiInfo wifiInfo) {
    ...
    private static byte[] com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress(NetworkInterface networkInterface) {
        HeliosApiHook heliosApiHook = new HeliosApiHook();
        Object[] objArr = new Object[0];
    ...
    public static int getSimNetworkType(Context context) {
        if (nqc == null) {
            nqc = new TTNetworkStackAPI(context);
        }
        return nqc.getSimNetworkType();
    }
    ...
    public static String getMacAddress(Context context) {
        try {
            ...
            if (connectionInfo != null) {
                return com_bytedance_common_utility_NetworkUtils_android_net_wifi_WifiInfo_getMacAddress(connectionInfo);
            }
            return null;
    ...
    private static String getMacAddressNew(Context context) {
        try {
            ...
            while (networkInterfaces.hasMoreElements()) {
                ...
                byte[] com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress = com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress(nextElement);
                if (com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress != null && com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress.length != 0) {
                    StringBuilder sb = new StringBuilder();
                    for (byte b : com_bytedance_common_utility_NetworkUtils_java_net_NetworkInterface_getHardwareAddress) {
    ...
    private static boolean isNetworkStackAvailable(String str) {
        return (NetworkStackConstant.ERR_NOT_REGISTERED.equals(str) || NetworkStackConstant.ERR_NOT_SUPPORTED.equals(str) || NetworkStackConstant.ERR_DISCONNECTED.equals(str)) ? false : true;
    }
    ...
    private static NetworkType getNetworkTypeInternNew(Context context) {
        ...
        try {
            ...
            if ("MOBILE".equals(activeNetworkType)) {
                if (!isNetworkStackAvailable) {
                    simNetworkType = ((TelephonyManager) context.getSystemService("phone")).getNetworkType();
                } else {
