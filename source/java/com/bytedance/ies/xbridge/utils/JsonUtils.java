...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0005\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0003\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u0006J\u001c\u0010\u0007\u001a\u0010\u0012\u0004\u0012\u00020\t\u0012\u0006\u0012\u0004\u0018\u00010\u00010\b2\u0006\u0010\u0005\u001a\u00020\nJ\u0014\u0010\u000b\u001a\u00020\u00062\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00010\u0004J\u001a\u0010\r\u001a\u00020\n2\u0012\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\u00010\b¨\u0006\u000f"}, d2 = {"Lcom/bytedance/ies/xbridge/utils/JsonUtils;", "", "()V", "jsonToList", "", "json", "Lorg/json/JSONArray;", "jsonToMap", "", "", "Lorg/json/JSONObject;", "listToJSON", "list", "mapToJSON", "map", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
        ...
        for (Map.Entry<String, ? extends Object> entry : map.entrySet()) {
            try {
                ...
                if (value instanceof Long) {
                    ...
                    jSONObject.put(key, IDLXDynamicKt.getValue((IDLXDynamic) value));
                }
            } catch (Throwable th) {
                XLog.INSTANCE.error("mapToJSON error:" + th.getMessage() + ",entry:" + entry);
            }
        }
        return jSONObject;
    }
        ...
        for (Object obj : list) {
            try {
                if (obj instanceof Float) {
                    ...
                    jSONArray.put(IDLXDynamicKt.getValue((IDLXDynamic) obj));
                }
            } catch (Throwable th) {
                XLog.INSTANCE.error("listToJSON error:" + th.getMessage() + ",entry:" + obj);
            }
        }
        return jSONArray;
    }
    ...
    public final Map<String, Object> jsonToMap(JSONObject json) {
        ...
        while (keys.hasNext()) {
            ...
            if (opt instanceof Long) {
                ...
                linkedHashMap.put(next, jsonUtils.jsonToMap(optJSONObject));
                ...
                linkedHashMap.put(next, jsonUtils2.jsonToList(optJSONArray));
