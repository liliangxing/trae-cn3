...
@DebugMetadata(c = "com.bytedance.ies.argus.api.ArgusWebDelegate$verifyShouldOverrideUrlLoading$lambda$24$lambda$23$$inlined$setAsyncReportAwaitTask$1", f = "ArgusWebDelegate.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* renamed from: com.bytedance.ies.argus.api.ArgusWebDelegate$verifyShouldOverrideUrlLoading$lambda$24$lambda$23$$inlined$setAsyncReportAwaitTask$1 */
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes3.dex */
public final class C1156xbcf7c2e8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ ArgusWebViewAspect $callingAspect$inlined;
    final /* synthetic */ CopyOnWriteArrayList $externServiceList$inlined;
    final /* synthetic */ BaseEventCenter.VerifyHandler $this_apply$inlined;
    int label;
    final /* synthetic */ ArgusWebDelegate this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1156xbcf7c2e8(Continuation continuation, CopyOnWriteArrayList copyOnWriteArrayList, ArgusWebDelegate argusWebDelegate, ArgusWebViewAspect argusWebViewAspect, BaseEventCenter.VerifyHandler verifyHandler) {
        super(2, continuation);
        this.$externServiceList$inlined = copyOnWriteArrayList;
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C1156xbcf7c2e8(continuation, this.$externServiceList$inlined, this.this$0, this.$callingAspect$inlined, this.$this_apply$inlined);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Iterator it = this.$externServiceList$inlined.iterator();
        while (it.hasNext()) {
