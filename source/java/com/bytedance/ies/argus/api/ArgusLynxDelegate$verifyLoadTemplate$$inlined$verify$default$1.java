...
@DebugMetadata(c = "com.bytedance.ies.argus.api.ArgusLynxDelegate$verifyLoadTemplate$$inlined$verify$default$1", f = "ArgusLynxDelegate.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes3.dex */
public final class ArgusLynxDelegate$verifyLoadTemplate$$inlined$verify$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ IArgusAspect $aspect;
    final /* synthetic */ LynxSignVerifyCallerParams $params$inlined;
    ...
    public ArgusLynxDelegate$verifyLoadTemplate$$inlined$verify$default$1(boolean z, BaseEventCenter baseEventCenter, IArgusAspect iArgusAspect, Continuation continuation, BaseEventCenter.VerifyHandler verifyHandler, ArgusLynxDelegate argusLynxDelegate, LynxSignVerifyCallerParams lynxSignVerifyCallerParams) {
        super(2, continuation);
        this.$saveEvent = z;
        this.$aspect = iArgusAspect;
        this.this$0$inline_fun$1 = verifyHandler;
        this.this$0 = argusLynxDelegate;
        this.$params$inlined = lynxSignVerifyCallerParams;
        this.this$0$inline_fun = baseEventCenter;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ArgusLynxDelegate$verifyLoadTemplate$$inlined$verify$default$1(this.$saveEvent, this.this$0$inline_fun, this.$aspect, continuation, this.this$0$inline_fun$1, this.this$0, this.$params$inlined);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (!this.$params$inlined.getIsSigned()) {
            context.getReportParams().setForceHighFrequency(true);
        }
        if (this.$params$inlined.getTasmType() == ILynxSecurityService.LynxTasmType.TYPE_TEMPLATE) {
            this.this$0.getContainerContext$anniex_release().setLastOpenFePge(this.$params$inlined);
        }
