...
@DebugMetadata(c = "com.bytedance.ies.argus.api.ArgusWebDelegate$verifyShouldInterceptRequest$$inlined$verify$default$1", f = "ArgusWebDelegate.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* renamed from: com.bytedance.ies.argus.api.ArgusWebDelegate$verifyShouldInterceptRequest$$inlined$verify$default$1 */
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes3.dex */
public final class C1154x4e7cb394 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public C1154x4e7cb394(boolean z, BaseEventCenter baseEventCenter, IArgusAspect iArgusAspect, Continuation continuation, BaseEventCenter.VerifyHandler verifyHandler, ArgusWebDelegate argusWebDelegate) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C1154x4e7cb394(this.$saveEvent, this.this$0$inline_fun, this.$aspect, continuation, this.this$0$inline_fun$1, this.this$0);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        AspectVerifyResult verifyResult = this.this$0$inline_fun$1.getVerifyResult();
        ...
        if (verifyResult.isBlock() && (argusWebResourceRequestRewritePayload = (ArgusWebResourceRequestRewritePayload) verifyResult.getRewritePayload()) != null) {
            argusWebResourceRequestRewritePayload.setResponse(ArgusWebDefaultDelegateKt.createBlockResponse(this.this$0));
        }
