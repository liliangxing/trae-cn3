...
@DebugMetadata(c = "com.bytedance.ies.argus.api.ArgusLynxDelegate$verifyAboutToRequestLynxSSRUrl$$inlined$verify$default$1", f = "ArgusLynxDelegate.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* renamed from: com.bytedance.ies.argus.api.ArgusLynxDelegate$verifyAboutToRequestLynxSSRUrl$$inlined$verify$default$1 */
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes3.dex */
public final class C1149x2ee4e8a4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public C1149x2ee4e8a4(boolean z, BaseEventCenter baseEventCenter, IArgusAspect iArgusAspect, Continuation continuation, BaseEventCenter.VerifyHandler verifyHandler, ArgusLynxDelegate argusLynxDelegate) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C1149x2ee4e8a4(this.$saveEvent, this.this$0$inline_fun, this.$aspect, continuation, this.this$0$inline_fun$1, this.this$0);
    }
