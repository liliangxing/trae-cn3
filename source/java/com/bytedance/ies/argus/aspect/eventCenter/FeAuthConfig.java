...
public final /* data */ class FeAuthConfig {
    ...
    public FeAuthConfig(AuthBridgeAccess access, Set<String> includedMethods, Set<String> excludedMethods, int i, Map<String, MethodCallLimitsBean> methodCallLimits, String feId, FeAuthConfigSource source) {
        Intrinsics.checkNotNullParameter(access, "access");
        Intrinsics.checkNotNullParameter(includedMethods, "includedMethods");
        Intrinsics.checkNotNullParameter(excludedMethods, "excludedMethods");
        Intrinsics.checkNotNullParameter(methodCallLimits, "methodCallLimits");
        ...
        this.methodCallLimits = methodCallLimits;
        this.feId = feId;
        this.source = source;
    }
