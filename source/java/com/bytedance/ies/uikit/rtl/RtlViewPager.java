...
public class RtlViewPager extends ViewPager {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: com.bytedance.ies.uikit.rtl.RtlViewPager.SavedState.1
            ...
            public SavedState m629createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m630newArray(int i) {
    ...
    private class ReversingAdapter extends DelegatingPagerAdapter {
        ...
        @Override // com.bytedance.ies.uikit.rtl.DelegatingPagerAdapter
