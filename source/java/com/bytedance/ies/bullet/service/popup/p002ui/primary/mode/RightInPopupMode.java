...
/* compiled from: RightInPopupMode.kt */
...
public final class RightInPopupMode extends PrimaryPopupMode {
    ...
    public ObjectAnimator getEnterAnim() {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(getFragment().getPopupContainerView(), "translationX", UIUtils.dpToPx$anniex_release(UIUtils.getDisplayMetrics$anniex_release(getFragment().getAct()).getWidth(), getFragment().getAct()), 0.0f);
    ...
    public ObjectAnimator getExitAnim() {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(getFragment().getPopupContainerView(), "translationX", 0.0f, UIUtils.dpToPx$anniex_release(UIUtils.getDisplayMetrics$anniex_release(getFragment().getAct()).getWidth(), getFragment().getAct()));
    ...
    public int getTitleBarBackImageRes() {
        return R.drawable.ic_title_bar_back_normal;
    }
}
