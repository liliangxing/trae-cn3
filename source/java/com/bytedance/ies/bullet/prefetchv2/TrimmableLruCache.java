...
public final class TrimmableLruCache<K, V> {
    ...
    public TrimmableLruCache(int i, Function2<? super K, ? super V, Boolean> function2, Function2<? super K, ? super V, Unit> function22) {
        Intrinsics.checkNotNullParameter(function2, "expireRule");
        Intrinsics.checkNotNullParameter(function22, "onValueTrimmed");
        this.maxSize = i;
    ...
    private final void trimToSize(int maxSize) {
        ...
        while (true) {
            synchronized (this) {
                ...
                Intrinsics.checkNotNullExpressionValue(entry, "map.entries.firstOrNull() ?: return");
                key = entry.getKey();
