...
public final /* data */ class RLChannelBundleModel {
    ...
    public final RLChannelBundleModel copy(String channel, String bundlePath, boolean valid) {
        Intrinsics.checkNotNullParameter(channel, "channel");
        Intrinsics.checkNotNullParameter(bundlePath, "bundlePath");
        return new RLChannelBundleModel(channel, bundlePath, valid);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.channel, rLChannelBundleModel.channel) && Intrinsics.areEqual(this.bundlePath, rLChannelBundleModel.bundlePath) && this.valid == rLChannelBundleModel.valid;
    }
