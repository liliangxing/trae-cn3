...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.bytedance.ies.bullet.container.popup.ui.draggable.ViewDragHelper.1
    ...
    private boolean mDirectFullScreen = false;
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: com.bytedance.ies.bullet.container.popup.ui.draggable.ViewDragHelper.2
    ...
    public static abstract class Callback {
        public abstract boolean canDrag(View view, MotionEvent motionEvent);
        ...
        public abstract boolean isTouchedThreshold(View view, int i);
    ...
    public void abort() {
        ...
        if (this.mDragState == 2) {
            ...
            this.mCallback.dispatchOnBottomSheetChangeMarginTop(this.mCapturedView, currY2 - currX);
    ...
    public boolean continueSettling(boolean z) {
        if (this.mDragState == 2) {
            ...
            if (top != 0) {
                this.mCallback.dispatchOnBottomSheetChangeMarginTop(this.mCapturedView, top);
    ...
    */
                ...
                if (actionMasked != 2) {
                    ...
                    while (i6 < pointerCount) {
                        ...
                        if (isValidPointerForActionMove(pointerId3)) {
                            ...
                            boolean z3 = (findTopChildUnder3 == null || !checkTouchSlop(findTopChildUnder3, f, f2)) ? false : z2;
                            if (z3) {
                                ...
                                if (!this.mCallback.canDrag(findTopChildUnder3, motionEvent)) {
                                    break;
                                }
                            ...
                            if (z3 && tryCaptureViewForDrag(findTopChildUnder3, pointerId3)) {
                                break;
                            }
                        }
                        i6++;
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 1) {
            if (this.mDragState == 1 && !this.mDirectFullScreen) {
                releaseViewForPointerUp();
            }
            cancel();
            if (this.mDirectFullScreen && this.mDragState == 1) {
                setDragState(0);
                return;
            }
            return;
        ...
        if (actionMasked == 2) {
            if (this.mDragState == 1) {
                if (isValidPointerForActionMove(this.mActivePointerId)) {
                    ...
                    if (i7 < 0 && this.mCallback.isTouchedThreshold(this.mCapturedView, i7)) {
                        this.mDirectFullScreen = true;
                        this.mCallback.onViewFullScreenTriggered(this.mCapturedView);
                    } else if (i7 > 0 && this.mCallback.isTouchedThreshold(this.mCapturedView, i7)) {
                        this.mDirectFullScreen = false;
                        this.mCallback.onViewNoFullScreenTriggered(this.mCapturedView, i7);
                    } else {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [com.bytedance.ies.bullet.container.popup.ui.draggable.ViewDragHelper$Callback] */
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(BytePatchException.ErrorCode.paramsError, this.mMaxVelocity);
    ...
    private void dragTo(int i, int i2, int i3, int i4) {
        ...
        if (i4 != 0) {
            ...
            this.mCallback.dispatchOnBottomSheetChangeMarginTop(this.mCapturedView, i4);
