...
import com.bytedance.kmp.image.painter.DrawablePainter$callback$2;
...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.callback = LazyKt.lazy(new Function0<DrawablePainter$callback$2.C01861>() { // from class: com.bytedance.kmp.image.painter.DrawablePainter$callback$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }

            /* JADX WARN: Type inference failed for: r0v0, types: [com.bytedance.kmp.image.painter.DrawablePainter$callback$2$1] */
            /* renamed from: invoke, reason: merged with bridge method [inline-methods] */
            public final C01861 m673invoke() {
                final DrawablePainter drawablePainter = DrawablePainter.this;
                return new Drawable.Callback() { // from class: com.bytedance.kmp.image.painter.DrawablePainter$callback$2.1
                    ...
                    public void invalidateDrawable(Drawable d) {
                        ...
                        drawablePainter3.m671setDrawableIntrinsicSizeuvyYCjk(intrinsicSize2);
                    }
    ...
    private final long m670getDrawableIntrinsicSizeNHjbRc() {
        return ((Size) this.drawableIntrinsicSize.getValue()).unbox-impl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDrawableIntrinsicSize-uvyYCjk, reason: not valid java name */
    public final void m671setDrawableIntrinsicSizeuvyYCjk(long j) {
    ...
    protected boolean applyAlpha(float alpha) {
        this.drawable.setAlpha(RangesKt.coerceIn(MathKt.roundToInt(alpha * HprofMemoryConstants.HPROF_HEAPDUMP_ROOT_UNKNOWN), 0, HprofMemoryConstants.HPROF_HEAPDUMP_ROOT_UNKNOWN));
        return true;
    }
    ...
    public long m672getIntrinsicSizeNHjbRc() {
        return m670getDrawableIntrinsicSizeNHjbRc();
    }
    ...
    protected void onDraw(DrawScope drawScope) {
        ...
        this.drawable.setBounds(0, 0, MathKt.roundToInt(Float.intBitsToFloat((int) (drawScope.getSize-NH-jbRc() >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (drawScope.getSize-NH-jbRc() & 4294967295L))));
        try {
            canvas.save();
