...
@DebugMetadata(c = "com.bytedance.kmp.image.utils.AsyncCache$getOrLoad$2", f = "AsyncCache.kt", i = {0, 0}, l = {38, 24}, m = "invokeSuspend", n = {"$this$coroutineScope", "$this$withLock_u24default$iv"}, s = {"L$0", "L$1"})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
final class AsyncCache$getOrLoad$2<V> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super V>, Object> {
