...
public final class KmpNetworkManager$get$$inlined$get$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public KmpNetworkManager$get$$inlined$get$1(String str, Map map, Map map2, RequestContext requestContext, KmpNetworkManagerImpl kmpNetworkManagerImpl, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KmpNetworkManager$get$$inlined$get$1<>(this.$url, this.$queries, this.$header, this.$requestContext, this.this$0, continuation);
    }
