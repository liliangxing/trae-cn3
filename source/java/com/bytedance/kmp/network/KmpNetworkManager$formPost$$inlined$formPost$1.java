...
public final class KmpNetworkManager$formPost$$inlined$formPost$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public KmpNetworkManager$formPost$$inlined$formPost$1(String str, Map map, Map map2, RequestBody requestBody, RequestContext requestContext, KmpNetworkManagerImpl kmpNetworkManagerImpl, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KmpNetworkManager$formPost$$inlined$formPost$1<>(this.$url, this.$queries, this.$header, this.$requestBody, this.$requestContext, this.this$0, continuation);
    }
