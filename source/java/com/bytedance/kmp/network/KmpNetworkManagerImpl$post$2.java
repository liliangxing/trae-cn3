...
public final class KmpNetworkManagerImpl$post$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public KmpNetworkManagerImpl$post$2(String str, Map<String, String> map, Map<String, String> map2, RequestBody requestBody, RequestContext requestContext, KmpNetworkManagerImpl kmpNetworkManagerImpl, Continuation<? super KmpNetworkManagerImpl$post$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new KmpNetworkManagerImpl$post$2<>(this.$url, this.$queries, this.$header, this.$requestBody, this.$requestContext, this.this$0, continuation);
    }
