...
@Metadata(d1 = {"\u0000\n\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u0001H\u0001\"\u0006\b\u0000\u0010\u0001\u0018\u0001*\u00020\u0002H\u008a@¨\u0006\u0003"}, d2 = {"<anonymous>", "T", "Lkotlinx/coroutines/CoroutineScope;", "com/bytedance/kmp/network/KmpNetworkManagerImpl$get$2"}, k = 3, mv = {1, 7, 0}, xi = 176)
@DebugMetadata(c = "com.bytedance.kmp.network.KmpNetworkManagerImpl$get$2", f = "KmpNetworkManagerImpl.kt", i = {1, 2, 2, 3}, l = {160, 409, 418, 421}, m = "invokeSuspend", n = {"request", "request", "response$iv", "body$iv"}, s = {"L$0", "L$0", "L$1", "L$0"})
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
public final class KmpNativeNetworkManager$get$$inlined$get$1<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public KmpNativeNetworkManager$get$$inlined$get$1(String str, Map map, Map map2, RequestContext requestContext, KmpNetworkManagerImpl kmpNetworkManagerImpl, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new KmpNativeNetworkManager$get$$inlined$get$1<>(this.$url, this.$queries, this.$header, this.$requestContext, this.this$0, continuation);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            request = new Request(appendUnEncodedQueryToUrl, "GET", map2, null, requestContext, kmpRequestMetrics);
