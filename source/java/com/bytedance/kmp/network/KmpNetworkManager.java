...
public final class KmpNetworkManager {
    ...
    public final IKmpNetworkService getService() {
        return service;
    }
    ...
    public static /* synthetic */ Object multiPartPost$default(KmpNetworkManager kmpNetworkManager, String str, String str2, Map map, List list, List list2, Map map2, Map map3, RequestContext requestContext, Continuation continuation, int i, Object obj) {
        ...
        KmpNetworkManagerImpl implementation2 = kmpNetworkManager.getImplementation();
        ...
        KmpNetworkManager$multiPartPost$$inlined$multiPartPost$1 kmpNetworkManager$multiPartPost$$inlined$multiPartPost$1 = new KmpNetworkManager$multiPartPost$$inlined$multiPartPost$1(str, map6, map5, build, requestContext2, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$multiPartPost$$inlined$multiPartPost$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public final /* synthetic */ <T> Object multiPartPost(String str, String str2, Map<String, String> map, List<MultipartRequestBody.MultiSourcePart> list, List<MultipartRequestBody.Part> list2, Map<String, String> map2, Map<String, String> map3, RequestContext requestContext, Continuation<? super T> continuation) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$multiPartPost$$inlined$multiPartPost$1 kmpNetworkManager$multiPartPost$$inlined$multiPartPost$1 = new KmpNetworkManager$multiPartPost$$inlined$multiPartPost$1(str, map3, map2, build, requestContext, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$multiPartPost$$inlined$multiPartPost$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    ...
    public static /* synthetic */ Object formPost$default(KmpNetworkManager kmpNetworkManager, String str, Map map, Map map2, Map map3, RequestContext requestContext, Continuation continuation, int i, Object obj) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$formPost$$inlined$formPost$1 kmpNetworkManager$formPost$$inlined$formPost$1 = new KmpNetworkManager$formPost$$inlined$formPost$1(str, map6, map5, build, requestContext2, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$formPost$$inlined$formPost$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public final /* synthetic */ <T> Object formPost(String str, Map<String, String> map, Map<String, String> map2, Map<String, String> map3, RequestContext requestContext, Continuation<? super T> continuation) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$formPost$$inlined$formPost$1 kmpNetworkManager$formPost$$inlined$formPost$1 = new KmpNetworkManager$formPost$$inlined$formPost$1(str, map3, map2, build, requestContext, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$formPost$$inlined$formPost$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    ...
    public static /* synthetic */ Object postString$default(KmpNetworkManager kmpNetworkManager, String str, String str2, String str3, Map map, Map map2, RequestContext requestContext, Continuation continuation, int i, Object obj) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$postString$$inlined$postString$1 kmpNetworkManager$postString$$inlined$postString$1 = new KmpNetworkManager$postString$$inlined$postString$1(str, map4, map3, kmpNetworkManagerImpl$postString$2, requestContext2, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$postString$$inlined$postString$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public final /* synthetic */ <T> Object postString(String str, String str2, String str3, Map<String, String> map, Map<String, String> map2, RequestContext requestContext, Continuation<? super T> continuation) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$postString$$inlined$postString$1 kmpNetworkManager$postString$$inlined$postString$1 = new KmpNetworkManager$postString$$inlined$postString$1(str, map2, map, kmpNetworkManagerImpl$postString$22, requestContext, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$postString$$inlined$postString$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    ...
    public static /* synthetic */ Object post$default(KmpNetworkManager kmpNetworkManager, String str, RequestBody requestBody, Map map, Map map2, RequestContext requestContext, Continuation continuation, int i, Object obj) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$post$$inlined$post$1 kmpNetworkManager$post$$inlined$post$1 = new KmpNetworkManager$post$$inlined$post$1(str, map4, map3, requestBody2, requestContext2, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$post$$inlined$post$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public final /* synthetic */ <T> Object post(String str, RequestBody requestBody, Map<String, String> map, Map<String, String> map2, RequestContext requestContext, Continuation<? super T> continuation) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$post$$inlined$post$1 kmpNetworkManager$post$$inlined$post$1 = new KmpNetworkManager$post$$inlined$post$1(str, map2, map, requestBody, requestContext, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$post$$inlined$post$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    ...
    public static /* synthetic */ Object get$default(KmpNetworkManager kmpNetworkManager, String str, Map map, Map map2, RequestContext requestContext, Continuation continuation, int i, Object obj) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$get$$inlined$get$1 kmpNetworkManager$get$$inlined$get$1 = new KmpNetworkManager$get$$inlined$get$1(str, map3, map4, requestContext2, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$get$$inlined$get$1, continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public final /* synthetic */ <T> Object get(String str, Map<String, String> map, Map<String, String> map2, RequestContext requestContext, Continuation<? super T> continuation) {
        ...
        CoroutineContext io2 = Dispatchers.getIO();
        Intrinsics.needClassReification();
        KmpNetworkManager$get$$inlined$get$1 kmpNetworkManager$get$$inlined$get$1 = new KmpNetworkManager$get$$inlined$get$1(str, map, map2, requestContext, implementation2, null);
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(io2, kmpNetworkManager$get$$inlined$get$1, continuation);
        InlineMarker.mark(1);
        return withContext;
