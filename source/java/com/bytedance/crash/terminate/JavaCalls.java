...
public class JavaCalls {
    ...
    private static <T> T getFieldOrThrow(Object obj, String str) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static <T> T callMethod(Object obj, String str, Object... objArr) {
        try {
            ...
            NpthLog.w(LOG_TAG, "Meet exception when call Method '" + str + "' in " + obj, e);
            return null;
        }
    }
    ...
    public static <T> T callStaticMethod(String str, String str2, Object... objArr) {
        try {
            ...
            NpthLog.w(LOG_TAG, "Meet exception when call Method '" + str2 + "' in " + str, e);
            return null;
        }
    }
    ...
    public static <T> T newInstance(Class<?> cls, Object... objArr) {
        try {
            ...
            NpthLog.w(LOG_TAG, "Meet exception when make instance as a " + cls.getSimpleName(), e);
            return null;
        }
    }
    ...
    private static <T> T newEmptyInstanceOrThrow(Class<?> cls) throws IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    public static Object newInstance(String str, Object... objArr) {
        try {
            ...
            NpthLog.w(LOG_TAG, "Meet exception when make instance as a " + str, e);
            return null;
        }
    }

    private static Object newInstanceOrThrow(String str, Object... objArr) throws SecurityException, NoSuchMethodException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
