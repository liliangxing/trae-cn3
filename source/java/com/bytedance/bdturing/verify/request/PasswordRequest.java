...
public final class PasswordRequest extends AbstractRequest {
    ...
    */
    ...
    public String getVerifyType() {
        return TuringVerifyType.PWD_VERIFY;
    }
    ...
    public /* synthetic */ PasswordRequest(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str);
    }
    ...
    public void buildUrl(StringBuilder queryBuilder) {
        ...
        UtilsKt.appendParams(queryBuilder, "decision_config", "block-password");
