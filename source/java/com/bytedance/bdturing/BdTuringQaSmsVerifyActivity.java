...
public class BdTuringQaSmsVerifyActivity extends AppCompatActivity implements TuringVerifyInterface {
    ...
    private VerifyWebViewListener webViewListener = new VerifyWebViewListener() { // from class: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity.1
        ...
        public void onLoadPageSuccess() {
            ...
            EventReport.turingH5LoadResult(0, System.currentTimeMillis() - BdTuringQaSmsVerifyActivity.this.mMaskTime, BdTuringQaSmsVerifyActivity.this.mRequest);
        }

        @Override // com.bytedance.bdturing.VerifyWebViewListener
        public void onLoadPageFail(int i, String str) {
            EventReport.turingH5LoadResult(1, System.currentTimeMillis() - BdTuringQaSmsVerifyActivity.this.mMaskTime, BdTuringQaSmsVerifyActivity.this.mRequest);
    ...
    private IVerifyInnerHandler mVerifyHandler = new VerifyDialogHandler() { // from class: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity.2
        ...
        public void onVerifyResult(int i, String str, String str2, String str3, String str4, String str5, JSONObject jSONObject) {
            boolean z = i == 0;
            LogUtil.m162i(BdTuringQaSmsVerifyActivity.TAG, "====> jsb onVerifyResult:" + i);
            EventReport.statisticVerifyResult(i, BdTuringQaSmsVerifyActivity.this.mRequest);
        ...
        public void onSetDialogSize(int i, int i2, boolean z) {
            BdTuringQaSmsVerifyActivity.this.changeDialog(i, i2, z);
        }

        @Override // com.bytedance.bdturing.methods.VerifyDialogHandler
        public void onSetDialogSizeV2(int i, int i2, boolean z) {
            BdTuringQaSmsVerifyActivity.this.changeDialogV2(i, i2, z);
        }

        @Override // com.bytedance.bdturing.methods.VerifyDialogHandler
        public void clearDialogResource() {
            LogUtil.m162i(BdTuringQaSmsVerifyActivity.TAG, "====> jsb clearDialogResource");
        ...
        public void uploadSmarterData() {
            ...
            BdTuringQaSmsVerifyActivity.this.callJsCode(JsCallParser.parseNativeCallJs(1, JsCallParser.VERIFY_DATA, JsCallParser.VALUE_CALL, smarterData, JsCallParser.VERIFY_DATA));
        }
    };
    private ComponentCallbacks mOrientationListener = new ComponentCallbacks() { // from class: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity.5
        ...
        public void onConfigurationChanged(Configuration configuration) {
            if (configuration.orientation == 1 || configuration.orientation == 2) {
                ...
                LogUtil.m160d(BdTuringQaSmsVerifyActivity.TAG, "canOrientation: " + z);
                if (z) {
                    JSONObject jSONObject = new JSONObject();
                    try {
                    ...
                    EventReport.statisticOrientationChange(i, BdTuringQaSmsVerifyActivity.this.mRequest);
                }
            }
        }
    };
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0603R.layout.bdturing_qa_sms_verify_activity);
        AbstractRequest currentRequest = RiskControlService.INSTANCE.getCurrentRequest();
        this.mRequest = currentRequest;
        EventReport.verifyActivityOnCreate(TAG, currentRequest);
        ...
        LogUtil.m162i(TAG, "loadUrl = " + this.mRequest.getUrl());
        ...
        if (this.mIsOrientationChange && layoutParams.width > 0 && layoutParams.height > 0) {
            ...
            this.mWebView.post(new Runnable() { // from class: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity.3
                ...
                public void run() {
                    ...
                    if (z2 && BdTuringQaSmsVerifyActivity.this.mWebContainer != null) {
                        BdTuringQaSmsVerifyActivity.this.mWebContainer.setRadius(0.0f);
                    }
    ...
    public void onBackPressed() {
        LogUtil.m162i(TAG, "====>onBackPressed");
    ...
    /* renamed from: com_bytedance_bdturing_BdTuringQaSmsVerifyActivity__onStop$___twin___ */
    public void m157x1bbced97() {
        super.onStop();
    ...
    protected void onDestroy() {
        ...
        try {
            try {
                if (this.mWebView != null) {
                    getWindow().getDecorView().post(new Runnable() { // from class: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity.6
                        ...
                        public void run() {
                            ViewParent parent;
                            LogUtil.m163w(BdTuringQaSmsVerifyActivity.TAG, "remove webview");
            ...
            if (this.mCallBack != null) {
                int i = C05927.$SwitchMap$com$bytedance$bdturing$EventReport$CloseType[this.mCloseReson.ordinal()];
                if (i == 1) {
    ...
    /* renamed from: com.bytedance.bdturing.BdTuringQaSmsVerifyActivity$7 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes3.dex */
    ...
    /* renamed from: com_bytedance_bdturing_BdTuringQaSmsVerifyActivity_com_bytedance_sysoptimizer_EnterTransitionLancet_onStop */
    public static void m156x83ba46c4(BdTuringQaSmsVerifyActivity bdTuringQaSmsVerifyActivity) {
        bdTuringQaSmsVerifyActivity.m157x1bbced97();
        if (EnterTransitionCrashOptimizer.getContext() != null) {
            try {
                ((Activity) bdTuringQaSmsVerifyActivity).getWindow().getDecorView().getViewTreeObserver().dispatchOnPreDraw();
