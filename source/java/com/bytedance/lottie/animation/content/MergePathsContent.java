...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    public Path getPath() {
        this.path.reset();
        int i = C02691.f39x5d3fc8b8[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
    ...
    /* renamed from: com.bytedance.lottie.animation.content.MergePathsContent$1 */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes4.dex */
    static /* synthetic */ class C02691 {

        /* renamed from: $SwitchMap$com$bytedance$lottie$model$content$MergePaths$MergePathsMode */
        static final /* synthetic */ int[] f39x5d3fc8b8;
        ...
        static {
            ...
            try {
                f39x5d3fc8b8[MergePaths.MergePathsMode.Add.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f39x5d3fc8b8[MergePaths.MergePathsMode.Subtract.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f39x5d3fc8b8[MergePaths.MergePathsMode.Intersect.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f39x5d3fc8b8[MergePaths.MergePathsMode.ExcludeIntersections.ordinal()] = 5;
