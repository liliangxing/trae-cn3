...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u0000 \u00152\u00020\u0001:\u0001\u0015B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0012\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\u0003H\u0007J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u0003H\u0016J\u0018\u0010\f\u001a\u00020\u00032\u0006\u0010\r\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\u0010\u0010\u0010\u001a\u00020\u00072\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u001a\u0010\u0013\u001a\u00020\u00072\u0006\u0010\u0014\u001a\u00020\u00032\b\u0010\u000e\u001a\u0004\u0018\u00010\u000fH\u0016R\u000e\u0010\u0005\u001a\u00020\u0003X\u0082D¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Lcom/bytedance/sdk/xbridge/cn/platform/web/protocol/JSB4Impl;", "Lcom/bytedance/sdk/xbridge/cn/platform/web/WebBridgeProtocol;", LynxBridgeCall.NAME_SPACE, "", "(Ljava/lang/String;)V", "TAG", "_invokeMethod", "", "invocation", "createBridgeCall", "Lcom/bytedance/sdk/xbridge/cn/platform/web/WebBridgeCall;", "msg", "createCallbackMessage", "call", "data", "Lorg/json/JSONObject;", "onSetUp", "view", "Landroid/webkit/WebView;", "sendEvent", Fields.EVENT, "Companion", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
public final class JSB4Impl extends WebBridgeProtocol {
    ...
    */
    ...
    public JSB4Impl(String str) {
        super(str);
        Intrinsics.checkNotNullParameter(str, LynxBridgeCall.NAME_SPACE);
        this.TAG = "JSB4BridgeImpl";
    }

    public /* synthetic */ JSB4Impl(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str);
    }

    /* compiled from: JSB4Impl.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/bytedance/sdk/xbridge/cn/platform/web/protocol/JSB4Impl$Companion;", "", "()V", "BRIDGE_OBJECT_NAME", "", "anniex_release"}, k = 1, mv = {1, 4, 3}, xi = 48)
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
    ...
    public WebBridgeCall createBridgeCall(String msg) {
        ...
        Intrinsics.checkNotNullExpressionValue(optString2, "request.optString(\"JSSDK\")");
        webBridgeCall.setSdkVersion(optString2);
        ...
        Intrinsics.checkNotNullExpressionValue(optString4, "request.optString(\"__iframe_url\")");
        webBridgeCall.setFrameUrl(optString4);
        String optString5 = jSONObject.optString("__callback_id");
        Intrinsics.checkNotNullExpressionValue(optString5, "request.optString(\"__callback_id\")");
        webBridgeCall.setCallbackId(optString5);
        String optString6 = jSONObject.optString(LynxBridgeCall.NAME_SPACE, getDefaultNameSpace());
        Intrinsics.checkNotNullExpressionValue(optString6, "request.optString(\"namespace\", defaultNameSpace)");
        webBridgeCall.setNamespace(wrapHostNamespace$anniex_release(optString6));
        ...
        webBridgeCall.setProtocolVersion("4");
    ...
    public void sendEvent(String event, JSONObject data) {
        ...
        try {
            ...
            jSONObject.put("__timestamp", System.currentTimeMillis());
            jSONObject.put("__sdk_version", "4.0");
            WebBridgeProtocol.evaluateJavaScript$default(this, "javascript:window.BDXBridge && BDXBridge._handleMessageFromApp && BDXBridge._handleMessageFromApp(" + jSONObject + ')', null, 2, null);
