...
public final class LynxDataProcessorForMap {
    ...
    private final Object proxyValue(final Class<? extends XBaseModel> clazz, final HashMap<String, Object> map, final IDLAnnotationData data) throws IllegalInputParamException {
        ...
        return Proxy.newProxyInstance(clazz.getClassLoader(), new Class[]{clazz}, new InvocationHandler() { // from class: com.bytedance.sdk.xbridge.cn.platform.lynx.LynxDataProcessorForMap$proxyValue$1
    ...
    public final Object convertValueWithAnnotation(Object value, IDLParamField annotation, IDLAnnotationData data) {
        ...
        if (isNestListClass(value, annotation)) {
            ...
            for (Object obj : list) {
                ...
                arrayList.add(lynxDataProcessorForMap.proxyValue(javaClass, hashMap2, data));
            }
            return arrayList;
        }
    ...
    private final void checkValue(IDLAnnotationModel classMap, HashMap<String, Object> params) {
        for (Map.Entry<String, IDLParamField> entry : classMap.getStringModel().entrySet()) {
    ...
    public final Map<String, Object> getMapWithDefault(HashMap<String, Object> map, IDLAnnotationModel model, IDLAnnotationData data) {
        ...
        while (it.hasNext()) {
            ...
            if (!Intrinsics.areEqual(((IDLParamField) entry.getValue()).getNestedClassType(), Reflection.getOrCreateKotlinClass(XBaseModel.Default.class)) && (obj instanceof ReadableMap)) {
                ...
                arrayList = lynxDataProcessorForMap.getMapWithDefault(hashMap, iDLAnnotationModel, data);
                ...
                for (Object obj2 : arrayList3) {
                    ...
                    IDLAnnotationModel iDLAnnotationModel2 = data.getModels().get(JvmClassMappingKt.getJavaClass(((IDLParamField) entry.getValue()).getNestedClassType()));
                    Intrinsics.checkNotNull(iDLAnnotationModel2);
                    arrayList4.add(lynxDataProcessorForMap2.getMapWithDefault(hashMap2, iDLAnnotationModel2, data));
                }
