...
@DebugMetadata(c = "com.bytedance.sdk.xbridge.cn.calendar.reducer.CalendarCreateReducer$getCalendars$1$1", f = "CalendarCreateReducer.kt", i = {0}, l = {185}, m = "invokeSuspend", n = {"$this$sequence"}, s = {"L$0"})
...
final class CalendarCreateReducer$getCalendars$1$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super CalendarModel>, Continuation<? super Unit>, Object> {
    ...
    public CalendarCreateReducer$getCalendars$1$1(Cursor cursor, Continuation<? super CalendarCreateReducer$getCalendars$1$1> continuation) {
        super(2, continuation);
        this.$it = cursor;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        Continuation<Unit> calendarCreateReducer$getCalendars$1$1 = new CalendarCreateReducer$getCalendars$1$1(this.$it, continuation);
        calendarCreateReducer$getCalendars$1$1.L$0 = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (this.$it.moveToNext()) {
            ...
            this.label = 1;
            if (sequenceScope.yield(new CalendarModel(j, string, string2, this.$it.getString(4), string3, this.$it.getInt(5), this.$it.getString(6), this.$it.getInt(7)), (Continuation) this) == coroutine_suspended) {
