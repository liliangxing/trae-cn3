...
public class OpenCustomDialog extends Dialog {
    ...
    /* renamed from: com.bytedance.sdk.open.aweme.ui.OpenCustomDialog$a */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
    ...
    /* renamed from: com.bytedance.sdk.open.aweme.ui.OpenCustomDialog$b */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes5.dex */
    ...
    private OpenCustomDialog(Builder builder) {
        super(builder.context, C0087R.style.custom_dialog);
        this.builder = builder;
    }

    /* synthetic */ OpenCustomDialog(Builder builder, ViewOnClickListenerC0110a viewOnClickListenerC0110a) {
        this(builder);
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0087R.layout.openplatform_open_custom_dialog);
        if (!TextUtils.isEmpty(this.builder.mMessage)) {
            ((TextView) findViewById(C0087R.id.content_tv)).setText(this.builder.mMessage);
        }
        TextView textView = (TextView) findViewById(C0087R.id.confirm);
        ...
        TextView textView2 = (TextView) findViewById(C0087R.id.cancel);
        ...
        if (this.builder.mNegativeListener != null) {
            textView2.setOnClickListener(new ViewOnClickListenerC0111b());
        }
        if (this.builder.mOnlyConfirm) {
            findViewById(C0087R.id.vertical_divide).setVisibility(8);
            textView2.setVisibility(8);
        }
        if (this.builder.mContentView != null) {
            FrameLayout frameLayout = (FrameLayout) findViewById(C0087R.id.content_fl);
            frameLayout.addView(this.builder.mContentView, new ViewGroup.LayoutParams(-1, -1));
            frameLayout.setVisibility(0);
            ((TextView) findViewById(C0087R.id.content_tv)).setVisibility(8);
        }
    }
