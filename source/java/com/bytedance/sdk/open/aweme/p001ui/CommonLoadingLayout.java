...
public class CommonLoadingLayout extends FrameLayout {
    ...
    private void init(Context context) {
        View inflate = LayoutInflater.from(context).inflate(C0087R.layout.aweme_open_loading_layout, (ViewGroup) this, true);
        this.mProgress = inflate.findViewById(C0087R.id.double_loading_view);
        this.mProgressBarLayout = (FrameLayout) inflate.findViewById(C0087R.id.progressBarLayout);
    }
