...
public class DoubleColorBallAnimationView extends View {
    ...
    private void checkData() {
        this.mAnimateStartTime = -1L;
        if (this.mSide <= 0) {
            setProgressBarInfo(getContext().getResources().getDimensionPixelSize(C0087R.dimen.default_loading_side));
        }
    ...
    private void init(Context context) {
        this.mColor1 = getContext().getResources().getColor(C0087R.color.aweme_open_loading_color1);
        this.mColor2 = getContext().getResources().getColor(C0087R.color.aweme_open_loading_color2);
    }
