...
public class RoundCornerImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0087R.styleable.RoundCornerImageView);
        this.radius = obtainStyledAttributes.getDimensionPixelOffset(C0087R.styleable.RoundCornerImageView_radius, this.defaultRadius);
        this.leftTopRadius = obtainStyledAttributes.getDimensionPixelOffset(C0087R.styleable.RoundCornerImageView_left_top_radius, this.defaultRadius);
        this.rightTopRadius = obtainStyledAttributes.getDimensionPixelOffset(C0087R.styleable.RoundCornerImageView_right_top_radius, this.defaultRadius);
        this.rightBottomRadius = obtainStyledAttributes.getDimensionPixelOffset(C0087R.styleable.RoundCornerImageView_right_bottom_radius, this.defaultRadius);
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0087R.styleable.RoundCornerImageView_left_bottom_radius, this.defaultRadius);
