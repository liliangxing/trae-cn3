...
class FacebookPlatformDelegate extends PlatformDelegate {
    ...
    public void requestLogin(Bundle bundle) {
        if (this.loginDelegate != null) {
            ...
            this.loginDelegate.api.ssoWithAccessTokenLogin(this.loginDelegate.platformId, this.loginDelegate.platform, this.accessToken, this.expiresIn, this.loginDelegate.mExtendParam, this.mLoginCallback);
        }
    }
    ...
    public void requestBind(Bundle bundle) {
        if (this.bindDelegate != null) {
            ...
            this.bindDelegate.api.ssoWithAccessTokenBind(this.bindDelegate.platformId, this.bindDelegate.platform, this.accessToken, this.expiresIn, this.bindDelegate.mExtendParam, this.mBindCallback);
        }
    }
    ...
    public void requestProfile(Bundle bundle) {
        if (this.profileAdapter != null) {
            ...
            this.profileAdapter.api.getOauthProfileByAccessToken(this.profileAdapter.platformId, this.profileAdapter.platform, this.accessToken, this.expiresIn, this.profileAdapter.mExtendParam, this.mProfileCallback);
        }
    }
