...
public class WeixinPlatformDelegate extends PlatformDelegate {
    ...
    WeixinPlatformDelegate(PlatformProfileAdapter platformProfileAdapter) {
    ...
    private void parseData(Bundle bundle) {
        ...
        this.url = bundle.getString(IWeixinService.ResponseConstants.URL);
    ...
    public void requestLogin(Bundle bundle) {
        if (this.loginDelegate != null) {
            ...
            if (this.loginDelegate.isLoginAndBindThirdMobileMode) {
                if (this.loginDelegate.isLoginNeedBindMobile) {
                ...
                this.loginDelegate.api.ssoWithAuthCodeBindMobileLogin(this.loginDelegate.platformId, "weixin", this.authCode, null, this.loginDelegate.isRegisterNeedThirdMobile, this.loginDelegate.isChangeBind, this.loginDelegate.mExtendParam, this.mLoginCallback);
                return;
            }
            this.loginDelegate.api.ssoWithAuthCodeLogin(this.loginDelegate.platformId, "weixin", this.authCode, 0L, this.loginDelegate.mExtendParam, this.mLoginCallback);
        }
    }
    ...
    public void requestBind(Bundle bundle) {
        if (this.bindDelegate != null) {
            ...
            if (this.bindDelegate.isBindPlatformAndThirdMobileMode) {
                this.bindDelegate.api.bindWithMobile(this.bindDelegate.platformId, "weixin", this.authCode, null, null, null, null, 0L, null, null, this.bindDelegate.mExtendParam, this.mBindCallback);
            } else {
                this.bindDelegate.api.ssoWithAuthCodeBind(this.bindDelegate.platformId, "weixin", this.authCode, 0L, this.bindDelegate.mExtendParam, this.mBindCallback);
            }
        }
    }
    ...
    public static class Factory implements PlatformDelegate.IFactory {
        ...
        public PlatformDelegate createProfile(PlatformProfileAdapter platformProfileAdapter) {
            return new WeixinPlatformDelegate(platformProfileAdapter);
        }
    }
}
