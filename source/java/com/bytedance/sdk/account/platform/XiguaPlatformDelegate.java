...
public class XiguaPlatformDelegate extends PlatformDelegate {
    ...
    XiguaPlatformDelegate(PlatformBindAdapter platformBindAdapter) {
        super(platformBindAdapter);
    }

    XiguaPlatformDelegate(PlatformLoginAdapter platformLoginAdapter) {
        super(platformLoginAdapter);
    }

    XiguaPlatformDelegate(PlatformProfileAdapter platformProfileAdapter) {
    ...
    public void requestLogin(Bundle bundle) {
        if (this.loginDelegate != null) {
            ...
            this.loginDelegate.api.ssoWithAuthCodeLogin(this.loginDelegate.platformId, null, this.authCode, 0L, this.loginDelegate.mExtendParam, this.mLoginCallback);
        }
    }
    ...
    public void requestBind(Bundle bundle) {
        if (this.bindDelegate != null) {
            ...
            this.bindDelegate.api.ssoWithAuthCodeBind(this.bindDelegate.platformId, null, this.authCode, 0L, this.bindDelegate.mExtendParam, this.mBindCallback);
        }
    }
    ...
    public void requestProfile(Bundle bundle) {
        if (this.profileAdapter != null) {
            ...
            this.profileAdapter.api.getOauthProfileByCode(this.profileAdapter.platformId, null, this.authCode, 0L, this.profileAdapter.mExtendParam, this.mProfileCallback);
        }
    }
    ...
    public static class Factory implements PlatformDelegate.IFactory {
        ...
        public PlatformDelegate createProfile(PlatformProfileAdapter platformProfileAdapter) {
            return new XiguaPlatformDelegate(platformProfileAdapter);
        }
    }
}
