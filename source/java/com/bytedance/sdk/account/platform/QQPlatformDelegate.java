...
public class QQPlatformDelegate extends PlatformDelegate {
    ...
    QQPlatformDelegate(PlatformProfileAdapter platformProfileAdapter) {
    ...
    private void parseData(Bundle bundle) {
        ...
        this.expires = string;
        this.exp = TypeUtils.parseLong(string, 0L);
    }
    ...
    public void requestLogin(Bundle bundle) {
        if (this.loginDelegate != null) {
            ...
            this.loginDelegate.api.ssoWithAccessTokenLogin(this.loginDelegate.platformId, "qzone_sns", this.accessToken, this.exp, this.loginDelegate.mExtendParam, this.mLoginCallback);
        }
    }
    ...
    public void requestBind(Bundle bundle) {
        if (this.bindDelegate != null) {
            ...
            this.bindDelegate.api.ssoWithAccessTokenBind(this.bindDelegate.platformId, this.bindDelegate.platform, this.accessToken, this.exp, this.bindDelegate.mExtendParam, this.mBindCallback);
        }
    }
    ...
    public void requestProfile(Bundle bundle) {
        if (this.profileAdapter != null) {
            parseData(bundle);
            this.profileAdapter.api.getOauthProfileByAccessToken(this.profileAdapter.platformId, this.profileAdapter.platform, this.accessToken, this.exp, this.profileAdapter.mExtendParam, this.mProfileCallback);
        }
    }
    ...
    public static class QQLoginFactor implements PlatformDelegate.IFactory {
        ...
        public PlatformDelegate createProfile(PlatformProfileAdapter platformProfileAdapter) {
            return new QQPlatformDelegate(platformProfileAdapter);
        }
    }
}
