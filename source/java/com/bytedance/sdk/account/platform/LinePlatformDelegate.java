...
class LinePlatformDelegate extends PlatformDelegate {
    ...
    LinePlatformDelegate(PlatformProfileAdapter platformProfileAdapter) {
    ...
    public void requestLogin(Bundle bundle) {
        if (this.loginDelegate != null) {
            ...
            this.loginDelegate.api.ssoWithAccessTokenLogin(this.loginDelegate.platformId, this.loginDelegate.platform, this.accessToken, 0L, this.loginDelegate.mExtendParam, this.mLoginCallback);
        }
    }
    ...
    public void requestBind(Bundle bundle) {
        if (this.bindDelegate != null) {
            ...
            this.bindDelegate.api.ssoWithAccessTokenBind(this.bindDelegate.platformId, this.bindDelegate.platform, this.accessToken, 0L, this.bindDelegate.mExtendParam, this.mBindCallback);
        }
    }
    ...
    public void requestProfile(Bundle bundle) {
        if (this.profileAdapter != null) {
            parseData(bundle);
            this.profileAdapter.api.getOauthProfileByAccessToken(this.profileAdapter.platformId, this.profileAdapter.platform, this.accessToken, 0L, this.profileAdapter.mExtendParam, this.mProfileCallback);
        }
    }
    ...
    static class Factory implements PlatformDelegate.IFactory {
        ...
        public PlatformDelegate createProfile(PlatformProfileAdapter platformProfileAdapter) {
            return new LinePlatformDelegate(platformProfileAdapter);
        }
    }
}
