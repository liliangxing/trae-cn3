    ...
    */
    ...
    public void setUpComponent(RefreshKernel refreshKernel, View view, View view2) {
        ...
        if (view != null) {
            ...
            viewGroup.addView((View) new Space(this.mContentView.getContext()), indexOfChild2, layoutParams);
        ...
        if (view2 != null) {
            ...
            viewGroup2.addView((View) new Space(this.mContentView.getContext()), indexOfChild3, layoutParams2);
