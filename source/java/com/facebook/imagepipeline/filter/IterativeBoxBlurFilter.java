...
public abstract class IterativeBoxBlurFilter {
    ...
    public static void boxBlurBitmapInPlace(Bitmap bitmap, int i, int i2) {
        ...
        Preconditions.checkArgument(((float) bitmap.getHeight()) <= BitmapUtil.MAX_BITMAP_SIZE);
        Preconditions.checkArgument(((float) bitmap.getWidth()) <= BitmapUtil.MAX_BITMAP_SIZE);
