...
public final class InPlaceRoundFilter {
    ...
    public static void roundBitmapInPlace(Bitmap bitmap) {
        ...
        Preconditions.checkArgument(width > 0 && ((float) width) <= BitmapUtil.MAX_BITMAP_SIZE);
        Preconditions.checkArgument(height > 0 && ((float) height) <= BitmapUtil.MAX_BITMAP_SIZE);
