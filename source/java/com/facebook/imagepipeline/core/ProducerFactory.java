...
import com.facebook.imagepipeline.producers.LocalContentUriThumbnailProducer;
...
public class ProducerFactory {
    ...
    public ProducerFactory(Context context, ByteArrayPool byteArrayPool, ImageDecoder imageDecoder, ProgressiveJpegConfig progressiveJpegConfig, boolean z, boolean z2, boolean z3, ExecutorSupplier executorSupplier, PooledByteBufferFactory pooledByteBufferFactory, MemoryCache<CacheKey, CloseableImage> memoryCache, MemoryCache<CacheKey, Bitmap> memoryCache2, MemoryCache<CacheKey, PooledByteBuffer> memoryCache3, BufferedDiskCache bufferedDiskCache, BufferedDiskCache bufferedDiskCache2, HashMap<String, BufferedDiskCache> hashMap, CacheKeyFactory cacheKeyFactory, PlatformBitmapFactory platformBitmapFactory, int i, int i2, boolean z4, int i3) {
        this(context, byteArrayPool, imageDecoder, progressiveJpegConfig, z, z2, z3, executorSupplier, pooledByteBufferFactory, memoryCache, memoryCache2, memoryCache3, bufferedDiskCache, bufferedDiskCache2, hashMap, cacheKeyFactory, platformBitmapFactory, i, i2, z4, i3, false);
    }
    ...
    public DecodeProducer newDecodeProducer(Producer<EncodedImage> producer) {
        return new DecodeProducer(this.mByteArrayPool, this.mExecutorSupplier.forDecode(), this.mImageDecoder, this.mProgressiveJpegConfig, this.mDownsampleEnabled, this.mResizeAndRotateEnabledForNetwork, this.mDecodeCancellationEnabled, producer, this.mMaxBitmapSize, this.mOomOptEnabled);
    }
    ...
    public ResizedImageDiskCacheReadProducer newResizedImageDiskCacheReadProducer(Producer<EncodedImage> producer) {
        return new ResizedImageDiskCacheReadProducer(this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCustomImageBufferedDiskCacheMap, this.mCacheKeyFactory, producer, this.mPooledByteBufferFactory);
    }
    ...
    public EncodedCacheKeyMultiplexProducer newResizedImageCacheKeyMultiplexProducer(Producer<EncodedImage> producer) {
        return new ResizedImageCacheKeyMultiplexProducer(this.mCacheKeyFactory, producer);
    }
    ...
    public LocalContentUriThumbnailProducer newLocalContentUriThumbnailProducer() {
        return new LocalContentUriThumbnailProducer(this.mExecutorSupplier.forBackgroundTasks(), this.mContentResolver);
    }
    ...
    public LocalVideoThumbnailProducer newLocalVideoThumbnailProducer() {
        return new LocalVideoThumbnailProducer(this.mExecutorSupplier.forDecode(), this.mExecutorSupplier.forLocalStorageWrite(), this.mContentResolver);
    }
    ...
    public ResizedImageDiskCacheWriteProducer newResizedImageDiskCacheWriteProducer(Producer<EncodedImage> producer, boolean z, ImageTranscoderFactory imageTranscoderFactory) {
        return new ResizedImageDiskCacheWriteProducer(this.mExecutorSupplier.forBackgroundTasks(), this.mPooledByteBufferFactory, producer, z, imageTranscoderFactory, this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCustomImageBufferedDiskCacheMap, this.mCacheKeyFactory);
    }
