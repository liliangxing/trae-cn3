...
public final class ThumbnailSizeChecker {
    ...
    public static boolean isImageBigEnough(int i, int i2, ResizeOptions resizeOptions) {
        return resizeOptions == null ? ((float) getAcceptableSize(i)) >= BitmapUtil.MAX_BITMAP_SIZE && getAcceptableSize(i2) >= ((int) BitmapUtil.MAX_BITMAP_SIZE) : getAcceptableSize(i) >= resizeOptions.width && getAcceptableSize(i2) >= resizeOptions.height;
    }
