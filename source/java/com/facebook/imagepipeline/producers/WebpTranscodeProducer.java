...
public class WebpTranscodeProducer implements Producer<EncodedImage> {
    ...
    public void transcodeLastResult(EncodedImage encodedImage, Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        this.mExecutor.execute(new StatefulPriorityProducerRunnable<EncodedImage>(consumer, producerContext.getListener(), PRODUCER_NAME, producerContext.getId(), Priority.getIntPriorityValue(producerContext.getPriority())) { // from class: com.facebook.imagepipeline.producers.WebpTranscodeProducer.1
            /* JADX INFO: Access modifiers changed from: protected */
            ...
            public void onSuccess(EncodedImage encodedImage2) {
                ...
                super.onSuccess((C03611) encodedImage2);
            }
