...
public class JpegTranscoderUtils {
    ...
    public static final ImmutableList<Integer> INVERTED_EXIF_ORIENTATIONS = ImmutableList.m412of((Object[]) new Integer[]{2, 7, 4, 5});
    ...
    public static int getForceRotatedInvertedExifOrientation(RotationOptions rotationOptions, EncodedImage encodedImage) {
        ...
        return immutableList.get((indexOf + ((!rotationOptions.useImageMetadata() ? rotationOptions.getForcedAngle() : 0) / 90)) % immutableList.size()).intValue();
    }
