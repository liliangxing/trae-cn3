...
public class TTFrescoOkHttpFetcher implements NetworkFetcher<FrescoTTNetFetcher.TTNetFetchState> {
    ...
    @Override // com.facebook.imagepipeline.producers.NetworkFetcher
    public void onFetchCompletion(FrescoTTNetFetcher.TTNetFetchState tTNetFetchState, int i) {
    }

    @Override // com.facebook.imagepipeline.producers.NetworkFetcher
    public boolean shouldPropagate(FrescoTTNetFetcher.TTNetFetchState tTNetFetchState) {
        return false;
    }

    @Override // com.facebook.imagepipeline.producers.NetworkFetcher
    public /* bridge */ /* synthetic */ FrescoTTNetFetcher.TTNetFetchState createFetchState(Consumer consumer, ProducerContext producerContext) {
        return createFetchState2((Consumer<EncodedImage>) consumer, producerContext);
    }
    ...
    public FrescoTTNetFetcher.TTNetFetchState createFetchState2(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
    ...
    protected void fetchWithRequest(final FrescoTTNetFetcher.TTNetFetchState tTNetFetchState, final NetworkFetcher.Callback callback, final Call call, final int i) {
        ...
        tTNetFetchState.getContext().addCallbacks(new BaseProducerContextCallbacks() { // from class: com.facebook.net.TTFrescoOkHttpFetcher.1
            @Override // com.facebook.imagepipeline.producers.BaseProducerContextCallbacks, com.facebook.imagepipeline.producers.ProducerContextCallbacks
            public void onCancellationRequested() {
                if (Looper.myLooper() == Looper.getMainLooper()) {
                    TTFrescoOkHttpFetcher.this.mCancellationExecutor.execute(new Runnable() { // from class: com.facebook.net.TTFrescoOkHttpFetcher.1.1
        ...
        final boolean z2 = z;
        call.enqueue(new Callback() { // from class: com.facebook.net.TTFrescoOkHttpFetcher.2
                ...
                try {
                    try {
                        try {
                            ...
                            if (!response.isSuccessful()) {
                                TTFrescoOkHttpFetcher.this.handleException(response, tTNetFetchState, call2, new IOException("Unexpected HTTP code " + response), callback, i);
                                if (z2) {
                                ...
                                if (body != null) {
                                    try {
                                        ...
                                        FLog.m483w(TTFrescoOkHttpFetcher.TAG, "Exception when closing response body", e);
                                        return;
                                    }
                                }
                                return;
                            ...
                            tTNetFetchState.completeRunnable = new Runnable() { // from class: com.facebook.net.TTFrescoOkHttpFetcher.2.1
                                ...
                                */
                                public void run() {
                                    ...
                                    if (response2 != null) {
                                        ...
                                        jSONObject.put(TTFrescoOkHttpFetcher.IMAGE_SIZE, contentLength);
                                        ...
                                        TTFrescoOkHttpFetcher.this.handleRequestTime(jSONObject, tTNetFetchState);
                                        if (TTFrescoOkHttpFetcher.sImageCallBack != null) {
                                            TTFrescoOkHttpFetcher.sImageCallBack.onImageOkCallBack(tTNetFetchState.fetchCompleteTime - tTNetFetchState.submitTime, tTNetFetchState.submitTime, responseWrap, httpRequestInfo, null, jSONObject);
                                        }
                                        TTFrescoOkHttpFetcher.this.handleRequest(tTNetFetchState, true, tTNetFetchState.fetchCompleteTime - tTNetFetchState.submitTime);
                                    }
                                    header = null;
                                    JSONObject jSONObject2 = new JSONObject();
                                    jSONObject2.put(TTFrescoOkHttpFetcher.IMAGE_SIZE, contentLength);
                                    ...
                                    TTFrescoOkHttpFetcher.this.handleRequestTime(jSONObject2, tTNetFetchState);
                                    if (TTFrescoOkHttpFetcher.sImageCallBack != null) {
                                    }
                                    TTFrescoOkHttpFetcher.this.handleRequest(tTNetFetchState, true, tTNetFetchState.fetchCompleteTime - tTNetFetchState.submitTime);
                                }
                            ...
                            TTFrescoOkHttpFetcher.this.handleException(response, tTNetFetchState, call2, e2, callback, i);
                            if (z2) {
                                CdnDeviceBandwidthSampler.getInstance().stopSampling();
                            }
                            if (0 != 0) {
                        ...
                        FLog.m483w(TTFrescoOkHttpFetcher.TAG, "Exception when closing response body", e3);
                    }
                } catch (Throwable th) {
                    if (z2) {
                        CdnDeviceBandwidthSampler.getInstance().stopSampling();
                    ...
                    if (0 != 0) {
                        try {
                            ...
                            FLog.m483w(TTFrescoOkHttpFetcher.TAG, "Exception when closing response body", e4);
                        }
                    }
                    throw th;
                }
            ...
            public void onFailure(Call call2, IOException iOException) {
                ...
                TTFrescoOkHttpFetcher.this.handleException(null, tTNetFetchState, call2, iOException, callback, i);
            }
        });
    }
