...
public class WebpBitmapFactoryImpl implements WebpBitmapFactory {
    ...
    public static Bitmap hookDecodeStream(InputStream inputStream, Rect rect, BitmapFactory.Options options) {
        ...
        if ((WebpSupportStatus.sIsWebpSupportRequired || Build.VERSION.SDK_INT == 28) && WebpSupportStatus.isWebpHeader(webpHeader, 0, 20) && options.inPreferredConfig == Bitmap.Config.ARGB_8888) {
    ...
    private static void setWebpBitmapOptions(Bitmap bitmap, BitmapFactory.Options options) {
        ...
        if (options != null) {
            options.outMimeType = Utils_commonKt.MIME_TYPE_WEBP;
        }
    }
