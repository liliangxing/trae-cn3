...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
    ...
    public void setController(@Nullable DraweeController draweeController) {
        ...
        if (isControllerValid()) {
            ...
            if (FrescoCacheMonitorUtil.isOptRest()) {
                this.mController.clearHierarchy();
            } else {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("controllerAttached", this.mIsControllerAttached).add("holderAttached", this.mIsHolderAttached).add("drawableVisible", this.mIsVisible).add(EventForwardLoader.KEY_EVENT_FORWARD_EVENTS, this.mEventTracker.toString()).toString();
    }
}
