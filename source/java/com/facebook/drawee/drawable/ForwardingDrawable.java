...
public class ForwardingDrawable extends Drawable implements Drawable.Callback, TransformCallback, TransformAwareDrawable, DrawableParent {
    ...
    private boolean mStopDrawUntilSetDrawable = false;
    ...
    public void draw(Canvas canvas) {
        Drawable drawable;
        Bitmap bitmap;
        if (this.mStopDrawUntilSetDrawable || (drawable = this.mCurrentDelegate) == null) {
            return;
        }
        if ((drawable instanceof RoundedBitmapDrawable) && (bitmap = ((RoundedBitmapDrawable) drawable).getBitmap()) != null && bitmap.isRecycled()) {
            return;
        }
    ...
    public Drawable setDrawable(Drawable drawable) {
        ...
        this.mStopDrawUntilSetDrawable = false;
        return current;
    }
    ...
    public void stopDrawUntilSetDrawable() {
        this.mStopDrawUntilSetDrawable = true;
    }
}
