...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    @Override // com.facebook.drawee.interfaces.SettableDraweeHierarchy
    public void stopDrawUntilSetImage() {
        this.mActualImageWrapper.stopDrawUntilSetDrawable();
    }
    ...
    public Drawable getControllerOverlay() {
        return this.mTopLevelDrawable.getControllerOverlay();
    }
    ...
    public void setChildDrawableAtIndex(int i, @Nullable Drawable drawable) {
        if (drawable == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public ScaleTypeDrawable getScaleTypeDrawableAtIndex(int i) {
            ...
            if (context instanceof Activity) {
                ((Activity) context).runOnUiThread(new Runnable() { // from class: com.facebook.drawee.generic.GenericDraweeHierarchy.1
                    ...
                    public void run() {
                        ...
                        GenericDraweeHierarchy.this.getScaleTypeDrawableAtIndex(1).setScaleType(scaleType);
                    }
                });
                return;
            }
