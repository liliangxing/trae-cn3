...
public class GenericDraweeHierarchyBuilder {
    ...
    private static int mGlobalFadeDuration = -1;

    public GenericDraweeHierarchyBuilder(Context context, Resources resources) {
    ...
    public static void setDefaultFadeDuration(int i) {
        mGlobalFadeDuration = i;
    }

    private void init() {
        int i = mGlobalFadeDuration;
        if (i < 0) {
            i = DEFAULT_FADE_DURATION;
        }
