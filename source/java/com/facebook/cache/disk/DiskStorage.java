...
public interface DiskStorage {
    ...
    Collection<Entry> getConfigEntries() throws IOException;

    List<Entry> getDiskCacheEntries() throws IOException;
    ...
    Map<String, String> getResourceConfig(String str, Object obj) throws IOException;
    ...
    long removeConfig(String str) throws IOException;
