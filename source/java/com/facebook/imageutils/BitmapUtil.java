...
public final class BitmapUtil {
    ...
    public static float MAX_BITMAP_SIZE = 2048.0f;
    ...
    public static String getBitmapConfigName(Bitmap bitmap) {
        Bitmap.Config config;
        return (bitmap == null || (config = bitmap.getConfig()) == null) ? "unknown" : config.name();
    }
    ...
    public static int getPixel(Bitmap bitmap, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && bitmap.getConfig() == Bitmap.Config.HARDWARE) {
            return bitmap.copy(Bitmap.Config.ARGB_8888, false).getPixel(i, i2);
        }
