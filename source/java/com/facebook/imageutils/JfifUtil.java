...
public class JfifUtil {
    ...
    public static int transformStandarExifOrientationForAvif(int i) {
        if (i == 0) {
            return 1;
        }
        if (i == 1) {
    ...
    public static int getExifOrientationFromAutoRotateAngle(int i) {
        return TiffUtil.getExifOrientationFromAutoRotateAngle(i);
    }
    ...
    public static int transformFromClockWiseToAntiClockWise(int i) {
        return Math.abs(360 - i) % MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL;
    }
