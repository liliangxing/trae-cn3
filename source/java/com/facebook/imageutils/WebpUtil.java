...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        return new Pair<>(Integer.valueOf((read | ((read2 & 63) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & UByte.MAX_VALUE) & 15) << 10) | ((((byte) inputStream.read()) & UByte.MAX_VALUE) << 2) | ((read2 & 192) >> 6)) + 1));
    }
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        ...
        return ((((byte) inputStream.read()) << 24) & (-16777216)) | ((((byte) inputStream.read()) << Tnaf.POW_2_WIDTH) & 16711680) | ((read2 << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (read & UByte.MAX_VALUE);
    }
    ...
    private static int read3Bytes(InputStream inputStream) throws IOException {
        ...
        return ((getByte(inputStream) << Tnaf.POW_2_WIDTH) & 16711680) | ((getByte(inputStream) << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (b & UByte.MAX_VALUE);
    }
