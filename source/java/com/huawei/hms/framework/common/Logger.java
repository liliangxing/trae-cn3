...
public class Logger {
    ...
    private static String complexMsg(String str, int i) {
        if (!TextUtils.isEmpty(str)) {
            ...
            return TextUtils.isEmpty(callMethodInfo) ? str : callMethodInfo + "|" + str;
        }
    ...
    private static String getVerboseCallMethodInfo(int i) {
        ...
        sb.append(Thread.currentThread().getName()).append("|").append(stackTraceElement.getFileName()).append("|").append(stackTraceElement.getClassName()).append("|").append(stackTraceElement.getMethodName()).append("|").append(stackTraceElement.getLineNumber());
        return sb.toString();
    }
    ...
    private static String getBriefCallMethodInfo(int i) {
        ...
        StackTraceElement stackTraceElement = stackTrace[i];
        String replace = stackTraceElement.getClassName().replace(CLASSNAME_COMMON_PRE_NK, "").replace(CLASSNAME_COMMON_PRE_FK, "");
        StringBuilder sb = new StringBuilder();
        sb.append(Thread.currentThread().getName()).append("|").append(replace).append("|").append(stackTraceElement.getLineNumber());
        return sb.toString();
    }
