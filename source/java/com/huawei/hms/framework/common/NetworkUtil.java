...
public class NetworkUtil {
    ...
    public static NetworkInfo getNetworkInfo(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getActiveNetworkInfo failed, exception:" + e.getClass().getSimpleName() + e.getMessage());
            return null;
        }
    }
    ...
    public static int netWork(Context context) {
        ...
        Logger.m1187v(TAG, "networkType " + networkType);
        if (networkType == 4) {
    ...
    public static String getNetWorkNSAorSA() {
        try {
            ...
            Logger.m1187v(TAG, "phoneId " + default4GSlotId);
            boolean isNsaState = hwTelephonyManager.isNsaState(default4GSlotId);
            Logger.m1187v(TAG, "isNsa " + isNsaState);
            return isNsaState ? STR_NSA : STR_SA;
        } catch (Throwable unused) {
            Logger.m1187v(TAG, "isNsaState error");
            return null;
        }
    }
    ...
    public static int getNetworkType(NetworkInfo networkInfo, Context context) {
        ...
        Logger.m1187v(TAG, "getHwNetworkType return is: " + subtype);
        if (subtype == 0) {
    ...
    private static String[] getDnsServerIpsFromConnectionManager(Context context) {
        ...
        if (context != null && (connectivityManager = (ConnectivityManager) ContextCompat.getSystemService(context, "connectivity")) != null) {
            try {
                ...
                Logger.m1185i(TAG, "getActiveNetworkInfo failed, exception:" + e.getClass().getSimpleName());
            } catch (RuntimeException e2) {
                Logger.m1185i(TAG, "getActiveNetworkInfo failed, exception:" + e2.getClass().getSimpleName());
            }
        }
    ...
    public static int getMobileRsrp(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getDbm: throwable:" + th.getClass());
            return Integer.MAX_VALUE;
        }
    }
    ...
    public static int getLteRsrq(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getLteRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT > 28) {
    ...
    public static int getLteRssnr(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getLteRssnr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT > 28) {
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(CellSignalStrengthLte.class);
            if (cellSignalStrengths.size() > 0) {
    ...
    public static int getLteRsrp(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getLteRsrp: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT > 28) {
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(CellSignalStrengthLte.class);
            if (cellSignalStrengths.size() > 0) {
    ...
    public static int getLteCqi(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getLteCqi: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT > 28) {
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(CellSignalStrengthLte.class);
            if (cellSignalStrengths.size() > 0) {
    ...
    public static int getLteRssi(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getLteRssi: throwable:" + th.getClass());
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getInfoWithReflect(SignalStrength signalStrength, String str) {
        try {
            ...
            Logger.m1185i(TAG, str + " : cannot access");
            return Integer.MAX_VALUE;
        } catch (NoSuchMethodException unused2) {
            Logger.m1185i(TAG, str + " : function not found");
            return Integer.MAX_VALUE;
        } catch (InvocationTargetException unused3) {
            Logger.m1185i(TAG, str + " : InvocationTargetException");
            return Integer.MAX_VALUE;
        } catch (Throwable th) {
            Logger.m1185i(TAG, str + " : throwable:" + th.getClass());
            return Integer.MAX_VALUE;
        }
    }
    ...
    public static int getNrSsRsrp(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrSsRsrp: throwable:" + th.getClass());
        }
    ...
    public static int getNrCsiRsrp(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrCsiRsrp: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
    ...
    public static int getNrSsRsrq(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrSsRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
    ...
    public static int getNrCsiRsrq(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrCsiRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
    ...
    public static int getNrSsSinr(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrSsSinr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
    ...
    public static int getNrCsiSinr(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getNrCsiSinr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
    ...
    public static int getWifiRssi(Context context) {
        ...
        if (context != null && Build.VERSION.SDK_INT >= 31) {
            try {
                ...
                Logger.m1185i(TAG, "getWifiRssiLevel did not has permission!" + e.getClass().getSimpleName() + e.getMessage());
            }
        }
        return i;
    }
    ...
    public static String getWifiGatewayIp(Context context) {
        ...
        try {
            ...
            return InetAddress.getByAddress(new byte[]{(byte) (i & JfifUtil.MARKER_FIRST_BYTE), (byte) ((i >> 8) & JfifUtil.MARKER_FIRST_BYTE), (byte) ((i >> 16) & JfifUtil.MARKER_FIRST_BYTE), (byte) ((i >> 24) & JfifUtil.MARKER_FIRST_BYTE)}).getHostAddress();
        } catch (RuntimeException | UnknownHostException e) {
            Logger.m1185i(TAG, "getWifiGatewayIp error!" + e.getClass().getSimpleName() + e.getMessage());
            return " ";
        }
    }
            ...
            if (systemService instanceof ConnectivityManager) {
                try {
                    ...
                    if (activeNetworkInfo != null) {
                        ...
                        Logger.m1185i(TAG, "getNetworkStatus networkIsConnected netInfo is null!");
                    }
                } catch (RuntimeException e) {
                    Logger.m1185i(TAG, "getNetworkStatus exception" + e.getClass().getSimpleName() + e.getMessage());
                }
            } else {
                Logger.m1185i(TAG, "getNetworkStatus ConnectivityManager is null!");
            }
        }
        return detailedState;
    }
            ...
            if (systemService instanceof ConnectivityManager) {
                ...
                try {
                    if (connectivityManager.isActiveNetworkMetered()) {
                        ...
                        Logger.m1187v(TAG, "ConnectType is not Mobile Network!");
                    }
                } catch (RuntimeException e) {
                    Logger.m1183e(TAG, "SystemServer error:", e);
                }
            }
        }
        return i;
    ...
    public static String getMNC(Context context) {
        ...
        if (telephonyManager == null) {
            Logger.m1182e(TAG, "getSubscriptionOperatorType: other error!");
            return SystemUtils.UNKNOWN;
        }
    ...
    public static boolean isUserUnlocked(Context context) {
        ...
        try {
            ...
            Logger.m1183e(TAG, "dealType rethrowFromSystemServer:", e);
            return true;
        }
    }
    ...
    public static boolean isConnectTypeChange(NetworkInfo networkInfo, NetworkInfo networkInfo2) {
        ...
        Logger.m1187v(TAG, "Find activity network changed");
        return true;
    }
    ...
    public static boolean isChangeToConnected(NetworkInfo networkInfo, NetworkInfo networkInfo2) {
        ...
        Logger.m1187v(TAG, "Find network state changed to connected");
        return true;
    }
    ...
    private static int getMobileSingalStrengthUpPPlatfrom(Context context) {
        ...
        try {
            ...
            Logger.m1185i(TAG, "getMobileSingalStrength: throwable:" + th.getClass());
            return i;
        }
    }
    ...
    public static boolean isSupportIpv6Net(Context context, int i) {
        ...
        if (ContextCompat.checkSelfPermission(context, "android.permission.ACCESS_NETWORK_STATE")) {
            ...
            if (connectivityManager == null) {
                Logger.m1182e(TAG, "mConnectivityManager is null");
                return z;
            }
            Network activeNetwork = connectivityManager.getActiveNetwork();
            if (activeNetwork == null) {
                Logger.m1182e(TAG, "network is null");
                return z;
            }
            LinkProperties linkProperties = connectivityManager.getLinkProperties(activeNetwork);
            if (linkProperties == null) {
                Logger.m1182e(TAG, "ipInfo is null");
                return z;
            }
            ...
            for (int i2 = 0; i2 < linkAddresses.size(); i2++) {
                ...
                if ((address instanceof Inet6Address) && !address.isLinkLocalAddress() && !address.isLoopbackAddress()) {
                    Logger.m1187v(TAG, "has ipv6 interface");
                    return true;
                }
            }
            Logger.m1187v(TAG, "has not ipv6 interface");
            return false;
        }
        Logger.m1187v(TAG, "has no network state permission");
        return z;
    }
    ...
    public static void updateCurrentNetworkType() {
        ...
        if (InitReport.isHasConnectNet()) {
            ...
            Logger.m1185i(TAG, "update currentNetworkType: " + networkTypeByReceiver + ", isSupportIpv6Net:" + isSupportIpv6Net);
        }
    }
