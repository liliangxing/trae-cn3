...
public class GrsApi {
    ...
    public static void ayncGetGrsUrl(String str, String str2, IQueryUrlCallBack iQueryUrlCallBack) {
        if (iQueryUrlCallBack == null) {
            Logger.m1189w(TAG, "IQueryUrlCallBack is must not null for process continue.");
            return;
        }
    ...
    public static void ayncGetGrsUrls(String str, IQueryUrlsCallBack iQueryUrlsCallBack) {
        if (iQueryUrlsCallBack == null) {
            Logger.m1189w(TAG, "IQueryUrlsCallBack is must not null for process continue.");
            return;
        }
        GrsClient grsClient2 = grsClient;
    ...
    public static void clearSp() {
        if (grsClient == null) {
            Logger.m1189w(TAG, "GrsApi.clearSp return because grsClient is null.");
        }
    }
    ...
    public static boolean forceExpire() {
        ...
        Logger.m1189w(TAG, "GrsApi.forceExpire return false because grsClient is null.");
        return false;
    }

    @Deprecated
    public static CountryCodeBean getCountryCode(Context context, boolean z) {
        return C1087a.m1192a(context, z);
    }

    @Deprecated
    public static int grsSdkInit(Context context, GrsBaseInfo grsBaseInfo) {
        Logger.m1189w(TAG, "GrsApi.grsSdkInit is @Deprecated,  And Only Application Can Call Once");
    ...
    public static String synGetGrsUrl(String str, String str2) {
        ...
        Logger.m1189w(TAG, "GrsApi.synGetGrsUrl method maybe grsSdkInit has not completed and grsClient is null.");
        return null;
    }
    ...
    public static Map<String, String> synGetGrsUrls(String str) {
        ...
        Logger.m1189w(TAG, "GrsApi.synGetGrsUrls method maybe grsSdkInit has not completed and grsClient is null.");
        return new HashMap();
    }
}
