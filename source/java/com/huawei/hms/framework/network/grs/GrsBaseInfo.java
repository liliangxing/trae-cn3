...
import com.huawei.hms.framework.network.grs.p026h.C1113b;
...
public class GrsBaseInfo implements Cloneable {
    ...
    private StringBuffer getStringBuffer(StringBuffer stringBuffer, boolean z, Context context) {
        ...
        stringBuffer.append("package_name").append(ContainerUtils.KEY_VALUE_DELIMITER).append(getUrlEncodedStr(context.getPackageName()));
        return stringBuffer;
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public GrsBaseInfo m2808clone() {
    ...
    public String getGrsParasKey(boolean z, boolean z2, Context context) {
        ...
        C1095b m1270a = C1095b.m1270a(context.getPackageName());
        C1119a m1272a = m1270a != null ? m1270a.m1272a() : null;
        String grsReqParamJoint = getGrsReqParamJoint(z, z2, m1272a != null ? m1272a.m1382a() : "", context);
    ...
    public String getGrsReqParamJoint(boolean z, boolean z2, String str, Context context) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        if ("1.0".equals(str)) {
            Logger.m1187v(TAG, "1.0 interface has no query param appname");
        ...
        if (!TextUtils.isEmpty(uid)) {
            ...
            if (z) {
                m1367a = C1113b.m1370b(uid);
            } else if (z2) {
                m1367a = C1113b.m1367a(uid);
            } else {
                stringBuffer.append(uid);
            }
            stringBuffer.append(m1367a);
        }
    ...
    public String getUrlEncodedStr(String str) {
        try {
            ...
            Logger.m1182e(TAG, "UnsupportedEncodingException, Please check the params!");
            return "";
        }
    }
