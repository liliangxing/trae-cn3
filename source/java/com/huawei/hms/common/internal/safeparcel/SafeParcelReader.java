...
public class SafeParcelReader {
    ...
    private static void a(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(new StringBuilder(hexString.length() + 46).append("Expected size ").append(i3).append(" got ").append(i2).append(" (0x").append(hexString).append(")").toString(), parcel);
    }

    private static boolean a(int i, int i2) {
        long j = i + i2;
        return j > SieveCacheKt.NodeLinkMask || j < SieveCacheKt.NodeMetaAndPreviousMask;
    }
    ...
    private static void b(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(new StringBuilder(hexString.length() + 46).append("Expected size ").append(i2).append(" got ").append(readSize).append(" (0x").append(hexString).append(")").toString(), parcel);
    }
