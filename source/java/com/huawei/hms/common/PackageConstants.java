...
public class PackageConstants {
    ...
    public static final String EMPTY_SERVICES_PACKAGE = "com.huawei.hwid";
    public static final String GENERAL_SERVICES_ACTION = "com.huawei.hms.core";
    public static final int HMS_SDK_VERSION_CODE = 61300301;
    public static final String HMS_SDK_VERSION_NAME = "6.13.0.301";
