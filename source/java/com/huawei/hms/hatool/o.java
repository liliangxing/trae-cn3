...
public abstract class o {
    ...
    public static String a(Context context) {
        return context == null ? "" : com_huawei_hms_hatool_o_android_provider_Settings$Secure_getString(context.getContentResolver(), "android_id");
    }
    ...
    private static String com_huawei_hms_hatool_o_android_provider_Settings$Secure_getString(ContentResolver contentResolver, String str) {
