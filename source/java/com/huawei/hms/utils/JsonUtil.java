...
public class JsonUtil {
    ...
    private static Object a(String str, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(ReportConst.ValidationReport.BODY) && jSONObject.getJSONObject(ReportConst.ValidationReport.BODY).has(str)) {
            return jSONObject.getJSONObject(ReportConst.ValidationReport.BODY).get(str);
        }
        return null;
    }
