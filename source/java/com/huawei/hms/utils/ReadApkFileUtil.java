                ...
                while (a2 != null) {
                    if (a2.length() != 0) {
                        if (a2.startsWith("ApkHash:")) {
                            f = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                        }
                        if (a2.startsWith(KEY_SIGNATURE)) {
                            c = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else if (a2.startsWith(KEY_SIGNATURE2)) {
                            d = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else if (a2.startsWith(KEY_SIGNATURE3)) {
                            e = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else {
    ...
    public static boolean isCertFound(String str) {
        ...
        try {
            ...
            try {
                ...
                HMSLog.e(a, "zipFile.close Exception!" + e3.getMessage());
            }
            z = z2;
        } catch (Exception e4) {
            e = e4;
    ...
    public static boolean verifyApkHash(String str) {
        ...
        try {
            ...
            try {
                ...
                HMSLog.i(a, "close stream Exception!" + e4.getMessage());
                return false;
            }
        } catch (Exception e5) {
            e = e5;
            ...
            try {
                ...
                HMSLog.i(str3, sb.append(e6.getMessage()).toString());
                return false;
            }
        } catch (Throwable th2) {
            th = th2;
