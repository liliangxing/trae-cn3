...
public class RunnableC1008a implements Runnable {
    ...
    public RunnableC1008a(Context context) {
        this.f946a = context;
    }
    ...
    public void run() {
        /*
            ...
            r3 = 0
            android.content.Context r4 = r8.f946a     // Catch: com.huawei.hms.common.ApiException -> L27 java.lang.Exception -> L90
            ...
            android.content.Context r5 = r8.f946a     // Catch: com.huawei.hms.common.ApiException -> L27 java.lang.Exception -> L90
            ...
            com.huawei.hms.support.log.HMSLog.m2120i(r1, r4)     // Catch: com.huawei.hms.common.ApiException -> L27 java.lang.Exception -> L90
        ...
        L27:
            ...
            com.huawei.hms.support.log.HMSLog.m2118e(r1, r4)     // Catch: java.lang.Exception -> L90
        L31:
            android.content.Context r4 = r8.f946a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            ...
            android.content.Context r5 = r8.f946a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            ...
            android.content.Context r3 = r8.f946a     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            boolean r2 = r2.m1876a(r3, r5, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            if (r2 != 0) goto L96
            java.lang.String r2 = "start service failed"
            com.huawei.hms.support.log.HMSLog.m2118e(r1, r2)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            goto L96
        L88:
            com.huawei.hms.support.log.HMSLog.m2120i(r1, r0)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L8c java.lang.Exception -> L90
            goto L96
        L8c:
            com.huawei.hms.support.log.HMSLog.m2120i(r1, r0)     // Catch: java.lang.Exception -> L90
            goto L96
        L90:
            r0 = move-exception
            java.lang.String r2 = "Push init failed"
            com.huawei.hms.support.log.HMSLog.m2119e(r1, r2, r0)
        L96:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.aaid.init.RunnableC1008a.run():void");
    }
}
