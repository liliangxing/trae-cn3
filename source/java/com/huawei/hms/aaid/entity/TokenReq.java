...
public class TokenReq implements IMessageEntity {
    ...
    public String toString() {
        ...
        stringBuffer.append(getClass().getName()).append("{pkgName: ").append(this.packageName).append(",isFirstTime: ").append(this.firstTime).append(",scope:").append(this.scope).append(",appId:").append(this.appId).append(",projectId:").append(this.projectId).append(",subjectId:").append(this.subjectId).append("}");
