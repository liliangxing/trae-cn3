...
public class HiAnalyticsUtil {
    ...
    /* renamed from: b */
    private static HiAnalyticsUtil f1805b;

    /* renamed from: c */
    private static HiAnalyticsUtils f1806c;

    /* renamed from: a */
    private String m2097a(Context context, String str) {
        return "01||" + context.getPackageName() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + Util.getAppId(context) + "|61300301|" + str;
    }
    ...
    public static HiAnalyticsUtil getInstance() {
        ...
        synchronized (f1804a) {
            if (f1805b == null) {
                f1805b = new HiAnalyticsUtil();
                f1806c = HiAnalyticsUtils.getInstance();
            }
            hiAnalyticsUtil = f1805b;
        }
    ...
    public boolean hasError() {
        ...
        HMSLog.m2120i("HiAnalyticsUtil", "not ChinaROM ");
        return true;
    }

    public void onBuoyEvent(Context context, String str, String str2) {
        f1806c.onBuoyEvent(context, str, str2);
    }

    public void onEvent(Context context, String str, Map<String, String> map) {
        f1806c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f1806c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f1806c.onNewEvent(context, str, map);
    }

    public void onEvent(Context context, String str, String str2) {
        if (context != null) {
            onEvent2(context, str, m2097a(context, str2));
        }
    }

    public boolean hasError(Context context) {
        return f1806c.hasError(context);
    }
