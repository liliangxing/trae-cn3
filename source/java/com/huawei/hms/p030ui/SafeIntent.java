...
public class SafeIntent extends Intent {
    ...
    public Bundle getBundleExtra(String str) {
        try {
            return m2123x5194a8e3(this, str);
        } catch (Exception unused) {
            return new Bundle();
        }
    }
    ...
    /* renamed from: INVOKESPECIAL_com_huawei_hms_ui_SafeIntent_com_bytedance_sysoptimizer_BadParcelableLancet_getBundleExtra */
    public static Bundle m2123x5194a8e3(Intent intent, String str) {
