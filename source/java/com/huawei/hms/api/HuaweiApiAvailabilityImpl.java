...
public final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    /* renamed from: a */
    private static final HuaweiApiAvailabilityImpl f1050a = new HuaweiApiAvailabilityImpl();

    /* renamed from: com.huawei.hms.api.HuaweiApiAvailabilityImpl$a */
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes6.dex */
    class C1029a implements BusResponseCallback {

        /* renamed from: a */
        final /* synthetic */ TaskCompletionSource[] f1051a;

        C1029a(TaskCompletionSource[] taskCompletionSourceArr) {
            this.f1051a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            HMSLog.m2118e("HuaweiApiAvailabilityImpl", "Test foreground bus error: resultCode " + i + ", errMessage" + str);
            this.f1051a[0].setException(new AvailabilityException());
            return null;
        }

        @Override // com.huawei.hms.activity.internal.BusResponseCallback
        public BusResponseResult succeedReturn(Activity activity, int i, Intent intent) {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Test foreground bus success: resultCode " + i + ", data" + intent);
            return null;
        }
    }
    ...
    /* renamed from: a */
    private static Intent m991a(Activity activity, String str) {
    ...
    public Task<Void> checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr) {
        ...
        if (huaweiApi != null) {
            try {
                ...
                HMSLog.m2120i("HuaweiApiAvailabilityImpl", "checkApi has AvailabilityException " + e.getMessage());
            }
        }
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2) {
        ...
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i);
        return getErrorDialog(activity, i, i2, null);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public String getErrorString(int i) {
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getErrorString, errorCode: " + i);
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new C1029a(taskCompletionSourceArr));
            ...
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "The HMS service is available.");
        } else {
            HMSLog.m2118e("HuaweiApiAvailabilityImpl", "Framework can not solve the availability problem.");
    ...
    public Intent getResolveErrorIntent(Activity activity, int i) {
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorIntent, errorCode: " + i);
        if (activity == null) {
            return null;
        }
        if (i == 1 || i == 2) {
            if (Util.isAvailableLibExist(activity) && AvailableUtil.isInstallerLibExist(activity)) {
                return (Intent) UpdateAdapter.invokeMethod("com.huawei.hms.update.manager.UpdateManager", "getStartUpdateIntent", new Object[]{activity, m993a(activity.getApplicationContext())});
            }
            return m991a(activity, NotInstalledHmsResolution.class.getName());
        }
        if (i != 6) {
            if (i == 9 && Util.isAvailableLibExist(activity)) {
                return m991a(activity, AppSpoofResolution.class.getName());
            }
            return null;
        }
        return m991a(activity, BindingFailedResolution.class.getName());
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i) {
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i);
    ...
    public int isHuaweiMobileNoticeAvailable(Context context) {
        ...
        if (TextUtils.isEmpty(hMSPackageNameForMultiService)) {
            HMSLog.m2121w("HuaweiApiAvailabilityImpl", "hmsPackageName is empty, Service is invalid.");
            return 1;
        }
        ...
        HMSLog.m2121w("HuaweiApiAvailabilityImpl", "hmsPackageName is not installed, Service is invalid.");
        return 1;
    }
    ...
    public void showErrorNotification(Context context, int i) {
        Checker.checkNonNull(context, "context must not be null.");
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter showErrorNotification, errorCode: " + i);
        if (!(context instanceof Activity)) {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "context not instanceof Activity");
            return;
        }
        Dialog errorDialog = getErrorDialog((Activity) context, i, 0);
        if (errorDialog == null) {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "showErrorNotification errorDialog can not be null");
        } else {
            errorDialog.show();
        }
    }
    ...
    /* renamed from: a */
    private static Intent m992a(Context context, String str) {
    ...
    public void resolveError(Activity activity, int i, int i2, PendingIntent pendingIntent) {
        ...
        if (pendingIntent != null) {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter resolveError, param pendingIntent is not null. and.errorCode: " + i);
        } else {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter resolveError, param pendingIntent is  null. get pendingIntent from error code.and.errorCode: " + i);
            pendingIntent = getResolveErrorPendingIntent(activity, i);
        }
        if (pendingIntent != null) {
            HMSLog.m2120i("HuaweiApiAvailabilityImpl", "In resolveError, start pendingIntent.errorCode: " + i);
            try {
                activity.startIntentSenderForResult(pendingIntent.getIntentSender(), i2, null, 0, 0, 0);
            } catch (IntentSender.SendIntentException unused) {
                HMSLog.m2118e("HuaweiApiAvailabilityImpl", "Enter resolveError, start pendingIntent failed.errorCode: " + i);
            }
        }
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        m994a(activity, errorDialog, HuaweiMobileServicesUtil.HMS_ERROR_DIALOG, onCancelListener);
        return true;
    }

    /* renamed from: a */
    private UpdateBean m993a(Context context) {
        ...
        try {
            ...
            HMSLog.m2118e("HuaweiApiAvailabilityImpl", "getString has Exception:" + e.getMessage());
        }
        return updateBean;
    }
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Checker.checkNonNull(activity, "activity must not be null.");
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getErrorDialog, errorCode: " + i);
        return m989a(activity, i, DialogRedirect.getInstance(activity, m990a(activity, i), i2), onCancelListener);
    }

    @Override // com.huawei.hms.api.HuaweiApiAvailability
    public PendingIntent getErrPendingIntent(Context context, int i, int i2) {
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "Enter getResolveErrorPendingIntent, errorCode: " + i + " requestCode: " + i2);
    ...
    public Task<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr) {
        ...
        if (huaweiApiCallable != null) {
            try {
                m995a(huaweiApiCallable);
            } catch (AvailabilityException e) {
                HMSLog.m2120i("HuaweiApiAvailabilityImpl", "HuaweiApiCallable checkApi has AvailabilityException " + e.getMessage());
            }
        }
        if (huaweiApiCallableArr != null) {
            for (HuaweiApiCallable huaweiApiCallable2 : huaweiApiCallableArr) {
                m995a(huaweiApiCallable2);
            }
        }
        return task;
    }
    ...
    /* renamed from: a */
    private Intent m990a(Activity activity, int i) {
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "getErrorResolutionIntent, errorCode: " + i);
        if (i == 1 || i == 2) {
            if (Util.isAvailableLibExist(activity) && AvailableUtil.isInstallerLibExist(activity)) {
    ...
    public Intent getResolveErrorIntent(Context context, int i) {
        ...
        if (i == 1 || i == 2) {
            if (Util.isAvailableLibExist(context) && AvailableUtil.isInstallerLibExist(context)) {
                return (Intent) UpdateAdapter.invokeMethod("com.huawei.hms.update.manager.UpdateManager", "getStartUpdateIntent", new Object[]{context, m993a(context.getApplicationContext())});
            }
            return m992a(context, NotInstalledHmsResolution.class.getName());
        }
        if (i != 6) {
            if (i == 9 && Util.isAvailableLibExist(context)) {
                return m992a(context, AppSpoofResolution.class.getName());
            }
            return null;
        }
        return m992a(context, BindingFailedResolution.class.getName());
    }

    /* renamed from: a */
    private static Dialog m989a(Activity activity, int i, DialogRedirect dialogRedirect, DialogInterface.OnCancelListener onCancelListener) {
        if (i == 0) {
            return null;
        }
    ...
    /* renamed from: a */
    private static void m994a(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        Checker.checkNonNull(activity, "activity must not be null.");
        ErrorDialogFragment.newInstance(dialog, onCancelListener).show(activity.getFragmentManager(), str);
    }

    /* renamed from: a */
    private void m995a(Object obj) throws AvailabilityException {
        ...
        HMSLog.m2120i("HuaweiApiAvailabilityImpl", "The service is unavailable: " + availabilityException.getMessage());
