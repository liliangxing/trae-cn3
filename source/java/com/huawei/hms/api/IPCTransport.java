...
public class IPCTransport implements DatagramTransport {
    ...
    private int syncCall(ApiClient apiClient, IAIDLCallback iAIDLCallback) {
        if (apiClient instanceof InnerApiClient) {
            ...
            try {
                ...
                if (aidlApiClient.getService() == null) {
                    HMSLog.m2118e(TAG, "HuaweiApiClient is not binded to service yet.");
                    return CommonCode.ErrorCode.INTERNAL_ERROR;
                }
                aidlApiClient.getService().asyncCall(dataBuffer, iAIDLCallback);
                return 0;
            } catch (Exception e) {
                HMSLog.m2118e(TAG, "sync call ex:" + e);
                return CommonCode.ErrorCode.INTERNAL_ERROR;
            }
        }
        if (apiClient instanceof AidlApiClient) {
            ...
            try {
                ...
                HMSLog.m2118e(TAG, "sync call ex:" + e2);
            }
        }
        return CommonCode.ErrorCode.INTERNAL_ERROR;
    }
    ...
    public final void post(ApiClient apiClient, DatagramTransport.InterfaceC1256a interfaceC1256a) {
        send(apiClient, interfaceC1256a);
    }

    @Override // com.huawei.hms.support.api.transport.DatagramTransport
    public final void send(ApiClient apiClient, DatagramTransport.InterfaceC1256a interfaceC1256a) {
        int syncCall = syncCall(apiClient, new IPCCallback(this.mResponseClass, interfaceC1256a));
        if (syncCall == 0 || interfaceC1256a == null) {
            return;
        }
        interfaceC1256a.mo2071a(syncCall, null);
    }
