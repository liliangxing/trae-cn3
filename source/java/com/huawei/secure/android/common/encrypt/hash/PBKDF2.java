...
public abstract class PBKDF2 {
    ...
    private static byte[] a(char[] cArr, byte[] bArr, int i2, int i3, boolean z) {
        if (cArr != null && cArr.length > 0) {
            if (bArr != null && bArr.length > 0) {
                if (bArr.length < 16) {
                    b.b(a, "pbkdf salt parameter length is not enough, length must be more than 16.");
                    return new byte[0];
                }
                if (i2 < 1000) {
                    b.b(a, "pbkdf iterations parameter count is less than 1000.");
                    return new byte[0];
                }
                if (i3 < 256) {
                    b.b(a, "pbkdf bytes parameter count is less than 256.");
                    return new byte[0];
                }
                return pbkdfBottom(cArr, bArr, i2, i3, z);
            }
            b.b(a, "pbkdf salt is empty.");
            return new byte[0];
        }
        b.b(a, "pbkdf password is empty.");
        return new byte[0];
    }
    ...
    public static boolean validatePasswordNew(String str, String str2, int i2) {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            if (str2.length() <= 32) {
                b.b(a, "encryptPassword length is must be more than (salt len * 2).");
                return false;
            }
            if (i2 < 10000) {
                b.b(a, "iterations times is not enough, Iterations must be performed for at least 10000 times, It is recommended that you perform iterations for at least 10000 times.");
            }
        ...
        b.b(a, "password or encryptPassword is null.");
        return false;
    }
