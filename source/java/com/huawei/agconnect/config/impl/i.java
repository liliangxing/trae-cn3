...
public class i implements ConfigReader {
    ...
    private void a(String str) {
        try {
            ...
            if (bigDecimal.compareTo(new BigDecimal("2.0")) == 0) {
                this.a.getJSONObject(SubTaskRequestMessage.EXECUTOR_CLIENT).put("app_id", b.getString("app_id"));
                return;
            }
    ...
    public String toString() {
        return "InputStreamReader{config=" + this.a.toString().hashCode() + AbstractJsonLexerKt.END_OBJ;
    }
}
