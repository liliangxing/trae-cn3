...
/* renamed from: com.cmic.sso.sdk.e.p */
/* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes6.dex */
public class C0146p {
    /* renamed from: a */
    public static String[] m394a(boolean z) {
        String[] strArr = {"", ""};
        ...
        try {
            ...
            C0133c.m328b("UmcIPUtils", "onlyMobileDataIp " + z + " IPV6 ip：" + sb.toString());
            C0133c.m328b("UmcIPUtils", "onlyMobileDataIp " + z + " IPV4 ip：" + sb2.toString());
            return strArr;
        } catch (Exception e) {
            e.printStackTrace();
            return strArr;
