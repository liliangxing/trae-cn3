...
public class TaskTraits {
    ...
    static {
        ...
        THREAD_POOL_USER_VISIBLE = taskPriority4.taskPriority(1);
        THREAD_POOL_BEST_EFFORT = taskPriority4.taskPriority(0);
    }
    ...
    public TaskTraits withExplicitDestination() {
        return (this.mUseThreadPool || hasExtension()) ? this : threadPool();
    }
