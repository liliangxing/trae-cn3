...
public class NetworkChangeNotifier {
    ...
    public interface Natives {
        ...
        @NativeClassQualifiedName("NetworkChangeNotifierDelegateAndroid")
        void notifyOfNetworkConnect(long j, NetworkChangeNotifier networkChangeNotifier, long j2, boolean z, int i);

        @NativeClassQualifiedName("NetworkChangeNotifierDelegateAndroid")
        void notifyOfNetworkDisconnect(long j, NetworkChangeNotifier networkChangeNotifier, boolean z, long j2);
        ...
        if (z) {
            if (this.mAutoDetector == null) {
                NetworkChangeNotifierAutoDetect networkChangeNotifierAutoDetect = new NetworkChangeNotifierAutoDetect(new NetworkChangeNotifierAutoDetect.Observer() { // from class: com.ttnet.org.chromium.net.NetworkChangeNotifier.1
                    ...
                    @Override // com.ttnet.org.chromium.net.NetworkChangeNotifierAutoDetect.Observer
                    public void onNetworkConnect(long j, int i, boolean z2) {
                        NetworkChangeNotifier.this.notifyObserversOfNetworkConnect(j, i, z2);
                    }
                    ...
                    @Override // com.ttnet.org.chromium.net.NetworkChangeNotifierAutoDetect.Observer
                    public void onNetworkDisconnect(long j, boolean z2) {
                        NetworkChangeNotifier.this.notifyObserversOfNetworkDisconnect(j, z2);
                    }
    ...
    private void forceUpdateNetworkType() {
        ...
        if (networkChangeNotifierAutoDetect != null) {
            ...
            if (this.mCurrentConnectionType != currentNetworkState.getConnectionType()) {
                ...
                this.mAutoDetector.runOnThread(new Runnable() { // from class: com.ttnet.org.chromium.net.NetworkChangeNotifier.2
                    @Override // java.lang.Runnable
                    public void run() {
                        NetworkChangeNotifier networkChangeNotifier = NetworkChangeNotifier.this;
                        networkChangeNotifier.notifyObserversOfConnectionTypeChange(networkChangeNotifier.mCurrentConnectionType);
                    }
                });
            }
        }
    ...
    public void mockConnectionTypeChangeForTesting(int i, long j) {
        if (BuildConfig.DCHECK_IS_ON) {
            notifyObserversOfConnectionTypeChange(i, j);
        }
    }
    ...
    public long getCurrentVpnNetId() {
        ...
        return networkChangeNotifierAutoDetect.getVpnNetId();
    }
    ...
    public static void fakeNetworkConnected(long j, int i) {
        setAutoDetectConnectivityState(false);
        getInstance().notifyObserversOfNetworkConnect(j, i, false);
    }
    ...
    public static void fakeNetworkDisconnected(long j) {
        setAutoDetectConnectivityState(false);
        getInstance().notifyObserversOfNetworkDisconnect(j, false);
    }
    ...
    void notifyObserversOfNetworkConnect(long j, int i, boolean z) {
        Iterator<Long> it = this.mNativeChangeNotifiers.iterator();
        while (it.hasNext()) {
            NetworkChangeNotifierJni.get().notifyOfNetworkConnect(it.next().longValue(), this, j, z, i);
        }
    }
    ...
    void notifyObserversOfNetworkDisconnect(long j, boolean z) {
        Iterator<Long> it = this.mNativeChangeNotifiers.iterator();
        while (it.hasNext()) {
            NetworkChangeNotifierJni.get().notifyOfNetworkDisconnect(it.next().longValue(), this, z, j);
        }
    }
