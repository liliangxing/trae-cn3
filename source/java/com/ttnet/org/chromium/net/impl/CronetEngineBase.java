...
public abstract class CronetEngineBase extends ExperimentalCronetEngine {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public abstract TTNetDiagnosisRequest createNetDiagnosisRequest(TTNetDiagnosisRequest.Callback callback, Executor executor, int i, List<String> list, int i2, int i3, int i4);
