...
public abstract class UrlRequest {
    ...
    public static abstract class Callback {
        ...
        public abstract void onRedirectReceived(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, String str, String str2) throws Exception;
    ...
    public abstract void setAddCookieCostUs(long j);

    public abstract void setAuthCredentials(String str, String str2);

    public abstract void setRequestCookieSource(int i);

    public void setRequestFlag(int i) {
    }

    public abstract void setRequestTypeFlags(int i);

    public abstract void setSaveCookieCostUs(long j);
