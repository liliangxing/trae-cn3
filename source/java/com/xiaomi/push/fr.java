...
public class fr {
    ...
    public fr(Bundle bundle) {
        ...
        if (bundle.containsKey("ext_err_type")) {
            this.f526a = bundle.getString("ext_err_type");
        }
        ...
        if (parcelableArray != null) {
            this.f527a = new ArrayList(parcelableArray.length);
    ...
    public Bundle a() {
        ...
        List<fk> list = this.f527a;
        if (list != null) {
            Bundle[] bundleArr = new Bundle[list.size()];
            Iterator<fk> it = this.f527a.iterator();
            int i = 0;
            while (it.hasNext()) {
                Bundle a2 = it.next().a();
                if (a2 != null) {
    ...
    public String m9913a() {
        ...
        Iterator<fk> it = m9914a().iterator();
        while (it.hasNext()) {
            sb.append(it.next().d());
        }
        sb.append("</error>");
    ...
    /* renamed from: a, reason: collision with other method in class */
    public synchronized List<fk> m9914a() {
        List<fk> list = this.f527a;
        if (list == null) {
    ...
    public static class a {
        ...
        public static final a n = new a(ReportConsts.RESPONSE_REDIRECT);
