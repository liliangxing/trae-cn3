...
public class ax {
    ...
    private static byte[] f193a;
    private static final String a = System.getProperty("line.separator");

    /* renamed from: a, reason: collision with other field name */
    private static char[] f194a = new char[64];
    ...
    public static char[] a(byte[] bArr, int i, int i2) {
        ...
        while (i < i7) {
            ...
            if (i9 < i7) {
                i3 = i9 + 1;
                i4 = bArr[i9] & UByte.MAX_VALUE;
            } else {
                i3 = i9;
                i4 = 0;
            }
            if (i3 < i7) {
                i5 = bArr[i3] & UByte.MAX_VALUE;
                i3++;
            } else {
                i5 = 0;
            }
    ...
    public static String b(String str) {
        return new String(m9639a(str));
    }

    /* renamed from: a, reason: collision with other method in class */
    public static byte[] m9639a(String str) {
