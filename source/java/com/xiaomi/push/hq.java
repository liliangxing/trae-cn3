...
public final class hq {
    ...
    private static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return hq.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return hq.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return hq.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return hq.a((byte[]) obj, (byte[]) obj2);
            }
            return hq.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static byte[] m10076a(ByteBuffer byteBuffer) {
        if (m10075a(byteBuffer)) {
    ...
    /* renamed from: a, reason: collision with other method in class */
    public static boolean m10075a(ByteBuffer byteBuffer) {
    ...
    public static ByteBuffer a(ByteBuffer byteBuffer) {
        return m10075a(byteBuffer) ? byteBuffer : ByteBuffer.wrap(m10076a(byteBuffer));
    }
}
