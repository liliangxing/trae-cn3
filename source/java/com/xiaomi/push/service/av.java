...
public class av {
    ...
    private static final byte[] f1005a;

    static {
        byte[] bArr = {48, -127, -97, 48, 13, 6, 9, 42, -122, 72, -122, -9, 13, 1, 1, 1, 5, 0, 3, -127, -115, 0, 48, -127, -119, 2, -127, -127, 0, -109, -38, -114, 26, -72, 78, Tnaf.POW_2_WIDTH, 70, -90, 113, -30, 36, 85, -3, -43, 123, Base64.padSymbol, -98, 4, -16, 67, 19, -90, -73, -5, -89, 36, 44, -27, 59, -123, 72, -73, -48, 49, 13, Tnaf.POW_2_WIDTH, 50, -27, -82, 18, -28, 84, 0, -41, Tnaf.POW_2_WIDTH, 69, -39, 7, 82, 56, 79, -37, 40, 85, 107, 98, 33, 123, -34, -49, 111, -11, 49, 28, 117, -74, 114, -122, -29, -84, 82, 22, -122, 42, -40, -79, 18, -116, -42, 101, -70, 44, 11, 62, -49, -3, -22, -2, 66, 90, -116, -75, -99, 34, 121, 69, 10, -81, -57, 89, -23, -36, -60, -81, 67, -114, 10, 79, 100, 29, 47, -24, 110, -66, -7, 87, Tnaf.POW_2_WIDTH, -125, -91, -43, -103, 67, -20, 41, 117, -37, -11, 2, 3, 1, 0, 1};
        f1005a = bArr;
        try {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            cipher.init(1, a);
            return android.util.Base64.encodeToString(a(cipher, 1, str.getBytes("UTF-8"), a.getModulus().bitLength()), 2);
        } catch (Throwable unused) {
            return null;
        }
    }
