...
public class fu {
    ...
    private Map<String, Object> f529a = new ConcurrentHashMap();
    ...
    protected void m9917a() {
        InputStream inputStream;
        XmlPullParser newPullParser;
        int eventType;
        try {
            for (ClassLoader classLoader : m9915a()) {
                            ...
                            if (newPullParser.getName().equals("iqProvider")) {
                                ...
                                if (!this.b.containsKey(a2)) {
                                    try {
                                        ...
                                        } else if (fl.class.isAssignableFrom(cls)) {
                                            this.b.put(a2, cls);
                                        }
                                ...
                                if (!this.f529a.containsKey(a3)) {
                                    try {
                                        Class<?> cls2 = Class.forName(nextText6);
                                        if (ft.class.isAssignableFrom(cls2)) {
                                            this.f529a.put(a3, cls2.newInstance());
                                        } else if (fo.class.isAssignableFrom(cls2)) {
                                            this.f529a.put(a3, cls2);
                                        }
    ...
    /* renamed from: a, reason: collision with other method in class */
    public Object m9916a(String str, String str2) {
        return this.f529a.get(a(str, str2));
    }
