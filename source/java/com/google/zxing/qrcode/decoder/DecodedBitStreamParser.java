...
final class DecodedBitStreamParser {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x012b A[LOOP:0: B:2:0x0022->B:23:0x012b, LOOP_END] */
    ...
    */
            ...
            try {
                ...
                switch (mode2) {
                    ...
                    default:
                        ...
                        int i13 = C08581.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode2.ordinal()];
                        if (i13 == i8) {
                            i = 3;
                            i2 = 2;
                            mode = mode2;
    ...
    private static void decodeHanziSegment(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        ...
        while (i > 0) {
            ...
            bArr[i2] = (byte) ((i4 >> 8) & JfifUtil.MARKER_FIRST_BYTE);
            bArr[i2 + 1] = (byte) (i4 & JfifUtil.MARKER_FIRST_BYTE);
            i2 += 2;
            i--;
        }
