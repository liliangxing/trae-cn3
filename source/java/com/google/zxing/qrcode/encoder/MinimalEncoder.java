...
public final class MinimalEncoder {
    ...
    static Version getVersion(VersionSize versionSize) {
        int i = C08611.f453x9d14eba6[versionSize.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C08611 {
        ...
        static final /* synthetic */ int[] f453x9d14eba6;
        ...
        static {
            ...
            try {
                f453x9d14eba6[VersionSize.MEDIUM.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f453x9d14eba6[VersionSize.LARGE.ordinal()] = 3;
    ...
    boolean canEncode(Mode mode, char c) {
        int i = C08611.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
    ...
    static int getCompactedOrdinal(Mode mode) {
        int i;
        if (mode == null || (i = C08611.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()]) == 1) {
            return 0;
        }
        if (i == 2) {
            return 1;
    ...
    public final class Edge {
        ...
        /* synthetic */ Edge(MinimalEncoder minimalEncoder, Mode mode, int i, int i2, int i3, Edge edge, Version version, C08611 c08611) {
        ...
        private Edge(Mode mode, int i, int i2, int i3, Edge edge, Version version) {
            ...
            int i6 = C08611.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
            if (i6 == 1) {
                i5 += 13;
            } else if (i6 == 2) {
                i5 += i3 == 1 ? 6 : 11;
    ...
    public final class ResultList {
        ...
        ResultList(Version version, Edge edge) {
            ...
            int i5 = C08611.f453x9d14eba6[MinimalEncoder.getVersionSize(version).ordinal()];
            if (i5 == 1) {
                i2 = 9;
            } else if (i5 != 2) {
                i = 27;
        ...
        public final class ResultNode {
            ...
            public int getSize(Version version) {
                ...
                int i2 = C08611.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[this.mode.ordinal()];
                if (i2 != 1) {
                    if (i2 == 2) {
