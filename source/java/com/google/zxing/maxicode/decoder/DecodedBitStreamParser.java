...
final class DecodedBitStreamParser {
    ...
    private static final byte[] POSTCODE_2_BYTES = {33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, Tnaf.POW_2_WIDTH, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2};
    private static final byte[][] POSTCODE_3_BYTES = {new byte[]{39, 40, 41, 42, 31, 32}, new byte[]{33, 34, 35, 36, 25, 26}, new byte[]{27, 28, 29, 30, 19, 20}, new byte[]{21, 22, 23, 24, 13, 14}, new byte[]{15, Tnaf.POW_2_WIDTH, 17, 18, 7, 8}, new byte[]{9, 10, 11, 12, 1, 2}};
    ...
    public static DecoderResult decode(byte[] bArr, int i) throws FormatException {
        ...
        if (i == 2 || i == 3) {
            ...
            DecimalFormat decimalFormat = new DecimalFormat(GeckoXDepender.TEMP_DEVICE_ID);
