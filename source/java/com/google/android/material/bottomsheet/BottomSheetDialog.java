...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C0425R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0425R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.coordinator = frameLayout.findViewById(C0425R.id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C0425R.id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout findViewById = this.container.findViewById(C0425R.id.coordinator);
        if (i != 0 && view == null) {
        ...
        findViewById.findViewById(C0425R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0425R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C0425R.style.Theme_Design_Light_BottomSheetDialog;
    }
    ...
    private static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(View view, WindowInsetsCompat windowInsetsCompat) {
            ...
            boolean z = (view.getSystemUiVisibility() & AnimationConstant.PROP_COLOR) != 0;
    ...
    public static void setLightStatusBar(View view, boolean z) {
        ...
        view.setSystemUiVisibility(z ? systemUiVisibility | AnimationConstant.PROP_COLOR : systemUiVisibility & (-8193));
    }
}
