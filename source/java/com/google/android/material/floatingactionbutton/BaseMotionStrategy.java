...
public abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(AnimationConstant.PROP_STR_OPACITY)) {
            arrayList.add(motionSpec.getAnimator(AnimationConstant.PROP_STR_OPACITY, this.fab, View.ALPHA));
        }
        ...
        if (motionSpec.hasPropertyValues(AnimationConstant.PROP_STR_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(AnimationConstant.PROP_STR_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(AnimationConstant.PROP_STR_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(AnimationConstant.PROP_STR_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
