...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    protected FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int i;
        if (z) {
            i = C0425R.animator.mtrl_fab_transformation_sheet_expand_spec;
        } else {
            i = C0425R.animator.mtrl_fab_transformation_sheet_collapse_spec;
        }
    ...
    private void updateImportantForAccessibility(View view, boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.LayoutParams) && (childAt.getLayoutParams().getBehavior() instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z2) {
                    if (!z) {
