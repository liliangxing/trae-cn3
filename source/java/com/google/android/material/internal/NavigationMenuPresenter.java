...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C0425R.dimen.design_navigation_separator_vertical_padding);
    }

    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C0425R.layout.design_navigation_menu, viewGroup, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C0425R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0425R.layout.design_navigation_item, viewGroup, false));
    ...
    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0425R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0425R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            ?? r4 = (NavigationMenuItemView) viewHolder.itemView;
            r4.setIconTintList(NavigationMenuPresenter.this.iconTintList);
            if (NavigationMenuPresenter.this.textAppearanceSet) {
                r4.setTextAppearance(NavigationMenuPresenter.this.textAppearance);
            }
            if (NavigationMenuPresenter.this.textColor != null) {
                r4.setTextColor(NavigationMenuPresenter.this.textColor);
            }
            ViewCompat.setBackground((View) r4, NavigationMenuPresenter.this.itemBackground != null ? NavigationMenuPresenter.this.itemBackground.getConstantState().newDrawable() : null);
            ...
            r4.setHorizontalPadding(NavigationMenuPresenter.this.itemHorizontalPadding);
            r4.setIconPadding(NavigationMenuPresenter.this.itemIconPadding);
            if (NavigationMenuPresenter.this.hasCustomItemIconSize) {
                r4.setIconSize(NavigationMenuPresenter.this.itemIconSize);
            }
            r4.setMaxLines(NavigationMenuPresenter.this.itemMaxLines);
