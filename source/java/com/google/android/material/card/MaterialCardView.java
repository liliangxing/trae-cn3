...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C0425R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C0425R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0425R.attr.materialCardViewStyle);
    }
    ...
    */
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C0425R.styleable.MaterialCardView, i, i2, new int[0]);
