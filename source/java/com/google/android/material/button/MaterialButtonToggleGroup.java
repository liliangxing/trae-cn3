...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C0425R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0425R.attr.materialButtonToggleGroupStyle);
    }
    ...
    */
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C0425R.styleable.MaterialButtonToggleGroup, i, i2, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C0425R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C0425R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = obtainStyledAttributes.getBoolean(C0425R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r5v1, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        ShapeAppearanceModel shapeAppearanceModel = r5.getShapeAppearanceModel();
        ...
        ViewCompat.setAccessibilityDelegate((View) r5, new AccessibilityDelegateCompat() { // from class: com.google.android.material.button.MaterialButtonToggleGroup.2
            /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v1, types: [com.google.android.material.button.MaterialButton, android.view.View] */
