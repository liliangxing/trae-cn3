...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    /* JADX WARN: Type inference failed for: r5v3, types: [com.google.android.material.chip.Chip, android.view.View] */
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        LayoutInflater from = LayoutInflater.from(context);
        ?? r5 = (Chip) from.inflate(C0425R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = r5;
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(C0425R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0425R.id.material_label);
