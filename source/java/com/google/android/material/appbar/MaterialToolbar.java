...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C0425R.style.Widget_MaterialComponents_Toolbar;
    ...
    */
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0425R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (obtainStyledAttributes.hasValue(C0425R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(obtainStyledAttributes.getColor(C0425R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = obtainStyledAttributes.getBoolean(C0425R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = obtainStyledAttributes.getBoolean(C0425R.styleable.MaterialToolbar_subtitleCentered, false);
