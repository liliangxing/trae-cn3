...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    private static final int DEF_STYLE_RES = C0425R.style.Widget_MaterialComponents_ShapeableImageView;
    ...
    */
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C0425R.styleable.ShapeableImageView, i, i2);
        this.strokeColor = MaterialResources.getColorStateList(context2, obtainStyledAttributes, C0425R.styleable.ShapeableImageView_strokeColor);
        this.strokeWidth = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_strokeWidth, 0);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPadding, 0);
        ...
        this.leftContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingLeft, dimensionPixelSize);
        this.topContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingTop, dimensionPixelSize);
        this.rightContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingRight, dimensionPixelSize);
        this.bottomContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingBottom, dimensionPixelSize);
        this.startContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingStart, UNDEFINED_PADDING);
        this.endContentPadding = obtainStyledAttributes.getDimensionPixelSize(C0425R.styleable.ShapeableImageView_contentPaddingEnd, UNDEFINED_PADDING);
