...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i = C0425R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C0425R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View inflate = cloneInContext.inflate(i, viewGroup, false);
        GridView gridView = (GridView) inflate.findViewById(C0425R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = inflate.findViewById(C0425R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C0425R.integer.mtrl_calendar_year_selector_span);
        RecyclerView findViewById = inflate.findViewById(C0425R.id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C0425R.id.month_navigation_fragment_toggle) != null) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (Pair<Long, Long> pair : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        if (pair.first != null && pair.second != null) {
                            ...
                            View findViewByPosition = layoutManager.findViewByPosition(positionForYear);
                            View findViewByPosition2 = layoutManager.findViewByPosition(positionForYear2);
                            int spanCount = positionForYear / layoutManager.getSpanCount();
                            int spanCount2 = positionForYear2 / layoutManager.getSpanCount();
                            int i = spanCount;
                            while (i <= spanCount2) {
                                View findViewByPosition3 = layoutManager.findViewByPosition(layoutManager.getSpanCount() * i);
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0425R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final ?? r0 = (MaterialButton) view.findViewById(C0425R.id.month_navigation_fragment_toggle);
        r0.setTag(SELECTOR_TOGGLE_TAG);
        ViewCompat.setAccessibilityDelegate((View) r0, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                String string;
                super.onInitializeAccessibilityNodeInfo(view2, accessibilityNodeInfoCompat);
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C0425R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C0425R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        MaterialButton materialButton = (MaterialButton) view.findViewById(C0425R.id.month_navigation_previous);
        materialButton.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C0425R.id.month_navigation_next);
        materialButton2.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C0425R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C0425R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        r0.setText(this.current.getLongName(view.getContext()));
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                if (i == 0) {
                    recyclerView.announceForAccessibility(r0.getText());
                }
            }
        });
        r0.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
