...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C0425R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C0425R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C0425R.attr.colorSurface, 0);
    ...
    public int compositeOverlay(int i, float f) {
        ...
        return ColorUtils.setAlphaComponent(MaterialColors.layer(ColorUtils.setAlphaComponent(i, JfifUtil.MARKER_FIRST_BYTE), this.elevationOverlayColor, calculateOverlayAlphaFraction), Color.alpha(i));
    }
    ...
    private boolean isThemeSurfaceColor(int i) {
        return ColorUtils.setAlphaComponent(i, JfifUtil.MARKER_FIRST_BYTE) == this.colorSurface;
    }
}
