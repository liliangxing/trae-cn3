...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final zabx zac(Context context, zabw zabwVar) {
        ...
        m509xb1df4a3a(context, zabxVar, intentFilter);
        zabxVar.zaa(context);
    ...
    final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                style.addAction(C0421R.drawable.common_full_open_on_phone, resources.getString(C0421R.string.common_open_on_phone), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(C0421R.string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(zae);
        }
        if (PlatformVersion.isAtLeastO()) {
    ...
    /* renamed from: INVOKEVIRTUAL_com_google_android_gms_common_GoogleApiAvailability_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver */
    public static Intent m509xb1df4a3a(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
