...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean zza(Context context, String str) {
        ...
        try {
            applicationInfo = context.getPackageManager().getApplicationInfo(str, AnimationConstant.PROP_COLOR);
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        try {
            context.getResources().getString(C0422R.string.common_google_play_services_unknown_issue);
