...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = 2;
        Log.m269d(TAG, "<init>, appId = " + str + ", checkSignature = " + z + ", launchMode = " + i);
        this.context = context;
        this.appId = str;
        this.checkSignature = z;
        this.launchMode = i;
        C1007b.f208a = context.getApplicationContext();
    ...
    public boolean doLaunchApp(Bundle bundle) {
        ...
        try {
            ...
            Log.m270e(TAG, "getTokenFromWX fail, exception = " + e);
        }
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    ...
                    str2 = DownloadConstants.PATH_KEY;
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638063616"}, null);
        if (query == null || !query.moveToFirst()) {
            Log.m270e(TAG, "getTokenFromWX , token is null , if your app targetSdkVersion >= 30, include 'com.tencent.mm' in a set of <package> elements inside the <queries> element");
            return null;
        }
        String string = query.getString(0);
        Log.m271i(TAG, "getTokenFromWX token is " + string);
        query.close();
        return string;
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        Log.m271i(TAG, "handleWxInternalRespType, extInfo = " + str);
        try {
            parse = Uri.parse(str);
            queryParameter = parse.getQueryParameter("wx_internal_resptype");
            Log.m271i(TAG, "handleWxInternalRespType, respType = " + queryParameter);
        } catch (Exception e) {
            Log.m270e(TAG, "handleWxInternalRespType fail, ex = " + e.getMessage());
        }
        if (C1007b.m278b(queryParameter)) {
            Log.m270e(TAG, "handleWxInternalRespType fail, respType is null");
            return false;
        }
        if (queryParameter.equals("subscribemessage")) {
            ...
            if (queryParameter2 != null && queryParameter2.length() > 0) {
                resp.errCode = C1007b.m276a(queryParameter2, 0);
            }
            resp.openId = parse.getQueryParameter("openid");
            resp.templateID = parse.getQueryParameter("template_id");
            resp.scene = C1007b.m276a(parse.getQueryParameter(TokenConstants.SCENE_KEY), 0);
        ...
        if (queryParameter.contains("invoice_auth_insert")) {
            ...
            if (queryParameter3 != null && queryParameter3.length() > 0) {
                resp2.errCode = C1007b.m276a(queryParameter3, 0);
            }
        ...
        if (queryParameter.contains("payinsurance")) {
            ...
            if (queryParameter4 != null && queryParameter4.length() > 0) {
                resp3.errCode = C1007b.m276a(queryParameter4, 0);
            }
        ...
        if (queryParameter.contains("nontaxpay")) {
            ...
            if (queryParameter5 != null && queryParameter5.length() > 0) {
                resp4.errCode = C1007b.m276a(queryParameter5, 0);
            }
        ...
        if (!"subscribeminiprogrammsg".equals(queryParameter) && !"5".equals(queryParameter)) {
            Log.m270e(TAG, "this open sdk version not support the request type");
            return false;
        }
        SubscribeMiniProgramMsg.Resp resp5 = new SubscribeMiniProgramMsg.Resp();
        String queryParameter6 = parse.getQueryParameter("ret");
        if (queryParameter6 != null && queryParameter6.length() > 0) {
            resp5.errCode = C1007b.m276a(queryParameter6, 0);
        }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        if (!isWXAppInstalled()) {
            Log.m270e(TAG, "openWXApp failed, not installed or signature check failed");
            return;
        }
        try {
            Log.m271i(TAG, "launchWXUsingPendingIntent");
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), 134217728).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
                @Override // android.app.PendingIntent.OnFinished
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i, String str, Bundle bundle) {
                    Log.m269d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e) {
            Log.m270e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e.getMessage());
            openWXApp();
        }
    }
    ...
    private boolean sendFinderOpenEvent(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderOpenEvent");
    ...
    private boolean sendFinderOpenFeed(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderOpenFeed");
    ...
    private boolean sendFinderOpenLive(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderOpenLive");
    ...
    private boolean sendFinderOpenProfile(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderOpenProfile");
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderShareVideo");
    ...
    private boolean sendFinderStartLive(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m271i(TAG, "sendFinderStartLive");
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            Log.m269d(TAG, "pay, set wxappPayEntryClassname = " + wxappPayEntryClassname);
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.m270e(TAG, "get from metaData failed : " + e.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
                Log.m270e(TAG, "pay fail, wxappPayEntryClassname is null");
                return false;
            }
        }
        MMessageActV2.Args args = new MMessageActV2.Args();
        ...
        try {
            ...
            Log.m270e(TAG, "getTokenFromWX fail, exception = " + e2);
        }
    ...
    public void detach() {
        Log.m269d(TAG, LynxImpressionEvent.EVENT_DETACH);
        this.detached = true;
        this.context = null;
    }
    ...
    public int getWXAppSupportAPI() {
        ...
        if (!isWXAppInstalled()) {
            Log.m270e(TAG, "open wx app failed, not installed or signature check failed");
            return 0;
        }
        this.wxSdkVersion = 0;
        try {
            ...
            Log.m269d(TAG, "OPEN_SDK_VERSION = " + this.wxSdkVersion);
        } catch (Exception e) {
            Log.m270e(TAG, "get from metaData failed : " + e.getMessage());
        }
        if (this.wxSdkVersion == 0) {
            final CountDownLatch countDownLatch = new CountDownLatch(1);
            C1007b.f209b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                ...
                public void run() {
                    try {
                        ...
                        Log.m273w(BaseWXApiImplV10.TAG, e2.getMessage());
                    }
            ...
            try {
                ...
                Log.m273w(TAG, e2.getMessage());
            }
        }
        Log.m269d(TAG, "wxSdkVersion = " + this.wxSdkVersion);
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.m270e(TAG, "handleIntent fail, ex = " + e.getMessage());
        }
        if (!WXApiImplComm.isIntentFromWx(intent, ConstantsAPI.Token.WX_TOKEN_VALUE_MSG)) {
            Log.m271i(TAG, "handleIntent fail, intent not from weixin msg");
            return false;
        }
        if (this.detached) {
        ...
        if (stringExtra2 != null && stringExtra2.length() != 0) {
            if (!checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), C0992a.m257a(stringExtra, intExtra, stringExtra2))) {
                Log.m270e(TAG, "checksum fail");
                return false;
            }
            int intExtra2 = intent.getIntExtra("_wxapi_command_type", 0);
            Log.m271i(TAG, "handleIntent, cmd = " + intExtra2);
            switch (intExtra2) {
                case 1:
                ...
                case 4:
                    ...
                    if (str != null && str.contains("wx_internal_resptype")) {
                        ...
                        Log.m271i(TAG, "handleIntent, extInfo contains wx_internal_resptype, ret = " + handleWxInternalRespType);
                        ...
                        try {
                            ...
                            if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                ...
                                if (queryParameter != null && queryParameter.length() > 0) {
                                    resp.errCode = C1007b.m276a(queryParameter, 0);
                                }
                                resp.resultInfo = parse.getQueryParameter("resultInfo");
                                resp.errStr = parse.getQueryParameter("errmsg");
                                String queryParameter2 = parse.getQueryParameter(DownloadSettingKeys.AhPlans.KEY_AH_PLAN_TYPE);
                                if (queryParameter2 != null && queryParameter2.length() > 0) {
                                    resp.businessType = C1007b.m276a(queryParameter2, 0);
                                }
                                iWXAPIEventHandler.onResp(resp);
                                return true;
                            }
                            Log.m269d(TAG, "not openbusinesswebview %" + str);
                        } catch (Exception e2) {
                            Log.m270e(TAG, "parse fail, ex = " + e2.getMessage());
                        }
                    }
                ...
                case 40:
                default:
                    Log.m270e(TAG, "unknown cmd = " + intExtra2);
                    return false;
                case 9:
        ...
        Log.m270e(TAG, "invalid argument");
        return false;
    }
    ...
    public boolean isWXAppInstalled() {
        ...
        try {
            ...
            Log.m273w(TAG, "isWXAppInstalled packageInfo is null");
            return false;
        } catch (Exception unused) {
            return false;
        }
    ...
    public boolean registerApp(String str, long j) {
        ...
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m270e(TAG, "register app failed for wechat app signature check failed");
            return false;
        }
        Log.m269d(TAG, "registerApp, appId = " + str);
        if (str != null) {
            this.appId = str;
        }
        Log.m269d(TAG, "registerApp, appId = " + str);
        ...
        Log.m269d(TAG, "register app " + this.context.getPackageName());
        C0992a.a aVar = new C0992a.a();
        aVar.f166a = "com.tencent.mm";
        aVar.f167b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        aVar.f168c = "weixin://registerapp?appid=" + this.appId;
        aVar.f169d = j;
        return C0992a.m255a(this.context, aVar);
    }
    ...
    public boolean sendReq(BaseReq baseReq, final SendReqCallback sendReqCallback) {
        ...
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m270e(TAG, "sendReq failed for wechat app signature check failed");
            return false;
        }
        ...
        if (!baseReq.checkArgs()) {
            Log.m270e(TAG, "sendReq checkArgs fail");
            return false;
        }
        Log.m271i(TAG, "sendReq, req type = " + baseReq.getType());
        ...
        if (baseReq.getType() == 2) {
            ...
            if (C1007b.m277a(req2.message.getType())) {
                ...
                if (!C1007b.m278b(str2)) {
                    String[] split = str2.split("\\?");
                    wXMiniProgramObject.path = (split.length > 1 ? new StringBuilder().append(split[0]).append(".html?").append(split[1]) : new StringBuilder().append(split[0]).append(".html")).toString();
                }
                int i = req2.scene;
                if (i != 3 && i != 1) {
                    req2.scene = 0;
        ...
        if (C1007b.m278b(extractMayNeedDoSecurityCheckUrl)) {
        ...
        int doExtraSecurityCheck = this.securityHelper.doExtraSecurityCheck(this.appId, "638063616", extractMayNeedDoSecurityCheckUrl, new WXAPiSecurityHelper.ISecurityCheck() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
            ...
            public void onCheckFinish(boolean z) {
                if (!z) {
                    Log.m271i(BaseWXApiImplV10.TAG, "WXAPiSecurityHelper, extra check do next step: check fail, stop process!");
                    BaseWXApiImplV10.this.callbackReq(sendReqCallback, false);
                } else {
                    Log.m271i(BaseWXApiImplV10.TAG, "WXAPiSecurityHelper, extra check do next step: check pass, doLaunchApp");
                    BaseWXApiImplV10.this.callbackReq(sendReqCallback, BaseWXApiImplV10.this.doLaunchApp(bundle));
                }
            }
        });
        if (doExtraSecurityCheck == 0) {
            Log.m271i(TAG, "WXAPiSecurityHelper, extra check pass, doLaunchApp");
            boolean doLaunchApp2 = doLaunchApp(bundle);
            callbackReq(sendReqCallback, doLaunchApp2);
            return doLaunchApp2;
        }
        if (doExtraSecurityCheck != 1) {
            Log.m271i(TAG, "WXAPiSecurityHelper, hold on request, extra check need to do next step");
            return true;
        }
        Log.m271i(TAG, "WXAPiSecurityHelper, extra check fail, return");
    ...
    public void unregisterApp() {
        ...
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m270e(TAG, "unregister app failed for wechat app signature check failed");
            return;
        }
        Log.m269d(TAG, "unregisterApp, appId = " + this.appId);
        String str = this.appId;
        if (str == null || str.length() == 0) {
            Log.m270e(TAG, "unregisterApp fail, appId is empty");
            return;
        }
        Log.m269d(TAG, "unregister app " + this.context.getPackageName());
        C0992a.a aVar = new C0992a.a();
        aVar.f166a = "com.tencent.mm";
        aVar.f167b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        aVar.f168c = "weixin://unregisterapp?appid=" + this.appId;
        C0992a.m255a(this.context, aVar);
    }
}
