...
public class ZipFile implements Closeable {
    ...
    public ZipFile(File file, String str, boolean z) throws IOException {
        ...
        this.OFFSET_COMPARATOR = new Comparator<ZipEntry>() { // from class: com.ss.android.socialbase.appdownloader.util.parser.zip.ZipFile.2
        ...
        this.archive = new RandomAccessFile(file, DownloadFileUtils.MODE_READ);
        try {
    ...
    public InputStream getInputStream(ZipEntry zipEntry) throws IOException, ZipException {
        ...
        if (method == 8) {
            ...
            return new InflaterInputStream(boundedInputStream, inflater) { // from class: com.ss.android.socialbase.appdownloader.util.parser.zip.ZipFile.1
    ...
    private void readCentralDirectoryEntry(Map<ZipEntry, NameAndComment> map) throws IOException {
        ...
        if (this.archive.length() - this.archive.getFilePointer() < value) {
        ...
        if (this.archive.length() - this.archive.getFilePointer() < value2) {
            throw new EOFException();
        }
        ...
        if (this.archive.length() - this.archive.getFilePointer() < value3) {
            throw new EOFException();
        }
    ...
    private void resolveLocalFileHeaderData(Map<ZipEntry, NameAndComment> map) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            long j3 = value2;
            if (this.archive.length() - this.archive.getFilePointer() < j3) {
                throw new EOFException();
            }
            ...
            try {
                entry.setExtra(bArr);
                offsetEntry.dataOffset = j2 + 2 + 2 + value + j3;
    ...
    public static class Entry extends ZipEntry {
        ...
        @Override // com.ss.android.socialbase.appdownloader.util.parser.zip.ZipEntry, java.util.zip.ZipEntry
        public int hashCode() {
            return (super.hashCode() * 3) + ((int) (this.offsetEntry.headerOffset % 2147483647L));
        }

        @Override // com.ss.android.socialbase.appdownloader.util.parser.zip.ZipEntry
