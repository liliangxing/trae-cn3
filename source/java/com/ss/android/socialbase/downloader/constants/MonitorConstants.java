...
public interface MonitorConstants {
    ...
    public static final String APP_INSTALL_RESULT_CODE = "install_result_code";
    public static final String APP_INSTALL_STATUS = "install_status";
    ...
    public static final String DOWNLOAD_DISK_CACHE = "download_disk_cache";
    public static final String DOWNLOAD_INSTALL_APP = "download_install_app";
    ...
    public static final String ENQUEUE_TYPE = "enqueue_type";
    public static final String ERR = "err";
    public static final String ERR_MSG = "error_msg";
    public static final String EXTRA_ABHIT = "abhit";
    public static final String EXTRA_APP_ID = "app_id";
    public static final String EXTRA_BACKGROUND_DOWNLOAD_BYTES = "background_download_bytes";
    public static final String EXTRA_BACKGROUND_DOWNLOAD_TIME = "background_download_time";
    ...
    public static final String EXTRA_DEVICE_AVAILABLE_SPACE = "device_available_space";
    ...
    public static final String EXTRA_DOWNLOAD_BACKUP_URL = "backup_url";
    ...
    public static final String EXTRA_DOWNLOAD_MD5_TIME = "md5_time";
    ...
    public static final String EXTRA_FAST_DOWNLOAD = "fast_download";
    ...
    public static final String EXTRA_SDK_ID = "sdk_app_id";
    public static final String EXTRA_TASK_SLEEP_TIME = "sleep_time";
    ...
    public static final String THROTTLE_SPEED = "throttle_net_speed";
