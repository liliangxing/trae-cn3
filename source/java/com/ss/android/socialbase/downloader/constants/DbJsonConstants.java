...
public interface DbJsonConstants {
    ...
    public static final String DBJSON_KEY_APP_PACKAGE_INFO = "app_package_info";
    public static final String DBJSON_KEY_DOWNLOAD_PREPARE_TIME = "dbjson_key_download_prepare_time";
    public static final String DBJSON_KEY_END_OFFSET = "end_offset";
    ...
    public static final String DBJSON_KEY_REDIRECT_PARTIAL_URL_RESULTS = "redirect_partial_url_results";
    public static final String DBJSON_KEY_START_OFFSET = "start_offset";
