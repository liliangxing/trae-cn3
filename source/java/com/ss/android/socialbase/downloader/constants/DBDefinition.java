...
public interface DBDefinition {
    ...
    public static final String DATABASE_SUBPROCESS_PREFIX_NAME = "downloader_";
    public static final String DATABASE_SUBPROCESS_SUFFIX_NAME = ".db";
    ...
    public static final int VERSION_DOWNLOAD_TABLE_ADD_BACK_CURBYTES = 19;
    ...
    public static final int VERSION_DOWNLOAD_TABLE_ADD_MONITOR_SCENE = 20;
