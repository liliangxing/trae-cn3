...
public interface SpJsonConstants {
    ...
    public static final String KEY_INSTALL_BIZ_PARAMS_JSON = "install_biz_params_json";
    public static final String KEY_INSTALL_BIZ_TYPE = "install_biz_type";
    public static final String KEY_INSTALL_CERT_ID = "install_cert_id";
