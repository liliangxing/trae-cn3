    ...
    public static DownloadAidlTask convertDownloadTaskToAidl(final DownloadTask downloadTask) {
        ...
        return new DownloadAidlTask.Stub() { // from class: com.ss.android.socialbase.downloader.utils.IPCUtils.1
            ...
            public IDownloadAidlListener getSingleDownloadListener(int i) throws RemoteException {
                return IPCUtils.convertListenerToAidl(DownloadTask.this.getSingleDownloadListener(DownloadHelper.convertListenerType(i)), i != ListenerType.SUB.ordinal());
            }

            @Override // com.ss.android.socialbase.downloader.model.DownloadAidlTask
            public int[] getDownloadListenerHashCodeLists(int i) {
                return DownloadTask.this.getDownloadListenerHashCodeLists(DownloadHelper.convertListenerType(i));
            }

            @Override // com.ss.android.socialbase.downloader.model.DownloadAidlTask
            public IDownloadAidlListener getDownloadListenerByHashCode(int i, int i2) {
                return IPCUtils.convertListenerToAidl(DownloadTask.this.getDownloadListenerByHashCode(DownloadHelper.convertListenerType(i), i2), i != ListenerType.SUB.ordinal());
            }
    ...
    private static void setDownloadListeners(DownloadTask downloadTask, DownloadAidlTask downloadAidlTask, ListenerType listenerType) throws RemoteException {
        ...
        if (downloadListenerHashCodeLists != null && downloadListenerHashCodeLists.length > 0) {
            for (int i : downloadListenerHashCodeLists) {
                IDownloadAidlListener downloadListenerByHashCode = downloadAidlTask.getDownloadListenerByHashCode(listenerType.ordinal(), i);
                if (downloadListenerByHashCode != null) {
                    concurrentHashMap.put(Integer.valueOf(downloadListenerByHashCode.getOriginHashCode()), convertListenerFromAidl(downloadListenerByHashCode));
                }
            }
        }
