...
public class AVMDLDataLoaderConfigure {
    ...
    public int mEnableQuicRegisterWithoutPlugin = 0;
    ...
    public int mLoadP2pPluginAfterMdlStart = 0;
    public String mImageLoaderConfigStr = null;
    public long mMaxCacheSize64 = 0;
    ...
    public int mSessionTimeout = DateCalculationsKt.SECONDS_PER_HOUR;
    ...
    public String mBusinessDirControlConfigStr = null;
        ...
        for (int i = 0; i < strArr.length; i++) {
            if (!TextUtils.isEmpty(strArr[i])) {
                if (this.mCacheDirListsStr == null) {
                    ...
                    this.mCacheDirListsStr += HiAnalyticsConstant.REPORT_VAL_SEPARATOR + strArr[i] + "$" + Long.toString(jArr[i]);
                }
            }
        }
        ...
        for (int i = 0; i < strArr.length; i++) {
            if (!TextUtils.isEmpty(strArr[i])) {
                if (this.mProtectCacheDirsStr == null) {
                    ...
                    this.mProtectCacheDirsStr += HiAnalyticsConstant.REPORT_VAL_SEPARATOR + strArr[i];
                }
            }
        }
