...
public class CustomVerify {
    ...
    static {
        ...
        try {
            ...
            try {
                Log.e("custom_verify", "find ttnet verify suc");
                z = true;
            } catch (Exception e) {
                e = e;
                z = true;
                Log.e("custom_verify", "found verify class or method exception:" + e.getMessage());
                Log.e("custom_verify", "find ttnet verify fail");
                if (!z) {
                }
                hasInited = true;
        ...
        if (!z) {
            try {
                ...
                Log.e("custom_verify", "found verify class or method exception:" + e3.getMessage());
