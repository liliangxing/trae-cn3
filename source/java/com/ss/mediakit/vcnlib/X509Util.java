...
public class X509Util {
    ...
    private static void ensureInitializedLocked() throws CertificateException, KeyStoreException, NoSuchAlgorithmException {
        ...
        if (sTrustStorageListener == null) {
            ...
            m235x65c61035(NetUtils.getApplicationContext(), sTrustStorageListener, intentFilter);
        }
    }
    ...
    /* renamed from: INVOKEVIRTUAL_com_ss_mediakit_vcnlib_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver */
    public static Intent m235x65c61035(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
