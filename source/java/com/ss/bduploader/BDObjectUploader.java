...
public class BDObjectUploader extends BDAbstractUpload implements Handler.Callback {
    ...
    public static final int KeyIsEnableGatewayForObject = 87;
    ...
    public static final int KeyIsGatewayThreshold = 88;
    ...
    private BDObjectUploaderAbstractListener mAbstractListener = null;
    ...
    public boolean handleMessage(Message message) {
        ...
        this.mListener.onNotify(i, bDObjectInfo != null ? bDObjectInfo.mProgress : 0L, bDObjectInfo);
        return true;
    }
    ...
    public void setEnableBigFile(long j) {
        long j2 = this.mHandle;
        if (j2 == 0) {
            return;
        }
        _setIntValue(j2, 87, 1);
        _setInt64Value(this.mHandle, 88, j);
    }
}
