...
public class Camera1Capturer extends CameraCapturer {
    ...
    public Camera1Capturer(String cameraName, CameraVideoCapturer.CameraEventsHandler eventsHandler, boolean captureToTexture, boolean isDesktopMode) {
        super(cameraName, eventsHandler, new Camera1Enumerator(captureToTexture, isDesktopMode));
        this.captureToTexture = captureToTexture;
        this.isDesktopMode = isDesktopMode;
        this.mEnableFaceAE = false;
    }

    public void enableFaceAE(boolean enabled) {
        this.mEnableFaceAE = enabled;
    }
    ...
    protected void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context applicationContext, SurfaceTextureHelper surfaceTextureHelper, String cameraName, int width, int height, int framerate) {
        Camera1Session.create(createSessionCallback, events, this.captureToTexture, this.isDesktopMode, applicationContext, surfaceTextureHelper, Camera1Enumerator.getCameraIndex(cameraName), width, height, framerate, this.mEnableFaceAE, this.mEnableFollowGravity);
    }
}
