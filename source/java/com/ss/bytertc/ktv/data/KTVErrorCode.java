...
public enum KTVErrorCode {
    OK(0),
    APPID_INVALID(AVMDLDataLoader.AVMDLErrorIsStatusCodeMoreThan400),
    PARAS_INVALID(AVMDLDataLoader.AVMDLErrorIsStatusCodeMoreThan500),
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$ss$bytertc$ktv$data$KTVErrorCode;
    ...
    public static KTVErrorCode fromId(int id) {
        for (KTVErrorCode kTVErrorCode : values()) {
            if (kTVErrorCode.value() == id) {
                return kTVErrorCode;
            }
        }
        return null;
