...
public class VendorQTI {
    ...
    public static void setupVpp(AJMediaFormat mediaFormat, int level) {
        if (mediaFormat == null) {
            return;
        }
    ...
    public static void debugEffect(AJMediaFormat mediaFormat) {
        if (mediaFormat == null) {
            return;
        }
    ...
    public static void enableLowLatency(AJMediaFormat mediaFormat) {
        if (mediaFormat == null) {
            return;
        }
