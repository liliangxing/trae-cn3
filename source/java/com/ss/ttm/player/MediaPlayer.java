...
public interface MediaPlayer {
    ...
    public static final int MEDIA_INFO_AUDIO_DECODE_ERROR_CONSUMED = -268435381;
    ...
    public static final int MEDIA_INFO_PLAY_LOOP_END = -268435379;
    ...
    public static final int MEDIA_INFO_VIDEO_RENDER_DEVICE_CHANGED = -268435382;
    ...
    public static final int MEDIA_INFO_VIDEO_SR_MODE_CHANGE = -268435380;
    ...
    public static final int MEDIA_PLAYER_AUDIO_METRIC_INFO = 87;
    ...
    public static final int MEDIA_PLAYER_HARDWARE_BUFFER_OPENGL_DEVICE = 11;
    public static final int MEDIA_PLAYER_HARDWARE_BUFFER_OUTPUT_DEVICE = 13;
    public static final int MEDIA_PLAYER_HARDWARE_BUFFER_SURFACE_CONTROL_DEVICE = 12;
    ...
    public static final int MEDIA_PLAYER_OPTION_ACTUAL_SIZE_RATE = 484;
    ...
    public static final int MEDIA_PLAYER_OPTION_AE_SAMI_MAX_LRA = 1363;
    ...
    public static final int MEDIA_PLAYER_OPTION_ALOG_LEVEL_PRECISE = 1502;
    ...
    public static final int MEDIA_PLAYER_OPTION_ANSENALED = 10215;
    public static final int MEDIA_PLAYER_OPTION_ANSTYPE = 10213;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIOX_BYTE_AUDIO_TUNER_DESC = 4029;
    public static final int MEDIA_PLAYER_OPTION_AUDIOX_BYTE_AUDIO_TUNER_TYPE = 4030;
    public static final int MEDIA_PLAYER_OPTION_AUDIOX_YGG_MODEL_PATH = 1170;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_CALCULATE_TIME = 37041;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_LEFT_RIGHT_DIFF = 37042;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_MIX_RATIO = 46524;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_OPEN_ANALYZE_AUDIO_FRAME = 46527;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_POSITION = 46523;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_CHANNEL_EXPAND_PROCESS_TYPE = 46526;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_DB_LIST_STR = 10201;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_MAX_CACHE_SIZE = 42142;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_MONITOR_MODE = 42876;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_OPENED_TIME = 632;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_QUEUE_THRESH = 42862;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_RENDERED_THRESH = 42863;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DECODER_START_TIME = 631;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DETECTION_RES = 4046;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_DROP_FRAME_STATS_STR = 10202;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_EFFECT_INT_SUCCESS = 1171;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION1_CONFIG = 30048;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION1_ENABLE = 46530;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION2_CONFIG = 30049;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION2_ENABLE = 46531;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION3_CONFIG = 30050;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION3_ENABLE = 46532;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION4_CONFIG = 30051;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_ALGO_POSITION4_ENABLE = 46533;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_DENOISE_CONFIG = 30047;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_DENOISE_ENABLE = 46529;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_LOUDNORM_INTEGRATED_LU = 10218;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_LOUDNORM_MOMENTARY_LU = 10217;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_KIT_LOUDNORM_SHORTTERM_LU = 10216;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LEFT_RMS_BIGGER = 46525;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LIVE_BALANCE3_CONFIG = 46506;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LIVE_BALANCE3_CONFIG_ENABLE = 46507;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LIVE_BALANCE3_FALLBACK_TO_COMPRESSOR = 46505;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_DRC_COMPRESSOR_RATIO = 10113;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_DRC_COMPRESSOR_THRESHOLD = 10122;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_GAIN_SMOOTHING_IN_SECONDS = 10115;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_IS_FIXED_DRC_COMPRESSOR_RATIO_SI = 10114;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_LIMITER_MAKEUP_GAIN = 10116;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_LOUDNESS_LOOKAHEAD_WINDOW = 10120;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_LOWER_LIMIT_LEVEL = 10119;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_MAX_GAIN = 10117;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_META_SMOOTHING_COUNT = 10121;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_MOMENTARY_LOUDNESS = 10105;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_NOISE_GATE_COMPRESSRATIO = 10103;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_SHORTTERM_LOUDNESS = 10104;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_WINDOW_LOUDNESS = 10106;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_LOUDNESS_STRATEGY_3_WINDOW_PEAK = 10107;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_AFTER_AE = 42731;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_BEFORE_AE = 42730;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_DETECT_DURATION = 42732;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_GET_RESULT_AFTER_AE = 10112;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_GET_RESULT_BEFORE_AE = 10111;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_MODEL_PATH = 10110;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_METRIC_USE_HANDLE_POOL = 42733;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_OUTLET_DB_LIST_STR = 10200;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_OUTLET_DB_VALUE = 10100;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_OUTPUT_DEVICE_TYPE = 3013;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_RENDER_CURRENT_PTS = 1142;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOFT_GAIN = 37032;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOFT_GAIN_ENABLE = 46512;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOFT_GAIN_OPTIMIZE = 37033;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOFT_GAIN_OPTIMIZE_ENABLE = 46534;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOURCE_AED_SCENE = 10211;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_SOURCE_ROUTE = 10210;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_STEREO_PLAYBACK_PARAMETER_UPDATED = 37040;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_STEREO_PLAYBACK_POSITION = 46521;
    ...
    public static final int MEDIA_PLAYER_OPTION_AUDIO_WATER_MARK_APP_ID = 46503;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_WATER_MARK_CONTENT = 46502;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_WATER_MARK_ERROR_CODE = 37030;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_WATER_MARK_INIT_OK = 37031;
    public static final int MEDIA_PLAYER_OPTION_AUDIO_WATER_MARK_WORKING = 37029;
    ...
    public static final int MEDIA_PLAYER_OPTION_AV_JB_LEVEL_IN_MS = 1143;
    ...
    public static final int MEDIA_PLAYER_OPTION_BIND_CORE = 10001;
    ...
    public static final int MEDIA_PLAYER_OPTION_CURRENT_POSITION_OFFSET_INFO = 482;
    ...
    public static final int MEDIA_PLAYER_OPTION_DASH_EVENT = 4013;
    public static final int MEDIA_PLAYER_OPTION_DASH_VIDO_DEMUX_READ_DUR = 4017;
    public static final int MEDIA_PLAYER_OPTION_DASH_VIDO_DEMUX_SWITCH_CNT = 4014;
    public static final int MEDIA_PLAYER_OPTION_DASH_VIDO_DEMUX_SWITCH_UP_CNT = 4015;
    ...
    public static final int MEDIA_PLAYER_OPTION_DENOISE_BOUND = 10214;
    ...
    public static final int MEDIA_PLAYER_OPTION_DISABLE_ALGO_SEI = 42510;
    public static final int MEDIA_PLAYER_OPTION_DISABLE_AUDIO_SOFT_GAIN_AMPLITUDE_CUTOFF = 46537;
    ...
    public static final int MEDIA_PLAYER_OPTION_DYNAMIC_MIX_BACKGROUND_RATE = 36029;
    public static final int MEDIA_PLAYER_OPTION_DYNAMIC_MIX_VOICE_RATE = 36028;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIOX_YGGDRASIL = 4031;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_CHANNEL_EXPAND = 46522;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_DECODER_MONITOR = 42861;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_EFFECT = 302;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_KIT_LOUDNORM = 46536;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_KIT_PROCESS = 46528;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_LIVE_BALANCE3_FALLBACK = 46504;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_LOUDNESS_STRATEGY_3 = 10108;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_MEM_SIZE_OPT = 43213;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_SEEKING_NO_ACCURATE = 1902;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_STEREO_PLAYBACK = 46520;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_AUDIO_WATER_MARK = 46508;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_HARDWARE_BUFFER_CALLBACK = 4025;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_HARDWARE_BUFFER_NATIVE_RENDER = 4036;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_HARDWARE_BUFFER_RENDER_DIRECTLY = 4035;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_MONO_AUDIO_EFFECT = 46535;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_PLAYER_INTERFACE_REFACTOR = 1746;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_SC_ABR_STRATEGY = 4016;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_SC_ABR_WORK_WITH_MANUAL_RESOLUTION = 4042;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_UNIFY_CODEC = 4044;
    ...
    public static final int MEDIA_PLAYER_OPTION_ENABLE_VOICE_CALLBACK = 1172;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_VSYNC_HELPER = 284;
    public static final int MEDIA_PLAYER_OPTION_ENABLE_WILL_RENDER_CALLBACK = 22026;
    ...
    public static final int MEDIA_PLAYER_OPTION_FORMATER_CURRENT_PTS = 1141;
    ...
    public static final int MEDIA_PLAYER_OPTION_GET_AUDIOTRACK_BUFFERSIZE = 966;
    ...
    public static final int MEDIA_PLAYER_OPTION_GET_AUDIO_LATENCY = 1164;
    ...
    public static final int MEDIA_PLAYER_OPTION_GET_DECODE_COUNT = 1165;
    public static final int MEDIA_PLAYER_OPTION_GET_DECODE_TIME = 1166;
    public static final int MEDIA_PLAYER_OPTION_GET_DECODE_TIME_BEFORE_WAIT = 1169;
    ...
    public static final int MEDIA_PLAYER_OPTION_GET_HW_FIRST_DECODE_TIME = 1167;
    ...
    public static final int MEDIA_PLAYER_OPTION_GET_REUSE_AUDIOTRACK = 1168;
    ...
    public static final int MEDIA_PLAYER_OPTION_GLOBAL_MUTE_STATE = 4033;
    public static final int MEDIA_PLAYER_OPTION_GS_AUDIOTRACK_POOL_MAX_USED_COUNT = 1360;
    public static final int MEDIA_PLAYER_OPTION_GS_AUDIOTRACK_POOL_SAMPLES_CHECK = 1361;
    public static final int MEDIA_PLAYER_OPTION_GS_AUDIOTRACK_POOL_SIZE = 1359;
    public static final int MEDIA_PLAYER_OPTION_GS_AUDIO_ADAPTER_MAX_QUEUE_SIZE = 1306;
    public static final int MEDIA_PLAYER_OPTION_GS_AUDIO_ADAPTER_MAX_USE_COUNT = 1307;
    ...
    public static final int MEDIA_PLAYER_OPTION_INITIAL_SIZE_RATE = 483;
    public static final int MEDIA_PLAYER_OPTION_IS_ACTIVE_MONO_AUDIO_EFFECT = 10212;
    public static final int MEDIA_PLAYER_OPTION_IS_AE_UPDATE_LUFS = 1362;
    ...
    public static final int MEDIA_PLAYER_OPTION_IS_ORIGINAL_PTS = 100;
    public static final int MEDIA_PLAYER_OPTION_IS_PLAYER_RELEASING_NOW = 1650;
    public static final int MEDIA_PLAYER_OPTION_IS_RADIO_MODE_VIDEO_HURRY_THRESHOLD = 43005;
    ...
    public static final int MEDIA_PLAYER_OPTION_IS_VIDEOEND_IS_ALLEOF = 57;
    ...
    public static final int MEDIA_PLAYER_OPTION_LAST_VIDO_SWITCH_TIME = 4018;
    ...
    public static final int MEDIA_PLAYER_OPTION_LIVE_ABR_STATISTICS_INFO = 1001;
    ...
    public static final int MEDIA_PLAYER_OPTION_LIVE_BALANCE_USE_HANDLE_POOL = 42734;
    ...
    public static final int MEDIA_PLAYER_OPTION_MEDIA_CODEC_EXT_CONFIG = 4034;
    ...
    public static final int MEDIA_PLAYER_OPTION_OFFSCREEN_RENDERING = 4024;
    ...
    public static final int MEDIA_PLAYER_OPTION_OPEN_AUDIO_METRIC = 10109;
    ...
    public static final int MEDIA_PLAYER_OPTION_PREVIOUS_GOP_BITRATE_IN_KBPS = 1513;
    ...
    public static final int MEDIA_PLAYER_OPTION_READ_SIZE_AT_OPEN_INPUT = 4012;
    ...
    public static final int MEDIA_PLAYER_OPTION_RESET_AUDIO_GRAPH_CACHE_SIZE = 42901;
    public static final int MEDIA_PLAYER_OPTION_RESET_CODEC_WITH_SIDE_DATA = 42511;
    ...
    public static final int MEDIA_PLAYER_OPTION_RTC_MINISDP_Custom_PARAMS = 816;
    ...
    public static final int MEDIA_PLAYER_OPTION_RTC_START_PLAY_STAT_INFO = 799;
    ...
    public static final int MEDIA_PLAYER_OPTION_RTM_ABR_EVENT_NOTIFY = 90;
    public static final int MEDIA_PLAYER_OPTION_RTM_ABR_FUNCTION_CALL = 10118;
    public static final int MEDIA_PLAYER_OPTION_RTM_BYE_BEFORE_CLOSE_FUNCTION_CALL = 10123;
    ...
    public static final int MEDIA_PLAYER_OPTION_RTM_DUMP_DIR = 798;
    public static final int MEDIA_PLAYER_OPTION_RTM_PASS_THROUGH_PARAMS = 897;
    ...
    public static final int MEDIA_PLAYER_OPTION_SET_LIVE_DEMUXER_HANDLE = 503;
    ...
    public static final int MEDIA_PLAYER_OPTION_SWITCH_TO_ADDITION_SUBTITLE = 1603;
    ...
    public static final int MEDIA_PLAYER_OPTION_TAKE_SCREEN_SHOT_SYNC = 4032;
    ...
    public static final int MEDIA_PLAYER_OPTION_THREAD_BUSY_COUNT = 4039;
    public static final int MEDIA_PLAYER_OPTION_THREAD_FREE_COUNT = 4040;
    public static final int MEDIA_PLAYER_OPTION_THREAD_POOL_SIZE = 4041;
    public static final int MEDIA_PLAYER_OPTION_THREAD_PRIORITY_VALUE = 562;
    public static final int MEDIA_PLAYER_OPTION_THREAD_REUSE_COUNT = 4037;
    ...
    public static final int MEDIA_PLAYER_OPTION_THREAD_TOTAL_COUNT = 4038;
    ...
    public static final int MEDIA_PLAYER_OPTION_TTAP_AUDIO_EFFECT_TYPE = 4026;
    ...
    public static final int MEDIA_PLAYER_OPTION_UNIFY_CODEC_RESUSE = 4045;
    ...
    public static final int MEDIA_PLAYER_OPTION_USE_PRE_DEMUXER = 4020;
    public static final int MEDIA_PLAYER_OPTION_USE_SURFACE_CONTROL = 4027;
    public static final int MEDIA_PLAYER_OPTION_USE_SWITCH_CODEC_SEAMLESS = 4043;
    ...
    public static final int MEDIA_PLAYER_OPTION_VC2_ADSP_LIBRARY_PATH = 1140;
    public static final int MEDIA_PLAYER_OPTION_VC2_AVG_LOG_DECODE_TIME = 4022;
    public static final int MEDIA_PLAYER_OPTION_VC2_DECODE_COUNT = 4021;
    public static final int MEDIA_PLAYER_OPTION_VC2_MAX_CACHED_FRAME_NUM = 4028;
    public static final int MEDIA_PLAYER_OPTION_VC2_STD_LOG_DECODE_TIME = 4023;
    ...
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_AVG_COST_TIME = 895;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_ERROR = 245;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_FRAME_COUNT = 896;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_COUNT_REASON1 = 889;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_COUNT_REASON2 = 890;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_COUNT_REASON3 = 891;
    ...
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION = 888;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION_REASON1 = 892;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION_REASON2 = 893;
    public static final int MEDIA_PLAYER_OPTION_VIDEO_RENDER_STALL_DURATION_REASON3 = 894;
    ...
    public static final int MEDIA_PLAYER_OPTION_VIDO_AVG_SWITCH_LAT = 4019;
    ...
    public static final int MEDIA_PLAYER_OUTPUT_DEVICE = 100;
    ...
    public interface OnExternInfoListener {
        void onExternInfo(MediaPlayer mp, int what, String info);

        default void onExternInfo2(MediaPlayer mp, int what, int parameter, String info) {
        }
    }
    ...
    public interface OnLogListener {
        void onLogInfo(MediaPlayer mp, String info);
    }
    ...
    public interface onSARChangedListener {
        void onSARChanged(MediaPlayer mp, int num, int den);
    }
    ...
    float getFloatOption(int key, float dValue);

    int getIntOption(int key, int dValue);

    long getLongOption(int key, long dValue);

    int getPlayerType();

    int getSelectedTrack(int trackType);

    String getStringOption(int key);
    ...
    void mouseEvent(int action, int deltaX, int deltaY);

    void pause();

    default void preDemux() {
    }
    ...
    default PipelineLoader prepareMix(PipelineLoadParams params) {
        return null;
    }
    ...
    void setCacheFile(String path, int mode);
    ...
    void setDataSource(Context context, Uri uri, Map<String, String> headers) throws IllegalArgumentException, SecurityException, IllegalStateException, IOException;

    void setDataSource(IMediaDataSource dataSource) throws IllegalArgumentException, IOException;

    void setDataSource(FileDescriptor fd, long offset, long length) throws IllegalStateException, IllegalArgumentException, IOException;
    ...
    int setFloatOption(int key, float value);

    default void setFloatOptionArray(int[] keys, float[] values) {
    }

    void setIntOption(int key, int value);

    default void setIntOptionArray(int[] keys, int[] values) {
    }

    void setIsMute(boolean isMute);

    long setLongOption(int key, long value);

    default void setLongOptionArray(int[] keys, long[] values) {
    }

    void setLooping(boolean b);

    void setMediaTransport(MediaTransport transport);
    ...
    void setOnExternInfoListener(OnExternInfoListener listener);

    default void setOnImageAvailableListener(ImageReader.OnImageAvailableListener listener, Handler handler) {
    }
    ...
    void setOnSARChangedListener(onSARChangedListener listener);

    void setOnSeekCompleteListener(OnSeekCompleteListener listener);

    void setOnVideoSizeChangedListener(OnVideoSizeChangedListener listener);

    void setPanoVideoControlModel(int model);

    void setPlaybackParams(PlaybackParams params);

    void setScreenOnWhilePlaying(boolean screenOn);

    void setStringOption(int key, String value);

    default void setStringOptionArray(int[] keys, String[] values) {
    }

    void setSurface(Surface surface);

    default void setSurfaceTimeOut(Surface surface, int timeoutMs) {
    }

    default void setTraitObject(int type, TraitObject traitObject) {
    }
    ...
    void switchStream(int bitrate, int streamType);

    void takeScreenshot(OnScreenshotListener listener);

    default void setWindowClient(TTAVWindowClient client) {
    ...
    public static class TrackInfo {
        ...
        public TrackInfo(int streamType, MediaFormat format) {
            this.mFormat = format;
            this.mStreamType = 0;
            if (streamType == 1) {
                this.mStreamType = 2;
