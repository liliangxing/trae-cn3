...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> amb(Iterable<? extends MaybeSource<? extends T>> iterable) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeAmb((MaybeSource[]) null, iterable));
    }
    ...
    public static <T> Maybe<T> fromFuture(Future<? extends T> future) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeFromFuture(future, 0L, (TimeUnit) null));
    }
    ...
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher) {
        return merge(publisher, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> publisher) {
        return mergeDelayError(publisher, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m315as(MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m316to(Function<? super Maybe<T>, R> function) {
        try {
