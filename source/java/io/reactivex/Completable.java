...
public abstract class Completable implements CompletableSource {
    ...
    public static Completable ambArray(CompletableSource... completableSourceArr) {
        ...
        return RxJavaPlugins.onAssembly(new CompletableAmb(completableSourceArr, (Iterable) null));
    }
    ...
    public static Completable amb(Iterable<? extends CompletableSource> iterable) {
        ...
        return RxJavaPlugins.onAssembly(new CompletableAmb((CompletableSource[]) null, iterable));
    }
    ...
    public static Completable merge(Publisher<? extends CompletableSource> publisher) {
        return merge0(publisher, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, false);
    }
    ...
    public static Completable mergeDelayError(Publisher<? extends CompletableSource> publisher) {
        return merge0(publisher, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, true);
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m311as(CompletableConverter<? extends R> completableConverter) {
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <U> U m312to(Function<? super Completable, U> function) {
        try {
    ...
    public final <T> Single<T> toSingle(Callable<? extends T> callable) {
        ...
        return RxJavaPlugins.onAssembly(new CompletableToSingle(this, callable, (Object) null));
    }
