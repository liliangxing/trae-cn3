...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T> Flowable<T> amb(Iterable<? extends Publisher<? extends T>> iterable) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableAmb((Publisher[]) null, iterable));
    }
    ...
    public static <T> Flowable<T> fromFuture(Future<? extends T> future) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableFromFuture(future, 0L, (TimeUnit) null));
    }
    ...
    public static <T, R> Flowable<R> zip(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function) {
        ...
        ObjectHelper.requireNonNull(iterable, "sources is null");
        return RxJavaPlugins.onAssembly(new FlowableZip((Publisher[]) null, iterable, function, bufferSize(), false));
    }
    ...
    public static <T, R> Flowable<R> zipIterable(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z, int i) {
        ...
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        return RxJavaPlugins.onAssembly(new FlowableZip((Publisher[]) null, iterable, function, i, z));
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m313as(FlowableConverter<T, ? extends R> flowableConverter) {
    ...
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return RxJavaPlugins.onAssembly(new FlowableBufferTimed(this, j, j2, timeUnit, scheduler, callable, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, false));
    }
    ...
    public final Flowable<List<T>> buffer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return (Flowable<List<T>>) buffer(j, timeUnit, scheduler, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final Single<T> elementAtOrError(long j) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableElementAtSingle(this, j, (Object) null));
    }
    ...
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function) {
        return flatMapCompletable(function, false, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    public final <R> Flowable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function) {
        return flatMapMaybe(function, false, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    public final <R> Flowable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function) {
        return flatMapSingle(function, false, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    public final Flowable<T> onBackpressureBuffer(int i, boolean z, boolean z2, Action action) {
        ...
        ObjectHelper.verifyPositive(i, PerfConsts.KEY_CURRENT_CAPACITY);
    ...
    public final Flowable<T> onBackpressureBuffer(long j, Action action, BackpressureOverflowStrategy backpressureOverflowStrategy) {
        ...
        ObjectHelper.verifyPositive(j, PerfConsts.KEY_CURRENT_CAPACITY);
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m314to(Function<? super Flowable<T>, R> function) {
        try {
