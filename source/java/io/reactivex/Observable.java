...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static <T> Observable<T> amb(Iterable<? extends ObservableSource<? extends T>> iterable) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableAmb((ObservableSource[]) null, iterable));
    }
    ...
    public static <T, R> Observable<R> combineLatest(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableCombineLatest((ObservableSource[]) null, iterable, function, i << 1, false));
    }
    ...
    public static <T, R> Observable<R> combineLatestDelayError(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i) {
        ...
        ObjectHelper.requireNonNull(function, "combiner is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableCombineLatest((ObservableSource[]) null, iterable, function, i << 1, true));
    }
    ...
    public static <T> Observable<T> fromFuture(Future<? extends T> future) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableFromFuture(future, 0L, (TimeUnit) null));
    }
    ...
    public static <T> Observable<T> merge(ObservableSource<? extends ObservableSource<? extends T>> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "sources is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMap(observableSource, Functions.identity(), false, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, bufferSize()));
    }
    ...
    public static <T> Observable<T> mergeDelayError(ObservableSource<? extends ObservableSource<? extends T>> observableSource) {
        ObjectHelper.requireNonNull(observableSource, "sources is null");
        return RxJavaPlugins.onAssembly(new ObservableFlatMap(observableSource, Functions.identity(), true, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, bufferSize()));
    }
    ...
    public static <T, R> Observable<R> zip(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function) {
        ...
        ObjectHelper.requireNonNull(iterable, "sources is null");
        return RxJavaPlugins.onAssembly(new ObservableZip((ObservableSource[]) null, iterable, function, bufferSize(), false));
    }
    ...
    public static <T, R> Observable<R> zipIterable(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, boolean z, int i) {
        ...
        ObjectHelper.requireNonNull(iterable, "sources is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableZip((ObservableSource[]) null, iterable, function, i, z));
    }
    ...
    @CheckReturnValue
    /* renamed from: as */
    public final <R> R m317as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return RxJavaPlugins.onAssembly(new ObservableBufferTimed(this, j, j2, timeUnit, scheduler, callable, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, false));
    }

    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<List<T>> buffer(long j, TimeUnit timeUnit) {
        return buffer(j, timeUnit, Schedulers.computation(), CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    public final Observable<List<T>> buffer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return (Observable<List<T>>) buffer(j, timeUnit, scheduler, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final <R> Observable<R> concatMapEager(Function<? super T, ? extends ObservableSource<? extends R>> function) {
        return concatMapEager(function, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, bufferSize());
    }
    ...
    public final <R> Observable<R> concatMapEagerDelayError(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z) {
        return concatMapEagerDelayError(function, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME, bufferSize(), z);
    }
    ...
    public final Single<T> elementAtOrError(long j) {
        ...
        return RxJavaPlugins.onAssembly(new ObservableElementAtSingle(this, j, (Object) null));
    }
    ...
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> function, boolean z) {
        return flatMap(function, z, CongestionController.MAX_REQUEST_FREQUENCY_REALTIME);
    }
    ...
    @CheckReturnValue
    /* renamed from: to */
    public final <R> R m318to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C11751.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {
