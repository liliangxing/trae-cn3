...
public final class EndConsumerHelper {
    ...
    public static boolean setOnce(AtomicReference<Disposable> atomicReference, Disposable disposable, Class<?> cls) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m37m((AtomicReference) atomicReference, (Object) null, (Object) disposable)) {
            return true;
        }
        disposable.dispose();
    ...
    public static boolean setOnce(AtomicReference<Subscription> atomicReference, Subscription subscription, Class<?> cls) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m37m((AtomicReference) atomicReference, (Object) null, (Object) subscription)) {
            return true;
        }
        subscription.cancel();
