...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m((AtomicReference) atomicReference, (Object) disposable2, (Object) disposable));
        if (disposable2 == null) {
            return true;
        }
        disposable2.dispose();
    ...
    public static boolean setOnce(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m((AtomicReference) atomicReference, (Object) null, (Object) disposable)) {
            return true;
        }
        disposable.dispose();
