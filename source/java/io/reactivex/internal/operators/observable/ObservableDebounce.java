    ...
    public static final class DebounceObserver<T, U> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                if (UByte$$ExternalSyntheticBackport0.m37m((AtomicReference) this.debouncer, (Object) disposable, (Object) debounceInnerObserver)) {
        ...
        public void onComplete() {
            ...
            this.done = true;
            DisposableHelper disposableHelper = (Disposable) this.debouncer.get();
            if (disposableHelper != DisposableHelper.DISPOSED) {
                ((DebounceInnerObserver) disposableHelper).emit();
                DisposableHelper.dispose(this.debouncer);
