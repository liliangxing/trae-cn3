            ...
            while (true) {
                if (!this.active) {
                    ...
                    try {
                        ...
                        if (!z2) {
                            try {
                                Callable callable = (ObservableSource) ObjectHelper.requireNonNull(this.mapper.apply(poll), "The mapper returned a null ObservableSource");
                                if (callable instanceof Callable) {
                                    ...
                                    this.active = true;
                                    callable.subscribe(this.observer);
                                }
                            } catch (Throwable th2) {
                                Exceptions.throwIfFatal(th2);
                                this.cancelled = true;
