...
public final class ParallelRunOn<T> extends ParallelFlowable<T> {
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        if (validate(subscriberArr)) {
            ...
            SchedulerMultiWorkerSupport schedulerMultiWorkerSupport = this.scheduler;
            if (schedulerMultiWorkerSupport instanceof SchedulerMultiWorkerSupport) {
                schedulerMultiWorkerSupport.createWorkers(length, new MultiWorkerCallback(subscriberArr, subscriberArr2));
            } else {
