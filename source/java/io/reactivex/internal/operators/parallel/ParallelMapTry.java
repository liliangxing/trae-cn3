...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
        ...
        public boolean tryOnNext(T t) {
            ...
            do {
                try {
                    ...
                    try {
                        j++;
                        i = C00051.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling[((ParallelFailureHandling) ObjectHelper.requireNonNull(this.errorHandler.apply(Long.valueOf(j), th), "The errorHandler returned a null item")).ordinal()];
                    } catch (Throwable th2) {
    ...
    /* loaded from: /data/user/work/trae_cn3_decoded/build/apk/classes8.dex */
    public static /* synthetic */ class C00051 {
