...
public abstract class CoreProps {
    ...
    public static final Prop<Integer> LIST_ITEM_REAL_LEVEL = Prop.of("list-item-real-level");
    public static final Prop<Integer> ORDERED_LIST_ITEM_NUMBER = Prop.of("ordered-list-item-number");
    public static final Prop<Boolean> LIST_ITEM_REAL_SELF = Prop.of("list-item-real-self");
    ...
    public static final Prop<Map<String, String>> LINK_EXTRA = Prop.of("link-extra");
    public static final Prop<Boolean> PARAGRAPH_IS_IN_TIGHT_LIST = Prop.of("paragraph-is-in-tight-list");
    public static final Prop<HashMap<String, Integer>> RENDER_NODE_INFO = Prop.of("render_node_info");
