...
public class MarkwonTheme {
    ...
    public final boolean disableLooseListMargin;
    public final boolean enablePlaceHolderIfDestinationBlank;
    ...
    protected final int orderedListItemColor;
    public final float textLineMulti;
    ...
    protected MarkwonTheme(Builder builder) {
        ...
        this.orderedListItemColor = builder.orderedListItemColor;
        this.bulletListItemColor = builder.bulletListItemColor;
        this.blankSpaceMulti = builder.blankSpaceMulti;
        this.textLineMulti = builder.textLineMulti;
        ...
        this.enablePlaceHolderIfDestinationBlank = builder.enablePlaceHolderIfDestinationBlank;
        this.disableLooseListMargin = builder.disableLooseListMargin;
    }
    ...
    public void applyListItemStyle(Paint paint, boolean z) {
        int i;
        if (z) {
            i = this.orderedListItemColor;
            if (i == 0) {
                i = this.listItemColor;
            }
        } else {
            i = this.bulletListItemColor;
            if (i == 0) {
                i = this.listItemColor;
            }
        }
    ...
    public static class Builder {
        ...
        private boolean disableLooseListMargin;
        private boolean enablePlaceHolderIfDestinationBlank;
        ...
        private int orderedListItemColor;
        private float textLineMulti;
        private int thematicBreakColor;
        private int thematicBreakHeight;

        Builder() {
            this.isLinkUnderlined = true;
            this.blankSpaceMulti = 1.0f;
            this.textLineMulti = 1.0f;
            this.headingBreakHeight = -1;
            this.thematicBreakHeight = -1;
            this.enablePlaceHolderIfDestinationBlank = false;
            this.disableLooseListMargin = false;
        }
        ...
        Builder(MarkwonTheme markwonTheme) {
            ...
            this.blankSpaceMulti = markwonTheme.blankSpaceMulti;
            ...
            this.enablePlaceHolderIfDestinationBlank = markwonTheme.enablePlaceHolderIfDestinationBlank;
            this.disableLooseListMargin = markwonTheme.disableLooseListMargin;
        }
        ...
        public Builder bulletListItemColor(int i) {
            this.bulletListItemColor = i;
            return this;
        }

        public Builder orderedListItemColor(int i) {
            this.orderedListItemColor = i;
            return this;
        }

        public Builder blankLineSpace(float f) {
            this.blankSpaceMulti = f;
            return this;
        }

        public Builder textLineSpace(float f) {
            this.textLineMulti = f;
            return this;
        }
        ...
        public Builder showImagePlaceHolderIfDestinationBlank(boolean z) {
            this.enablePlaceHolderIfDestinationBlank = z;
            return this;
        }

        public Builder disableLooseListMargin(boolean z) {
            this.disableLooseListMargin = z;
            return this;
        }
