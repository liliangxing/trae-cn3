...
public abstract class ImageProps {
    ...
    public static final Prop<Integer> IMAGE_START_INDEX = Prop.of("image-start-index");
    public static final Prop<Integer> IMAGE_END_INDEX = Prop.of("image-end-index");
    public static final Prop<Integer> IMAGE_START_MARGIN = Prop.of("image-start-margin");
