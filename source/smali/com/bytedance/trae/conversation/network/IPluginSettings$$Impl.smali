...
.class public Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;
.super Ljava/lang/Object;
.source "IPluginSettings$$Impl.java"

.implements Lcom/bytedance/trae/conversation/network/IPluginSettings;
...
.method static constructor <clinit>()void
    ...
    sput-object v0, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->GSON Lcom/google/gson/Gson;
    return-void 
.end method
...
.method public constructor <init>(com.bytedance.news.common.settings.api.Storage)void
    ...
    iput-object v0, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mStickySettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;
    invoke-direct v0, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V
    iput-object v0, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mTransientSettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;
    invoke-direct v0, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V
    iput-object v0, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mCachedSettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl$1;
    invoke-direct v0, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl$1;-><init>(Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;)V
    iput-object v0, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mInstanceCreator Lcom/bytedance/news/common/settings/internal/InstanceCreator;
    iput-object v2, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    ...
    move-result-object v2
    iput-object v2, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mExposedManager Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    move-result-object v2
    iput-object v2, v1, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    return-void 
.end method

.method public getCliTaskPluginMinIdeVersion()java.lang.String
    .registers 5
    # ins_size=1
    iget-object v0, v4, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mExposedManager Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    const-string v1, "cli_task_plugin_min_ide_version"
    ...
    move-result v0
    if-eqz v0, +034h
    iget-object v0, v4, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    if-eqz v0, +030h
    ...
    invoke-interface v0, v3, v2, Ljava/util/Map;->put(Ljava/lang/Object; Ljava/lang/Object;)Ljava/lang/Object;
    iget-object v2, v4, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    const-string v3, "get settings key = cli_task_plugin_min_ide_version"
    invoke-interface v2, v3, v0, Lcom/bytedance/services/apm/api/IEnsure;->ensureNotReachHere(Ljava/lang/String; Ljava/util/Map;)V
    iget-object v0, v4, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    if-eqz v0, +00fh
...
.method public updateSettings(com.bytedance.news.common.settings.api.SettingsData)void
    ...
    move-result-object v0
    const-string v1, "nova_settings_com.bytedance.trae.conversation.network.IPluginSettings"
    if-nez v7, +072h
    ...
    if-eqz v7, +005h
    invoke-virtual v0, v1, v5, Lcom/bytedance/news/common/settings/internal/MetaInfo;->setSettingsVersion(Ljava/lang/String; I)V
    iget-object v4, v6, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    if-eqz v4, +03fh
    ...
    invoke-interface v4, v2, v3, Lcom/bytedance/services/apm/api/IEnsure;->ensureNotReachHere(Ljava/lang/Throwable; Ljava/lang/String;)V
    if-eqz v7, +029h
    iget-object v2, v6, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    if-eqz v2, +025h
    invoke-virtual v7, Lcom/bytedance/news/common/settings/api/SettingsData;->getAppSettings()Lorg/json/JSONObject;
    move-result-object v2
    if-eqz v2, +013h
    const-string v3, "cli_task_plugin_min_ide_version"
    invoke-virtual v2, v3, Lorg/json/JSONObject;->has(Ljava/lang/String;)Z
    move-result v4
    if-eqz v4, +00bh
    iget-object v4, v6, Lcom/bytedance/trae/conversation/network/IPluginSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
