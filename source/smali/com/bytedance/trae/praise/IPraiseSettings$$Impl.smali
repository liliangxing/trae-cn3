...
.class public Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;
.super Ljava/lang/Object;
.source "IPraiseSettings$$Impl.java"

.implements Lcom/bytedance/trae/praise/IPraiseSettings;
...
.method static constructor <clinit>()void
    ...
    sput-object v0, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->GSON Lcom/google/gson/Gson;
    return-void 
.end method
...
.method public constructor <init>(com.bytedance.news.common.settings.api.Storage)void
    ...
    iput-object v0, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStickySettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;
    invoke-direct v0, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V
    iput-object v0, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mTransientSettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;
    invoke-direct v0, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V
    iput-object v0, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mCachedSettings Ljava/util/concurrent/ConcurrentHashMap;
    new-instance v0, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl$1;
    invoke-direct v0, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl$1;-><init>(Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;)V
    iput-object v0, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mInstanceCreator Lcom/bytedance/news/common/settings/internal/InstanceCreator;
    iput-object v2, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    ...
    move-result-object v2
    iput-object v2, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mExposedManager Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    move-result-object v2
    iput-object v2, v1, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    return-void 
.end method

.method public getAndroidAppRating()com.google.gson.JsonObject
    .registers 6
    # ins_size=1
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mExposedManager Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    const-string v1, "android_app_rating_v1"
    ...
    move-result v0
    if-eqz v0, +034h
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    if-eqz v0, +030h
    ...
    invoke-interface v0, v3, v2, Ljava/util/Map;->put(Ljava/lang/Object; Ljava/lang/Object;)Ljava/lang/Object;
    iget-object v2, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    const-string v3, "get settings key = android_app_rating_v1"
    invoke-interface v2, v3, v0, Lcom/bytedance/services/apm/api/IEnsure;->ensureNotReachHere(Ljava/lang/String; Ljava/util/Map;)V
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStickySettings Ljava/util/concurrent/ConcurrentHashMap;
    ...
    goto +49h
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mCachedSettings Ljava/util/concurrent/ConcurrentHashMap;
    invoke-virtual v0, v1, Ljava/util/concurrent/ConcurrentHashMap;->containsKey(Ljava/lang/Object;)Z
    move-result v0
    if-eqz v0, +00bh
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mCachedSettings Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v0, Lcom/google/gson/JsonObject;
    goto +31h
    iget-object v0, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    const/4 v2, 0
    if-eqz v0, +025h
    ...
    move-result-object v0
    sget-object v3, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->GSON Lcom/google/gson/Gson;
    new-instance v4, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl$2;
    invoke-direct v4, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl$2;-><init>(Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;)V
    invoke-virtual v4, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl$2;->getType()Ljava/lang/reflect/Type;
    ...
    move-object v0, v2
    if-eqz v0, +007h
    iget-object v2, v5, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStickySettings Ljava/util/concurrent/ConcurrentHashMap;
...
.method public updateSettings(com.bytedance.news.common.settings.api.SettingsData)void
    ...
    move-result-object v0
    const-string/jumbo v1, praise_settings_com.bytedance.trae.praise.IPraiseSettings
    if-nez v7, +072h
    ...
    if-eqz v7, +005h
    invoke-virtual v0, v1, v5, Lcom/bytedance/news/common/settings/internal/MetaInfo;->setSettingsVersion(Ljava/lang/String; I)V
    iget-object v4, v6, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->iEnsure Lcom/bytedance/services/apm/api/IEnsure;
    if-eqz v4, +03fh
    ...
    invoke-interface v4, v2, v3, Lcom/bytedance/services/apm/api/IEnsure;->ensureNotReachHere(Ljava/lang/Throwable; Ljava/lang/String;)V
    if-eqz v7, +02eh
    iget-object v2, v6, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    if-eqz v2, +02ah
    invoke-virtual v7, Lcom/bytedance/news/common/settings/api/SettingsData;->getAppSettings()Lorg/json/JSONObject;
    move-result-object v2
    if-eqz v2, +018h
    const-string v3, "android_app_rating_v1"
    invoke-virtual v2, v3, Lorg/json/JSONObject;->has(Ljava/lang/String;)Z
    move-result v4
    if-eqz v4, +010h
    iget-object v4, v6, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mStorage Lcom/bytedance/news/common/settings/api/Storage;
    ...
    iget-object v2, v6, Lcom/bytedance/trae/praise/IPraiseSettings$$Impl;->mCachedSettings Ljava/util/concurrent/ConcurrentHashMap;
